<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyCashCollectionRTOLocationWise_WithSmsDealer.aspx.cs" Inherits="HSRP.BusinessReports.DailyCashCollectionRTOLocationWise_WithSmsDealer" %>
                                            ...
                                            <tr>
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                 <asp:Button ID="Button1" runat="server" 
                                                    ...
                                                    &nbsp;</td>
                                                    <td>
                                               <asp:Button ID="btnExportToExcel" runat="server"  Visible="false"
                                                        Text="Records With Complete Info" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="btnExportToExcel_Click" />
                                            
                                                </td>
                                                <td>
                                                  <asp:Button ID="btnAllLocationPdf" runat="server" Visible="false"
