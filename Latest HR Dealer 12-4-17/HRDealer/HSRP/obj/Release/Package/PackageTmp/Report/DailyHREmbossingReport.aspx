        ...
        <tr>
            <td valign="top">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            <table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    <td>
                                        ...
                                        <asp:UpdatePanel runat="server" ID="UpdateClient" UpdateMode="Conditional">
                                            ...
                                            <Triggers>                                                 
                                                ...
                                                <td valign="middle" align="left" style="width:25px">
                                                    <img id="calendar_from_button" tabindex="3" alt="" onclick="OrderDate_OnClick()"
                                                        onmouseup="OrderDate_OnMouseUp()" class="calendar_button" src="../images/btn_calendar.gif" />
                                                </td>
                                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 40px">
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;" width="500px"nowrap="nowrap">
                                                    ...
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="Report In Excel" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="btnExportToExcel_Click" Width="0px" 
                                                        Visible="False" />
                                                    <asp:Button ID="btnExportToPDF" runat="server" Text="Report In PDF" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="btnExportToPDF_Click" Width="100px" />
                                                         ...
                                                         <asp:Button ID="btnAll" runat="server" Text="All Report In PDF" ToolTip="Please Click for Report" Visible="false"
                                                        class="button"  OnClick="btnAllReportPDF_Click" Width="0px" />
                                                </td>
