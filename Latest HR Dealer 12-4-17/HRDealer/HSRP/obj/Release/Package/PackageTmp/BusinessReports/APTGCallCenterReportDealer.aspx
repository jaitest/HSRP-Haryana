<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="APTGCallCenterReportDealer.aspx.cs" Inherits="HSRP.BusinessReports.APTGCallCenterReportDealer" %>
...
<script type="text/javascript" src="../windowfiles/dhtmlwindow.js"></script>
    ...
    <script type="text/javascript">
     function OpenPopUp(recordId) {
         window.open('UKNewProcessStatus.aspx?vehicleregno=' + recordId, 'MyWindow', 'width=200,height=600');
            return false;
     }
        </script>
    <script type="text/javascript">
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="15">
                                        <span class="headingmain">AP TG Call Center Report</span>
                                    </td>
                                </tr>
                                        <tr>
    ...
    ControlType="Picker" PickerCssClass="picker">
                                                ...
                                                <td>
                                                    <asp:Button ID="btnexport" runat="server" onclick="btnexport_Click" Text="GO" 
                                                        Font-Bold="True" onclientclick="validate()"  BackColor="Orange" ForeColor="#000000"/>
                                                </td>
                                ...
                                <td colspan="15">
                                  <asp:GridView ID="grdpending" runat="server" CellPadding="8" ForeColor="#333333"  AutoGenerateColumns="false"
                                        GridLines="None" Width="700px"  OnSelectedIndexChanged="grdpending_SelectedIndexChanged" OnRowCommand="grdpending_RowCommand">
        ...
        <ItemTemplate>
       <asp:LinkButton runat="server" ID="lnkView" CommandArgument='<%#Eval("vehicleregno") %>'
         CommandName="Approval">Remark</asp:LinkButton>
         </ItemTemplate>
       </asp:TemplateField>--%>

                                        <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick='<%# Eval("vehicleregno", "return OpenPopUp({0})") %>'
                            Text="Open Pop Up"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
