...
namespace HSRP.EmbossingData
{
    public partial class Embossing : System.Web.UI.Page
    {
        ...
        private void ShowGrid()
        {
            ...
            {
                SQLString = "select hsrprecordid,vehicleregno,hsrp_rear_lasercode,hsrp_Front_lasercode,HSRPRecord_AuthorizationNo,hsrpRecord_CreationDate,  MobileNo from hsrprecords where hsrp_stateid ='" + HSRPStateID + "' and PdfFileName='" + dropdownDuplicateFIle.SelectedItem.ToString() + "' and orderstatus ='New Order' and addrecordby = 'Dealer' order by VehicleClass,VehicleType,VehicleRegNo";                          
        ...
        protected void btnGO_Click(object sender, EventArgs e)
        {
            ...
            SQLString = "select  Distinct pdffilename   from hsrprecords  where hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and addrecordby = 'Dealer'  and rtolocationID='" + dropDownListClient.SelectedValue + "' and  pdffilename is not null and Hsrprecord_creationdate between '" + AuthorizationDate + "' and  '" + ToDate + "' and orderstatus='New Order' group by  pdffilename, convert(varchar,pdfdownloaddate,111)";
