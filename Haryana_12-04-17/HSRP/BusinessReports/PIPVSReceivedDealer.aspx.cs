...
{
    public partial class PIPVSReceivedDealer : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "Business_report_PIPVSReceivedSummaryDealer");
        ...
        protected void btnDetail_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            string strParameter = string.Empty;
            cmd = new SqlCommand("Business_report_PIPVSReceivedSummaryDealer", con);
        ...
        protected void grdid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day5orMore")
            {
                ...
                //strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,aptgvehrecdate,103)<=dateadd(day,-1,'" + day4date + "') and HSRPRecord_CreationDate>'" + BusinessReportStartDate + "'  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");

                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,isnull(aptgvehrecdate,hsrprecord_creationdate),103)<=dateadd(day,-1,'" + day4date + "') and HSRPRecord_CreationDate>'" + BusinessReportStartDate + "' and isnull(VehicleRegNo,'')!='' and  isnull(erpassigndate,'') !='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            ...
            if (e.CommandName == "Day1")
            {
                ...
                Label Day1 = (Label)grdid.Rows[RowIndex].FindControl("lblDay1Date");
                day1date = Day1.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,aptgvehrecdate,103) between  dateadd(day,0,'" + day1date + "' ) and '" + ReportDate2 + "' and isnull(VehicleRegNo,'')!='' and  isnull(erpassigndate,'') !='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");

                //strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,isnull(aptgvehrecdate,hsrprecord_creationdate),103) between  dateadd(day,0,'" + day1date + "' ) and dateadd(day,1,'" + ReportDate2 + "' ) and isnull(VehicleRegNo,'')!='' and  isnull(erpassigndate,'') !='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
                //strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "'  and convert(date,isnull(aptgvehrecdate,hsrprecord_creationdate),103) between '" + day1date + "' and '" + ReportDate2 + "' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day2")
            {
               ...
               // strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,isnull(aptgvehrecdate,hsrprecord_creationdate),103) between  '" + day2date + "' and dateadd(day,-1,'" + day1date + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
                //strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,isnull(aptgvehrecdate,hsrprecord_creationdate),103) between  dateadd(day,0,'" + day1date + "' ) and '" + ReportDate2 + "' and isnull(VehicleRegNo,'')!='' and  isnull(erpassigndate,'') !='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");

                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,aptgvehrecdate,103) between  '" + day2date + "' and dateadd(day,-1,'" + day1date + "') and isnull(VehicleRegNo,'')!='' and  isnull(erpassigndate,'') !='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day3")
            {
                ...
                //strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,isnull(aptgvehrecdate,hsrprecord_creationdate),103) between  '" + day3date + "' and  dateadd(day,-1,'" + day2date + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,aptgvehrecdate,103) between  '" + day3date + "' and  dateadd(day,-1,'" + day2date + "') and isnull(VehicleRegNo,'')!='' and  isnull(erpassigndate,'') !='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day4")
            {
                ...
                Label Day4 = (Label)grdid.Rows[RowIndex].FindControl("lblDay4Date");
                day4date = Day4.Text.ToString();
               // strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,isnull(aptgvehrecdate,hsrprecord_creationdate),103) between  '" + day4date + "' and dateadd(day,-1,'" + day3date + "')   and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,aptgvehrecdate,103) between  '" + day4date + "' and dateadd(day,-1,'" + day3date + "') and isnull(VehicleRegNo,'')!='' and  isnull(erpassigndate,'') !=''  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
        ...
        private void SaveAndDownloadFile12()
        {
            ...
            Export12(strOrderType, book, 1, "Business_report_PIPVSReceivedSummaryDealer");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day5orMore")
            {
                ...
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,aptgvehrecdate,103)<=dateadd(day,-4,'" + ReportDate2 + "') and hsrprecord_creationdate>'" + BusinessReportStartDate + "' and isnull(VehicleRegNo,'')!='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            ...
            if (e.CommandName == "Day1")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,aptgvehrecdate,103)=dateadd(day,0,'" + ReportDate2 + "') and isnull(VehicleRegNo,'')!='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day2")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,aptgvehrecdate,103)=dateadd(day,-1,'" + ReportDate2 + "') and isnull(VehicleRegNo,'')!='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day3")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,aptgvehrecdate,103)=dateadd(day,-2,'" + ReportDate2 + "') and isnull(VehicleRegNo,'')!='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day4")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,aptgvehrecdate,103)=dateadd(day,-3,'" + ReportDate2 + "') and isnull(VehicleRegNo,'')!='' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
