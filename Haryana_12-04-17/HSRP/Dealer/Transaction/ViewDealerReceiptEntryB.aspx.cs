...
{
    public partial class ViewDealerReceiptEntryB : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                bl.DailyEnityDeatail(Session["UID"].ToString(), "DealerReceiptEntryB.aspx");
        ...
        public void edit()
        {
            ...
            ddlPaymentMode.SelectedItem.Text = dt.Rows[0]["mode"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                "ChequeDeliveredBy,mode) Values(2,'" + OrderDate.SelectedDate + "'," +
                "" + ddlDealerName.SelectedValue.ToString() + ",'" + txtChequeAmount.Text + "','" + txtChequeNo.Text + "','" + txtDrawnBankName.Text + "'," +
                "'" + txtDeliveredBy.Text + "','" + ddlPaymentMode.SelectedItem.Text + "')";
        ...
        protected void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            SQLString = "update dbo.DealerReceiptEntry set mode='"+ddlPaymentMode.SelectedItem.Text+"', ChequeDate='" + OrderDate.SelectedDate + "'" +
        ...
        public void Refresh()
        {
            ddlPaymentMode.Text = "--Select Payment Mode--";
        ...
        protected void ddlPaymentMode_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlPaymentMode.SelectedItem.Text == "Cash")
            {
                ...
                txtDrawnBankName.Enabled = false;
                txtChequeNo.Text = "";
                txtDeliveredBy.Text = "";
                txtDrawnBankName.Text = "";
            }
