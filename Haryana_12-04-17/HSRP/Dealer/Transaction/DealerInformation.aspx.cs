    ...
    public partial class DealerInformation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                bl.DailyEnityDeatail(Session["UID"].ToString(), "DealerInformation.aspx");
                DealerName();
        ...
        public void DealerName()
        {
            ...
            ddlDealerName.Items.Insert(0, "--Select State Name--");
            ddlDealerName.Items[0].Value = "--Select State Name--";
        }
