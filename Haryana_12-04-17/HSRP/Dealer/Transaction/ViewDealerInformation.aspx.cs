...
{
    public partial class ViewDealerInformation : System.Web.UI.Page
    {
        ...
        public void buildGrid()
        {
            try
            {
               ...
               // string OrderStatus = dropDownListorderStatus.SelectedItem.Text;
                ...
                SQLString = "SELECT CONVERT (varchar(20),DateOfIssue,103) as DateOfIssue,ImperestID as SNo,ImperestID,ImperestAmt,Remarks FROM ImperestDetails where HSRPStateID='" + HSRPStateID + "' and RTOLocationID='" + RTOLocationID + "' and UserID='" + dropDownListUser.SelectedValue + "' and DateOfIssue  between '" + AuthorizationDate + "' and '" + OrderDate1 + "' ";
