...
{
    public partial class BiharDealerDownloadProductionWithDate : System.Web.UI.Page
    {
        ...
        private void FilldropDownListClient()
        {
            if (UserType == "0")
            {
                ...
                //SQLString = "select distinct dealerid,(select [dealername] from dealerMaster a where a.DealerId=hsrprecords.dealerid) as DealerName from hsrprecords where HSRP_StateID=" + intHSRPStateID + " and Addrecordby='Dealer'";

                Utils.PopulateDropDownList(dropDownListClient, SQLString.ToString(), CnnString, "--ALL--");
               // Utils.DealerNameDropDownList(dropDownListClient, SQLString.ToString(), CnnString, "--ALL--");
