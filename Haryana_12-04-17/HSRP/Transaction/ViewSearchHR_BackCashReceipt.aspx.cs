...
{
    public partial class ViewSearchHR_BackCashReceipt : System.Web.UI.Page
    {
        ...
        protected void Grid1_ItemCommand(object sender, ComponentArt.Web.UI.GridItemCommandEventArgs e)
        {
            ...
            // && Date.ToString() == CreationDate.ToString("MM/dd/yyyy")

            if (Session["UID"].ToString() != "7593")
            {
            ...
            //if (Createdby.Trim().ToString() == "7593")
            //{
           ...
           // }
            ...
            //    lblErrMsg.Text = "Get Only Last Two Month Receipt";
            //    return;
