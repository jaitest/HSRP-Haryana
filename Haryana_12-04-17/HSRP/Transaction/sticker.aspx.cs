...
namespace HSRP.EmbossingData
{
    public partial class Sticker : System.Web.UI.Page
    {
        ...
        private void ShowGrid()
        {
            ...
            {
                string SQLString = "select hsrprecordid,vehicleregno,hsrp_rear_lasercode,hsrp_Front_lasercode,OrderStatus from hsrprecords where OrderStatus in('Embossing Done') and PdfFileName='" + dropdownDuplicateFIle.SelectedItem.ToString() + "' and StickerMandatory='Y'";
