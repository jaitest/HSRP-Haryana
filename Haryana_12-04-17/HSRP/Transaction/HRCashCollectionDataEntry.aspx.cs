...
namespace HSRP.Transaction
{
    public partial class HRCashCollectionDataEntry : System.Web.UI.Page
    {
        ...
        //        Utils.PopulateDropDownList(DropdownRTOName, SQLString.ToString(), ConnectionString, "--Select RTO Location--");
        //    }
        //    else
        //    {
        //        SQLString = "select RTOLocationName,RTOLocationID from RTOLocation Where HSRP_StateID=" + HSRPStateID + " and ActiveStatus!='N'  Order by RTOLocationName";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               string strQuery = "insert into HSRPRecords (hsrprecord_authorizationno,hsrprecord_authorizationdate,SaveMacAddress,DeliveryChallanNo,ISFrontPlateSize,ISRearPlateSize,invoiceno, address1," +
                       ...
                       Math.Round(decimal.Parse(lblAmount.Text), 0) + "','" + dt.Rows[0]["vatper"].ToString() + "','" + date1 + "','" + DepositDate.SelectedDate + "','','','" + txtRegNumber.Text + "','WebDirect', '" + StickerMandatory + "')";
