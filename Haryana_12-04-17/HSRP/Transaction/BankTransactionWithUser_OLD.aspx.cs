...
{
    public partial class BankTransactionWithUser_OLD : System.Web.UI.Page
    {
        ...
        public void FillUsers()
        {
            ...
            query1 = "SELECT UserID,UserFirstName FROM USERS WHERE HSRP_STATEID='" + HSRPStateID + "'";
            DataTable dt = Utils.GetDataTable(query1, ConnectionString);
            ddl_user.DataSource = dt;
            ddl_user.DataTextField = "UserFirstName";
        ...
        private void Filldropdowndealer()
        {
            if (HSRPStateID == "2")
            {
                if (UserType == "0")
                {
                    ddlBothDealerHHT1.Visible = false;
                    SQLString = "select SNO,[NAME OF THE DEALER] from delhi_dealermaster  where ActiveStatus='Y'";
                    //Utils.PopulateDropDownList(ddlBothDealerHHT, SQLString.ToString(), ConnectionString, "--Select Dealer Name--");
                    DataTable dts = Utils.GetDataTable(SQLString, ConnectionString);
                    ddlBothDealerHHT.DataSource = dts;
                    ddlBothDealerHHT.DataTextField = "NAME OF THE DEALER";
                    ddlBothDealerHHT.DataValueField = "SNO";
                    ddlBothDealerHHT.DataBind();
                    ddlBothDealerHHT.Items.Insert(0, "--Select Dealer Name--");
                    ddlBothDealerHHT.Items[0].Value = "0";
            ...
            else
            {
                ...
                if (UserType == "0")
                {
                    ...
                    SQLString = "select DealerId,dealername from dealerMaster";
        ...
        protected void ButtonSubmit_Click(object sender, EventArgs e)
        {
           ...
           // OrderDate1 = System.DateTime.Now;
            ...
            String From2 = StringOrderDate[0] + "/" + StringOrderDate[1] + "/" + StringOrderDate[2].Split(' ')[0];
            OrderDate2 = new DateTime(Convert.ToInt32(StringOrderDate[2].Split(' ')[0]), Convert.ToInt32(StringOrderDate[0]), Convert.ToInt32(StringOrderDate[1]));
            // OrderDate1 = System.DateTime.Now;
