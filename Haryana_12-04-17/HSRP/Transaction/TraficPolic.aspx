<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TraficPolic.aspx.cs" Inherits="HSRP.Transaction.TraficPolic" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintChalan(i, S) {
            ...
            //            alert("Hello");
            googlewin = dhtmlwindow.open("googlebox", "iframe", "ViewPrintInvoice.aspx?Mode=PrintChalan&HSRPRecordID=" + i + "&Status=" + S + "", "Print Invoice", "width=400px,height=75px,resize=1,scrolling=1,center=2", "recal")
            googlewin.onclose = function () {
    ...
    <script language="javascript" type="text/javascript">
        function validate() { 
            ...
            if (invalidChar(document.getElementById("txtSearchAll"))) {
                alert("Special Characters Not Allowed.");
                document.getElementById("txtSearchAll").focus();
                return false;
            }
        } 
    </script>

    <table id="Table1" runat="server"  style="height:800px" width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="midtable">
        <tr>
            <td valign="top">
                                ...
                                <tr>
                                    ...
                                    <td style="width:378px">
                                     <asp:Label ForeColor="Black" Font-Size="Medium" Text="Enter Vehicle Reg No. :" runat="server" ID="label1" />&nbsp;&nbsp;
                                                 <asp:TextBox ID="txtSearchAll" onblur="this.value=removeSpaces(this.value);" runat="server"></asp:TextBox>
                                        
                                    
                                    </td>
                                    <td style=" margin-left:-50px; width: 161px;" align="left">
                    ...
                    <tr>
                        <td>
                            <table width="99%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <tr > 
                                <td><br /></td>
                                <td  ><div id="vehshow" runat="server" style="text-align: center;"> </div></td>
                                </tr>
                                <%--<tr>
                                    <td colspan="2">
                                                ...
                                                <ComponentArt:GridLevel DataKeyField="HSRPRecordID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <ComponentArt:GridColumn DataField="HSRPRecordID" Visible="False" />
                                                         <ComponentArt:GridColumn DataField="OrderDate" HeadingText="Data Entry Date" SortedDataCellCssClass="SortedDataCell" Width="90" />
