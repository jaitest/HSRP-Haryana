<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HSRPSummeryState_WiseReport.aspx.cs" Inherits="HSRP.Report.HSRPSummeryState_WiseReport" Title="Daily Summery State Wise" %>
            ...
            <td valign="top">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Summary Location Wise</span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                ...
                                <td></td>
                                 <td valign="middle" class="form_text" nowrap="nowrap">
                                       ...
                                       <asp:Label ID="Label2" runat="server" Text="HSRP State:"></asp:Label>
                                    </td>
                                    ...
                                    <td valign="middle">
                                        ...
                                        <asp:DropDownList ID="ddlState" runat="server" DataTextField="HSRPStateName" 
                                            DataValueField="HSRP_StateID" Height="16px" Width="119px">
                                        </asp:DropDownList>
                                    </td>
                                    ...
                                    <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 97px;";>  
                                                                  <asp:Label Text="Order Type:" runat="server" ID="labelDate0" /> </td>
                    ...
                    <asp:DropDownList ID="DropDownListOrderType" runat="server" 
                        ...
                        DataValueField="HSRP_StateID" Height="25px" Width="80px">
                        ...
                        <asp:ListItem Value="N">Non Dealer</asp:ListItem>
                                                            ...
                                                            <td style="font-size: 10px;">
                                                              ...
                                                              <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 97px;";> 
                                                                  <asp:Label Text="From:" Visible="true" runat="server" ID="labelDate" /> </td>
                                                              <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 97px;";> 
                                                              ...
                                                              <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 30.px;"
                                        ;> 
                                                                <img id="calendar_from_button" tabindex="3" alt="" onclick="OrderDate_OnClick()"
                                                                    onmouseup="OrderDate_OnMouseUp()" class="calendar_button" src="../images/btn_calendar.gif" /></td>
                                                              <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 50px;"
                                        ;> <asp:Label Text="To:" Visible="true" runat="server" ID="label1" /> </td>
                                    ...
                                    <tr>
                                    <td colspan="11" style="height: 14px">
