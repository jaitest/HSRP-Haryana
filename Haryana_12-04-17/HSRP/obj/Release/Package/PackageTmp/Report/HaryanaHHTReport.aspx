<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HaryanaHHTReport.aspx.cs" Inherits="HSRP.Report.HaryanaHHTReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Haryana HHT Report
                                        </span>
                                    </td>
                                                ...
                                                <td style="position: relative; Left: 0px; top: 0px; width:150px">
                                                   ...
                                                   <td style="position: relative; left: 0px; top: 0px; width:150px">
                                                    <asp:Button ID="btnVoidSummary" runat="server" Text="Void Summary" 
                                                        ...
                                                        class="button" onclick="btnVoidSummary_Click" />
                                                </td>
                                              <td style="position: relative; left: 0px; top: 0px; width:150px">
                                                    &nbsp;</td>
                                                <tr>
