<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BlockVehicleReport.aspx.cs" Inherits="HSRP.Report.BlockVehicleReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Blocked Vehicle Report</span>
                                    </td>
                                ...
                                <tr>
                                   <%-- <td valign="middle" class="form_text" nowrap="nowrap">
                                                ...
                                                <td valign="middle" width="100px">
                                                    <asp:DropDownList Visible="true"  ID="DropDownListStateName"
                                          ...
                                          --%>     
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnGo" runat="server" Text="Export" 
                                                        ToolTip="Please Click for Report" Width="100px"
                                                        class="button" onclick="btnGo_Click" BackColor="Orange" ForeColor="#000000" />
                                                </td>

                                <td colspan="9">
                                                        <asp:Label ID="LabelError"  Visible="false" runat="server" Font-Names="Tahoma" ForeColor="Red"></asp:Label>
                                                    </td>
