<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewLaserCode.aspx.cs" Inherits="HSRP.Transaction.AssignLaserCode" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function editpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            //  alert(i);
            googlewin = dhtmlwindow.open("googlebox", "iframe", "EditAssignCode.aspx?Mode=Edit&HSRPID=" + i, "Assign Laser Code", "width=950px,height=400px,resize=1,scrolling=1,center=1", "recal")
        ...
        function assignpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            //  alert(i);
            googlewin = dhtmlwindow.open("googlebox", "iframe", "EditAssignCode.aspx?Mode=assign&HSRPID=" + i, "Update Laser Code", "width=950px,height=400px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location.href = "AssignLaserCode.aspx";
                return true;
            }
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Assign Laser Code </span>
                                    </td>
                                        ...
                                        <ComponentArt:Grid ID="Grid1" ClientIDMode="AutoID" runat="server" ImagesBaseUrl="~/images"
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel DataKeyField="HSRPRecordID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <ComponentArt:GridColumn DataField="HSRPRecord_AuthorizationNo" HeadingText="HSRP Authorization No." SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="VehicleRegNo" HeadingText="Vehicle Reg. No."
                                                            SortedDataCellCssClass="SortedDataCell" Width="100" />

                                                        <ComponentArt:GridColumn DataField="OwnerName" Visible="true" HeadingText="Owner Name"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="MobileNo" HeadingText="Mobile No." SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="EmailID" HeadingText="Email ID" AllowGrouping="False"
                                                            SortedDataCellCssClass="SortedDataCell" Width="100" />
                                                            <ComponentArt:GridColumn DataCellCssClass="maintext" DataCellClientTemplateId="Assign"
                                                            HeadingText="Assign" SortedDataCellCssClass="SortedDataCell" Width="50" />
                                            ...
                                            <ClientTemplates>
                                                <ComponentArt:ClientTemplate ID="Assign">
                                                    <a style="color: Red" onclick="javascript:assignpage(## DataItem.GetMember('HSRPRecordID').Value ##);">
                                                        Assign</a>
                                                </ComponentArt:ClientTemplate>
                                                <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:editpage(## DataItem.GetMember('HSRPRecordID').Value ##);">
                                                        Edit</a>
                                                </ComponentArt:ClientTemplate>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <div style="overflow: hidden; width: 115px;">
                                                                                            <b>Code :</b><nobr>## DataItem.GetMember(&#39;HSRPRecord_AuthorizationNo&#39;).Value ##</nobr></div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div style="overflow: hidden; width: 135px;">
                                                                                            <b>Name :</b><nobr>## DataItem.GetMember(&#39;VehicleRegNo&#39;).Value ##</nobr></div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
