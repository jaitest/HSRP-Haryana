<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyCashCollectionRTOLocationWise_WithDate_Authorty.aspx.cs" Inherits="HSRP.Report.DailyCashCollectionRTOLocationWise_WithDate_Authorty" %>
                                    ...
                                    <td>
                                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                                ...
                                                <td valign="middle" class="form_text" nowrap="nowrap">Vehicle Class
                                                ...
                                                <td valign="middle" class="form_text" nowrap="nowrap" >&nbsp; 
                                                    <asp:DropDownList ID="DropDownListVehicleModel" runat="server" 
                                                        ...
                                                        Style="margin-left: 8px" TabIndex="13" Width="150px" Visible="false">
                                                        ...
                                                        <asp:ListItem Text="MCV/HCV/TRAILERS" Value="MCV/HCV/TRAILERS"></asp:ListItem>
                                                         <asp:ListItem Text="E-RICKSHAW" Value="E-RICKSHAW"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                <td valign="middle" class="form_text" nowrap="nowrap">
                                                    &nbsp;
                                               ...
                                               <asp:Button ID="btnExportToExcel" runat="server" 
                                                ...
                                                <td>
                                                  <asp:Button ID="btnpdf" runat="server" 
                                                        ...
                                                        class="button" onclick="btnpdf_Click" Visible="false"/>
                                                </td>
                                                <tr>
                                                    <td colspan="9">
