...
{
    public partial class Daily_MP_RegisteringAuthority : System.Web.UI.Page
    {
        ...
        private void FilldropDownListOrganization()
        {
            ...
            {
                SQLString = "select HSRPStateName,HSRP_StateID from HSRPState  where hsrp_stateID in ('5','4') and ActiveStatus='Y' Order by HSRPStateName";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string filename = "MonthlyStatementFromConcessionaireToRegisteringAuthority-MonthWise-" + dropDownListClient.SelectedItem.ToString()+"-" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            var colWidthPercentages = new[] { 10f, 35f, 20f, 25f, 25f, 35f, 25f, 35f, 15f };
            table.SetWidths(colWidthPercentages);
            SQLString = "Report_Monthly_StatementLocationWiseRegisteringAuthority'" + FromDate + "','" + ToDate + "','" + intHSRPStateID + "','"+dropDownListClient.SelectedValue+"'";
            DataTable ds = Utils.GetDataTable(SQLString, CnnString);

            GenerateCell(table, 9, 0, 0, 0, 0, 1, 1, "", 50, 0);
            GenerateCell(table, 9, 0, 0, 0, 0, 0, 0, "SCHEDULE-E :  Monthly Statement Form Service Provider To Registering Authority", 15, 0);
            GenerateCell(table, 9, 0, 0, 0, 0, 0, 0, "RTO Name:      " + dropDownListClient.SelectedItem.ToString(), 15, 0);
            GenerateCell(table, 9, 0, 0, 0, 0, 0, 0, "Month:      " + ddlMonth.SelectedItem.ToString() + ddlYear.SelectedValue, 15, 0);
            ...
            for (int i = 0; i < ds.Rows.Count; i++)
            {
                ...
                GenerateCell(table, 1, 1, 1, 0, 1, 1, 0, sno.ToString(), 20, 0);
               
                if (VehicleType == "2W")
                {
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, "Complete Set of Registration Plates Inclusive of Snap Lock and fixing for 2 Wheelers- Schooters, Motorcycles, Mopeds", 40, 0);
                   
                
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehiclecash"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehiclecash"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["replacevehicle"].ToString(), 20, 0);

                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["replaceveihclecash"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, Total1.ToString(), 20, 0);


                }
                if (VehicleType == "3W")
                {
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, "Complete Set of Registration Plates Inclusive of Snap Lock, 3rd Registration Plate and fixing for 3 wheelers and invalid carriages.", 40, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehiclecash"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehiclecash"].ToString(), 20, 0);
                ...
                if (VehicleType == "4W")
                {
                    ...
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, "Complete Set of Registration Plates Inclusive of Snap Lock 3rd Registration Plate and fixing for Light Motor Vehicles/Passenger Cars.", 40, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehiclecash"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehiclecash"].ToString(), 20, 0);
                ...
                if (VehicleType == "4HW")
                {
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, "Complete Set of Registration Plates Inclusive of Snap Lock 3rd Registration Plate and fixing for Medium Commercial Vehicles/Havy Commercial Vehicles/Trailer/combination/others.", 40, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehiclecash"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehiclecash"].ToString(), 20, 0);
                ...
                if (VehicleType == "500X120")
                {
                    ...
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, "Registration Plate Size 500X120 mm", 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehiclecash"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehiclecash"].ToString(), 20, 0);
                ...
                {
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, "Registration Plate Size 300X200 mm", 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehiclecash"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehiclecash"].ToString(), 20, 0);
                ...
                {
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, "Registration Plate Size 200X100 mm", 20, 0);
                ...
                {
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, "Registration Plate Size 285X45 mm", 20, 0);
                ...
                {
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, " 3rd Registration Plate Sticker Inclusive of Printing", 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["newvehiclecash"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehicleorder"].ToString(), 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, ds.Rows[i]["oldvehiclecash"].ToString(), 20, 0);
                ...
                sno = sno + 1;
                GenerateCell(table, 1, 1, 1, 0, 1, 1, 0, sno.ToString(), 20, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, "Snap Locks.", 20, 0);

                totalNewscnaplock1 = 2 * totalNewscnaplock1;
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, totalNewscnaplock1.ToString(), 20, 0);
                ...
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, totalPriceNewscnaplock1.ToString(), 20, 0);

                totaloldscnaplock1 = 2 * totaloldscnaplock1;
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, totaloldscnaplock1.ToString(), 20, 0);
                ...
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, totalPriceOldcnaplock1.ToString(), 20, 0);
                ...
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 0, TotalSnapLocak.ToString(), 20, 0);
