...
{
    public partial class AffixiationVehicleWiseCountReport : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "[New_AffixiationVehicleCount]");
            //  Export("D", book, 2);
            ...
            try
            {
              ...
              //  AddNewCell(row, "", "HeaderStyle2", 9);
               ...
               // AddNewCell(row, "", "HeaderStyle2", 2);
                ...
                WorksheetCell cell1 = row.Cells.Add(" Today's Affixiation Vehicle Count");
                cell1.MergeAcross = 7; // Merge two cells together
                cell1.StyleID = "HeaderStyle6";
                WorksheetCell cell2 = row.Cells.Add("Month to Date Affixiation Vehicle Count");
                cell2.MergeAcross = 7; // Merge two cells together
                cell2.StyleID = "HeaderStyle6";
                WorksheetCell cell3 = row.Cells.Add("Last Month Affixiation Vehicle Count");
                cell3.MergeAcross = 7; // Merge two cells together
                cell3.StyleID = "HeaderStyle6";
                WorksheetCell cell4 = row.Cells.Add("Financial Year To Date Affixiation Vehicle Count");
