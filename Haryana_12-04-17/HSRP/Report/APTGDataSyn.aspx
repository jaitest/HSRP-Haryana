<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="APTGDataSyn.aspx.cs" Inherits="HSRP.Report.APTGDataSyn" %>
                        ...
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr id="TR1" runat="server">
                                    <td > 
                                          <asp:Label ID="Label4" class="headingmain" runat="server"  > Update AP TG DATA </asp:Label> 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <EditItemTemplate>
                                           ...
                                           <asp:Label ID="lblmsg" runat="server" Font-Names="Arial" Font-Size="10pt" ForeColor="#FF3300" />
                                    </td>
                                </tr>
