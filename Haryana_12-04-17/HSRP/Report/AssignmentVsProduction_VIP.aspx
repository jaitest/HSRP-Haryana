<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AssignmentVsProduction_VIP.aspx.cs" Inherits="HSRP.Report.AssignmentVsProduction_VIP" %>
...
<script type="text/javascript">
    ...
    ControlType="Picker" PickerCssClass="picker" Height="22px" Width="79px">
                                                ...
                                                <td style="height: 40px" width="15">
                                                    <asp:Button ID="btnexport" runat="server" onclick="btnexport_Click" Visible="false" Text="PIP VS ASSIGNMENT" 
                                                        Font-Bold="True" BackColor="Orange" ForeColor="#000000"/>
                                                    </td>
            <td>

                                                    
                   <asp:Button ID="btnPvA" runat="server"  Text="Detail" Visible="false"
                                                        Font-Bold="True" BackColor="Orange" ForeColor="#000000" OnClick="btnPvA_Click"/>
                </td>
               ...
               <td style="height: 40px"  width="30">
                                                    <asp:Button ID="btnassign" runat="server"  Text="ASSIGNMENT VS PRODUCTION" 
                                                        Font-Bold="True" BackColor="Orange" ForeColor="#000000" OnClick="btnassign_Click"/>
                   </td>
             <td style="height: 40px" width="30">
                   <asp:Button ID="Button1" runat="server"  Text="Detail" 
                                                        Font-Bold="True" BackColor="Orange" ForeColor="#000000" OnClick="Button1_Click"/>
                   </td>
            <td><asp:Button ID="BtnPIP" runat="server"  Text="PIP VS PRODUCTION" Visible="true"
            
                                                            Font-Bold="True" BackColor="Orange" ForeColor="#000000" Width="142px" OnClick="BtnPIP_Click"/></td>
            <td style="height: 40px" width="30">
                   <asp:Button ID="btndetail" runat="server"  Text="Detail" Font-Bold="True" BackColor="Orange" ForeColor="#000000" Visible="true" OnClick="btndetail_Click" />
                   </td>
