<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Tc_Report_RegVsCll.aspx.cs" Inherits="HSRP.UTKReports.Tc_Report_RegVsCll" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain"> TC Report </span>
                                    </td>
                                        ...
                                        <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnGo" runat="server" Text="GO" ToolTip="GO" Visible="false"
                                                        class="button" onclick="btnGo_Click" />
                                                </td>
   
                                                 <td valign="middle" class="form_text" nowrap="nowrap">
                                                    <asp:Label Text="Location:" runat="server" ID="label1" Visible="False" />
                                                </td>
