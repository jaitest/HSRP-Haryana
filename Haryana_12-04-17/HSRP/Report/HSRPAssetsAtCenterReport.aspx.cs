...
{
    public partial class HSRPAssetsAtCenterReport : System.Web.UI.Page
    {
        int UserType;
        ...
        protected void btnexport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string filename = "HSRP Assets Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                book.Properties.Title = "HSRP Assets Report";
                ...
                Worksheet sheet = book.Worksheets.Add("HSRP Assets Report");
                ...
                WorksheetCell cell = row.Cells.Add("HSRP Assets Report");
                ...
                row.Cells.Add(new WorksheetCell("RTOLoctionName", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Product Name", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Make", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Model", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("SerialNo", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("WorkingStatus", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("UserName", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("UserMobileNo", "HeaderStyle6"));
                ...
                if (dropDownListClient.SelectedItem.Text == "ALL")
                {
                    ...
                    SQLString = "select b.rtolocationname as RTOLoctionName, a.ProductName,a.Make,a.Model,a.SerialNo,a.WorkingStatus,a.UserName,a.UserMobileNo,Remarks from HSRP_Assets as a inner join rtolocation as b on a.rtolocationid=b.rtolocationid WHERE a.EntryDate between '" + ReportDate1 + "' and '" + ReportDate2 + "' and   a.HSRP_StateID='" + DropDownListStateName.SelectedValue.ToString() + "' order by a.EntryDate desc";
                    int sno = 0;
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                        {
                            ...
                            row.Cells.Add(new WorksheetCell(dtrows["RTOLoctionName"].ToString(), DataType.String, "HeaderStyle"));
                            row.Cells.Add(new WorksheetCell(dtrows["ProductName"].ToString(), DataType.String, "HeaderStyle"));
                            row.Cells.Add(new WorksheetCell(dtrows["Make"].ToString(), DataType.String, "HeaderStyle"));
                            row.Cells.Add(new WorksheetCell(dtrows["Model"].ToString(), DataType.String, "HeaderStyle"));
                            row.Cells.Add(new WorksheetCell(dtrows["SerialNo"].ToString(), DataType.String, "HeaderStyle"));
                            row.Cells.Add(new WorksheetCell(dtrows["WorkingStatus"].ToString(), DataType.String, "HeaderStyle"));
                            row.Cells.Add(new WorksheetCell(dtrows["UserName"].ToString(), DataType.String, "HeaderStyle"));
                            row.Cells.Add(new WorksheetCell(dtrows["UserMobileNo"].ToString(), DataType.String, "HeaderStyle"));
                ...
                else
                {
                    ...
                    SQLString = "select b.rtolocationname as RTOLoctionName, a.ProductName,a.Make,a.Model,a.SerialNo,a.WorkingStatus,a.UserName,a.UserMobileNo,Remarks from HSRP_Assets as a inner join rtolocation as b on a.rtolocationid=b.rtolocationid WHERE a.EntryDate between '" + ReportDate1 + "' and '" + ReportDate2 + "' and   a.HSRP_StateID='" + DropDownListStateName.SelectedValue.ToString() + "' AND a.RTOLocationID='" + dropDownListClient.SelectedValue.ToString() + "' order by a.Entrydate desc";
