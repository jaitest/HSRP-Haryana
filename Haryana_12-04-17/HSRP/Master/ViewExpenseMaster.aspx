...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function editpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "ExpenseMaster.aspx?Mode=Edit&ExpenceID=" + i, "Update Expense Master Details", "width=550px,height=250px,resize=1,scrolling=1,center=1", "recal")
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "ExpenseMaster.aspx?Mode=New", "Add New Expense Master", "width=550px,height=250px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New HSRP State" class="button">Add New Expense Master</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
