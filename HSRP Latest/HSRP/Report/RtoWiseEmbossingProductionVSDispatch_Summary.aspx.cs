    ...
    public partial class RtoWiseEmbossingProductionVSDispatch_Summary : System.Web.UI.Page
    {
        ...
        protected void grdid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day5orMore")
            {
                ...
                if (state.ToString().Trim() == "4")
                {
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname, (select rtolocationname from rtolocation r where r.rtolocationid = a.userrtolocationid )as deliverylocation,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),orderdate,103) as orderdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103)<=dateadd(day,-" + K + ",'" + strdatetime + "') and  hsrprecord_creationdate>'" + BusinessReportStartDate + "' and (convert(date,ChallanDate)>'" + strdatetime + "' or isnull(ChallanDate,'')='')");
                }
                else
                {
            ...
            if (e.CommandName == "Day2")
            {
                ...
                if (state.ToString().Trim() == "4")
                {
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,(select rtolocationname from rtolocation r where r.rtolocationid = a.userrtolocationid )as deliverylocation,  vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),orderdate,103) as orderdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103) = dateadd(day,-" + K + ",'" + strdatetime + "') and (convert(date,ChallanDate)>'" + strdatetime + "' or isnull(ChallanDate,'')='')");
                }
                else
                {
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,convert(varchar(15),orderdate,103) as orderdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,OrderEmbossingDate,103) = dateadd(day,-" + K + ",'" + strdatetime + "') and (convert(date,ChallanDate)>'" + strdatetime + "' or isnull(ChallanDate,'')='')");
            ...
            if (e.CommandName == "Day4")
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (state.Trim() == "4")
                    {
                        row.Cells.Add(new WorksheetCell("deliverylocation", "HeaderStyle"));
                    }
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                        {
                            ...
                            if(state.Trim()=="4")
                            {
                                row.Cells.Add(new WorksheetCell(dtrows["deliverylocation"].ToString(), DataType.String, "HeaderStyle1"));
                            }
                            ...
                            row.Cells.Add(new WorksheetCell(dtrows["orderdate"].ToString(), DataType.String, "HeaderStyle1"));
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day5orMore")
            {
                ...
                if (state.ToString().Trim() == "4")
                {
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname, (select rtolocationname from rtolocation r where r.rtolocationid = a.userrtolocationid )as deliverylocation, vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),orderdate,103),convert(varchar(15),OrderDate,103)) orderdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,OrderEmbossingDate,103)=dateadd(day, -" + K + ",'" + ReportDate2 + "') and orderembossingdate>'01-jan-2015' and erpassigndate is not null and PDfDownloadDate is not null and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
                }
                else
                {
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),orderdate,103),convert(varchar(15),OrderDate,103)) orderdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,OrderEmbossingDate,103)=dateadd(day, -" + K + ",'" + ReportDate2 + "') and orderembossingdate>'01-jan-2015' and erpassigndate is not null and PDfDownloadDate is not null and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
            ...
            if (e.CommandName == "Day2")
            {
                ...
                if (state.ToString().Trim() == "4")
                {
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,(select rtolocationname from rtolocation r where r.rtolocationid = a.userrtolocationid )as deliverylocation, vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),orderdate,103),convert(varchar(15),OrderDate,103)) orderdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,-" + K + ",'" + ReportDate2 + "') and erpassigndate is not null and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
                }
                else
                {
                    strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),orderdate,103),convert(varchar(15),OrderDate,103)) orderdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,OrderEmbossingDate,103)=dateadd(day,-" + K + ",'" + ReportDate2 + "') and erpassigndate is not null and (convert(date,ChallanDate)>'" + ReportDate2 + "' or isnull(ChallanDate,'')='')");
