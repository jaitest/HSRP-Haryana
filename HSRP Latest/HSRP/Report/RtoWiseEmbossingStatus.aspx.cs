...
namespace HSRP.Report
{
    public partial class RtoWiseEmbossingStatus : System.Web.UI.Page
    {
        ...
        protected void grdid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (state == "3")
            {
                hsrprecord_creationdate = "16-jun-2015";
            }
            int K = 0;
            if (e.CommandName == "Day5orMore")
            {
                string query1 = "select count(*) from HolidayDateTime where hsrp_stateid =" + state + " and   convert(date,blockDate,103) between dateadd(day,-4,'" + ReportDate2 + "') and dateadd(day,0, '" + ReportDate2 + "') ";
                int j = Utils.getScalarCount(query1, CnnString1);
                K = 4 + j;
                ...
                if (state == "4")
                {
                    strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname, (select RTOLocationName from rtolocation where rtolocationid =  UserRTOLocationID) as PlateDeliverLocation, vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate ,  ( select userfirstname +' '+userlastname from users where   userid  = Createdby) as Createdby   from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate)<=dateadd(day,-" + K + ",'" + ReportDate2 + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "'  and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
                }
                else
                {
            ...
            if (e.CommandName == "Day1") 
            {
                ...
                if (state == "4")
                {
                    strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,(select RTOLocationName from rtolocation where rtolocationid =  UserRTOLocationID) as PlateDeliverLocation, vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate, ( select userfirstname +' '+userlastname from users where   userid  = Createdby) as Createdby  from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate,101) between  dateadd(day,0,'" + day1date + "' ) and '" + ReportDate2 + "' and isnull(VehicleRegNo,'')!='' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
                }
                else
                {
                    strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate,101) between  dateadd(day,0,'" + day1date + "' ) and '" + ReportDate2 + "' and isnull(VehicleRegNo,'')!='' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='')  order by 1");
            ...
            {
                string query1 = "select count(*) from HolidayDateTime where hsrp_stateid =" + state + " and   convert(date,blockDate,103) between dateadd(day,-1,'" + ReportDate2 + "') and dateadd(day,0, '" + ReportDate2 + "') ";
                int j = Utils.getScalarCount(query1, CnnString1);
                K = 1 + j;
                ...
                if (state == "4")
                {
                    strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname, (select RTOLocationName from rtolocation where rtolocationid =  UserRTOLocationID) as PlateDeliverLocation, vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate, ( select userfirstname +' '+userlastname from users where   userid  = Createdby) as Createdby  from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate,101) between  '" + day2date + "' and dateadd(day,-" + K + ",'" + ReportDate2 + "') and isnull(VehicleRegNo,'')!='' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') order by 1");
                }
                else
                {
                    strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate,101) between  '" + day2date + "' and dateadd(day,-" + K + ",'" + ReportDate2 + "') and isnull(VehicleRegNo,'')!='' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') order by 1");
            ...
            {
                string query1 = "select count(*) from HolidayDateTime where hsrp_stateid =" + state + " and   convert(date,blockDate,103) between dateadd(day,-2,'" + ReportDate2 + "') and dateadd(day,0, '" + ReportDate2 + "') ";
                int j = Utils.getScalarCount(query1, CnnString1);
                K = 2 + j;
                ...
                if (state == "4")
                {
                    strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname, (select RTOLocationName from rtolocation where rtolocationid =  UserRTOLocationID) as PlateDeliverLocation, vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate ,  ( select userfirstname +' '+userlastname from users where   userid  = Createdby) as Createdby   from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate,101) between  '" + day3date + "' and dateadd(day,-" + K + ",'" + ReportDate2 + "') and isnull(VehicleRegNo,'')!=''  and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') order by 1");
                }
                else
                {
                    strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate,101) between  '" + day3date + "' and dateadd(day,-" + K + ",'" + ReportDate2 + "') and isnull(VehicleRegNo,'')!=''  and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') order by 1");
            ...
            {
                string query1 = "select count(*) from HolidayDateTime where hsrp_stateid =" + state + " and   convert(date,blockDate,103) between dateadd(day,-3,'" + ReportDate2 + "') and dateadd(day,0, '" + ReportDate2 + "') ";
                int j = Utils.getScalarCount(query1, CnnString1);
                K = 3 + j;
                ...
                if (state == "4")
                {
                    strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,(select RTOLocationName from rtolocation where rtolocationid =  UserRTOLocationID) as PlateDeliverLocation, vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate ,  ( select userfirstname +' '+userlastname from users where   userid  = Createdby) as Createdby  from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate,101) between  '" + day4date + "' and dateadd(day,-" + K + ",'" + ReportDate2 + "') and isnull(VehicleRegNo,'')!='' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') order by 1");
                }
                else
                {
                    strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,erpassigndate,101) between  '" + day4date + "' and dateadd(day,-" + K + ",'" + ReportDate2 + "') and isnull(VehicleRegNo,'')!='' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') order by 1");
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (state == "4")
                    {
                        row.Cells.Add(new WorksheetCell("PlateDeliverLocation", "HeaderStyle"));
                    }
                    ...
                    if (state == "4")
                    {
                        row.Cells.Add(new WorksheetCell("Created BY", "HeaderStyle"));
                    }
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                        {
                            ...
                            if (state == "4")
                            {
                                row.Cells.Add(new WorksheetCell(dtrows["PlateDeliverLocation"].ToString(), DataType.String, "HeaderStyle1"));
                            }
                            ...
                            if (state == "4")
                            {
                                row.Cells.Add(new WorksheetCell(dtrows["Createdby"].ToString(), DataType.String, "HeaderStyle1"));
                            }
           ...
           // DateTime ReportDate2 = OrderDatefrom.SelectedDate;
            ...
            if (state == "4" || state == "6" || state == "1" || state == "3")
            {
                ...
                if (e.CommandName == "Day5orMore")
                {
                    ...
                    if (state == "4")
                    {
                        strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname, (select RTOLocationName from rtolocation where rtolocationid =  UserRTOLocationID) as PlateDeliverLocation, vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and isnull(vehicleregno,'')!='' and convert(date,HSRPRecord_CreationDate)<=dateadd(day,-" + K + ",'" + ReportDate2 + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') order by 1");
                    }
                    else
                    {
                        strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and isnull(vehicleregno,'')!='' and convert(date,HSRPRecord_CreationDate)<=dateadd(day,-" + K + ",'" + ReportDate2 + "') and  hsrprecord_creationdate >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate)>'" + ReportDate2 + "' or isnull(orderembossingdate,'')='') order by 1");
           ...
           // DateTime ReportDate2 = OrderDatefrom.SelectedDate;
            ...
            if (e.CommandName == "OpeningWithRegNoA")
            {
              ...
              // Changes by vimal
               ...
               // strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "'and (convert(date,HSRPRecord_CreationDate,103)<= dateadd(day,-1,'" + ReportDate2 + "') and  convert(date,hsrprecord_creationdate) >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate,103)>'" + ReportDate2 + "'  or isnull(orderembossingdate,'')='')) and isnull(vehicleregno,'')!='' ");
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate , ( select userfirstname +' '+userlastname from users where   userid  = Createdby) as Createdby from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "'and (convert(date,HSRPRecord_CreationDate,103)<= dateadd(day,-1,'" + ReportDate2 + "') and  convert(date,hsrprecord_creationdate) >'" + hsrprecord_creationdate + "' and (convert(date,orderembossingdate,103)>'" + ReportDate2 + "'  or isnull(orderembossingdate,'')='')) and isnull(vehicleregno,'')!=''  and isnull(hsrp_front_lasercode,'')='' and isnull(hsrp_rear_lasercode,'')=''");
            }
            ...
            if (e.CommandName == "OpeningwithoutRegnoB")
            {
                ...
                strSQL.Append("select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,( select userfirstname +' '+userlastname from users where   userid  = Createdby) as Createdby from hsrprecords a, rtolocation b where a.rtolocationid=b.RTOLocationID and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,HSRPRecord_CreationDate,103)<= dateadd(day,-1,'" + ReportDate2 + "') and convert(date,hsrprecord_creationdate) >'" + hsrprecord_creationdate + "' and (isnull(vehicleregno,'')='')");
            }
            if (e.CommandName == "TodayOrderswithRegNoC")
            {
                ...
                Label lblembnameEC = (Label)grdPvA.Rows[RowIndex].FindControl("lblembnameEC");
                embcentername = lblembnameEC.Text.ToString();
                strSQL.Append(" select isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,convert(varchar(15),erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate ,( select userfirstname +' '+userlastname from users where   userid  = Createdby) as Createdby from hsrprecords a, rtolocation b  where a.rtolocationid=b.RTOLocationID  and b.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "'  and convert(date,HSRPRecord_CreationDate,103)='" + ReportDate2 + "' and convert(date,hsrprecord_creationdate) >'" + hsrprecord_creationdate + "' and (isnull(vehicleregno,'')!='')");
             }
