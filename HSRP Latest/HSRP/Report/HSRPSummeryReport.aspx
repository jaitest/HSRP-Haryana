<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HSRPSummeryReport.aspx.cs" Inherits="HSRP.Report.HSRPSummeryReport" Title="Daily Production MIS" %>
...
<script type="text/javascript" src="../windowfiles/dhtmlwindow.js"></script>
    ...
    <script type="text/javascript">
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "HSRPSummeryState_WiseReport.aspx?Mode=New", "Add New HSRP STATE REPORT", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location = 'HSRPSummeryReport.aspx';
                return true;
            }
        }
    </script>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Daily MIS All State Report</span>
                                    </td>
                                 ...
                                 <td valign="middle" class="form_text" nowrap="nowrap">
                                    ...
                                    <td valign="top" style="width:105px"; onmouseup="OrderDate_OnMouseUp()">
                                                                <ComponentArt:Calendar ID="OrderDate" runat="server" PickerFormat="Custom" PickerCustomFormat="dd/MM/yyyy"
                                                                    ControlType="Picker" PickerCssClass="picker" MinDate="2014-04-01">
                                                                    <ClientEvents>
