    ...
    public partial class HRMonthlyReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Worksheet sheet = book.Worksheets.Add("Daily Report From Concessionaire to Registering Authority");
                ...
                row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                row.Cells.Add(new WorksheetCell(" ", "HeaderStyle3"));
                WorksheetCell cell = row.Cells.Add("Daily Report From Concessionaire to Registering Authority");
