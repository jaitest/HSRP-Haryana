...
{
    public partial class DailyBiharAuthorityReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ddlYear.SelectedValue.ToString() == "2014")
                {
                    if (ddlMonth.SelectedValue.ToString() == "01")
                    {
                        LabelError.Text = "Please Select Month After March";
                        return;
                    }
                ...
                else
                {
                    ...
                    else if (ddlMonth.SelectedValue.ToString() == "12")
                    {
                     ...
                     string filename = "BIHAR Authority Report_" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                     ...
                     Worksheet sheet = book.Worksheets.Add("BIHAR Authority Report");
                     ...
                     row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                     WorksheetCell cell5 = row.Cells.Add("ANNEXURE IV ");
                     cell5.MergeAcross = 3; // Merge two cells togetherto 
                     cell5.StyleID = "HeaderStyle3";
                     ...
                     row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                     row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                     WorksheetCell cell = row.Cells.Add("Monthly Report From Vendor to the Transport Department");
                     ...
                     WorksheetCell cell3 = row.Cells.Add("HSRP fitted");
                     ...
                     row.Cells.Add(new WorksheetCell("New ", "HeaderStyle6"));
                     row.Cells.Add(new WorksheetCell("Existing", "HeaderStyle6"));
                     row.Cells.Add(new WorksheetCell("New Reg. ", "HeaderStyle6"));
                     row.Cells.Add(new WorksheetCell("Existing", "HeaderStyle6"));
                     row.Cells.Add(new WorksheetCell("", "HeaderStyle"));
                     row = sheet.Table.Rows.Add();
                     ...
                     SQLString = "Report_rtoreport_embossed'" + FromDate + "','" + ToDate + "', 1 ";
