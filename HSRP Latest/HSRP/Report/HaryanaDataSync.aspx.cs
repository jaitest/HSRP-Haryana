...
{
    public partial class HaryanaDataSync : System.Web.UI.Page
    {
        int UserType1;
        ...
        private Boolean validate1()
        {
            ...
            if (getvalue == "--Select Location--")
            {
                ...
                Label1.Text = "Please select Location Name";
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "GetAllRecordRtoWise");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                #region Fetch Data
                SQLString = "select RTOLocationname,max(isnull(registrationdate,hsrprecord_creationdate)) as RegistrationDate,DATEDIFF(day,max(isnull(registrationdate,hsrprecord_creationdate)),getdate()) as SyncDelay from HSRPRecordsStaggingArea a,rtolocation b where a.RTOLocationID=b.RTOLocationID and b.HSRP_StateID='" + HSRPStateID + "' group by RTOLocationName order by 3";
                ...
                WorksheetCell cell = row.Cells.Add("Sync Report");
