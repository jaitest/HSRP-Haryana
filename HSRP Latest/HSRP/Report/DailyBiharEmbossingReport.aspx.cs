...
namespace HSRP.Report
{
    public partial class DailyBiharEmbossingReport : System.Web.UI.Page
    {
        ...
        private void InitialSetting()
        {
            ...
            OrderDate.MinDate = (DateTime.Parse(TodayDates)).AddDays(-1.00);
        }
        #region DropDown
        ...
        //private void FilldropDownListClient()
        //{
        //    //SQLString = "select rtolocationname,rtolocationcode from rtolocation  where hsrp_stateid='1' and rtolocationid in (select distinct distrelation from rtolocation where  hsrp_stateid='1') Order by rtolocationname";
        //   SQLString = "select rtolocationname,RTOLocationID from rtolocation  where hsrp_stateid='1' and rtolocationid in (select distinct RTOLocationID from rtolocation where  hsrp_stateid='1') Order by rtolocationname";
        //    Utils.PopulateDropDownList(dropDownListClient, SQLString.ToString(), CnnString, "--Select RTO--");
        //}
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "BIHAR Embossing Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                Workbook book = new Workbook();

                if (DropDownListStateName.SelectedItem.Text == "--Select State--")
                {
                    LabelError.Visible = true;
                    LabelError.Text = "Please Select State.";
                    return;
                ...
                {
                    LabelError.Visible = true;
                    LabelError.Text = "Please Select Rto Location.";
                    return;
               ...
               //// cell5.StyleID = "HeaderStyle6";
                ...
                SQLString = "SELECT    b.ProductColor, a.VehicleRegNo, a.OrderEmbossingDate, a.HSRPRecordID, a.OwnerName, a.VehicleType, a.HSRP_Front_LaserCode,Product_1.ProductColor,a.HSRP_Rear_LaserCode, a.VehicleClass, a.StickerMandatory, Product_1.ProductCode AS FrontPlateSize, a.RearPlateSize, b.ProductCode AS RearPlateSize1,a.FrontPlateSize AS FrontPlateSize ,a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '1' AND a.OrderEmbossingDate  between '" + FromDate + "' and '" + ToDate + "'";
