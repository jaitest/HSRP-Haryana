            ...
            <asp:GridView ID="grdid" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false" OnRowCommand="grdid_RowCommand" OnSelectedIndexChanged="grdid_SelectedIndexChanged">
                <AlternatingRowStyle BackColor="White" />
                 <Columns>
                     ...
                     <asp:TemplateField HeaderText="Affixation Center" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                ...
                                <ItemStyle HorizontalAlign="Left" Width="6%"/>
                                        ...
                                        <asp:TemplateField HeaderText="Embossing Center" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <asp:Label ID="lblembname" runat="server" Text=<%#Eval("EmbossingCenter")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                      <asp:TemplateField HeaderText="AssignedLaserCoder" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <asp:Label ID="lblassgnlaser" runat="server" Text=<%#Eval("AssignedLaserCode")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                       <asp:TemplateField HeaderText="ToDayProd" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <asp:Label ID="lblToDayProd" runat="server" Text=<%#Eval("TodayProd")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>

                      <asp:TemplateField HeaderText="day1date" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <asp:Label ID="lblday1date" runat="server" Text=<%#Eval("day1date")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>

                       <asp:TemplateField HeaderText="day2date" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <asp:Label ID="lblday2date" runat="server" Text=<%#Eval("day2date")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>

                       <asp:TemplateField HeaderText="day3date" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <asp:Label ID="lblday3date" runat="server" Text=<%#Eval("day3date")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>

                       <asp:TemplateField HeaderText="day4date" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <asp:Label ID="lblday4date" runat="server" Text=<%#Eval("day4date")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>

                                   <asp:TemplateField HeaderText="Day1" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Day2" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                               ...
                               <asp:TemplateField HeaderText="Day3" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Day4" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Day5orMore" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                 ...
                 <Columns>
                     ...
                     <asp:TemplateField HeaderText="Affixation Center" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                ...
                                <ItemStyle HorizontalAlign="Left" Width="6%"/>
                                        ...
                                        <asp:TemplateField HeaderText="PIP" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                 ...
                 <Columns>
                     ...
                     <asp:TemplateField HeaderText="Affixation Center" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                ...
                                <ItemStyle HorizontalAlign="Left" Width="6%"/>
                                   ...
                                   <asp:TemplateField HeaderText="OpeningWithRegNo(A)" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                               <%--<asp:Label ID="lblDay1" runat="server" Text=<%#Eval("Day1")%>></asp:Label>--%>
                                    ...
                                    <asp:TemplateField HeaderText="OpeningwithoutRegno(B)" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                              <%-- <asp:Label ID="lblDay2" runat="server" Text=<%#Eval("Day2")%>></asp:Label>--%>
                             ...
                             <asp:TemplateField HeaderText="TodayOrderswithRegNo(C)" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                            <%--   <asp:Label ID="lblDay4" runat="server" Text=<%#Eval("Day4")%>></asp:Label>--%>
                                            ...
                                            <asp:TemplateField HeaderText="TodayOrderswithoutRegNo(D)" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
