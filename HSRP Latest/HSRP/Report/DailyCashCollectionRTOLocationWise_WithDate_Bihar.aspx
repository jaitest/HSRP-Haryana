<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyCashCollectionRTOLocationWise_WithDate_Bihar.aspx.cs" Inherits="HSRP.Report.DailyCashCollectionRTOLocationWise_WithDate_Bihar" %>
                                        ...
                                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                               ...
                                               <asp:Button ID="btnExportToExcel" runat="server" 
                                                ...
                                                <td>
                                                  <asp:Button Visible="false" ID="btnAllLocationPdf" runat="server" 
                                                ...
                                                <td>
                                                  <asp:Button Visible="false" ID="btnpdf" runat="server" 
