<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TransportReport.aspx.cs" Inherits="HSRP.Report.TransportReport"%>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">TransPort Report</span>
                                    </td>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle" style="width:  50px">
                                                    <asp:DropDownList CausesValidation="false" ID="DropDownListStateName"
                                                        runat="server" DataTextField="HSRPStateName" AutoPostBack="true" DataValueField="HSRP_StateID" OnSelectedIndexChanged="DropDownListStateName_SelectedIndexChanged1">
                                                    </asp:DropDownList><br />
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="DropDownListStateName" ValidationGroup="Excel" runat="server" ErrorMessage="Please Select State" InitialValue="--Select State--"></asp:RequiredFieldValidator>
                                                </td>
                                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 100px">
                                                    &nbsp;&nbsp;<asp:Label Text="Location:" runat="server" ID="label1" />
                                                </td>
                                                <td valign="middle" style="width:  50px">
                                                    <asp:DropDownList CausesValidation="false" ID="ddlRtoLocation"
                                                        runat="server" DataTextField="RTOLocationName" DataValueField="RTOLocationcode">
                                                    </asp:DropDownList><br />
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="ddlRtoLocation" ValidationGroup="Excel" runat="server" ErrorMessage="Please Select Location" InitialValue="--Select Location--"></asp:RequiredFieldValidator>
                                                </td>
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="TransportReport"  ToolTip="Please Click for Report" ValidationGroup="Excel" BackColor="Orange" ForeColor="#000000"
                                                        class="button"  OnClick="btnExportToExcel_Click" />
                                                </td>
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnSummary" runat="server" Text="Rejection Report" ToolTip="Please Click for Report" Visible="false" BackColor="Orange" ForeColor="#000000"
                                                        class="button"  onclick="btnSummary_Click" />
                                                </td>
                                                <tr>
                                                    <td colspan="9">
