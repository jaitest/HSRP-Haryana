...
{
    public partial class EmbossingVehicleWiseCountReport : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            string filename = "EmbossingVehicleCount" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet,string strProcName)
        {
            try
            {
                ...
                WorksheetCell cell = row.Cells.Add("Embossing Vehicle Count Report");
