...
{
    public partial class SatateWisependency : System.Web.UI.Page
{
    int UserType1;
    ...
    private void Export()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("[Report_SatateWise_pendency1]", con);
           ...
           // cmd.Parameters.Add(new SqlParameter("@StateId", strStateId));
            ...
            cmd.Parameters.Add(new SqlParameter("@Tdate", HSRPAuthDate.SelectedDate));
           // cmd.Parameters.Add(new SqlParameter("@addrecordby", ddlBothDealerHHT.SelectedItem.Text));
            ...
            row.Cells.Add(new WorksheetCell("Report :", "HeaderStyle3"));
                ...
                row.Cells.Add(new WorksheetCell("State Wise Pendency Report", "HeaderStyle3"));
            ...
            AddNewCell(row, "All State", "HeaderStyle2", 1);
            row = sheet.Table.Rows.Add();
            row.Index = iIndex++;
          ...
          //  row.Cells.Add(new WorksheetCell("New Order :", "HeaderStyle3"));
            ...
            for (int j = 0; j < dt.Rows.Count; j++)
            {
                ...
                for (int i = 0; i < dt.Columns.Count; i++)
                {
                    ...
                    if (dt.Rows[j]["STATE"].ToString().Equals("") && i.Equals(0))
                    {
                        // AddNewCell(row, "Total", "HeaderStyle6", 1);
                    }
                    else if (dt.Rows[j]["STATE"].ToString().Equals(1))
                    {
            ...
            string filename = "Satate Wise pendency" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
