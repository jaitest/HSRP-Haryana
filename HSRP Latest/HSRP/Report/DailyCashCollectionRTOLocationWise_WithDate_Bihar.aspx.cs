...
{
    public partial class DailyCashCollectionRTOLocationWise_WithDate_Bihar : System.Web.UI.Page
    {
        ...
        private void InitialSetting()
        {
            ...
            string min = "04/01/2015";
            HSRPAuthDate.SelectedDate = (DateTime.Parse(TodayDate)).AddDays(0.00);
            HSRPAuthDate.MinDate = (DateTime.Parse(min)).AddDays(-0.00);
            ...
            OrderDate.MinDate = (DateTime.Parse(min)).AddDays(-0.00);
        ...
        private void FilldropDownListClient()
        {
            ...
            else
            {
                ...
                SQLString = "SELECT  distinct (a.RTOLocationName) as RTOLocationName, a.RTOLocationID FROM UserRTOLocationMapping INNER JOIN RTOLocation a ON UserRTOLocationMapping.RTOLocationID = a.RTOLocationID where  a.LocationType!='District' and UserRTOLocationMapping.UserID='" + strUserID + "' and ActiveStatus!='N' Order by RTOLocationName ";
        ...
        private String MakeQueryOnTheBasisOfSelectedOption(String StringOrderDate, String StringAuthDate, String RtoCode)
        {
            if (ddlVehicleReference.SelectedItem.Text == "Both" && DropDownListVehicleModel.SelectedItem.Text == "All")
            {
                if (strUserID == "990")
                {
                    ...
                    SQLString = "SELECT  HSRP_StateID,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,convert(varchar(10),ordercloseddate,103) as AffixDate" +
                           ...
                           ",hsrp_front_lasercode,hsrp_rear_lasercode,ownername,convert(varchar(15),HSRPRecord_CreationDate,103) as CashReceiptDateTime,StickerMandatory" +
            ...
            else if (ddlVehicleReference.SelectedItem.Text == "Both")
            {
                SQLString = "SELECT  HSRP_StateID,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,convert(varchar(10),ordercloseddate,103) as AffixDate" +
                    ",(select p.ProductCode from product p where h.FrontPlateSize = p.ProductID) as frontplatesize" +
                    ",(select p.ProductCode from product p where h.rearPlateSize = p.ProductID) as rearplatesize" +
                    ",hsrp_front_lasercode,hsrp_rear_lasercode,convert(varchar(15),HSRPRecord_CreationDate,103) as CashReceiptDateTime,ownername,StickerMandatory" +
        ...
        private void ExportRecordExcel(Workbook book, DataTable dt, string RtoName = null, string RtoCode = null)
        {
            ...
            try
            {
                ...
                row.Cells.Add(new WorksheetCell("Vechicle  Class", "HeaderStyle6"));
                ...
                row.Cells.Add(new WorksheetCell("3rd Stiker", "HeaderStyle6"));
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (ddlVehicleReference.SelectedItem.Text == "Both" && DropDownListVehicleModel.SelectedItem.Text == "All")
            {
                SQLString = "SELECT  HSRP_StateID,convert(varchar(15),HSRPRecord_CreationDate,103) as CashReceiptDateTime,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,convert(varchar(10),ordercloseddate,103) as AffixDate, StickerMandatory FROM HSRPRecords h where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + dropDownListClient.SelectedValue + "' and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 order by OrderDate";
            }
            else if (ddlVehicleReference.SelectedItem.Text == "Both")
            {
