...
namespace HSRP.BR1Reports
{
    public partial class DailyRegisteringAuthority : System.Web.UI.Page
    {
        ...
        {
            SQLString = "select rtolocationname,rtolocationid from rtolocation  where hsrp_stateid='1' and rtolocationid in (select distinct distrelation from rtolocation where  hsrp_stateid='1') Order by rtolocationname";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                LabelError.Text = "";
                     ...
                     //string filename = RTOName+" - "  + System.DateTime.Now.Year.ToString() + ".xls";
                     string filename = "Schedule-E-MonthlyStatementFromConcessionaireToRegisteringAuthority-MonthWise-" + dropDownListClient.SelectedItem.ToString() + "-" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                     ...
                     //SQLString = "Report_Monthly_Statement_Registering_Authority'" + FromDate + "','" + ToDate + "','1','0'";
