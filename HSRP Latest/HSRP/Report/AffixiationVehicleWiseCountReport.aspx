<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AffixiationVehicleWiseCountReport.aspx.cs" Inherits="HSRP.Report.AffixiationVehicleWiseCountReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Total Affixiation Vehicle Count</span>
                                    </td>
        ...
        <tr>
            ...
            <td style="height: 25px;" valign="middle" width="250">
                    ...
                    <img id="calendar_from_button"  alt="" onclick="OrderDatefrom_OnClick()"
                        ...
                        <asp:Button ID="btnexport" runat="server" Font-Bold="True" ForeColor="#000000" 
                            onclick="btnexport_Click" BackColor="Orange" Text="Export To Excel" />
