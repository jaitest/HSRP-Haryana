...
{
    public partial class MPMonthlyReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "NCT of MADHYA PRADESH HSRP Project Monthly Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                Worksheet sheet = book.Worksheets.Add("NCT of MADHYA PRADESH HSRP Project Monthly Report");
                ...
                row.Cells.Add(new WorksheetCell(" ", "HeaderStyle3"));
                WorksheetCell cell = row.Cells.Add("NCT of MADHYA PRADESH HSRP Project Monthly Report");
                ...
                SQLString = "SELECT   a.Address1,a.OrderType ,a.ManufacturerName,a.OrderDate ,a.OrderClosedDate,a.HSRPRecord_AuthorizationDate, b.ProductColor, a.HSRPRecord_AuthorizationNo, a.OrderEmbossingDate, a.HSRPRecordID, a.OwnerName, a.VehicleType, a.HSRP_Front_LaserCode,Product_1.ProductColor,a.HSRP_Rear_LaserCode, a.VehicleClass, a.StickerMandatory, Product_1.ProductCode AS FrontPlateSize, a.RearPlateSize, b.ProductCode AS RearPlateSize1,a.FrontPlateSize AS FrontPlateSize ,a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '5' AND a.OrderClosedDate  between '" + FromDate + "' and '" + ToDate + "'";
