...
{
    public partial class BankTransactionReportDealer : System.Web.UI.Page
    {
        int UserType;
        ...
        protected void btnexport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                WorksheetCell cell = row.Cells.Add("HSRP Bank Transaction Report Dealer");
                ...
                else
                {
                    ...
                    SQLString = "SELECT t.[TransactionID] ,convert(varchar, t.DepositDate, 103) AS DepositDate,m.[BankName],(select RTOLocationName from RTOLocation where rtolocationid=t.RTOLocation) as Center,t.[BranchName],t.[DepositAmount],t.[DepositBy],t.[StateID],t.[RTOLocation],convert(varchar, EntryDate, 103) as EntryDate,t.[BankSlipNo],t.[Remarks],t.[AccountNo],Chq_no,chq_date,(select (userfirstname+' '+UserLastName) as Name from users u where t.userid=u.userid) as username,Dealerid FROM [dbo].[BankTransaction] as t inner join bankmaster as m on t.BankName=m.id  WHERE t.EntryDate between '" + ReportDate1 + "' and '" + ReportDate2 + "' and  t.StateID='" + DropDownListStateName.SelectedValue.ToString() + "'  and isnull(dealerid,'')!=''  and (t.voidstatus is null or voidstatus='') AND t.RTOLocation='" + dropDownListClient.SelectedValue.ToString() + "' and  (t.voidstatus is null or t.voidstatus ='' ) order by t.EntryDate desc";
