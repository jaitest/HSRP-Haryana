...
namespace HSRP.Report
{
    public partial class CollectionReportDealerAndNonDealer : System.Web.UI.Page
    {
        ...
        protected void btnexport_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToDateTime(OrderDatefrom.SelectedDate.ToString("MM/dd/yyyy")) > Convert.ToDateTime(OrderDateto.SelectedDate.ToString("MM/dd/yyyy")))
            {
                Label1.Visible = true;
                Label1.Text = "Please Check To Date";
                return;
            }


            if (Convert.ToDateTime(OrderDateto.SelectedDate.ToString()) > Convert.ToDateTime(System.DateTime.Now))
            {
                Label1.Visible = true;
                Label1.Text = "Please Check To Date";
                return;
        ...
        private void Export(string strReportType, Workbook book,int iActiveSheet)
        {
                try
                {
                    String StringOrderDate = OrderDatefrom.SelectedDate.ToString("dd/MM/yyyy") + " 00:00:00";
                    String StringAuthDate = OrderDateto.SelectedDate.ToString("dd/MM/yyyy") + " 23:59:59";
                    ...
                    cmd.Parameters.Add(new SqlParameter("@fromdate", OrderDatefrom.SelectedDate.ToString("MM/dd/yyyy") + " 00:00:00"));
                    cmd.Parameters.Add(new SqlParameter("@todate", OrderDateto.SelectedDate.ToString("MM/dd/yyyy") + " 23:59:59"));
