<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="CashReceiptDataEntryDealer.aspx.cs" Inherits="HSRP.Transaction.CashReceiptDataEntryDealer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:UpdateProgress ID="UpdateProgress" runat="server">
    ...
    <div style="width: 100%;"> 
            ...
            <div style="width: 100%; height:383px; margin: 0px auto 0px auto">
                ...
                <td style="width: 347px">
                    ...
                    <tr>
                        ...
                        <td class="form_text" style="width: 128px">
                            <%--<asp:TextBox ID="txtVehicleRegNo" runat="server" class="form_textbox11"></asp:TextBox>--%>
                            <table>
                                                        <tr>
                                                            <td>
                                                                <asp:UpdatePanel runat="server" ID="UpdatePanelAuthNo" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <asp:AutoCompleteExtender UseContextKey="true" ServiceMethod="GetVehicleCashinHandRegsNo" MinimumPrefixLength="1"
                                                                            ServicePath="~/WCFService/ServiceForSuggestion.svc" CompletionInterval="10" EnableCaching="false"
                                                                            TargetControlID="txtVehicleRegNo" ID="AutoCompleteExtender1" runat="server"
                    ...
                    <tr id="div1" runat="server">
                        ...
                        <td style="width: 347px">
                            <asp:TextBox ID="txtFatherName"  runat="server" Width="160" class="form_textbox11" MaxLength="10"></asp:TextBox>
                        </td>
                    ...
                    <tr id="divAddress" runat="server">
                     <td class="form_text" style="width: 128px">
                        ...
                        <td>
                            <asp:TextBox ID="txtOldAddress"  runat="server" Width="320" Height="36px" class="form_textbox11" Enabled="false"
                    ...
                    <tr  id="div2" runat="server">
                        ...
                        <td>
                            <asp:TextBox ID="txtChassisNo"  runat="server" Width="160" class="form_textbox11" MaxLength="10"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 347px">
                            <asp:TextBox ID="txtMobileNo" onkeypress="return isNumberKey(event)" runat="server" Width="160" class="form_textbox11" MaxLength="10"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                             <asp:DropDownList Style="margin-left: 3px; margin-bottom: 0px;" 
                                                                AutoPostBack="true" CausesValidation="false"
                                                                ID="DropDownListOrderType" runat="server" TabIndex="20" Width="170px" 
                                                                OnSelectedIndexChanged="DropDownListOrderType_SelectedIndexChanged">
                    ...
                    <tr>
                        ...
                        <td style="width: 347px">
                        <asp:TextBox ID="txtCounterNo" runat="server"  Width="160" class="form_textbox11"></asp:TextBox> 
      ...
      <div style="border:0px solid; width:730px; height:40px; float:right ">
