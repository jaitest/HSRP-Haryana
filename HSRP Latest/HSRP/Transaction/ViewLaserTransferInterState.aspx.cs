...
{
    public partial class ViewLaserTransferInterState : System.Web.UI.Page
    {
        ...
        public void buildGrid()
        {
            try
            {
                SQLString = "SELECT Batch.BatchID,  Batch.ProductID, Product.ProductCode, Batch.BatchCode, Batch.Prefix,Batch.LaserCodeFrom, Batch.LaserCodeTo, CONVERT(varchar(10), Batch.DateOfManufacturing,101) as DateOfManufacturing,  CONVERT(varchar(10), Batch.CreateDateTime,101) as CreateDateTime FROM Batch INNER JOIN Product ON Batch.ProductID = Product.ProductID order by Batch.BatchID desc";
