    ...
    public partial class EmbossingCenterWiseQuantity : System.Web.UI.Page
    {
        ...
        private void FilldropDownListClient()
        {
            try
            {
                if (UserType == "0")
                {
                    SQLString = "select  EmbCenterName , Emb_Center_Id  as  NAVEMBID  from EmbossingCenters  Where State_Id='" + HSRP_StateID + "' and ActiveStatus!='N' and Emb_Center_Id is not null and EmbCenterName is not null Order by EmbCenterName";
