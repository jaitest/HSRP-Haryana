...
#region comment
        ...
        public void EpsionPrint(string hsrpRecordID )
        {
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                PdfPCell cell65anew1 = new PdfPCell(new Phrase(" ", new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell65anew1.Colspan = 4;
                cell65anew1.BorderWidthLeft = 0f;
                cell65anew1.BorderWidthRight = 0f;
                cell65anew1.BorderWidthTop = 0f;
                ...
                PdfPCell cell622 = new PdfPCell(new Phrase(" ", new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell622.Colspan = 4;
