...
namespace HSRP.Master
{
    public partial class AddHRDealer : System.Web.UI.Page
    {
        ...
        protected void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            string Sql1= "Select * From Users where UserLoginName ='" +txtDealerloginid.Text.ToString().Trim() + "'";
            DataTable dtcount = Utils.GetDataTable(Sql1, CnnString);
            ...
            if (Utils.ExecNonQuery(SQLString, CnnString) > 0)
            {
                ...
                if (dtt.Rows.Count > 0)
                {
                    lblSucMess.Visible = true;
                    lblSucMess.Text = string.Empty;
                    lblSucMess.Text = "Dealer Already Maped . Try another?.";
                    return;
