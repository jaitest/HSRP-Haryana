...
{
    public partial class HRCashCollectionDataEntry : System.Web.UI.Page
    {
        ...
        private void FilldropDownListRTOLocation()
        {
            ...
            if (UserType.Equals(0))
            {
               // int.TryParse(dropDownListHSRPState.SelectedValue, out intHSRPStateID);
                ...
                Utils.PopulateDropDownList(dropDownListRTOLocation, SQLString.ToString(), ConnectionString, "--Select Location--");
            }
            else
            {
               // int.TryParse(Session["UID"].ToString(), out UID);
                ...
                dropDownListRTOLocation.Items.Insert(0, new System.Web.UI.WebControls.ListItem("--Select Location--", "--Select Location--"));
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (dropDownListRTOLocation.SelectedValue == "--Select Location--")
                {
               ...
               string q = "select  gstbasicamount ,SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount	 , Roundoff_NetAmount  from tax where OrderType	 ='" + ddlOrderType.SelectedValue + "' and VehicleType ='" + ddlVehicletype.SelectedItem.ToString() + "' and   HSRP_StateID= '" + HSRPStateID + "'";
               ...
               string strQuery = "insert into HSRPRecords (hsrprecord_authorizationno,hsrprecord_authorizationdate,SaveMacAddress,DeliveryChallanNo,ISFrontPlateSize,ISRearPlateSize,invoiceno, address1," +
                       ...
                       "VAT_Amount,RoundOff_NetAmount,VAT_Percentage,PlateAffixationDate,DateOfInsurance,ReceiptNo,Exshowroomprice,vehicleregno,addrecordby, StickerMandatory ,userrtolocationid ,  SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount	) " +
        ...
        public void EpsionPrint()
        {
            ...
            string SQLString = " select top 1  hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType , EngineNo , SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount	 , gstbasicamount from hsrprecords where  EngineNo ='" + txtEngineNo.Text + "' order by  HSRPRecord_CreationDate desc";
