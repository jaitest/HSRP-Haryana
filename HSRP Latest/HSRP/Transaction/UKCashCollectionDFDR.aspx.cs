...
{
    public partial class UKCashCollectionDFDR : System.Web.UI.Page
    {
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    string StrNICVehicleType = dt.Rows[0]["NICvehicletype"].ToString().Split('*')[0];
                    if (StrNICVehicleType.ToUpper().Trim() == "E-RICKSHAW(P)(3WT)" || StrNICVehicleType.Trim() == "e-Rickshaw(P)(3WT)")
                    {
                        lblVehicleType.Text = "E-RICKSHAW";
                 ...
                 ViewState["StrNICVehicleType1"] = StrNICVehicleType;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               if (StrTransactonType2 == "DB" || StrTransactonType2 == "NB" || StrTransactonType2 == "OB" || StrTransactonType2 == "OS")
                {

                    lblErrMess.Visible = true;
                    lblErrMess.Text = "";
                    lblErrMess.Text = "Only DF OR DR ALLOW.";
                ...
                if (ddlVehicleClass.Text == "NON-TRANSPORT")
                {
                    ...
                    if (lblVehicleType.Text.Trim() == "E-RICKSHAW" && ddlVehicleClass.Text == "NON-TRANSPORT")
                    {
                        lblErrMess.Visible = true;
                        lblErrMess.Text = "";
                        lblErrMess.Text = " Please Select Vehicle Class TRANSPORT For E-RICKSHAW.";
                        return;
                    }

                    if (ViewState["StrNICVehicleType1"].ToString() == "Motor Cycle/Scooter(2WN)" || ViewState["StrNICVehicleType1"].ToString() == "M-Cycle/Scooter(2WN)")
                    {
                    ...
                    ViewState["StrNICVehicleType1"].ToString();
                    if (ViewState["StrNICVehicleType1"].ToString() == "Motor Cycle/Scooter(2WN)" || ViewState["StrNICVehicleType1"].ToString() == "M-Cycle/Scooter(2WN)" || string.IsNullOrEmpty(ViewState["StrNICVehicleType1"].ToString()))
                    {
        ...
        public void EpsionPrint()
        {
            ...
            string username = " select  userfirstname+' '+userlastname as UserLoginName from users where UserID='" + USERID + "'";
            DataTable dtusername = Utils.GetDataTable(username, ConnectionString);
            string userloginname = dtusername.Rows[0]["UserLoginName"].ToString();
            ...
            // string SQLString = "select hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType , SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount	 , gstbasicamount  from hsrprecords where  vehicleRegNo ='UK06AN2721' order by  HSRPRecord_CreationDate desc";
            string SQLString = "select hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType , SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount	 , gstbasicamount  from hsrprecords where  vehicleRegNo ='" + txtRegNo.Text + "' order by  HSRPRecord_CreationDate desc";
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                PdfPCell cell1234 = new PdfPCell(new Phrase("RTOLocation  : " + RtoLocationName, new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell1234.Colspan = 2;
                cell1234.BorderColor = BaseColor.WHITE;
                cell1234.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell1234);
                ...
                PdfPCell cell1203 = new PdfPCell(new Phrase(AffAddress, new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell1203.Colspan = 2;
                cell1203.BorderWidthLeft = 0f;
                cell1203.BorderWidthRight = 0f;
                cell1203.BorderWidthTop = 0f;
                ...
                PdfPCell cell0 = new PdfPCell(new Phrase("HSRP CASH RECEIPT", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.UNDERLINE, iTextSharp.text.BaseColor.BLACK)));
                cell0.Colspan = 2;
                cell0.BorderWidthLeft = 0f;
                cell0.BorderWidthRight = 0f;
                cell0.BorderWidthTop = 0f;
                ...
                string GSTIN = Utils.getScalarValue("select GSTIN from hsrpstate where HSRP_StateID='" + HSRPStateID + "' ", ConnectionString);

                PdfPCell cell22111 = new PdfPCell(new Phrase(": " + GSTIN.ToString(), new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell22111.Colspan = 0;
                cell22111.BorderWidthLeft = 0f;
                cell22111.BorderWidthRight = 0f;
                cell22111.BorderWidthTop = 0f;
                ...
                PdfPCell cell64 = new PdfPCell(new Phrase(Message, new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell64.Colspan = 4;
                cell64.BorderWidthLeft = 0f;
                cell64.BorderWidthRight = 0f;
                cell64.BorderWidthTop = 0f;
                ...
                PdfPCell cell65a = new PdfPCell(new Phrase(MessageSec, new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell65a.Colspan = 4;
                cell65a.BorderWidthLeft = 0f;
                cell65a.BorderWidthRight = 0f;
                cell65a.BorderWidthTop = 0f;
                ...
                PdfPCell cellmsg = new PdfPCell(new Phrase(MessageSecnNew, new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cellmsg.Colspan = 4;
                cellmsg.BorderWidthLeft = 0f;
                cellmsg.BorderWidthRight = 0f;
                cellmsg.BorderWidthTop = 0f;
                ...
                PdfPCell cellmsg1 = new PdfPCell(new Phrase(MessageSecNew1, new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cellmsg1.Colspan = 4;
                cellmsg1.BorderWidthLeft = 0f;
                cellmsg1.BorderWidthRight = 0f;
                cellmsg1.BorderWidthTop = 0f;
                ...
                PdfPCell cell631 = new PdfPCell(new Phrase("Affixation Center : " + RtoLocationName, new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell631.Colspan = 4;
                cell631.BorderWidthLeft = 0f;
                cell631.BorderWidthRight = 0f;
                cell631.BorderWidthTop = 0f;
                ...
                PdfPCell cellESPN = new PdfPCell(new Phrase("\u2022" + "Corporate office : " + "Dehradun," + RTOAddress, new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cellESPN.Colspan = 4;
                cellESPN.BorderWidthLeft = 0f;
                cellESPN.BorderWidthRight = 0f;
                cellESPN.BorderWidthTop = 0f;
                ...
                PdfPCell cellofficeESPN = new PdfPCell(new Phrase("\u2022" + "Registered office : " + " B-84, Phase – I, Mayapuri Industrial Area, New Delhi - 110064 ", new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cellofficeESPN.Colspan = 4;
                cellofficeESPN.BorderWidthLeft = 0f;
                cellofficeESPN.BorderWidthRight = 0f;
                cellofficeESPN.BorderWidthTop = 0f;
                ...
                PdfPCell cell63 = new PdfPCell(new Phrase("FOR " + GetAddress.Rows[0]["CompanyName"].ToString(), new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell63.Colspan = 4;
                cell63.BorderWidthLeft = 0f;
                cell63.BorderWidthRight = 0f;
                cell63.BorderWidthTop = 0f;
                ...
                PdfPCell cell62 = new PdfPCell(new Phrase("(AUTH.SIGH.)" + " " + userloginname, new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell62.Colspan = 2;
                cell62.BorderWidthLeft = 0f;
                cell62.BorderWidthRight = 0f;
                cell62.BorderWidthTop = 0f;
                ...
                PdfPCell celldupRouCash4022 = new PdfPCell(new Phrase(" ", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                celldupRouCash4022.Colspan = 4;
        ...
        protected void ddlVehicleClass_SelectedIndexChanged(object sender, EventArgs e)
        {
           if (ViewState["StrNICVehicleType1"].ToString() == "Motor Cycle/Scooter(2WN)" || ViewState["StrNICVehicleType1"].ToString() == "M-Cycle/Scooter(2WN)")
           {
               ...
               {
                   string SQLString2 = "select dbo.hsrpplateamt ('" + HSRPStateID + "','" + ddlVehicleType.SelectedItem.ToString() + "','" + ddlVehicleClass.SelectedItem.ToString() + "','" + lblTransactionType.Text + "') as Amount";
