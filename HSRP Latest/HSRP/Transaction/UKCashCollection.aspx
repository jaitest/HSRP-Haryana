              ...
              <tr>
                <td width="69%"><table id="Table1" width="900" align="center" style="font-size: 16px; color:Black; font-family:@Batang; background-color:#fff" >
                  <tr>
                    ...
                    <td valign="top"><asp:Button ID="btnGo" runat="server" Text="Go"  OnClick="btnGo_Click" Width="120px" /></td>
                    <td valign="top"> <asp:Button ID="Btnreset" runat="server" Text="Reset"   OnClick="btreset_Click" Width="118px" /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><asp:Label ID="lblVehicleType" runat="server" Text=""  Visible="false">     </asp:Label>
                        <asp:Label ID="lblVehicleTypeERicksha" runat="server" Text="" Visible="false">  </asp:Label>
                     &nbsp;&nbsp;&nbsp;&nbsp;
                     <asp:DropDownList ID="ddlVehicleType" runat="server" Visible="false"   
                         DataTextField="VEHICLETYPE" DataValueField="VEHICLETYPE" OnSelectedIndexChanged="ddlVehicleType_SelectedIndexChanged" AutoPostBack="true">
                    ...
                    <td><asp:Label ID="lblTransactionType" runat="server" Text=""></asp:Label>
                  ...
                  <tr>
                    ...
                    <td><asp:TextBox ID="txtMobileno" runat="server" CssClass="text_box" MaxLength="10"  ValidationGroup="Mobile"></asp:TextBox>
                      <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtMobileno"  ValidationExpression="^[0-9]{10}$"  ErrorMessage="Invalid Value"></asp:RegularExpressionValidator>
                      <br />
            ...
            Affixation Center Name :<span style="color:Red">*</span>
                  ...
                  <tr>
                    <td><a class="alert1" id="save1">Confirm</a>
                      <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" BackColor="Orange" Width="57px" ValidationGroup="Mobile"    /></td>

                    <td><asp:Button ID="Button3" runat="server" CssClass="button" Height="23px" onclick="Button3_Click" TabIndex="12" Text="Epson Print"  Width="100px" Visible="False" />                
                     </td>

                   <td>     <%--<asp:Button ID="btnDownload" runat="server"  Text="Download Receipt"    OnClick="btnDownloadReceipt_Click" CssClass="button" Visible="false" Width="135px" />--%> 
                        <%-- <asp:Button ID="Button1" runat="server" Text="Test"  OnClick="btnTest_Click" CssClass="button" Visible="false" Width="111px" />--%>
