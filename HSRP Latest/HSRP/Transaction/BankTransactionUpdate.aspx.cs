        ...
        private void EditBankTransaction(string TransactionID)
        {
            try
            {
                   ...
                   // string ss1 = ds.Rows[0]["EntryDate"].ToString();
                    ...
                    DateTime dt = DateTime.Parse(ds.Rows[0]["EntryDate"].ToString());                                         
                    string newString = dt.Year.ToString()+"-"+dt.Month.ToString()+"-"+dt.Day.ToString();
                    DepositDate1.SelectedDate = DateTime.Parse(newString +" 00:00:00"); //DateTime.Parse(ds.Rows[0]["EntryDate"].ToString()).AddDays(0.00);  
