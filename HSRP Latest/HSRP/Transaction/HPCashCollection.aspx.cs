            ...
            try
            {
                ...
                else
                {
                    ...
                    if (message == "Y")
                    {
                        ...
                        string smsmessage = "Cash Rs." + lblAmount.Text.Trim() + " received against HSRP " + txtRegNo.Text.Trim() + " on " + DateTime.Now.ToString("dd-MM-yyyy") + " receipt number " + cashrc + ". Transport Dept HP.";
