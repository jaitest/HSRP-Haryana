<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BankTransactionApprovalDealerBihar.aspx.cs" Inherits="HSRP.Transaction.BankTransactionApprovalDealerBihar" %>
                        ...
                        <td>
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtSearchByname" Width="250px" Visible="false" runat="server"></asp:TextBox>
                                        <asp:AutoCompleteExtender ServiceMethod="SearchByDealerName" MinimumPrefixLength="1" CompletionInterval="10" EnableCaching="false" CompletionSetCount="10" TargetControlID="txtSearchByname" ID="AutoCompleteExtender2" runat="server" FirstRowSelected="false">  
                                        </asp:AutoCompleteExtender>

                                        <asp:TextBox ID="txtSearchByID" Width="250px" Visible="false" runat="server"></asp:TextBox>
                                        <asp:AutoCompleteExtender ServiceMethod="SearchCustomers" MinimumPrefixLength="1" CompletionInterval="10" EnableCaching="false" CompletionSetCount="10" TargetControlID="txtSearchByID" ID="AutoCompleteExtender1" runat="server" FirstRowSelected="false">  
                                        </asp:AutoCompleteExtender>    
                            ...
                            <table width="99%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:GridView ID="grdid" runat="server" CellPadding="4" ForeColor="#333333"
                                            ...
                                            OnRowDataBound="grdid_RowDataBound" OnSelectedIndexChanged="grdid_SelectedIndexChanged">
                                            <AlternatingRowStyle BackColor="White" />
                                            <Columns>
                                                <asp:BoundField HeaderText="Transaction ID" DataField="TransactionID" />
                                                <asp:BoundField HeaderText="Account No/Transaction Type" DataField="Transactiontype" />
                                              <%--  <asp:BoundField HeaderText="Deposit Date" DataField="Deposit Date" />--%>
                                                ...
                                                <asp:BoundField HeaderText="Deposit By /Deposit Date" DataField="DepositBy" />
                                                ...
                                                <asp:TemplateField HeaderText="Approval">
                                                    <ItemTemplate>
                                                        <asp:LinkButton runat="server" ID="lnkView" ClientIDMode="Static" CommandArgument='<%#Eval("TransactionID") %>'  CommandName="Approval" ValidationGroup="link">Approved</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Cheque Approval">
                                                    <ItemTemplate>
                                                        <asp:LinkButton runat="server" ID="lnkChrec" ClientIDMode="Static" CommandArgument='<%#Eval("TransactionID") %>' CommandName="CheqeApproval">cheque Approved</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <td>
                                        <asp:Panel ID="Panel3" runat="server" BackColor="White" Height="269px" Width="400px" Style="display: none">
                                            <table width="100%" style="border: Solid 3px #507CD1; width: 100%; height: 100%" cellpadding="0" cellspacing="0">
                                                <tr style="background-color: #507CD1">
                                                    <td colspan="2" style="height: 10%; color: White; font-weight: bold; font-size: larger" align="center">Approval Cheque Transaction</td>
                                                </tr>
                                                <tr>
                                                    <td align="right" style="width: 45%">TransactionId:
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtchakdate" runat="server" /><br />

                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txtchakdate" ValidationGroup="chequeApproved" runat="server" ErrorMessage="Please Enter Cheque Clearance Date"></asp:RequiredFieldValidator>
                                                        <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtchakdate" Format="dd/MM/yyyy" ></asp:CalendarExtender>
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                       <asp:Button ID="btnchequeapproved" CommandName="Update"  runat="server" Text="Cheque Approved" ValidationGroup="chequeApproved" OnClick="btnchequeApproval" />
                                                        <asp:Button ID="btnchequeCancel" runat="server" Text="Cancel" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>

                                        <asp:Button ID="btnPopupShow" runat="server" Style="display: none" />
                                        <asp:ModalPopupExtender ID="ModalPopupExtender3" runat="server" TargetControlID="btnPopupShow" PopupControlID="Panel3"  CancelControlID="btnchequeCancel" BackgroundCssClass="modalBackground">
                                        </asp:ModalPopupExtender>
