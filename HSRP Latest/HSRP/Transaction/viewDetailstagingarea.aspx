<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewDetailstagingarea.aspx.cs" Inherits="HSRP.Transaction.viewDetailstagingarea" %>
             ...
             <table style="background-color:White" width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                ...
                <td colspan="7">
                    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true">
                             ...
                             <tr>
                         <td class="auto-style1" style="padding-bottom: 10px">Order Date :</td>
                         <td class="auto-style2"></td>
                         <td class="auto-style2">   <asp:Label ID="LabelDataEntryDate" runat="server" class="form_text" ></asp:Label></td>
                         <td class="auto-style2"></td>
                         <td class="auto-style2"></td>
                         <td class="auto-style2"></td>
                         </tr>
                  ...
                  <%--  <tr>
                   <td class="form_text" style="padding-bottom: 10px"> Laser Plate Box No. </td> 
                    ...
                    <%-- <tr>
                      <td class="form_text" style="padding-bottom: 10px; margin-left: 120px;"> 
                          <asp:Label ID="Label1" runat="server" class="form_text" Text="Order Book By :"></asp:Label></td> 
                        <td  > </td> 
                        <td class="form_text" style="padding-bottom: 10px">
                        ...
                        <tr>
                         ...
                         <td></td>
                         <td class="form_text" style="padding-bottom: 10px">   <asp:Label ID="LabelRemarks" runat="server" class="form_text" ></asp:Label></td>
                         <td></td>
                         
                         <td class="form_text" style="padding-bottom: 10px">Order Status :</td>
                          <td></td>
                          <td class="form_text" style="padding-bottom: 10px">   <asp:Label ID="Labelorderstatus" runat="server" class="form_text" ></asp:Label></td>
                         </tr>

                         <tr>
                         <td class="form_text" style="padding-bottom: 10px">Embossing Date :</td>
                         <td></td>
                         <td class="form_text" style="padding-bottom: 10px">   <asp:Label ID="LabelEmbdate" runat="server" class="form_text" ></asp:Label></td>
                         <td></td>
                         
                         <td class="form_text" style="padding-bottom: 10px">Closed Date :</td>
                          <td></td>
                          <td class="form_text" style="padding-bottom: 10px">   <asp:Label ID="Labelcloesddate" runat="server" class="form_text" ></asp:Label></td>
