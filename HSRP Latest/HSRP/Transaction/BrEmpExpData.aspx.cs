...
{
    public partial class BrEmpExpData : System.Web.UI.Page
    {
           ...
           try
                {
                     ...
                     if (Fields.Length == 13)
                    {
                        ...
                        string ChessinNo = string.Empty;
                        string EnginNo = string.Empty;                       
                        string HSRP_Authrization_no = string.Empty;                       
                    

                        for (int i = 0; i <= dt.Rows.Count - 1; i++)
                        {
                            rtolocationName= dt.Rows[i][1].ToString();
                            DealerName = dt.Rows[i][2].ToString().Replace("'", "`");
                            VehicleReg= dt.Rows[i][3].ToString();
                            StrOwnerName = dt.Rows[i][4].ToString().Replace("'", "`");
                            Address =  dt.Rows[i][5].ToString();

                            NICVehicleType = dt.Rows[i][6].ToString();
                            Manufacturename= dt.Rows[i][7].ToString();
                            Model= dt.Rows[i][8].ToString();
                            ChessinNo= dt.Rows[i][9].ToString();
                            EnginNo= dt.Rows[i][10].ToString();
                            HSRP_Authrization_no= dt.Rows[i][11].ToString();                         

                           
                            string Rtolocationid = Utils.getScalarValue("select rtolocationid from  rtolocation where   rtolocationName='" +  rtolocationName + "'", CnnString);
                           // string qu = "select  ordertype  from hsrprecords where vehicleRegNo='" + VehicleReg + "'";
                           // string OrderType = Utils.getScalarValue(qu, CnnString);                            
                            ...
                            sbRows.Append("'" + Rtolocationid + "','" + dt.Rows[i][2].ToString() + "','" + dt.Rows[i][3].ToString() + "','" + dt.Rows[i][4].ToString().Trim() + "','  " + dt.Rows[i][5].ToString() + " ',' " + ourvehicleType + " ',' " + dt.Rows[i][7].ToString().Trim() + " ',' " + dt.Rows[i][8].ToString().Trim() + " ',' " + dt.Rows[i][9].ToString().Trim() + " ',' " + dt.Rows[i][10].ToString().Trim() + "  ',' " + dt.Rows[i][11].ToString().Trim() + " '");
                          
                            string chkRecord = "SELECT COUNT(*) FROM HSRPRecordsStaggingArea WHERE  HSRP_StateID ='1'  and RTOLocationID='" + Rtolocationid + "' and vehicleRegNo= '" + VehicleReg + "' ";
                            ...
                            if (count < 1)
                            {
                                ...
                                //if (OrderType == "NB" || OrderType == "OB" || OrderType == "DB")
                                //{
                                //    Hsrp_History = "INSERT INTO HSRPRecordsStaggingArea (HSRP_StateID,RTOLocationID  ,DealerName, VehicleRegNo,OwnerName, address1 , VehicleType, Manufacturer,ManufacturerModel,ChassisNo,EngineNo,  HSRPRecord_AuthorizationNo, ISFrontPlateSize,ISRearPlateSize, NICVehicleType,NICVehicleRegNo) values (" + 1 + " ," + sbRows.ToString() + ",'Y','Y', '" + filename + "','" + NICVehicleType + "','" + dt.Rows[i][3].ToString() + "');";
                                //}
                                //else if (OrderType == "DF")
                                //{
                                //    Hsrp_History = "INSERT INTO HSRPRecordsStaggingArea (HSRP_StateID,RTOLocationID  ,DealerName, VehicleRegNo,OwnerName, address1 , VehicleType, Manufacturer,ManufacturerModel,ChassisNo,EngineNo,  HSRPRecord_AuthorizationNo, ISFrontPlateSize,ISRearPlateSize, NICVehicleType,NICVehicleRegNo) values (" + 1 + " ," + sbRows.ToString() + ",'Y','N','" + filename + "','" + NICVehicleType + "','" + dt.Rows[i][3].ToString() + "');";
                                //}
                                //else if (OrderType == "DR")
                                //{
                                //    Hsrp_History = "INSERT INTO HSRPRecordsStaggingArea (HSRP_StateID,RTOLocationID  ,DealerName, VehicleRegNo,OwnerName, address1 , VehicleType, Manufacturer,ManufacturerModel,ChassisNo,EngineNo,  HSRPRecord_AuthorizationNo, ISFrontPlateSize,ISRearPlateSize, NICVehicleType,NICVehicleRegNo) values (  " + 1 + " ," + sbRows.ToString() + ",'N','Y','" + filename + "','" + NICVehicleType + "','" + dt.Rows[i][3].ToString() + "');";
                                // }
                                //else if (OrderType == "OS")
                                //{
                                //    Hsrp_History = "INSERT INTO HSRPRecordsStaggingArea (HSRP_StateID,RTOLocationID  ,DealerName, VehicleRegNo,OwnerName, address1 , VehicleType, Manufacturer,ManufacturerModel,ChassisNo,EngineNo,  HSRPRecord_AuthorizationNo, ISFrontPlateSize,ISRearPlateSize, NICVehicleType,NICVehicleRegNo) values ( " + 1 + " ," + sbRows.ToString() + ",'N','N','" + filename + "','" + NICVehicleType + "','" + dt.Rows[i][3].ToString() + "');";
                                //}

                                Hsrp_History = "INSERT INTO HSRPRecordsStaggingArea (HSRP_StateID,RTOLocationID  ,DealerName, VehicleRegNo,OwnerName, address1 , VehicleType, Manufacturer,ManufacturerModel,ChassisNo,EngineNo,  HSRPRecord_AuthorizationNo,  NICVehicleType,NICVehicleRegNo) values (" + 1 + " ," + sbRows.ToString() + ", ' " + NICVehicleType + "','" + dt.Rows[i][3].ToString() + "');";
                        ...
                        Utils.ExecNonQuery("UPDATE HSRPRecordsStaggingArea set VehicleRegNo=replace(VehicleRegNo,' ','') where HSRP_StateID='" + 1 + "' and RTOLocationID='" + RTOLocationID + "' ", CnnString);
