...
namespace HSRP.Master.InvoiceMaster
{
    public partial class ViewPO : System.Web.UI.Page
    {
        ...
        protected void LinkbuttonSearch_Click(object sender, EventArgs e)
        {
            ...
            ds = blinvoce.ShowViewPO2(OrderDate1.ToString("dd/MM/yyyy"));
            ...
            if (e.Control.ID == "LinkButtonPO")
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                   int i = ds.Tables[0].Rows.Count;
                    ...
                    PdfPCell cell12093 = new PdfPCell(new Phrase("HSRP", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                    cell12093.Colspan = 7;
