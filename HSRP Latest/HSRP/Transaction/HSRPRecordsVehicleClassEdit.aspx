                                    ...
                                    <tr>
                                        <td align="left"  class="form_text" nowrap="nowrap">
                                            <asp:Label Text="Chassis No:" Visible="false" runat="server" ID="Label1" />
                                               <asp:Label Text="Vehicle Reg No:" Visible="false" runat="server" ID="Label6" />
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtChassisNo" Visible="false"  runat="server"></asp:TextBox>
                                             <asp:TextBox ID="txtRegNo" Visible="false"  runat="server"></asp:TextBox>
                                        </td>   
                                        ...
                                        <td class="auto-style2" nowrap="nowrap">
                                            ...
                                            <asp:LinkButton ID="lnkModifyVehicle1" runat="server" AutoPostBack="true" OnClick="lnkModifyVehicle1_Click" Text="Modify Vehicle Reg No."></asp:LinkButton>
                                        </td>
                                    </tr>
