...
namespace HSRP.Transaction
{
    public partial class UKCashCollection : System.Web.UI.Page
    {
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
           // btnDownload.Visible = false;
            ...
            try
            {
                ...
                string strVehicleNo = txtRegNo.Text.ToString().Trim();
                string strCheck = strVehicleNo.Substring(0, 1);
                //if (strCheck.ToUpper().ToString().Trim() != "U" )
                //{
                ...
                if (txtRegNo.Text.Trim().ToString() == "" || string.IsNullOrEmpty(txtRegNo.Text.Trim()))
                {
                    lblErrMess.Visible = true;
                    lblErrMess.Text = "Pleae Enter Vehicle Registration No. ";
                    return;
                }
        ...
        //    string SQLString = "select hsrprecordID, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType,CashReceiptNo from hsrprecords where  VehicleRegNo ='" + txtRegNo.Text + "' order by  HSRPRecord_CreationDate desc";
            ...
            try
            {
               ...
               for (int k = 0; k < chararrinput.Length; k++)
               {
                ...
                if (ddlVehicleClass.Text == "NON-TRANSPORT")
                {
                    ...
                    if (lblVehicleTypeERicksha.Text.Trim() =="E-RICKSHAW" && ddlVehicleClass.Text == "NON-TRANSPORT")
                    {
                        lblErrMess.Visible = true;
                        lblErrMess.Text = "";
