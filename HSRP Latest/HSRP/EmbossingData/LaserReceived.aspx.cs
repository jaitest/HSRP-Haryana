    ...
    public partial class LaserReceived : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (strUserID.ToString().Trim() == "7594")
                {
        ...
        protected void btnGO_Click(object sender, EventArgs e)
        {
            ...
            {
                SQLString = "select  Distinct ChallanNo   from hsrprecords  where hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and rtolocationID='" + dropDownRtoLocation.SelectedValue + "' and RecievedAffixationStatus='N' and  ChallanNo is not null and  ChallanNo like '%" + Searchtext.Text.Trim() + "%'";
            }
        ...
        protected void btnUpdate_Click(object sender, System.EventArgs e)
        {
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                if (chk.Checked == true)
                {
                   ...
                   // SMSText = "Your H.S.R.P. "+ reg_no +" is ready for Affixation, Please visit your H.S.R.P. center for Affixation Between 2 PM - 5.30 PM. HSRP Team";
                    ...
                    if (HSRPStateID == "4")
                    {
                        ...
                        string SMSTextHR = string.Empty;
                         if (PhoneNumber.Length > 0)
                         {
                            if ((rtolocationid == "467") || (rtolocationid == "479") || (rtolocationid == "490") || (rtolocationid == "474") || (rtolocationid == "468") || (rtolocationid == "506") || (rtolocationid == "509") || (rtolocationid == "519") || (rtolocationid == "521") || (rtolocationid == "543"))
                            {
                                SMSTextHR = "Your H.S.R.P. " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center for Affixation Between 02:00 AM - 5.30 PM. HSRP Team";
                            }                         
                            else
                            {
                                SMSTextHR = "Your H.S.R.P. " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center for Affixation Between 09:30 AM - 5.30 PM. HSRP Team";
                            }                       
                                                     
                            string querycountday = "SELECT DATEDIFF(day,( Select  convert(date, hsrpRecord_CreationDate ) from hsrprecords  where HSRPRecordID='" + strRecordId + "'),  convert(date,GETDATE()) ) as diff";
                            DataTable dtcountday = Utils.GetDataTable(querycountday, CnnString);

                            string queryHolidayday = "select count(*) from HolidayDateTime where hsrp_stateid =" + HSRPStateID + " and convert(date,blockDate,103) between dateadd(day,-5, convert(date,getdate())) and dateadd(day,0, convert(date,getdate()) ) ";
                            int j = Utils.getScalarCount(queryHolidayday, CnnString);
                            int  K = 5 + j;
                             
                            if (Convert.ToInt32(dtcountday.Rows[0]["diff"].ToString()) <= K)
                           {
                           
                                sendURL = "http://103.16.101.52:8080/bulksms/bulksms?username=sse-hsrphr&password=hsrphr&type=0&dlr=1&destination=" + PhoneNumber + "&source=HRHSRP&message=" + SMSTextHR;
                        ...
                        else
                        {
                         ...
                         SqlQuery = "insert into HRSMSDetail (HSRPRecordID,RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode,Smstext) values('" + strRecordId + "','" + RTOLocationID + "','" + lblVehicleRegNo.Text + "','" + PhoneNumber + "','" + result + "','" + SMSTextHR+ "')";
                    ...
                    {                       
                        ...
                        if (PhoneNumber.Length > 0)
                        {
                            ...
                            {
                                sendURL = "http://103.16.101.52:8080/bulksms/bulksms?username=sse-ukhsrp&password=ukhsrp&type=0&dlr=1&destination=" + PhoneNumber + "&source=UKHSRP&message=" + SMSTextuk;
                                HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create(sendURL);
                                myRequest.Method = "GET";
                                WebResponse myResponse = myRequest.GetResponse();
                                StreamReader sr = new StreamReader(myResponse.GetResponseStream(), System.Text.Encoding.UTF8);
                        ...
                        SqlQuery = "insert into UKSMSDetail (HSRPRecordID,RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode,smstext) values('" + strRecordId + "','" + RTOLocationID + "','" + lblVehicleRegNo.Text + "','" + PhoneNumber + "','" + result + "','" + SMSTextuk + "')";
                        Utils.ExecNonQuery(SqlQuery, CnnString);
                    }
                   ...
                   //-------------------For BR SMS----------------
                    ...
                    {
                        string SMSTextbr = string.Empty;
                        if (PhoneNumber.Length > 0)
                        {
                            if (rtolocationid == "302")
                            {
                                SMSTextbr = "Your H.S.R.P. " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center for Affixation Between 11:00 AM - 5.00 PM. HSRP Team";
                            }
                            else
                            {
                                SMSTextbr = "Your H.S.R.P. for " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center Between 2 PM - 5.30 PM for Affixation. HSRP Team";
                            }
                            string SMSCheck = "Select top 1 HSRPRecordID from BRSMSDetail where HSRPRecordID='" + strRecordId + "'";
                            DataTable HSRPRecordID = Utils.GetDataTable(SMSCheck, CnnString);
                            if (HSRPRecordID.Rows.Count == 0)
                            {
                                sendURL = "http://103.16.101.52:8080/bulksms/bulksms?username=sse-biharhsrp&password=biharhsr&type=0&dlr=1&destination=" + PhoneNumber + "&source=BRHSRP&message=" + SMSTextbr;
                                HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create(sendURL);
                                myRequest.Method = "GET";
                                WebResponse myResponse = myRequest.GetResponse();
                                StreamReader sr = new StreamReader(myResponse.GetResponseStream(), System.Text.Encoding.UTF8);
                        ...
                        SqlQuery = "insert into BRSMSDetail(HSRPRecordID,RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode,smstext) values('" + strRecordId + "','" + RTOLocationID + "','" + lblVehicleRegNo.Text + "','" + PhoneNumber + "','" + result + "','" + SMSTextbr + "')";
                        Utils.ExecNonQuery(SqlQuery, CnnString);
                    }
