<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DealerSticker.aspx.cs" Inherits="HSRP.EmbossingData.DealerSticker" %>
                        ...
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:Label Text="Location:"  runat="server" ID="labelClient" />
                                    </td>
                                    <td valign="middle" class="form_text">
                                       <%-- <asp:UpdatePanel runat="server" ID="UpdateRTOLocation" UpdateMode="Conditional">
                                            <ContentTemplate>--%>
                                                <asp:DropDownList  ID="dropDownListClient" CausesValidation="false"
                                                    Width="140px" runat="server" DataTextField="RTOLocationName" AutoPostBack="true"
                                      ...
                                      <%--  </asp:UpdatePanel>--%>
                                       ...
                                       <td valign="middle" class="form_text"  nowrap="nowrap">
                                         <asp:Label Text="Dealer :" runat="server"  ID="labelSelectType" />

                                     </td>
                                    <td>                               
                        
                                         <asp:DropDownList  ID="ddlBothDealerHHT" CausesValidation="false"
                                                    Width="140px" runat="server" DataTextField="dealername" 
