...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function vali() {
            ...
            if (document.getElementById("<%=ddlDealertype.ClientID%>").value == "--Select Dealer Type--") {
                alert("Please Select Dealer Type .");
                document.getElementById("<%=ddlDealertype.ClientID%>").focus();
                return false;
            }
...
&nbsp;<span class="alert"> </span> </td>
                                                ...
                                                <asp:ListItem>--Select RTO Location--</asp:ListItem>
                                                    ...
                                                    <tr>
                                                         <td class="style7">
                                                            Dealer Type :<span class="alert">* </span>
                                                        </td>
                                                         <td class="style4">
                                                           
                                                           <asp:DropDownList class="form_textbox12" runat="server" DataTextField ="ChargingType" DataValueField ="ChargingType" ID="ddlDealertype">
