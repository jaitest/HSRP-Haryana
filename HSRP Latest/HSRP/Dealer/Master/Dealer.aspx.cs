...
namespace HSRP.Dealer.Master
{
    public partial class Dealer : System.Web.UI.Page
    {
       ...
       //     StringDealerCode = textBoxDealerCode.Text.Trim().Replace("'", "''").ToString();
            ...
            "ChargingType='" + ddlDealertype.SelectedItem.Text.ToString() + "',erpclientcode='" + txtERPClientCode.Text.ToString().ToUpper() + "',erpembcode='" + txtERPEmbossingCode.Text.ToString().ToUpper() + "',IsActive=" + ActiveStatus + " where DealerID=" + DealerID + " ";
            if (Utils.ExecNonQuery(SQLString, CnnString) <= 0)
            {
        ...
        {
            SQLString = "  select  distinct  ChargingType   from  dealermaster  where  isnull(ChargingType,'')!='' ";
            Utils.PopulateDropDownList(ddlDealertype, SQLString.ToString(), CnnString, "--Select Dealer Type--");
        }
        ...
        protected void buttonSave_Click(object sender, EventArgs e)
        {
          ...
          //  StringDealerCode = textBoxDealerCode.Text.Trim().Replace("'", "''").ToString();
            ...
            if (string.IsNullOrEmpty(ddlDealertype.SelectedItem.Text.ToString().Trim()))
            {
                lblErrMess.Text = String.Empty;
                lblErrMess.Text = "Please Select Dealer Type.";
                return;
            }
            else
            {
                if (ddlDealertype.SelectedItem.Text.ToString() == "--Select Dealer Type--")
                {
                    lblErrMess.Text = String.Empty;
                    lblErrMess.Text = "Please Select Dealer Type.";
                    return;
            ...
            if (HsrpStateId == "4")
            {
                ...
                SQLString = "insert into  DealerMaster (erpembcode,DealerName,Address,City,[State],ContactPerson," +
                 ...
                 "" + StringcheckBoxFourWheeler + "," + StringcheckBoxCommercialVehicle + ",'" + ddlDealertype.SelectedItem.Text.ToString() + "','" + ActiveStatus + "','" + contactPersionID + "', '" + Session["UserHSRPStateID"] + "','" + StringrtolocationId + "','" + txtERPClientCode.Text.ToString().ToUpper() + "')";
            }
            else
            {
                SQLString = "insert into  DealerMaster (DealerName,Address,City,[State],ContactPerson," +
                 ...
                 "'" + StringState + "','" + StringPersonName + "','" + StringMobileNo + "','" + StringAreaDealer + "'," + StringcheckBoxTwoWheeler + "," +
                 "" + StringcheckBoxFourWheeler + "," + StringcheckBoxCommercialVehicle + ",'" + ddlDealertype.SelectedItem.Text.ToString() + "','" + ActiveStatus + "','" + contactPersionID + "', '" + Session["UserHSRPStateID"] + "','" + StringrtolocationId + "','" + txtERPClientCode.Text.ToString().ToUpper() + "','" + txtERPEmbossingCode.Text.ToString().ToUpper() + "')";
            }
            if (Utils.ExecNonQuery(SQLString, CnnString) > 0)
            {
