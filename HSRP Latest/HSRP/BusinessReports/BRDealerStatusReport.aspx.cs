...
{
    public partial class BRDealerStatusReport : System.Web.UI.Page
    {
        int UserType1;
        ...
        {//
            string sqlstring = "[Business_ReportTypewisesummary_onlinereport] '" + Dateto.SelectedDate + "','" + Dateto.SelectedDate + "','DB','1','0','0','0' ";
            dt11 = new DataTable();
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //change sp Name
                cmd = new SqlCommand("Business_ReportTypewisesummary_onlinereport", con);//Business_ReportTypewisesummary_report
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "Business_ReportTypewisesummary_onlinereport");
        ...
        {
            Workbook book = new Workbook();
            string filename = "Bihar Online Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                book.Properties.Title = "Bihar Online Report";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    row.Index = iIndex++;
                    row.Cells.Add(new WorksheetCell("Report :   Bihar Online Report - ", "HeaderStyle2"));
