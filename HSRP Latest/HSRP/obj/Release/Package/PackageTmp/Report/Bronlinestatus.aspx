<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Bronlinestatus.aspx.cs" Inherits="HSRP.Report.Bronlinestatus" %>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                              &nbsp;<span class="headingmain"> BR New Process Status </span>&nbsp;</td>
                    </tr>
                            ...
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                              ...
                              <asp:GridView ID="GrdAP" runat="server" BackColor="White" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            BR  Dealer Orders</HeaderTemplate>
                                        <ItemTemplate>
                                     ...
                                     <asp:TemplateField>
                                        <HeaderTemplate>
                                            BR Non Dealer Orders</HeaderTemplate>
                                        <ItemTemplate>
