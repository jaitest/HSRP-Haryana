<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyBiharEmbossingReport.aspx.cs" Inherits="HSRP.Report.DailyBiharEmbossingReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">BIHAR : Daily Report from Embossing Stations/affixing station to DTO</span>
                                    </td>
                                        ...
                                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                                ...
                                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 100px">
                                                    <asp:Label Text="HSRP State:"  runat="server" ID="labelOrganization" Visible="true" />
                                                </td>
                                                <td valign="middle" style="width: 200px">
                                                    <asp:DropDownList  CausesValidation="false" ID="DropDownListStateName" Visible="true"
                                                        runat="server" DataTextField="HSRPStateName" DataValueField="HSRP_StateID">
                                                    </asp:DropDownList>
                                                </td>
                                                <td valign="middle" class="form_text">   <asp:Label Text="Location:" Visible="true" runat="server" ID="labelClient" /></td>
