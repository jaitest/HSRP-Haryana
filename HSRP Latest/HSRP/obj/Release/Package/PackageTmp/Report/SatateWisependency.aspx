<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SatateWisependency.aspx.cs" Inherits="HSRP.Report.SatateWisependency" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Satate Wise pendency Report</span>
                                    </td>
    ...
    <table style="width: 85%; height: 51px; left: 50px;">
        <tr>
            ...
            <td valign="middle" class="form_text" colspan="2" nowrap="nowrap">
                <asp:Label Text="HSRP State:" runat="server" ID="labelOrganization1"  Visible="false"  ForeColor="Black" Font-Bold="True" />
                                           
            </td>
            <td style="width: 80px; ">
                
                    <ContentTemplate>
                        <asp:DropDownList ID="DropDownListStateName" runat="server"  Visible="false"
