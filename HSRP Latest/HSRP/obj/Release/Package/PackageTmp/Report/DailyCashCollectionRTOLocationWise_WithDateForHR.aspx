<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyCashCollectionRTOLocationWise_WithDateForHR.aspx.cs" Inherits="HSRP.Report.DailyCashCollectionRTOLocationWise_WithDateForHR" %>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle" class="form_text">
                                                    <asp:UpdatePanel runat="server" ID="UpdateRTOLocation" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Label Text="Location:" Visible="true" runat="server" ID="labelClient" />&nbsp;<asp:DropDownList AutoPostBack="false" Visible="true" ID="dropDownListClient" CausesValidation="false"
                                                ...
                                                <td valign="middle" class="form_text" nowrap="nowrap">Vehicle Type<asp:DropDownList ID="DropDownListVehicleModel" runat="server" 
                                                ...
                                                <td>
                                                    &nbsp;</td>
                                                <td>
                                                <asp:Button ID="btn_ExportInPDF" runat="server" 
                                                        Text=" Export In PDF" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="btn_ExportInPDF_Click" Width="100px" />
                    ...
                    <tr>
                        <td colspan="6">
                            <ComponentArt:Calendar runat="server" ID="CalendarOrderDate" AllowMultipleSelection="false"
                                ...
                                NextImageUrl="cal_nextMonth.gif" MinDate="1914-06-01">
                                <ClientEvents>
