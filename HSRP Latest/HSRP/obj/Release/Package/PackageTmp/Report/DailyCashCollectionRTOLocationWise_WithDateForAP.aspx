<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyCashCollectionRTOLocationWise_WithDateForAP.aspx.cs" Inherits="HSRP.Report.DailyCashCollectionRTOLocationWise_WithDateForAP" %>
                                       ...
                                       <%--         <td valign="middle" class="form_text" nowrap="nowrap">
                                                ...
                                                <td>
                                                 <asp:Button ID="Button1" runat="server" 
                                                        Text="Export In Excel" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="Button1_Click" Visible="False" />
                                                   </td>
                                         <%--           <td>
