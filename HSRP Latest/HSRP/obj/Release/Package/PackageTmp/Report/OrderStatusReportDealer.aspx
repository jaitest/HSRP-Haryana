<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="OrderStatusReportDealer.aspx.cs" Inherits="HSRP.Report.OrderStatusReportDealer" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Order Status Report Dealer</span>
                                    </td>
        ...
        <tr>
            ...
            <td style="height: 59px">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="labelOrder" runat="server" Font-Bold="True" ForeColor="Black" 
                            style="font-size: small" Text="Record Type:" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td valign="middle" class="Label_user_batch" nowrap="nowrap" 
                            ...
                            CausesValidation="false" Height="21px" 
                            onselectedindexchanged="dropDownListClient_SelectedIndexChanged" 
                            Width="151px">
                                                        <asp:ListItem>--Select Record Type--</asp:ListItem>
                                                        <asp:ListItem>Dealer</asp:ListItem>
                                                        <asp:ListItem>HHT</asp:ListItem>
                        </asp:DropDownList>
                                                &nbsp;</td>
