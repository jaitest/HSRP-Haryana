<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="HRCashCollection_V4NewLatest.aspx.cs" Inherits="HSRP.Transaction.HRCashCollection_V4NewLatest" %>
  ...
  <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:ListItem>Tatkal-AH</asp:ListItem>
      ...
      <tr>
        <td><a class="alert1" id="save1">Confirm</a>   <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click"  BackColor="Orange" Width="57px" ValidationGroup="Mobile" />
           <%-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="btnsave" runat="server" Text="Save"   BackColor="Orange" Width="57px" ValidationGroup="Mobile" OnClick="btnsave_Click" Visible="false"/>--%>
        </td>
        ...
        <td >
          <%--  <asp:Button ID="btnDownload" runat="server" Text="Download Receipt"  OnClick="btnDownloadReceipt_Click" CssClass="button" Visible="false" Width="136px" />--%>
