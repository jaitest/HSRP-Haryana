<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HPCashCollectionV4.aspx.cs" Inherits="HSRP.Transaction.HPCashCollectionV4" %>
...
<marquee class="mar1" direction="left" >Please Ensure Customer Data On Screen Matches With Authorization Slip Before Save. Penalty Will Be Imposed On Generation Of Wrong Cash Receipt.</marquee>
      ...
      <fieldset>
            <legend>
                ...
                HP  Cash Collection V4 </div>
            </legend>
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td width="900">
        <table id="Table1" width="100%" align="center" style="font-size: 16px; color:Black; font-family:Batang; background-color:#fff" >
     <%-- <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
     ...
     <%--   <tr>
      ...
      <tr>
        ...
        <td colspan="3"><asp:Label ID="lblAddress" runat="server" Text=""></asp:Label>
      ...
      <tr>
        ...
        <td><asp:Label ID="lblVehicleType" runat="server" Text=""></asp:Label>
           <%-- <asp:Label ID="lblVehicleTypeERicksha" runat="server" Text="" Visible="false">  </asp:Label>--%>
             &nbsp;&nbsp;&nbsp;&nbsp;

                     <asp:DropDownList ID="ddlVehicleType" runat="server" Visible="false"   OnSelectedIndexChanged="ddlVehicleType_SelectedIndexChanged" AutoPostBack="true">
       ...
       <%-- <td class="form_text"> Transaction Type </td>
        ...
        <td class="form_text">Order Type <span style="color: #FF3300">*</span>  </td>
                <td align="left">                
      ...
      <tr>
        <td class="form_text"> Vehicle Class Type <span style="color: #FF3300">*</span> </td>
          <td>
          <%--  <asp:DropDownList ID="ddlVehicleClass" runat="server" onselectedindexchanged="ddlVehicleClass_SelectedIndexChanged"  AutoPostBack="True">
            ...
            <asp:ListItem>NON-TRANSPORT</asp:ListItem>
               ...
               <asp:DropDownList ID="ddlVehicleClass" runat="server" CssClass="form_text" 
                                AutoPostBack="True" OnSelectedIndexChanged="ddlVehicleClass_SelectedIndexChanged">
                                <asp:ListItem Value="--Select Vehicle Class--">--Select Vehicle Class--</asp:ListItem>
                                 <asp:ListItem Value="TRANSPORT">TRANSPORT</asp:ListItem>                               
                                  <asp:ListItem Value="NON-TRANSPORT">NON-TRANSPORT</asp:ListItem>
      ...
      <tr>
        ...
        <td><asp:Label ID="lblAmount" runat="server" Text=""></asp:Label></td>
         <%-- <td class="form_text"> Registration Date 
