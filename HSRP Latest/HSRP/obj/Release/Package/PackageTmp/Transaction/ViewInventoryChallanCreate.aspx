<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="ViewInventoryChallanCreate.aspx.cs" Inherits="HSRP.Master.ViewInventoryChallanCreate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function editpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            //  alert(i);
            googlewin = dhtmlwindow.open("googlebox", "iframe", "InventoryChallanCreate.aspx?Mode=Edit&DispatchID=" + i, "Update Received Details", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
//            googlewin.onclose = function () {
            //                window.location.href = "ViewInventoryChallanCreate.aspx";
//                return true;
//            }
        }
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "InventoryChallanCreate.aspx?Mode=New", "Add Inventory Challan", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location = 'ViewInventoryChallanCreate.aspx';
                return true;
            }
        }
    </script>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">View Inventory Challan </span>
                                    </td>
                                ...
                                <tr>
                                  <%--  <td valign="middle" class="form_text" nowrap="nowrap">
                                    ...
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New Hub" class="button">Add New Inventory Challan</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <table width="99%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ComponentArt:Grid ID="Grid1" runat="server" ImagesBaseUrl="~/images"
                                                ...
                                                <ComponentArt:GridLevel RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    <Columns>
                                                       <%-- <ComponentArt:GridColumn DataField="Autoid" Visible="False" />--%>
                                                             <ComponentArt:GridColumn DataField="ProductSize" HeadingText="Product Size" AllowGrouping="False"
                                                            ...
                                                            SortedDataCellCssClass="SortedDataCell" Width="100" />
                                                        <ComponentArt:GridColumn DataField="Laseredcodefrom" Visible="true" HeadingText="Laser Code From"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="Laseredcodeto" HeadingText="Laser To" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
                                                            
                                                            <ComponentArt:GridColumn DataField="CreationDate" HeadingText="Date" AllowGrouping="False"
                                                            SortedDataCellCssClass="SortedDataCell" Width="100" />
                                                        <ComponentArt:GridColumn DataField="prifix" HeadingText="Prifix" AllowGrouping="False"
                                                        ...
                                                        <ComponentArt:GridColumn DataField="Quantity" HeadingText="Quantity" Width="80" />
                                                        <ComponentArt:GridColumn DataField="Rate" HeadingText="Rate" AllowGrouping="False"
                                                            SortedDataCellCssClass="SortedDataCell" Width="100" />
                                                             <ComponentArt:GridColumn DataField="InvoiceNo" HeadingText="InvoiceNo" AllowGrouping="False"
                                                            SortedDataCellCssClass="SortedDataCell" Width="100" />
                                                            <%-- <ComponentArt:GridColumn DataField="Rate" HeadingText="Rate" AllowGrouping="False"
                                                            SortedDataCellCssClass="SortedDataCell" Width="100" />
                                                         --%>
