                                ...
                                <tr>
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        ...
                                        <asp:Button ID="btnDownloadRecords" Width="114px" runat="server" Text="Download In PDF"
                                            ToolTip="Please Click for Report" class="button"  OnClick="btnDownloadRecords_Click" />
                                            <br />
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" visible="false" class="form_text" nowrap="nowrap">
                                     ...
                                     <td valign="middle" visible="false" class="form_text" nowrap="nowrap">
                                        ...
                                        <asp:DropDownList runat="server" Visible="false" ID="DDlDealerName" Width="140px" DataTextField="dealername" DataValueField="dealerid" OnSelectedIndexChanged="DDlDealerName_SelectedIndexChanged">                                          
                                        </asp:DropDownList>
