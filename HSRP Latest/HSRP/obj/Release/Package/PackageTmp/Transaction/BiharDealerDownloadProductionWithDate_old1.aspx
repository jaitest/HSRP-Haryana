<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="BiharDealerDownloadProductionWithDate_old1.aspx.cs" Inherits="HSRP.Master.BiharDealerDownloadProductionWithDate_old1" %>
                                        ...
                                        <asp:UpdatePanel runat="server" ID="UpdateRTOLocation" UpdateMode="Conditional" >
                                            <ContentTemplate>
                                                <asp:DropDownList Visible="true" ID="dropDownListClient" CausesValidation="false"
                                                    Width="140px" runat="server" DataTextField="RTOLocationName"  AutoPostBack="true"   DataValueField="RTOLocationID" OnSelectedIndexChanged="dropDownListClient_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                            <Triggers>
                                       ...
                                       <%-- <asp:DropDownList Visible="true" ID="ddlBothDealerHHT" CausesValidation="false" Width="140px"
                                        ...
                                        <asp:DropDownList Visible="true" ID="ddlBothDealerHHT" CausesValidation="false" Width="140px"
                                         DataTextField="DealerName" DataValueField="dealerid"  
                                            AutoPostBack="false" runat="server" Height="16px">  
                                        </asp:DropDownList>
