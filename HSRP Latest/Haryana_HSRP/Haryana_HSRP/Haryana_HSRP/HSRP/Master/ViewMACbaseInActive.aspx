<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewMACbaseInActive.aspx.cs" Inherits="HSRP.Master.ViewMACbaseInActive" %>
...
<script type="text/javascript" src="../windowfiles/dhtmlwindow.js"></script>
    ...
    <script type="text/javascript">
        function editpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            //  alert(i);
            googlewin = dhtmlwindow.open("googlebox", "iframe", "PlantMaster.aspx?Mode=Edit&PlantID=" + i, "Update MACbase", "width=650px,height=330px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location.href = "ViewMACbase.aspx";
                return true;
            }
        }
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "PlantMaster.aspx?Mode=New", "Add New Add New MACbase", "width=650px,height=330px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location = 'ViewMACbase.aspx';
                return true;
            }
        }
    </script>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">View MACbase InActive</span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:Label Text="" Visible="false" runat="server" ID="label1" />
                                    </td>
                                    <td valign="middle">
                                        &nbsp;</td>
                            ...
                            <table width="99%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <ComponentArt:Grid ID="Grid2" PlantIDMode="MacBaseID" runat="server" ImagesBaseUrl="~/images"
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel DataKeyField="MacBaseID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%--<ComponentArt:GridColumn DataField="UserName" Visible="true" HeadingText="User Name"
                                                            Width="100" />--%>
