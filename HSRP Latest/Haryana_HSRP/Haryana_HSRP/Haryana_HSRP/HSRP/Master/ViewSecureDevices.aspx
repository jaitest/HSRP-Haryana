...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function editpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            //  alert(i);
            googlewin = dhtmlwindow.open("googlebox", "iframe", "SecureDevices.aspx?Mode=Edit&UserID=" + i, "Update User Details", "width=950px,height=300px,resize=1,scrolling=1,center=1", "recal")
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "SecureDevices.aspx?Mode=New", "Secure Devices", "width=950px,height=300px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Secure Devices Master </span>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ComponentArt:Grid ID="Grid1" ClientIDMode="AutoID" runat="server" ImagesBaseUrl="~/images"
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel DataKeyField="SecureDeviceID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    SortImageHeight="19">
                                                    <Columns>
                                                        <ComponentArt:GridColumn DataField="SecureDeviceID" Visible="False" />
                                                        <ComponentArt:GridColumn DataField="MACAddress" HeadingText="MAC Address" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
