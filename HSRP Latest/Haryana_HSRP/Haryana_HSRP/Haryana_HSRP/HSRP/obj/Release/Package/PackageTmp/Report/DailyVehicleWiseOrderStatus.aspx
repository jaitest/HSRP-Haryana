<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyVehicleWiseOrderStatus.aspx.cs" Inherits="HSRP.Report.DailyVehicleWiseOrderStatus" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Daily  Vehicle Wise Order Status Report</span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        <asp:Label ID="Label2" CssClass="RTOLabel" runat="server"> Select For All State : </asp:Label>  
                                        <asp:CheckBox ID="checkboxAll" runat="server" Checked="false" />
                                    </td>
                                 ...
                                 <td valign="middle" class="form_text" nowrap="nowrap">
                                    ...
                                    <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 97px;";> <asp:Label Text="Select Date:" Visible="true" runat="server" ID="labelDate" /> </td>
                                        <td valign="middle" class="form_text" nowrap="nowrap" style="width: 100px">
                                                    &nbsp;&nbsp;
                                                    <asp:Label Text="From:" Visible="true" runat="server" ID="label1" />
                                                    &nbsp;&nbsp;
                                                </td>
