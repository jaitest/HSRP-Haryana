    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td><asp:Button ID="btnExcel" runat="server" CssClass="button" 
                    onclick="btnExcel_Click" Text="Export to Excel" BackColor="Orange" ForeColor="#000000"/></td>
        <td><asp:Button ID="btnstatus" runat="server" CssClass="button" 
                    onclick="btnstatus_Click" Text="Status" BackColor="Orange" ForeColor="#000000" /></td>
      </tr>
      <tr>
