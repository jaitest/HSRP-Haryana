<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HSRPRecordsVehicleLocEdit.aspx.cs" Inherits="HSRP.Transaction.HSRPRecordsVehicleLocEdit" %>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr align="left">
                            <td background="../images/midtablebg.jpg" align="left">
                                <asp:Label ID="Label4" class="headingmain" runat="server">Vehicle Location Update</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                            ...
                            <td align="center" id="td_Vehicle" runat="server" >
                                ...
                                <table width="50%" cellpadding="0" cellspacing="0" class="form_text">
                                    <tr>
                                        ...
                                        <td align="left"  class="form_text" nowrap="nowrap">
                                            <asp:Label Text="Vehicle Location:" Visible="true" runat="server" ID="lblVehi" />
                                        </td>
                                        <td align="left">
                                            <asp:DropDownList AutoPostBack="true" CausesValidation="false" ID="ddlVehicleLoc"  runat="server" Width="170px">
                                            </asp:DropDownList>
                                        </td>                                        
                                    </tr>
                                    <tr>
