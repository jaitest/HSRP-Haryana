...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function validate() {
            ...
            if (document.getElementById("<%=DdlreportType.ClientID%>").value == "--Select Report Type--") {
                    ...
                    <ContentTemplate>
                        <asp:DropDownList ID="dropDownListClient" runat="server" AutoPostBack="True" DataTextField="RTOLocationName" 
                            ...
                            Width="151px">
                                            ...
                                            <td style="width: 124px; height: 59px;">
                                                 <asp:Label Text="Report Type:" runat="server" ID="label2" ForeColor="Black"     Font-Bold="True" />
                                            </td>
                                            <td style="height: 59px">
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    <ContentTemplate>
                    
                        <asp:DropDownList ID="DdlreportType" runat="server" TabIndex="4" Height="22px" Width="165px" AutoPostBack="true" style="margin-left:8px;">
                            <asp:ListItem Value="--Select Report Type--">--Select Report Type--</asp:ListItem>
