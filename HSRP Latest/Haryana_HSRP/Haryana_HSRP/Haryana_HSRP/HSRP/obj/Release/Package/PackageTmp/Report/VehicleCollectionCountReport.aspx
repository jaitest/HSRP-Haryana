<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VehicleCollectionCountReport.aspx.cs" Inherits="HSRP.Report.VehicleCollectionCountReport" %>
        ...
        <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="dropDownListClient" runat="server" AutoPostBack="True" 
                            ...
                            DataValueField="RTOLocationID" Height="21px"  Width="151px" 
            ...
            <td valign="middle" class="Label_user_batch" nowrap="nowrap" 
                            style="width: 7px; height: 59px;">
                                                ...
                                                <td> <asp:Label Text="Date:" runat="server" ID="labelDate" Font-Bold="True" 
                                                        ForeColor="Black" /> </td>
                                                <td>
    ...
    ControlType="Picker" PickerCssClass="picker">
                                                ...
                                                <td>
                                                                        ...
                                                                        <asp:DropDownList ID="ddlReport" runat="server">
                                                                            ...
                                                                            <asp:ListItem Value="Collection">Collection Wise</asp:ListItem>
                                                                        </asp:DropDownList>
                        ...
                        BorderColor="#99FF99" SearchOnKeyPress="true" ShowSearchBox="true"
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel  DataKeyField="MONTHNAME" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    SortImageHeight="19">
                                                    <Columns>
                                            <ComponentArt:GridColumn DataCellCssClass="maintext" DataField="SCOOTER" HeadingText="2W"
                                                SortedDataCellCssClass="SortedDataCell" IsSearchable="True" />
                                                <ComponentArt:GridColumn DataCellCssClass="maintext" DataField="MOTOR CYCLE" HeadingText=" 3W"
                                                SortedDataCellCssClass="SortedDataCell"  Align="Right" />
                                                 <ComponentArt:GridColumn DataCellCssClass="maintext" DataField="LMV(CLASS)" HeadingText="LMV"
                                                SortedDataCellCssClass="SortedDataCell"  Align="Right" />
