...
namespace HSRP.BusinessReports
{
    public partial class ReportTypeWiseSummary_report_Online : System.Web.UI.Page
    {
        ...
        {//
            string sqlstring = "[Business_ReportTypewisesummary_onlinereport] '" + Dateto.SelectedDate + "','" + Dateto.SelectedDate + "','DB','4','0','0','0' ";
            dt11 = new DataTable();
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //WorksheetCell cell = row.Cells.Add("Haryana Online Report");
