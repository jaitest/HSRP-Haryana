...
{
    public partial class RtoWiseEmbossingProductionVSDispatch_SummaryDealer : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "report_Business_ProductionVSDispatch_SummaryDealer");
        ...
        protected void btnDetail_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            string strParameter = string.Empty;
            cmd = new SqlCommand("report_Business_ProductionVSDispatch_SummaryDealer", con);
        ...
        private void SaveAndDownloadFile12()
        {
            ...
            Export12(strOrderType, book, 1, "report_Business_ProductionVSDispatch_SummaryDealer");
