...
{
    public partial class DispatchvsReceivedDealer : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "Business_report_DispatchvsReceived_SummaryDealer");
        ...
        protected void grdid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day1")
            {
                ...
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,convert(varchar(20),orderembossingdate,103) as orderembossingdate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and a.HSRP_StateID='" + state + "'  and embcentername='" + embcentername + "' and convert(date,ChallanDate,103)='" + ReportDate2 + "' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            ...
            if (e.CommandName == "Day2")
            {
                ...
                Label embcenter = (Label)grdid.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,convert(varchar(20),orderembossingdate,103) as orderembossingdate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate  from hsrprecords  a, rtolocation b  where a.rtolocationid=b.rtolocationid and a.HSRP_StateID='" + state + "'  and embcentername='" + embcentername + "'  and convert(date,ChallanDate,103)=dateadd(day,-1,'" + ReportDate2 + "') and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day3")
            {
                ...
                Label embcenter = (Label)grdid.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,convert(varchar(20),orderembossingdate,103) as orderembossingdate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate  from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "'  and embcentername='" + embcentername + "'  and convert(date,ChallanDate,103)=dateadd(day,-2,'" + ReportDate2 + "') and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day4")
            {
                ...
                Label embcenter = (Label)grdid.Rows[RowIndex].FindControl("lblembname");
                embcentername = embcenter.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,convert(varchar(20),orderembossingdate,103) as orderembossingdate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate  from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "'  and embcentername='" + embcentername + "' and convert(date,ChallanDate,103)=dateadd(day,-3,'" + ReportDate2 + "') and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
        ...
        protected void btnDetail_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            string strParameter = string.Empty;
            cmd = new SqlCommand("Business_report_DispatchvsReceived_SummaryDealer", con);
        ...
        private void SaveAndDownloadFile12()
        {
            ...
            Export12(strOrderType, book, 1, "Business_report_DispatchvsReceived_SummaryDealer");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day1")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,ChallanDate,103)=dateadd(day,0,'" + ReportDate2 + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day2")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,ChallanDate,103)=dateadd(day,-1,'" + ReportDate2 + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day3")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,ChallanDate,103)=dateadd(day,-2,'" + ReportDate2 + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day4")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,ChallanDate,103)=dateadd(day,-3,'" + ReportDate2 + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
