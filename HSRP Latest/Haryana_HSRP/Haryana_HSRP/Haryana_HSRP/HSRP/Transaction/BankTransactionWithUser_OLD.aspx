<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankTransactionWithUser_OLD.aspx.cs"
    Inherits="HSRP.Master.BankTransactionWithUser_OLD" %>
               ...
               <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="ddl_user" runat="server" 
                            DataTextField="UserFirstName" DataValueField="UserID" Height="20px" 
                 ...
                 <tr>
                    ...
                    <td>
                        <asp:DropDownList Visible="true" ID="ddlBothDealerHHT" CausesValidation="false" Width="140px"
                                         DataTextField="NAME OF THE DEALER" DataValueField="SNO"  
                                            AutoPostBack="false" runat="server">  
                                        </asp:DropDownList> 

                                        <asp:DropDownList Visible="true" ID="ddlBothDealerHHT1" CausesValidation="false" Width="140px"
                                         DataTextField="dealername" DataValueField="dealername"  
                                            AutoPostBack="false" runat="server">  
                                        </asp:DropDownList>
                    </td>
                </tr>
