...
<script type="text/javascript">
    ...
    function edit(i) { // Define This function of Send Assign Laser ID 
        ...
        googlewin = dhtmlwindow.open("googlebox", "iframe", "ImperestDetails.aspx?Mode=Edit&ImperestID=" + i, "Edit Imperest Details", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
    ...
    function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
        ...
        googlewin = dhtmlwindow.open("googlebox", "iframe", "ImperestDetails.aspx?Mode=New", "Add New Imperest Details", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
        googlewin.onclose = function () {
                ...
                <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">View Imperest </span>
                                    </td>
