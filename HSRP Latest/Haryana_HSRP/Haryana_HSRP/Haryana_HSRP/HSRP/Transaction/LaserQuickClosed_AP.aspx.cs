    ...
    public partial class LaserQuickClosed_AP : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (int.Parse(hsrpid) > 0)
                {
                    ...
                    strCloseFlg = objAPAssign.UpdateHSRPAffixation(lblauthno.Text, serverdate);
        ...
        protected void btnGO_Click(object sender, EventArgs e)
        {
           ...
           // lblErrMessvehicle.Text = "";
            ...
            SQLString = "select r.RTOLocationName, h.HSRPRecord_AuthorizationNo,h.HSRP_Front_LaserCode,h.HSRP_Rear_LaserCode from hsrprecords as h inner join rtolocation as r on h.RTOLocationID=r.RTOLocationID where  h.HSRP_STATEID=9 AND  h.VehicleRegno ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "'";
