            ...
            try
            {
                ...
                //    {
                        ...
                        string strQuery = "insert into hsrprecords (SaveMacAddress,DeliveryChallanNo,ISFrontPlateSize,ISRearPlateSize,invoiceno, address1,manufacturername," +
                               ...
                               "VAT_Amount,RoundOff_NetAmount,VAT_Percentage,remarks,PlateAffixationDate,CounterNo,addrecordby) " +
                               ...
                               Math.Round(decimal.Parse(lblAmount.Text), 0) + "','" + dt.Rows[0]["vatper"].ToString() + "','" + remarks.Text + "','" + date1 + "','"+ CounterNo+"','"+AddRecordBy+"')";
                ...
                //    {
                //        lblErrMess.Visible = true;
                //        lblErrMess.Text = "Required AC No.";
                //        return;
                //    }
                //}
            }
