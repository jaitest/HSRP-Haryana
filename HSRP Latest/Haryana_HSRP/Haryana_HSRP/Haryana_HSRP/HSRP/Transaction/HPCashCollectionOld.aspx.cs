...
{
    public partial class HPCashCollectionOld : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                Query = "select VehicleRegNo,HsrpRecord_AuthorizationNo from hsrprecords where hsrp_stateid='3' and VehicleRegNo ='" + txtRegNumber.Text.Trim() + "' and HsrpRecord_AuthorizationNo='" + txtAuthorizationNo.Text.Trim() + "'";
