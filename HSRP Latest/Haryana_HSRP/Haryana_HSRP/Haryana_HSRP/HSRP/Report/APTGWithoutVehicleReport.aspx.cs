...
{
    public partial class APTGWithoutVehicleReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "HSRPWithvehicleRegnoReport-" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                book.Properties.Title = "HSRPWithvehicleRegnoReport";
                ...
                WorksheetCell cell = row.Cells.Add("HSRPWithvehicleRegnoReport");
                ...
                //{
                    ...
                    row.Cells.Add(new WorksheetCell("AuthorizationNo", "HeaderStyle6"));
