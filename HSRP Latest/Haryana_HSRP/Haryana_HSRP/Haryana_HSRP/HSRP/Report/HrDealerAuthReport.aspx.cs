...
{
    public partial class HrDealerAuthReport : System.Web.UI.Page
    {
        int UserType1;
        ...
        {
            string sqlstring = "[Business_ReportTypewisesummary_onlinereport_auth] '" + Dateto.SelectedDate + "','" + Dateto.SelectedDate + "','DB','4','0','0','0' ";
            dt11 = new DataTable();
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //change sp Name
                cmd = new SqlCommand("Business_ReportTypewisesummary_onlinereport_auth", con);//Business_ReportTypewisesummary_report
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "Business_ReportTypewisesummary_onlinereport_auth");
