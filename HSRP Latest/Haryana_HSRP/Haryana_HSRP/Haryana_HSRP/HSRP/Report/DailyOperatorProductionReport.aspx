<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyOperatorProductionReport.aspx.cs" Inherits="HSRP.Report.DailyOperatorProductionReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Daily Operator wise Production Report</span>
                                    </td>
                                ...
                                <td></td>
                                 <td valign="middle" class="form_text" nowrap="nowrap">
                                    ...
                                    <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 97px;"
                                        ; align="right">
                                        <asp:Label Text="Select Date" runat="server" ID="labelDate0"/> 
                                    </td>
                                    <td valign="middle" class="form_text">
                                    ...
                                    <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 97px;"; align="right"> 
                                           <%-- <asp:Label Text="To" runat="server" ID="labelDate" /> </td>
