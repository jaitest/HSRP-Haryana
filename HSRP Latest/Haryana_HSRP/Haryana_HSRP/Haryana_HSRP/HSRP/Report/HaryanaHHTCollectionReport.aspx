<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HaryanaHHTCollectionReport.aspx.cs" Inherits="HSRP.Report.HaryanaHHTCollectionReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Haryana HHT Collection Report
                                        </span>
                                    </td>
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    <td>
                                        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                                <td>
                                                </td>
                                    ...
                                    <td valign="top" style="width:105px"; onmouseup="OrderDate_OnMouseUp()">
                                                ...
                                                &nbsp;
                                                <asp:Label Text="Machine ID " runat="server" ID="lblmachine" /></td>
                                                <td>
                                                    <asp:TextBox ID="txtmachineid" runat="server"></asp:TextBox></td>
                                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 100px">
                                                    &nbsp;&nbsp;
                                                    <asp:Label Text="From Date " runat="server" ID="labelDate" />
                                                    &nbsp;&nbsp;
                                                </td>
                                                <td valign="top" onmouseup="OrderDate_OnMouseUp()" align="left" style="width: 100px">
                                                    <ComponentArt:Calendar ID="OrderDate" runat="server" PickerFormat="Custom" PickerCustomFormat="dd/MM/yyyy"
                                                        ControlType="Picker" PickerCssClass="picker">
                                                        <ClientEvents>
                                                            <SelectionChanged EventHandler="OrderDate_OnDateChange" />
                                                ...
                                                <td valign="top" align="left">
                                                    ...
                                                    <td valign="middle" class="form_text" nowrap="nowrap"> &nbsp;&nbsp;<asp:Label Text="To Date:" Visible="true" runat="server" ID="labelTO" /> &nbsp;&nbsp;</td>
                                   <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()" align="left">
                                                ...
                                                <td style="position: relative; Left: 0px; top: 0px; width:150px">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="Expot To Excel" ToolTip="Click For Report" OnClientClick="return validate()" 
                                                        class="button"  OnClick="btnExportToExcel_Click" />
                                                </td>
                                                   <td style="position: relative; left: 0px; top: 0px; width:150px">
                                                    <asp:Button ID="btnVoidSummary" runat="server" Text="Void Summary" 
                                                           ToolTip="Void Summary" OnClientClick="return validate()" 
                                                        class="button" onclick="btnVoidSummary_Click" Visible="False" />
                                                </td>
                                              <td style="position: relative; left: 0px; top: 0px; width:150px">
                                                    &nbsp;</td>
                                                <tr>
