    ...
    private void Export(string strStateId, string strStateName)
    {
        try
        {
            ...
            if (DropDownListOrderType.SelectedItem.Text == "Dealer")
            {
                ...
                //{
                    sql = "select challanno as InvoiceNo,convert(date,challandate,106) as InvoiceDate,RTOLocationName as Location,b.EmbCenterName as EmbossingCenter,SUM(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) as 'Motorcycle',SUM(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) as 'Scooter',SUM(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END ) '3W',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END ) as 'LMV',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END ) as 'LMV Transport', SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END ) as MCV, SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ) as Tractor,  	 SUM(CASE WHEN (VehicleType = 'E-RICKSHAW' )  THEN 1 ELSE 0 END ) as 'E-RICKSHAW', (sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END )+SUM(CASE WHEN (VehicleType = 'E-RICKSHAW' )  THEN 1 ELSE 0 END ) )as TotalQuantity,(sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END )*96 + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END )*120 +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)*120+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )*344+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )*344+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )*388+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END )*96  +  SUM(CASE WHEN (VehicleType = 'E-RICKSHAW' )  THEN 1 ELSE 0 END )*120 )as TotalWeight from HSRPRecords a ,rtolocation b where a.rtolocationid=b.rtolocationid  and a.HSRP_StateID='" + strStateId + "' and convert(date,challandate,106) between '" + OrderDate.SelectedDate + "'  and '" + HSRPAuthDate.SelectedDate + "' and addrecordby !='Dealer' and challanno is not null and challandate is not null group by EmbCenterName, challanno, convert(date,challandate,106),RTOLocationName order by convert(date,challandate,106) ,challanno";
                //}
                //else
                //{
            ...
            if (DropDownListOrderType.SelectedItem.Text == "Non Dealer")
            {
                ...
                //if (DropDownListStateName.SelectedValue.ToString() == "6")
                //{
                //    sql = "select challanno as InvoiceNo,convert(date,challandate,106) as InvoiceDate,RTOLocationName as Location,b.EmbCenterName as EmbossingCenter,SUM(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) as 'Motorcycle',SUM(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) as 'Scooter', SUM(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END ) '3W',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END ) as 'LMV',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END ) as 'LMV Transport', SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END ) as MCV, SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ) as Tractor,SUM(CASE WHEN (VehicleType = 'E-RICKSHAW' )  THEN 1 ELSE 0 END ) as 'E-RICKSHAW',(sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END )+SUM(CASE WHEN (VehicleType = 'E-RICKSHAW' )  THEN 1 ELSE 0 END ))as TotalQuantity from HSRPRecords a ,rtolocation b where a.rtolocationid=b.rtolocationid  and a.HSRP_StateID='" + strStateId + "' and convert(date,challandate,106)  between '" + OrderDate.SelectedDate + "'  and '" + HSRPAuthDate.SelectedDate + "' and addrecordby !='Non Dealer' and challanno is not null and challandate is not null group by EmbCenterName, challanno, convert(date,challandate,106),RTOLocationName order by convert(date,challandate,106) ,challanno";
                //}
                //     if ( DropDownListStateName.SelectedValue.ToString() == "4")
                //{
                sql = "select challanno as InvoiceNo,convert(date,challandate,106) as InvoiceDate,RTOLocationName as Location,b.EmbCenterName as EmbossingCenter,SUM(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) as 'Motorcycle',SUM(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) as 'Scooter',SUM(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END ) '3W',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END ) as 'LMV',SUM(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END ) as 'LMV Transport', SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END ) as MCV, SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ) as Tractor,  	 SUM(CASE WHEN (VehicleType = 'E-RICKSHAW' )  THEN 1 ELSE 0 END ) as 'E-RICKSHAW', (sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END ) + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END ) +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END ) +SUM(CASE WHEN (VehicleType = 'E-RICKSHAW' )  THEN 1 ELSE 0 END ) )as TotalQuantity,(sum(CASE WHEN (VehicleType = 'MOTOR CYCLE')  THEN 1 ELSE 0 END )*96 + sum(CASE WHEN (VehicleType='SCOOTER')  THEN 1 ELSE 0 END )*120 +sum(CASE WHEN (VehicleType = 'Three Wheeler') THEN 1 ELSE 0 END)*120+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Non-Transport'  THEN 1 ELSE 0 END )*344+sum(CASE WHEN (VehicleType = 'LMV'  OR VehicleType='LMV(Class)') and  Vehicleclass ='Transport'  THEN 1 ELSE 0 END )*344+SUM(CASE WHEN (Vehicletype ='MCV/HCV/TRAILERS')  THEN 1 ELSE 0 END )*388+SUM(CASE WHEN (VehicleType = 'Tractor' )  THEN 1 ELSE 0 END )*96  +  SUM(CASE WHEN (VehicleType = 'E-RICKSHAW' )  THEN 1 ELSE 0 END )*120 )as TotalWeight from HSRPRecords a ,rtolocation b where a.rtolocationid=b.rtolocationid  and a.HSRP_StateID='" + strStateId + "' and convert(date,challandate,106)  between '" + OrderDate.SelectedDate + "'  and '" + HSRPAuthDate.SelectedDate + "' and addrecordby !='Non Dealer' and challanno is not null and challandate is not null group by EmbCenterName, challanno, convert(date,challandate,106),RTOLocationName order by convert(date,challandate,106) ,challanno";
           ...
           // row.Cells.Add(new WorksheetCell("2W", "HeaderStyle6"));
            ...
            if (DropDownListStateName.SelectedValue.ToString() == "6" || DropDownListStateName.SelectedValue.ToString()=="4")
            {
                row.Cells.Add(new WorksheetCell("E-RICKSHAW", "HeaderStyle6"));
            }
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                {
                   ...
                   // row.Cells.Add(new WorksheetCell(dtrows["2W"].ToString(), DataType.String, "HeaderStyle"));
                    ...
                    if (DropDownListStateName.SelectedValue.ToString() == "6" && DropDownListOrderType.SelectedItem.Text == "Non Dealer" || DropDownListStateName.SelectedValue.ToString() == "4")
                    {
                        row.Cells.Add(new WorksheetCell(dtrows["E-RICKSHAW"].ToString(), DataType.String, "HeaderStyle"));
                    }
                    else if (DropDownListStateName.SelectedValue.ToString() == "6" && DropDownListOrderType.SelectedItem.Text == "Dealer")
                    {
                        Label1.Visible = true;
                        Label1.Text = "E-RICKSHAW is not valid for Dealer";
                        return;
                    }
