<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="DailyMPEmbossingReport.aspx.cs" Inherits="HSRP.Report.DailyMPEmbossingReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">MADHYA PRADESH : Daily Report from Embossing Stations to Registering Authority</span>
                                    </td>
                                        ...
                                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                                ...
                                                <td valign="middle" style="width: 200px">
                                                    <asp:DropDownList CausesValidation="false" ID="DropDownRTOName"
                                    ...
                                    <td valign="top" style="width:105px"; onmouseup="OrderDate_OnMouseUp()">
                                                ...
                                                <td>
                                                 <asp:Button ID="btnGo" runat="server" Text="Go" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="btnGo_Click" OnClientClick="javascript: return validate();"  />
                                                </td>
                                                <tr>
                                                    <td colspan="9">
