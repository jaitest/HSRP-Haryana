<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TSGovtReport26.aspx.cs" Inherits="HSRP.APTSGovtReport.TSGovtReport" %>
                        ...
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr id="TR1" runat="server">
                                    <td > 
                                          <asp:Label ID="Label4" class="headingmain" runat="server"  > Report:Download TS Govt Data </asp:Label> 
                    ...
                    <tr>
                       ...
                       <tr>
                        <td colspan="2"  class="headingmain">
                            ...
                            <i>Direct Call To Govt Server Method :GetAuthorizationnotRegistered </i>
                      </td>
                           <td valign="middle" class="form_text" nowrap="nowrap">
                               <asp:Button ID="APGetAuthno"    runat="server" 
                                            Text="DownloadTSGetAuthNo" ToolTip="TSGetAuthNo" Visible="true"
                     ...
                     <td colspan="2"  class="headingmain">
                           ...
                           <td>
                                ...
                                <asp:Button ID="BtnApreport"  runat="server" 
                                            Text="DownloadTSGetOnlineReport" ToolTip="TSGetReport"
                                            class="button"  OnClientClick=" return validate()" OnClick="BtnApreport_Click"/><br /><br />
                               <asp:Button ID="btnOfflineTSReport" runat="server" Text="DownloadTSGetOfflineReport" OnClick="btnOfflineTSReport_Click" />
