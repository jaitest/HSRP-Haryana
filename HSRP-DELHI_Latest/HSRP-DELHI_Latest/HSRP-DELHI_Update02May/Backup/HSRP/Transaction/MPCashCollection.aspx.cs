    ...
    public partial class MPCashCollection : System.Web.UI.Page
    {
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                String SqlQuery = "SELECT top(1) HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,OwnerName,Address1,MobileNo,EmailID,OrderType,VehicleClass,VehicleType,ManufacturerName,ManufacturerModel,ChassisNo,EngineNo,VehicleRegNo FROM View_MP_HSRPRecordsStagging_New where VehicleRegNo='" + txtRegNo.Text + "'";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "exec [getPlatesData] '" + HSRPStateID + "','" + ddlVehicleType.SelectedItem.ToString() + "','" + ddlVehicleClass.SelectedItem.ToString() + "', '" + lblTransactionType.Text + "'";
                ...
                SqlCommand cmd = new SqlCommand("New_InsertDataMP", con);
        ...
        public void EpsionPrint()
        {
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                string strMessage = "\u2022" + " Vehicle Owner is required to visit along with vehicle for the affixation of HSRP, on the fourth working day, a confirmation SMS will be sent to the registered mobile number provided by the customer.";


                PdfPCell cell64a = new PdfPCell(new Phrase(strMessage, new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell64a.Colspan = 2;
                cell64a.BorderWidthLeft = 0f;
                cell64a.BorderWidthRight = 0f;
                cell64a.BorderWidthTop = 0f;
                cell64a.BorderWidthBottom = 0f;
                cell64a.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell64a);
        ...
        protected void ddlVehicleClass_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if ((ddlVehicleType.SelectedItem.ToString() == "MCV/HCV/TRAILERS") || (ddlVehicleType.SelectedItem.ToString() == "LMV(CLASS)") || (ddlVehicleType.SelectedItem.ToString() == "LMV"))
            {
