                 ...
                 string strQuery = "insert into hsrprecords (SaveMacAddress,DeliveryChallanNo,ISFrontPlateSize,ISRearPlateSize,invoiceno, address1,manufacturername," +
                    ...
                    if (i > 0)
                    {
                        ...
                        if (lblMobileNo.Text.Length > 0)
                        {
                            ...
                            string sendURL = "http://quick.smseasy.in:8080/bulksms/bulksms?username=sse-tshsrp&password=tshsrp&type=0&dlr=1&destination="+ lblMobileNo.Text.ToString()+"&source=TSHSRP&message=" + SMSText;
