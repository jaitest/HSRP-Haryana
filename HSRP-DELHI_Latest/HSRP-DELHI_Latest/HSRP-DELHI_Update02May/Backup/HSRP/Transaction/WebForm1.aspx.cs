    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void ButtonSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataTable dt11 = Utils.GetDataTable("select  (select rtolocationname from rtolocation where rtolocationid =a.rtolocationid) locationname,vehicleregno,HSRPRecord_CreationDate,OwnerName,vehicletype,ordertype,orderstatus from dbo.HSRPRecords a  where VehicleRegNo ='" + txtVehicleRegNo.Text.Trim().Trim() + "' order by hsrprecord_creationdate desc", ConnectionString);
                ...
                GridView2.DataSource = dt11;
                GridView2.DataBind();

                lblMesageSave.Text = +z + " Record(s) Already exist.Click on Ok To Save Another";
