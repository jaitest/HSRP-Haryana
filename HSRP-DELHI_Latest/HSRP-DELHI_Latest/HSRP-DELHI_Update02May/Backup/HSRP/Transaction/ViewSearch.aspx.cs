                ...
                if (e.Control.ID.ToString() == "LinkButtonCashReceipt")
                {
                    ...
                    if (obj.FillHSRPRecordDeliveryChallan(HSRPRecordID, ref dataSetFillHSRPDeliveryChallan))
                    {
                       ...
                       // string AffixactionCenter = "select * from AffixationCenters";
                        ...
                        string username = " select UserLoginName from users where UserID='" + strUserID + "'";
                        ...
                        PdfPCell cellRtoLocation = new PdfPCell(new Phrase("RTOLocation :" +RtoLocationName, new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
