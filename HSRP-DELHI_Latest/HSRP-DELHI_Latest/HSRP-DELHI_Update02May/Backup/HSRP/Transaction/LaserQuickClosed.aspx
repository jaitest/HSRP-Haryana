    ...
    <ContentTemplate>
                ...
                <tr  id="DivSecond" runat="server" visible="false">
                   ...
                   <td></td>
                       ...
                       <td class="style4"> &nbsp;</td>
                        ...
                        <td align="center" width="80" nowrap="nowrap" > 
                            <asp:Label ID="lblClosedDate" runat="server" CssClass="Label_user" 
                                Text="Order Closed Date" Visible="False"></asp:Label>
                </td> 
                        <td align="right" > 
                            <asp:TextBox ID="txtClosedDate" runat="server" Height="24px" Visible="False" 
                            ...
                            </asp:CalendarExtender>&nbsp;<asp:RangeValidator ID="rangeDate" runat="server" 
                                ControlToValidate="txtClosedDate" 
                    ...
                    <asp:Button ID="btnSave" runat="server"   class="button"  Text="Order Closed" TabIndex="4" OnClientClick="return ValidationQuick()"   
