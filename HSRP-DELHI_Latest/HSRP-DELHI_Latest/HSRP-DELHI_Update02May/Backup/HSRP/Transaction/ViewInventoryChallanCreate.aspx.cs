...
{
    public partial class ViewInventoryChallanCreate : System.Web.UI.Page
    {
        ...
        public void buildGrid()
        {
            ...
            //" where goodsReceiveInvoiceData.ReceivedCode='" + dropDownInvoiceNo.SelectedItem + "' and goodsReceiveInvoiceData.Received ='N'";
                ...
                SQLString = "select ProductSize,Prifix,Laseredcodefrom,Laseredcodeto,CreationDate,Quantity,Rate,InvoiceNo from PlateBarcodeDetail";
