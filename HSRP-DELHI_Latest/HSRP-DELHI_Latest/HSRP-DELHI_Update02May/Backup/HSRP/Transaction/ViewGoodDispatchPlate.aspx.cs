...
{
    public partial class ViewGoodDispatchPlate : System.Web.UI.Page
    {
        ...
        public void buildGrid()
        {
            ...
            try
            {
                ...
                if (UserType == "0")
                {
                    ...
                    SQLString = "SELECT GoodDispatchPlate.BoxNo, GoodDispatchPlate.DispatchRefNo, GoodDispatchPlate.GoodDispatchPlateID, RTOLocation.RTOLocationName, RTOLocation_1.RTOLocationName AS DispatchLocationName,  HSRPState.HSRPStateName FROM GoodDispatchPlate INNER JOIN RTOLocation ON GoodDispatchPlate.EmbossingLocation = RTOLocation.RTOLocationID INNER JOIN RTOLocation AS RTOLocation_1 ON GoodDispatchPlate.DispatchLocation = RTOLocation_1.RTOLocationID INNER JOIN HSRPState ON GoodDispatchPlate.HSRP_StateID = HSRPState.HSRP_StateID where HSRPState.HSRP_StateID=" + intStateID;
                }
                else
                {
                    HSRPStateID = Convert.ToInt32(Session["UserHSRPStateID"].ToString());
                    SQLString = "SELECT GoodDispatchPlate.BoxNo, GoodDispatchPlate.DispatchRefNo, GoodDispatchPlate.GoodDispatchPlateID, RTOLocation.RTOLocationName, RTOLocation_1.RTOLocationName AS DispatchLocationName,  HSRPState.HSRPStateName FROM GoodDispatchPlate INNER JOIN RTOLocation ON GoodDispatchPlate.EmbossingLocation = RTOLocation.RTOLocationID INNER JOIN RTOLocation AS RTOLocation_1 ON GoodDispatchPlate.DispatchLocation = RTOLocation_1.RTOLocationID INNER JOIN HSRPState ON GoodDispatchPlate.HSRP_StateID = HSRPState.HSRP_StateID where HSRPState.HSRP_StateID=" + HSRPStateID;
                }
