<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealerReceiptEntryA.aspx.cs"
    Inherits="HSRP.Dealer.Transaction.DealerReceiptEntry" %>
...
<body>
    ...
    <div style="margin: 20px; background-color: #FFFFFF;" align="left">
        <fieldset>
            <legend>
                <div style="margin-left: 10px; width:189px; font-size: medium; color: Black">
            ...
            <div style="margin: 20px;" align="left">
                <div>
                    <table width="100%" border="0" align="left" cellpadding="3" cellspacing="1">
                        ...
                        <tr>
                            <td class="form_text">
                                Cheque Received Date :<span class="alert">* </span>
                            </td>
                            <td>
                                <table>
                                    <tr>
                        ...
                        <tr>
                            <td class="form_text">
                                Cheque Amount :<span class="alert">* </span>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtChequeNo" runat="server" class="form_textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="form_text">
                                Draw Bank Name :<span class="alert">* </span>
                            </td>
                            <td>
                                <asp:TextBox ID="txtDrawnBankName" runat="server" class="form_textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="form_text">
