        ...
        protected void buttonSave_Click(object sender, EventArgs e)
        {
          ...
          //  StringDealerCode = textBoxDealerCode.Text.Trim().Replace("'", "''").ToString();
            ...
            if (HsrpStateId == "4")
            {
                ...
                if (ddlembossing.SelectedItem.ToString().Equals("--Select Embossing Center--"))
                {
                    lblErrMess.Text = string.Empty;
            ...
            if (HsrpStateId == "4")
            {
                if (ddlembossing.SelectedItem.ToString().Equals("Gurgaon"))
                {
                    Dealercode = "EC-DLR-GGN";

                }
                else if (ddlembossing.SelectedItem.ToString().Equals("Faridabad"))
                {
                    Dealercode = "EC-DLR-FBD";

                }
                else if (ddlembossing.SelectedItem.ToString().Equals("Karnal"))
                {
            ...
            if (HsrpStateId == "4")
            {
                ...
                SQLString = "insert into  DealerMaster (erpembcode,DealerName,Address,City,[State],ContactPerson," +
                    ...
                    "ChargingType,IsActive,ContactPersionID,HSRP_StateID ,RTOLocationID) values" +
                 "('" + Dealercode + "','" + StringDealerName + "','" + StringAddress + "','" + StringCity + "'," +
                 "'" + StringState + "','" + StringPersonName + "','" + StringMobileNo + "','" + StringAreaDealer + "'," + StringcheckBoxTwoWheeler + "," +
                 "" + StringcheckBoxFourWheeler + "," + StringcheckBoxCommercialVehicle + ",'" + StringChargingType + "','" + ActiveStatus + "','" + contactPersionID + "', '" + Session["UserHSRPStateID"] + "','" + Session["UserRTOLocationID"] + "')";
            }
            else
            {
