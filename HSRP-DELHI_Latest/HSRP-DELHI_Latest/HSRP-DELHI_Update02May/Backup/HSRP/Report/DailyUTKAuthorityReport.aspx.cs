...
{
    public partial class DailyUTKAuthorityReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string filename = "UTK Authority Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                Worksheet sheet = book.Worksheets.Add("UTK Authority Report");
                ...
                row.Cells.Add(new WorksheetCell("", "HeaderStyle5"));
                WorksheetCell cell5 = row.Cells.Add("ANNEXURE II");
                ...
                row.Cells.Add(new WorksheetCell("", "HeaderStyle5"));
                row.Cells.Add(new WorksheetCell("", "HeaderStyle5"));
                WorksheetCell cell6 = row.Cells.Add("(shedule 2 ,Clause 5.5.1 (b))");
                ...
                row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                WorksheetCell cell = row.Cells.Add(" Monthly Report From Approved to Transport Department");
                ...
                WorksheetCell cell3 = row.Cells.Add("High Scurity Registration Plates Supplied");
                ...
                row.Cells.Add(new WorksheetCell("Existing", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("New Registration ", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Existing", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("", "HeaderStyle"));
                row = sheet.Table.Rows.Add();
                ...
                //if (dropDownListClient.SelectedItem.Text.ToUpper().Equals("ALL"))
                //{
                //    SQLString = "Report_rtoreport_embossed'" + FromDate + "','" + ToDate + "', 6 ";
                //}
                //else
                //{
                    SQLString = "Report_rtoreport_embossed_UK'" + FromDate + "','" + ToDate + "', 6 ,'"+dropDownListClient.SelectedValue+"'";
              //  }
