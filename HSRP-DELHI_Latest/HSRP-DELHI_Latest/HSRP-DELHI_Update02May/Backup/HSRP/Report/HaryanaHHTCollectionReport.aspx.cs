...
{
    public partial class HaryanaHHTCollectionReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    LabelError.Text = "Please Enter Machine ID";
                    return;
                }
                ...
                string filename = "Haryana_HHT_Report_" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                {
                    SQLString = "SELECT distinct [machine_id],billno, [hrsp] as AuthNo,[name] as Owner_name,[mobileno],[regno],[vclass],[vtype],[ttype] as OrderType,[regid] as RtoName,[amount],convert(varchar(25),[dateandtime],105)+' '+convert(varchar(25),[dateandtime],108) as [dateandtime],[void_bit] FROM [collection_details] where stateid ='HARYANA' and dateandtime between '" + ReportDate1 + "' and  '" + ReportDate2 + "' and machine_id='"+txtmachineid.Text+"' order by regid,dateandtime";
                }
                else
                {
                    return;
        ...
        protected void btnVoidSummary_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (DropDownListStateName.SelectedItem.ToString().ToUpper() == "HARYANA")
                {
                   // by yudhvir 10march SQLString = "SELECT [hrsp] as AuthNo,[name] as Owner_name,[mobileno],[regno],[vclass],[vtype],[ttype] as OrderType,[regid] as RtoName,[amount],convert(varchar(25),[dateandtime],105)+' '+convert(varchar(25),[dateandtime],108) as [dateandtime],[machine_id],[void_bit] FROM [collection_details] where stateid ='HARYANA' and void_bit='void' and dateandtime between '" + ReportDate1 + "' and  '" + ReportDate2 + "' order by regid,dateandtime";
                    SQLString = "SELECT [hrsp] as AuthNo,[name] as Owner_name,[mobileno],[regno],[vclass],[vtype],[ttype] as OrderType,[regid] as RtoName,[amount],convert(varchar(25),[dateandtime],105)+' '+convert(varchar(25),[dateandtime],108) as [dateandtime],[machine_id],[void_bit] FROM [collection_details] where stateid ='HARYANA' and dateandtime between '" + ReportDate1 + "' and  '" + ReportDate2 + "' order by regid,dateandtime";
                }
                else
                {
                    return;
