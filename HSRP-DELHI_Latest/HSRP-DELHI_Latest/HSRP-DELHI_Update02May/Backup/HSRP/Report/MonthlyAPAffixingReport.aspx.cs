...
{
    public partial class MonthlyAPAffixingReport : System.Web.UI.Page
    {
        ...
        {
            SQLString = "select RTOLocationName,RTOLocationID from RTOLocation where Hsrp_StateId='9'order and ActiveStatus='Y' by RTOLocationName ";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                WorksheetCell cell1 = row.Cells.Add("Monthly Report from Affixing Station");
                ...
                ////row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                ////row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                //WorksheetCell cell = row.Cells.Add("Daily Report from Affixing Stations");
                //cell.MergeAcross =16; // Merge two cells togetherto 
                ...
                WorksheetCell cell6 = row.Cells.Add("Month: " + ddlmonth.SelectedItem.ToString());
                row = sheet.Table.Rows.Add();
                ...
                WorksheetCell cell3 = row.Cells.Add(" HSRP Background Colour");
