<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyCashCollectionRTOLocationWise_WithDate2.aspx.cs" Inherits="HSRP.Report.DailyCashCollectionRTOLocationWise_WithDate1" %>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle" class="form_text" nowrap="nowrap">Vehicle Reference&nbsp;
                                                    <asp:DropDownList ID="ddlVehicleReference" runat="server">
                                                        <asp:ListItem>Select Vehicle Reference</asp:ListItem>
