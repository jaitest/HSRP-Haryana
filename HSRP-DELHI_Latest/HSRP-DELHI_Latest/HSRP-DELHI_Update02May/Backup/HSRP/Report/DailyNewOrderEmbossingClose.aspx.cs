...
{
    public partial class DailyNewOrderEmbossingClose : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "DailyProductionStatus-" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                book.Properties.Title = "HSRP Daily Production Status Report";
                ...
                Worksheet sheet = book.Worksheets.Add("HSRP Daily Production MIS Report");
                ...
                WorksheetCell cell = row.Cells.Add("HSRP Daily Production Status Report");
                ...
                row.Cells.Add(new WorksheetCell("Order Closed", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Total Panding Order", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("TOtal New Order", "HeaderStyle6"));
                row = sheet.Table.Rows.Add();
                ...
                if (UserType == 0)
                {
                    SQLString = "Report_DailyAllEmbosingCloseNewOrder'" + OrderDate1 + "','" + intHSRPStateID + "'";
                }
                else
                {
                    ...
                    SQLString = "Report_DailyAllEmbosingCloseNewOrder'" + OrderDate1 + "','" + HSRPStateID + "'";
                }
                ...
                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        if (State != dtrows["StateName"].ToString())
                        {
                            sno = sno + 1;
                            row = sheet.Table.Rows.Add();
        ...
        //        if (UserType == 0)
        //        {
        //            SQLString = "Report_Daily_ProductionMIS'" + OrderDate1 + "','" + intHSRPStateID + "','" + intRTOLocationID + "',0";
        //        }
        //        else
        //        {
        //            HSRPStateID = Convert.ToInt32(Session["UserHSRPStateID"].ToString());
        ...
        //            SQLString = "Report_Daily_ProductionMIS'" + OrderDate1 + "','" + HSRPStateID + "','" + RTOLocationID + "',1";
        //        }
        ...
        //            string filename = "DailProductionMISReport-" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
        //            Workbook book = new Workbook();
        //            // Specify which Sheet should be opened and the size of window by default
        //            book.ExcelWorkbook.ActiveSheetIndex = 1;
        //            book.ExcelWorkbook.WindowTopX = 100;
        ...
        //            // Some optional properties of the Document
        //            book.Properties.Author = "HSRP";
        //            book.Properties.Title = "HSRP Daily Production MIS Report";
        //            book.Properties.Created = DateTime.Now;
        ...
        //            row.Cells.Add(new WorksheetCell("HSRP Daily Production MIS Report", "HeaderStyle0"));
        //            row = sheet.Table.Rows.Add();
        ...
        //            row.Cells.Add(new WorksheetCell("Location", "HeaderStyleData1"));
        //            row.Cells.Add(new WorksheetCell("Autho.Slip", "HeaderStyleData1"));
        //            row.Cells.Add(new WorksheetCell("Production", "HeaderStyleData1"));
        //            row.Cells.Add(new WorksheetCell("Installation", "HeaderStyleData1"));
        //            row.Cells.Add(new WorksheetCell("Balance For Production", "HeaderStyleData1"));
        //            row.Cells.Add(new WorksheetCell("Balance For Installation", "HeaderStyleData1"));
        //            row = sheet.Table.Rows.Add();
        ...
        //            row.Index = 7;
        //            Int32 totAuth = 0;
        //            Int32 totProduction = 0;
        //            Int32 totInstallation = 0;
        //            Int32 totBalProduction = 0;
        //            Int32 totBalInstallation = 0;
        //            int sno = 0;
        ...
        //                row.Cells.Add(new WorksheetCell(dtrows["Location"].ToString(), "HeaderStyleData2"));
        //                row.Cells.Add(new WorksheetCell(dtrows["Autho.Slip"].ToString(), "HeaderStyleData2"));
        //                row.Cells.Add(new WorksheetCell(dtrows["Production"].ToString(), "HeaderStyleData2"));
        //                row.Cells.Add(new WorksheetCell(dtrows["Installation"].ToString(), "HeaderStyleData2"));
        //                row.Cells.Add(new WorksheetCell(dtrows["Balance For Production"].ToString(), "HeaderStyleData2"));
        //                row.Cells.Add(new WorksheetCell(dtrows["Balance For Installation"].ToString(), "HeaderStyleData2"));

        //                totAuth = +totAuth + Convert.ToInt32(dt.Tables[0].Rows[0]["Autho.Slip"]);
        //                totProduction = +totProduction + Convert.ToInt32(dt.Tables[0].Rows[0]["Production"]);
        //                totInstallation = +totInstallation + Convert.ToInt32(dt.Tables[0].Rows[0]["Installation"]);
        //                totBalProduction = +totBalProduction + Convert.ToInt32(dt.Tables[0].Rows[0]["Balance For Production"]);
        //                totBalInstallation = +totBalInstallation + Convert.ToInt32(dt.Tables[0].Rows[0]["Balance For Installation"]);
        ...
        //            row.Cells.Add(new WorksheetCell(Convert.ToInt32(totAuth).ToString(), "HeaderStyleData1"));
        //            row.Cells.Add(new WorksheetCell(Convert.ToInt32(totProduction).ToString(), "HeaderStyleData1"));
        //            row.Cells.Add(new WorksheetCell(Convert.ToInt32(totInstallation).ToString(), "HeaderStyleData1"));
        //            row.Cells.Add(new WorksheetCell(Convert.ToInt32(totBalProduction).ToString(), "HeaderStyleData1"));
        //            row.Cells.Add(new WorksheetCell(Convert.ToInt32(totBalInstallation).ToString(), "HeaderStyleData1"));
        //            row = sheet.Table.Rows.Add();
        //            HttpContext context = HttpContext.Current;
        //            context.Response.Clear();
        //            // Save the file and open it
