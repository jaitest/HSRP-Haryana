    ...
    public partial class ComplainReportResolution : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strUpdate = "update complaint set Solution='" + txtresolution.Text + "', SolutionDate='"+ System.DateTime.Now+"' where id='" + strcomplaindID + "'";
                Utils.ExecNonQuery(strUpdate, CnnString);
                llbMSGSuccess.Text = "Record Update Sucessfully. ";
            }
            catch(Exception ex)
            { 
