            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                if (chk.Checked == true)
                {
                   ...
                   // SMSText = "Your H.S.R.P. "+ reg_no +" is ready for Affixation, Please visit your H.S.R.P. center for Affixation Between 2 PM - 5.30 PM. HSRP Team";
                    ...
                    SMSText = "Your H.S.R.P. " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center for Affixation.Please Ignore if already Affixed. HSRP Team";
                    ...
                    if (HSRPStateID == "5")
                    {
                        if (PhoneNumber.Length > 0)
                        {
                           ...
                           sendURL = "http://103.16.101.52:8080/bulksms/bulksms?username=sse-mphsrp&password=mphsrp&type=0&dlr=1&destination=" + PhoneNumber + "&source=MPHSRP&message=" + SMSText;
                        ...
                        SqlQuery = "insert into MPSMSDetail (HSRPRecordID,RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode) values('" + strRecordId + "','" + RTOLocationID + "','" + lblVehicleRegNo.Text + "','" + PhoneNumber + "','" + result + "')";
                    ...
                    else if (HSRPStateID == "4")
                    {
                        ...
                        {
                            SMSText = "Your H.S.R.P. " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center for Affixation Between 02:00 AM - 5.30 PM. HSRP Team";
                        
                     }
                        else
                        {  
                            SMSText = "Your H.S.R.P. " + reg_no + " is ready for Affixation, Please visit your H.S.R.P. center for Affixation Between 09:30 AM - 5.30 PM. HSRP Team";
                     }


                        if (PhoneNumber.Length > 0)
                        {
                            sendURL = "http://103.16.101.52:8080/bulksms/bulksms?username=sse-hsrphr&password=hsrphr&type=0&dlr=1&destination=" + PhoneNumber + "&source=HRHSRP&message=" + SMSText;
                            HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create(sendURL);
                            myRequest.Method = "GET";
                            WebResponse myResponse = myRequest.GetResponse();
                            StreamReader sr = new StreamReader(myResponse.GetResponseStream(), System.Text.Encoding.UTF8);
                        ...
                        SqlQuery = "insert into HRSMSDetail (HSRPRecordID,RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode) values('" + strRecordId + "','" + RTOLocationID + "','" + lblVehicleRegNo.Text + "','" + PhoneNumber + "','" + result + "')";
                        Utils.ExecNonQuery(SqlQuery, CnnString);
                    }
                    else if (HSRPStateID == "11")
                    {
                        objTGService.UpdateHSRPAvailableAtOffice(strAuthNo, DateTime.Now.ToString("dd/MM/yyyy"));
                        if (PhoneNumber.Length > 0)
                        {
                            sendURL = "http://103.16.101.52:8080/bulksms/bulksms?username=sse-tshsrp&password=tshsrp&type=0&dlr=1&destination=" + PhoneNumber + "&source=TSHSRP&message=" + SMSText;
                            HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create(sendURL);
                            myRequest.Method = "GET";
                            WebResponse myResponse = myRequest.GetResponse();
                            StreamReader sr = new StreamReader(myResponse.GetResponseStream(), System.Text.Encoding.UTF8);
                    ...
                    {
                        objAPService.UpdateHSRPAvailableAtOffice(strAuthNo, DateTime.Now.ToString("dd/MM/yyyy"));
                        if (PhoneNumber.Length > 0)
                        {
                            sendURL = "http://103.16.101.52:8080/bulksms/bulksms?username=sse-aphsrp&password=aphsrp&type=0&dlr=1&destination=" + PhoneNumber + "&source=APHSRP&message=" + SMSText;
                            HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create(sendURL);
                            myRequest.Method = "GET";
                            WebResponse myResponse = myRequest.GetResponse();
                            StreamReader sr = new StreamReader(myResponse.GetResponseStream(), System.Text.Encoding.UTF8);
                    ...
                    else if (HSRPStateID == "6")
                    {
                        if (PhoneNumber.Length > 0)
                        {
                            sendURL = "http://103.16.101.52:8080/bulksms/bulksms?username=sse-ukhsrp&password=ukhsrp&type=0&dlr=1&destination=" + PhoneNumber + "&source=UKHSRP&message=" + SMSText;
                            HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create(sendURL);
                            myRequest.Method = "GET";
                            WebResponse myResponse = myRequest.GetResponse();
                            StreamReader sr = new StreamReader(myResponse.GetResponseStream(), System.Text.Encoding.UTF8);
                        ...
                        SqlQuery = "insert into UKSMSDetail (HSRPRecordID,RtoLocationID,VehicleRegNo,MobileNo,SentResponseCode) values('" + strRecordId + "','" + RTOLocationID + "','" + lblVehicleRegNo.Text + "','" + PhoneNumber + "','" + result + "')";
                        Utils.ExecNonQuery(SqlQuery, CnnString);
                    }
