...
namespace HSRP.EmbossingData
{
    public partial class Affixation : System.Web.UI.Page
    {
        ...
        private void ShowGrid()
        {
            ...
            {
                string SQLString = "select hsrprecordid,vehicleregno,hsrp_rear_lasercode,hsrp_Front_lasercode,HSRPRecord_AuthorizationNo from hsrprecords where hsrp_stateid ='" + HSRPStateID + "' and PdfFileName='" + dropdownDuplicateFIle.SelectedItem.ToString() + "' and orderstatus ='Embossing Done' order by VehicleClass,VehicleType,VehicleRegNo";
