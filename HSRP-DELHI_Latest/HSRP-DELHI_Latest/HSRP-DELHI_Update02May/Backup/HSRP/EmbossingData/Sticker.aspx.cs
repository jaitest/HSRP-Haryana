    ...
    public partial class Sticker1 : System.Web.UI.Page
    {
        ...
        private void ShowGrid()
        {
            ...
            if (dropdownDuplicateFIle.SelectedItem.Text != "--Select RTO Name--")
            {
                        ...
                        string SQLString = "select hsrprecordid,vehicleregno,hsrp_rear_lasercode,hsrp_Front_lasercode,OrderStatus from hsrprecords where OrderStatus='Embossing Done' and PdfFileName='" + dropdownDuplicateFIle.SelectedItem.ToString() + "' and hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and rtolocationID='" + dropDownListClient.SelectedValue + "' and StickerMandatory='Y'";
