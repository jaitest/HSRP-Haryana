...
{
    public partial class ViewVehicleMake : System.Web.UI.Page
    {
        ...
        public void buildGrid()
        {
            try
            {
                SQLString = "select VehicleMakerID,VehicleMakerDescription,convert(varchar, CreatedDateTime , 105) as CreatedDateTime,ActiveStatus from VehicleMakerMaster order by VehicleMakerDescription";
