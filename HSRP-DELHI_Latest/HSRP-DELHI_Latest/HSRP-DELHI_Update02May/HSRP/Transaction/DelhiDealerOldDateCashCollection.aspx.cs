                ...
                if (z <= 0)
                {
                    ...
                    if (hiddenfieldReferenceValue.Value == "DelhiOldData")
                    {
                        ...
                        if (txtMobileNo.Text.Length > 0)
                        {
                            ...
                            string SMSText = " Cash Rs." + Round_OffAmount.ToString() + " collected against Reg No. " + txtVehicleRegNo.Text + " receipt number " + lblCashReceiptNo.Text + "dated  " + System.DateTime.Now.ToString("dd/MM/yyyy") + ".HSRP TEAM";
