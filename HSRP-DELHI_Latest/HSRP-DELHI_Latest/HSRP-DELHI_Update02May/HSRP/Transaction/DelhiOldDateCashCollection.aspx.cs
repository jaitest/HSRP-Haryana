...
{
    public partial class DelhiOldDateCashCollection : System.Web.UI.Page
    {
        ...
        string ownFatherName = String.Empty;
        DateTime OrderDate1;
        string Address = String.Empty;
        string ownAddress = String.Empty;
        string valueamount = String.Empty;
     
        decimal Round_OffAmount;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (MacAddressType == "Y")
            {
                DivCounterNo.Visible = false;
                divlabelCounterNo.Visible = false;
            }
            else
            {
        ...
        public void FillVehicleModel()
        {
           ...
           // string strquery2="Select VehicleModelID,VehicleModelDescription From VehicleModelMaster order by VehicleModelDescription";
        ...
        {
            txtAmount.Text = "";
            SQLString = "select dbo.hsrpplateamt ('" + HSRPStateID + "','" + DropDownListVehicleModel.SelectedItem.ToString() + "','" + DropDownListVehicleClass.SelectedItem.ToString() + "','OB') as Amount";
            DataTable dt = Utils.GetDataTable("select dbo.hsrpplateamt ('" + HSRPStateID + "','" + DropDownListVehicleModel.SelectedItem.ToString() + "','" + DropDownListVehicleClass.SelectedItem.ToString() + "','OB') as Amount", ConnectionString);
            txtAmount.Text = dt.Rows[0]["Amount"].ToString();
            SQLString = "select FrontPlateID,RearPlateID,StickerID from RegistrationPlateDetail  where hsrp_stateid ='" + HSRPStateID + "' and vehicletype='" + DropDownListVehicleModel.SelectedItem.Text + "' and vehicleclass='" + DropDownListVehicleClass.SelectedItem.Text + "' and ordertype='OB'";
            ...
            if (dtPlateSize.Rows.Count > 0)
            {
                ...
                float strnetamount1 = float.Parse(HiddenFieldFrontPlatePrice.Value) + float.Parse(HiddenFieldRearPlatePrice.Value) + float.Parse(HiddenFieldscrewrate.Value) + float.Parse(HiddenFieldStickerID.Value) + float.Parse(hiddenfieldDiscount.Value);
        ...
        protected void ButtonSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (txtAmount.Text.Trim() != "")
            {
                ...
                String SqlCheck = "select COUNT(VehicleRegNo) from dbo.HSRPRecords where hsrp_stateid ='"+ HSRPStateID +"' and VehicleRegNo ='" + txtVehicleRegNo.Text.Trim().Trim() + "'";
        ...
        {
            oname = txtOwnerName.Text;
            ownername = oname.Replace("'", "");
            father = txtFatherName.Text;
            ownFatherName = father.Replace("'", "");
            string vehiclemodel = DropDownVehicleModel1.SelectedValue.ToString();
            Address = txtAddress.Text;
            ownAddress = Address.Replace("'", "");
            valueamount = txtAmount.Text;
            Round_OffAmount = Math.Round(Convert.ToDecimal(valueamount));
            ...
            // "INSERT INTO HSRPRecords (HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,isVIP,NetAmount,VehicleType,OrderStatus,CashReceiptNo,OwnerFatherName, EmailID, ChassisNo, EngineNo, HSRP_Front_LaserCode, HSRP_Rear_LaserCode,CreatedBy,Reference) values(GetDate(),'" + HSRPStateID + "','" + RTOLocationID + "','" + txtAuthorizationNo.Text + "','" + Convert.ToDateTime(OrderDate1).ToString("MM/dd/yyyy") + "','" + txtVehicleRegNo.Text.Trim().ToUpper() + "','" + txtOwnerName.Text + "','" + txtMobileNo.Text + "','" + DropDownListVehicleClass.SelectedItem.ToString() + "','" + DropDownListOrderType.SelectedValue.ToString() + "','" + Sticker + "','" + Vip + "','" + txtAmount.Text + "','" + DropDownListVehicleModel.SelectedItem.ToString() + "','New Order','" + dt1.Rows[0]["PrifixNo"].ToString() + "','" + txtFatherName.Text.Trim() + "', '" + txtEmailID.Text.Trim() + "', '" + txtChassisNo.Text.Trim() + "', '" + txtEngineNo.Text.Trim() + "', '" + DropDownListFrontPlate.SelectedItem.Text.Trim() + "', '" + DropDownListRearPlate.SelectedItem.Text.Trim() + "','" + Session["UID"].ToString() + "','" + txtReference.Text + "')";
                    ...
                    {
                        //string SaveMacAdd = txtCounterNo.Text.Trim() ;
                        string SaveMacAdd =string.Empty;

                      //  Query = "INSERT INTO HSRPRecords (HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,OwnerName,ownerFatherName,Address1,MobileNo,VehicleClass,OrderType,StickerMandatory,isVIP,NetAmount,Roundoff_NetAmount,VehicleType,OrderStatus,CashReceiptNo,ChassisNo, EngineNo,DealerCode,CreatedBy,SaveMacAddress,Addrecordby,ISFrontPlateSize,ISRearPlateSize,FrontPlateSize,RearPlateSize,Reference,ManufacturerModel,vehicleref) values(GetDate(),'" + HSRPStateID + "','" + RTOLocationID + "','" + txtAuthorizationNo.Text + "','" + lblRegDate.Text+ "','" + txtVehicleRegNo.Text.Trim().ToUpper() + "','" + ownername + "','" + ownFatherName + "','" + ownAddress + "','" + txtMobileNo.Text + "','" + DropDownListVehicleClass.SelectedItem.ToString() + "','OB','" + Sticker + "','" + Vip + "','" + txtAmount.Text + "','" + Round_OffAmount + "','" + DropDownListVehicleModel.SelectedItem.ToString() + "','New Order','" + dt1.Rows[0]["PrifixNo"].ToString() + "', '" + txtChassisNo.Text.Trim() + "', '" + txtEngineRegNo.Text.Trim() + "','" + SaveMacAdd + "','" + Session["UID"].ToString() + "','" + Session["MacAddress"].ToString() + "','DelhiOldData','Y','Y','" + DropDownListFrontPlate.SelectedValue + "','" + DropDownListRearPlate.SelectedValue + "','" + txtReference.Text + "','" + vehiclemodel.ToString() + "','Old')";  
                        ...
                        lst.Add(txtAuthorizationNo.Text);
                        lst.Add(lblRegDate.Text);
                        lst.Add(txtVehicleRegNo.Text.Trim().ToUpper());
                        lst.Add(ownername);
                        lst.Add(ownFatherName);
                        lst.Add(ownAddress);
                        lst.Add(txtMobileNo.Text);
                        lst.Add(DropDownListVehicleClass.SelectedItem.ToString());
                        lst.Add("OB");
                        lst.Add(Sticker);   //sticker
                        lst.Add(Vip);
                        lst.Add(txtAmount.Text);
                        lst.Add(Round_OffAmount.ToString());
                        lst.Add(DropDownListVehicleModel.SelectedItem.ToString());
                        lst.Add("New Order");
                        lst.Add(dt1.Rows[0]["PrifixNo"].ToString());  //cash reciept
                        lst.Add(txtChassisNo.Text.Trim());   //chasis
                        lst.Add(txtEngineRegNo.Text.Trim());
                        lst.Add(SaveMacAdd);   
                        lst.Add(Session["UID"].ToString());  
                        lst.Add(Session["MacAddress"].ToString());
                        lst.Add("DelhiOldData");
                        lst.Add("Y");
                        lst.Add("Y");
                        lst.Add(DropDownListFrontPlate.SelectedValue);
                        lst.Add(DropDownListRearPlate.SelectedValue);
                        lst.Add(txtReference.Text);
                        lst.Add(vehiclemodel.ToString());
                        lst.Add("Old");
                       // lst.Add(HiddenFieldFrontPlatePrice.Value);//frontplate prize
                       // lst.Add(HiddenFieldRearPlatePrice.Value);//rearplate prize
                       // lst.Add(HiddenFieldStickerID.Value);//sticker prize
                       // lst.Add(HiddenFieldscrewrate.Value);//screwrate
                       // lst.Add(hiddenfieldTotalAmount.Value);//total amount
                       // lst.Add(hiddenfieldVATAMOUNT.Value);//vatamount
                       //// lst.Add(hiddenfieldNetAmount.Value);//rounoff amount
                       // lst.Add(hiddenfieldTax.Value);//vat tax amount
                        j = obj.InsertDelhiOldDataCashCollection(lst);
                        ...
                        if (txtMobileNo.Text.Length > 0)
                        {
                            ...
                            string SMSText = " Cash Rs." + hiddenfieldNetAmount.Value.ToString() + " collected against Reg No. " + txtVehicleRegNo.Text + " receipt number " + lblCashReceiptNo.Text + "dated  " + System.DateTime.Now.ToString("dd/MM/yyyy") + ".HSRP TEAM";
                   ...
                   //else
                   //  {
                   // //lblSucMess.Text = "Dublicate Vehicle Reg No";
        ...
        protected void buttonGo_Click(object sender, EventArgs e)
        {
            ...
            if (dataSetFillDetails.Rows.Count > 0)
            {
                ...
                SQLString = "select FrontPlateID,RearPlateID from RegistrationPlateDetail  where hsrp_stateid ='" + HSRPStateID + "' and vehicletype='" + DropDownListVehicleModel.SelectedItem.Text + "' and vehicleclass='" + DropDownListVehicleClass.SelectedItem.Text + "' and ordertype='OB'";
                DataTable dtPlateSize = Utils.GetDataTable(SQLString, ConnectionString);
                GetRateForVehicle();
                //if (dtPlateSize.Rows.Count > 0)
                //{
...
//DropDownListOrderType.Enabled = true;
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            if (dataSetFillDetails.Rows.Count > 0)
            {
                ...
                txtOldAddress.Text = dataSetFillDetails.Rows[0]["OlaAddress"].ToString();
                lblRegDate.Text = dataSetFillDetails.Rows[0]["Reg_Date"].ToString();
                lblOrderStatus.Text = dataSetFillDetails.Rows[0]["OrderStatus"].ToString();
                string vehicletype = dataSetFillDetails.Rows[0]["vehicletype"].ToString();
        ...
        protected void DropDownVehicleModel1_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        protected void checkBoxThirdSticker_CheckedChanged(object sender, EventArgs e)
        {
