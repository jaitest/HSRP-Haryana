...
{
    public partial class EditCashCollectionBihar : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HSRPStateID != "1")
            {
                ddlaffixation.Visible = false;
                lblaffixation.Visible = false;
            }
            ...
            if (HSRPStateID.ToString().Equals("1"))
            {
                ddlaffixation.Visible = true;
                lblaffixation.Visible = true;
                //btna4printing.Visible = true;
            }  
        ...
        public void fillAffixationCenter()
        {
            ...
            sqlquery = "select Affix_Id,AffixCenterDesc from AffixationCenters where State_Id='" + HSRPStateID + "' and RTO_ID='" + RTOLocationID + "' order by AffixCenterDesc";
        ...
        public void updateandsaverecords()
        {
            ...
            string Affix_Id = String.Empty;
            if (vehiclemodel == "--Select Vehicle Model--")
            {
                vehiclemodel = "";
            }
            if (ddlaffixation.SelectedItem.ToString() == "--Select Affixation Center--" && HSRPStateID == "1")
            {
                Affix_Id = ddlaffixation.SelectedValue.ToString();
            ...
            Query = "update HSRPRecords set HSRPRecord_CreationDate=GetDate(),HSRP_StateID='" + HSRPStateID + "',RTOLocationID='" + RTOLocationID + "',HSRPRecord_AuthorizationNo='" + txtAuthorizationNo.Text + "',HSRPRecord_AuthorizationDate='" + Convert.ToDateTime(OrderDate1).ToString("MM/dd/yyyy") + "',VehicleRegNo='" + txtVehicleRegNo.Text.Trim().ToUpper() + "',OwnerName='" + txtOwnerName.Text + "',MobileNo='" + txtMobileNo.Text + "',VehicleClass='" + DropDownListVehicleClass.SelectedItem.ToString() + "',OrderType='" + DropDownListOrderType.SelectedValue.ToString() + "',StickerMandatory='" + Sticker + "',isVIP='" + Vip + "',NetAmount='" + txtAmount.Text + "',VehicleType='" + DropDownListVehicleModel.SelectedItem.ToString() + "',OrderStatus='New Order',OwnerFatherName='" + txtFatherName.Text.Trim() + "', EmailID='" + txtEmailID.Text.Trim() + "', ChassisNo='" + txtChassisNo.Text.Trim() + "', EngineNo='" + txtEngineNo.Text.Trim() + "', HSRP_Front_LaserCode='" + DropDownListFrontPlate.SelectedItem.Text.Trim() + "', HSRP_Rear_LaserCode='" + DropDownListRearPlate.SelectedItem.Text.Trim() + "',CreatedBy='" + Session["UID"].ToString() + "',Reference='" + txtReference.Text + "',ManufacturerModel='" + vehiclemodel + "',vehicleref='New',FrontplatePrize='" + HiddenFieldFrontPlatePrice.Value + "',RearPlatePrize='" + HiddenFieldRearPlatePrice.Value + "',StickerPrize='" + HiddenFieldStickerID.Value + "',ScrewPrize='" + HiddenFieldscrewrate.Value + "',TotalAmount='" + hiddenfieldTotalAmount.Value + "',VAT_Amount='" + hiddenfieldVATAMOUNT.Value + "',RoundOff_NetAmount='" + hiddenfieldNetAmount.Value + "',VAT_Percentage='" + hiddenfieldTax.Value + "',Affix_Id='" + Affix_Id + "' where HSRPRecordID='"+hiddenfieldhsrprecordID.Value+"'";
        ...
        //        string Message = "\u2022" + " Vehicle Owner is required to visit along with vehicle for the affixation of HSRP, on the two working day from the date of  issuance of cash receipt.";
        ...
        protected void buttonGo_Click(object sender, EventArgs e)
        {
            ...
            allEnabletrue();
            btnDownloadReceipt.Visible = false;
            String SqlCheck = "SELECT HSRPRecordID, RTOLocationID, HSRP_StateID,OrderStatus,affix_id,HSRPRecord_CreationDate, HSRPRecord_AuthorizationNo, HSRPRecord_AuthorizationDate, OwnerName, OwnerFatherName, Address1, MobileNo, EmailID,StickerMandatory, OrderType,OrderStatus, VehicleClass, VehicleType, ManufacturerName, ManufacturerModel, ChassisNo, EngineNo, Manufacturer, VehicleRegNo, NetAmount FROM HSRPRecords  where hsrp_StateID='" + Session["UserHSRPStateID"].ToString() + "' and vehicleRegNo ='" + txtVehicleRegNo.Text.Trim().Trim() + "' and OrderStatus='New Order'";
            dtz = Utils.GetDataTable(SqlCheck, ConnectionString);
            try
            {
                if (dtz.Rows.Count > 0)
                {
                    hiddenfieldhsrprecordID.Value = dtz.Rows[0]["HSRPRecordID"].ToString();
                    ...
                    txtFatherName.Text = dtz.Rows[0]["OwnerFatherName"].ToString();
                    txtEmailID.Text = dtz.Rows[0]["EmailID"].ToString();
                    lblorderstatus.Text = dtz.Rows[0]["OrderStatus"].ToString();
                    if (!string.IsNullOrEmpty(dtz.Rows[0]["affix_id"].ToString()))
                    {
                        ddlaffixation.SelectedValue = dtz.Rows[0]["affix_id"].ToString();
                    }                   
                        
                    
                    //ddlaffixation.SelectedItem.Text = dtz.Rows[0]["affix_id"].ToString();
                    if (lblorderstatus.Text != "New Order")
                    {
                    ...
                    //if (vehtype != "" )
                    {
                        ...
                        if (!string.IsNullOrEmpty(dtz.Rows[0]["VehicleType"].ToString()))
                        {
                    ...
                    {
                        DropDownListFrontPlate.Enabled = true;
                    }

                    if (DropDownListRearPlate.SelectedItem.Text != "")
                    {
                        DropDownListRearPlate.Enabled = true;
                    }
                    checkBoxThirdSticker.Enabled = true;
                }
                else
                {
