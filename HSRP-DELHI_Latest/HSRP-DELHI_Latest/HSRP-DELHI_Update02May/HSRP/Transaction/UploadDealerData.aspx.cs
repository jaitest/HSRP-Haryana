...
namespace HSRP.Transaction
{
    public partial class UploadDealerData : System.Web.UI.Page
    {
        ...
        private void ValidationCheckOnRecords(DataTable ExcelSheet)
        {
            ...
            //{
            //    //string strHSRPRecord_AuthorizationNo = ExcelSheet.Rows[i]["HSRPRecord_AuthorizationNo"].ToString();
            //    //string strstrHSRPRecord_AuthorizationNo = strHSRPRecord_AuthorizationNo.Substring(0, 2);
            //    //if (strstrHSRPRecord_AuthorizationNo != "DL" && strstrHSRPRecord_AuthorizationNo != "dl")
            //    //{
            //    //    llbMSGError.Visible = true;
            //    //    llbMSGError.Text = "";
            //    //    llbMSGError.Text = "Please Enter Valid HSRPRecord_AuthorizationNo.";
            //    //    return;
            //    //}

            //    //if (ExcelSheet.Rows[i]["HSRPRecord_AuthorizationNo"].ToString().Trim().Replace(" ", "").Length == 16)
            //    //{
            //    //    i = i + 2;
            //    //    llbMSGError.Text = "Excel Sheet : Has <b>HSRPRecord_AuthorizationNo</b> Field more or less than 16 characters At Row : " + i;
            //    //    FlagIsDirty = true;
            //    //    return;
            //    //}
