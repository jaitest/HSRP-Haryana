...
{
    public partial class ImpExpDatawithoutvehicletypeDL : System.Web.UI.Page
    {
        ...
        private void InsertDataInstage(string StateID)
        {
            ...
            else
            {
                try
                {
                    ...
                    //       "VehicleType", "OwnerName", "Manufacturer", "HSRPRecord_AuthorizationNo");

                    CreateDynamicDataTable(dt, "VehicleRegNo", "ChassisNo", "EngineNo", "OrderType",
                            "Manufacturername", "Manufacturemodel", "OwnerName", "HSRPRecord_AuthorizationNo");
                    ...
                    for (int i = 0; i <= dt.Rows.Count - 1; i++)
                    {
                        ...
                        for (int j = 0; j <= dt.Columns.Count - 1; j++)
                        {
                            ...
                            else
                            {
                               ...
                               // NICVehicleType = dt.Rows[i][4].ToString().Split('*')[0];
                                ...
                                StrOwnerName = dt.Rows[i][6].ToString().Replace("'", "`");

                               // StrDealerName = dt.Rows[i][6].ToString().Replace("'", "`");
                                strManufacturername = dt.Rows[i][4].ToString().Replace("'", "`");
                                strManufacturemodel = dt.Rows[i][5].ToString().Replace("'", "`");
                                ...
                                sbRows.Append("'" + dt.Rows[i][0].ToString() + "','" + dt.Rows[i][1].ToString() + "','" + dt.Rows[i][2].ToString() + "','" + dt.Rows[i][3].ToString().Trim() + "','" + dt.Rows[i][4].ToString() + "','" + dt.Rows[i][5].ToString() + "','" + StrOwnerName + "','" + dt.Rows[i][7].ToString() + "','" + dropDownListOrg.SelectedValue + "','" + dropDownListClient.SelectedValue + "'");
                            }
                        ...
                        if (count < 1)
                        {
                            ...
                            {
                                Hsrp_History = "INSERT INTO HSRPRecordsStaggingArea (VehicleRegNo,ChassisNo,EngineNo,OrderType,ManufacturerName,ManufacturerModel,OwnerName,HSRPRecord_AuthorizationNo,HSRP_StateID,RTOLocationID,ISFrontPlateSize,ISRearPlateSize,VehicleClass,FileName,NICVehicleType,NICVehicleRegNo) values (" + sbRows.ToString() + ",'Y','Y','Non-Transport','" + filename + "','" + NICVehicleType + "','" + NICVehicleRegNo + "');";
                            }
                            else if (dt.Rows[i][3].ToString().Trim() == "DF")
                            {
                                Hsrp_History = "INSERT INTO HSRPRecordsStaggingArea (VehicleRegNo,ChassisNo,EngineNo,OrderType,OwnerName,ManufacturerName,ManufacturerModel,OwnerName,HSRPRecord_AuthorizationNo,HSRP_StateID,RTOLocationID,ISFrontPlateSize,ISRearPlateSize,VehicleClass,FileName,NICVehicleType,NICVehicleRegNo) values (" + sbRows.ToString() + ",'Y','N','Non-Transport','" + filename + "','" + NICVehicleType + "','" + NICVehicleRegNo + "');";
                            }
                            else if (dt.Rows[i][3].ToString().Trim() == "DR")
                            {
                                Hsrp_History = "INSERT INTO HSRPRecordsStaggingArea (VehicleRegNo,ChassisNo,EngineNo,OrderType,OwnerName,ManufacturerName,ManufacturerModel,OwnerName,HSRPRecord_AuthorizationNo,HSRP_StateID,RTOLocationID,ISFrontPlateSize,ISRearPlateSize,VehicleClass,FileName,NICVehicleType,NICVehicleRegNo) values (" + sbRows.ToString() + ",'N','Y','Non-Transport','" + filename + "','" + NICVehicleType + "','" + NICVehicleRegNo + "');";
                            }
                            else if (dt.Rows[i][3].ToString().Trim() == "OS")
                            {
                                Hsrp_History = "INSERT INTO HSRPRecordsStaggingArea (VehicleRegNo,ChassisNo,EngineNo,OrderType,OwnerName,ManufacturerName,ManufacturerModel,OwnerName,HSRPRecord_AuthorizationNo,HSRP_StateID,RTOLocationID,ISFrontPlateSize,ISRearPlateSize,VehicleClass,FileName,NICVehicleType,NICVehicleRegNo) values (" + sbRows.ToString() + ",'N','N','Non-Transport','" + filename + "','" + NICVehicleType + "','" + NICVehicleRegNo + "');";
                            }
        ...
        protected void ButImpData_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    string updateStatus = "UPDATE HSRPRecords SET SendRecordToNic='Y' from HSRPRecords a,HSRPRecordsStaggingArea b where a.VehicleRegNo=b.VehicleRegNo and b.HSRP_StateID='" + dropDownListOrg.SelectedValue + "' and b.RTOLocationID='" + dropDownListClient.SelectedValue + "' and a.OrderStatus='Closed' and a.SendRecordToNicOld='N'";
                    Utils.ExecNonQuery(updateStatus, CnnString);
                    llbMSGSuccess.Text = " Total Record Transfered to NIC is : " + dt.Rows.Count;
                    ...
                    {
                        fileName = ConfigurationManager.AppSettings["DataFolder"].ToString() + "HSRP-" + dropDownListClient.SelectedItem.ToString().Replace(" ", "") + '-' + DateTime.Now.ToString("ddmmyyyyhhmmss") + ".dat";
                    }
