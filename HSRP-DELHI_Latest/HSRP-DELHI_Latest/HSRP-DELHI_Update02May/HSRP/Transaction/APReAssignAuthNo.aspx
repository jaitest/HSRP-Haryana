<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="APReAssignAuthNo.aspx.cs" Inherits="HSRP.Transaction.APReAssignAuthNo" %>
              ...
              <tr>
                <td width="900"><table id="Table1" width="100%" align="center" style="font-size: 16px; color:Black; font-family:@Batang; background-color:#fff" >
                  <tr>
                    ...
                    <td><asp:Label ID="lblSucMess" runat="server" Font-Size="18px" ForeColor="Blue"></asp:Label></td>
                    <td>&nbsp;</td>
                    <td><asp:Label ID="lblErrMess" runat="server" Font-Size="18px" ForeColor="Red"></asp:Label></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td><asp:TextBox ID="txtAuthNo" runat="server" class="form_textbox12"></asp:TextBox>
                      &nbsp;&nbsp;&nbsp;&nbsp;
                      <asp:Button ID="btnGo" runat="server" Text="  Go-Step-1  " OnClick="btnGo_Click" 
                    CssClass="button" Width="100px" /></td>
                    <%--<td class="form_text">New Authorization Number</td>--%>
                    <td class="form_text">
                    <asp:Label ID="lblnewauth" runat="server" Text="New Authorization Number" ></asp:Label></td>
                    <td><asp:TextBox ID="txtnewAuthNo" runat="server"  class="form_textbox12"></asp:TextBox>

                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btngo2" runat="server" Text="  Go-Step-2 " CssClass="button" 
                            Width="100px" onclick="btngo2_Click" />
                    </td>
