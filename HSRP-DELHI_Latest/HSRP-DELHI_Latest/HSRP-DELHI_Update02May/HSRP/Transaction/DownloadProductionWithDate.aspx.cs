    ...
    public partial class DownloadProductionWithDate : System.Web.UI.Page
    {
        ...
        protected void btnDownloadRecords_Click(object sender, EventArgs e)
        {
           ...
           // string From1 = "11/28/14";
            ...
            string strSel = "select isnull(max(right(ProductionSheetRunningNo,7)),000000) from EmbossingCenters where State_Id='" + DropDownListStateName.SelectedValue.ToString() + "' and Emb_Center_Id='" + strEmbId + "'";
