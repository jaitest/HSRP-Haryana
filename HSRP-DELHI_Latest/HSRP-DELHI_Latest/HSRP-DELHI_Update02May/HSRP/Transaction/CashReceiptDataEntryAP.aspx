<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="CashReceiptDataEntryAP.aspx.cs" Inherits="HSRP.Transaction.CashReceiptDataEntryAP" %>
                    ...
                    <table border="0" align="right" style=" width: 85%;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <asp:LinkButton ID="LinkButtonGO" runat="server" CssClass="button" 
                                    onclick="LinkButtonGO_Click">GO</asp:LinkButton>
                            </td>
                        </tr>
