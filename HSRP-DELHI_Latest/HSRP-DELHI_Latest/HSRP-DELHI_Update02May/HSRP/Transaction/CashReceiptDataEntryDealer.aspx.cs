...
{
    public partial class CashReceiptDataEntryDealer : System.Web.UI.Page
    {
        ...
        { 
            ...
            CalendarDepositDate.SelectedDate = (DateTime.Parse(TodayDate)).AddDays(-5);
            CalendarDepositDate.VisibleDate = (DateTime.Parse(TodayDate)).AddDays(-5);

            DepositDate.SelectedDate = (DateTime.Parse(TodayDate)).AddDays(-5);
        ...
        protected void ButtonSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (z <= 0)
            {
                ...
                else
                {
                    ...
                    //    Query = "INSERT INTO HSRPRecords (HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,OwnerName,ownerFatherName,Address1,MobileNo,VehicleClass,OrderType,StickerMandatory,isVIP,NetAmount,VehicleType,OrderStatus,CashReceiptNo,CreatedBy,ISFrontPlateSize,ISRearPlateSize,FrontPlateSize,RearPlateSize) values(GetDate(),'" + HSRPStateID + "','" + RTOLocationID + "','" + txtAuthorizationNo.Text + "','" + OrderDate1.ToString() + "','" + txtVehicleRegNo.Text.Trim().ToUpper() + "','" + txtOwnerName.Text + "','" + txtFatherName.Text + "','" + txtAddress.Text + "','" + txtMobileNo.Text + "','" + DropDownListVehicleClass.SelectedItem.ToString() + "','" + DropDownListOrderType.SelectedValue.ToString() + "','" + Sticker + "','" + Vip + "','" + txtAmount.Text + "','" + DropDownListVehicleModel.SelectedItem.ToString() + "','New Order','" + dt1.Rows[0]["PrifixNo"].ToString() + "','" + Session["UID"].ToString() + "','Y','Y','" + DropDownListFrontPlate.SelectedValue + "','" + DropDownListRearPlate.SelectedValue + "')";
                    //    i = Utils.ExecNonQuery(Query, ConnectionString);
                    //} 
                }
                if (i > 0)
                {
                    ...
                    if (txtMobileNo.Text.Length > 0)
                    {
                        ...
                        string SMSText = " Cash Rs." + txtAmount.Text + " collected against Reg No. " + txtVehicleRegNo.Text + " receipt number " + lblCashReceiptNo.Text + "dated  " + System.DateTime.Now.ToString("dd/MM/yyyy") + ".HSRP TEAM";
