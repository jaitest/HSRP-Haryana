...
namespace HSRP.Master
{
    public partial class BankTransactionWithUser : System.Web.UI.Page
    {
        ...
        public void FillUsers()
        {
            ...
            query1 = "SELECT UserID,UserLoginname FROM USERS WHERE HSRP_STATEID='" + HSRPStateID + "' and ActiveStatus='Y' order by UserLoginname asc";
        ...
        private void Filldropdowndealer()
        {
            ...
            else
            {
                ...
                if (UserType == "0")
                {
                    ...
                    SQLString = "select DealerId,dealername from dealerMaster order by dealername asc";
