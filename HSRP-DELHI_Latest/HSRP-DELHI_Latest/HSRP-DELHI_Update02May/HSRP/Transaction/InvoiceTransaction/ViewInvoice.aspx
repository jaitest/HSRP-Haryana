<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewInvoice.aspx.cs" Inherits="HSRP.Master.InvoiceMaster.ViewInvoice" %>
...
<script type="text/javascript">
    function edit(i) { // Define This function of Send Assign Laser ID
        ...
        googlewin = dhtmlwindow.open("googlebox", "iframe", "InvoiceOrder.aspx?Mode=Edit&HeaderID=" + i, "Update Invoice Order", "width=1000px,height=500px,resize=1,scrolling=1,center=1", "recal")
        googlewin.onclose = function () {
            window.location.href = "ViewInvoice.aspx";
            return true;
        }
    }
    ...
    function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
        ...
        googlewin = dhtmlwindow.open("googlebox", "iframe", "InvoiceOrder.aspx?Mode=New", "Add New Invoice Order", "width=1000px,height=500px,resize=1,scrolling=1,center=1", "recal")
        googlewin.onclose = function () {
            window.location = 'ViewInvoice.aspx';
            return true;
        }
    }
    </script>
                             ...
                             <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader" align="right">
                               ...
                               <td style=" width:500px;">
                                    ...
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New HSRP State" class="button">Add New Order </a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td colspan="2">
                                       <%-- <asp:GridView ID="Grid1" runat="server">
                                        ...
                                        <ComponentArt:Grid ID="Grid1" CustomerIDMode="HeaderID" runat="server" ImagesBaseUrl="~/images"
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel DataKeyField="HeaderID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    SortImageHeight="19">
                                                   <Columns>
                                                       <ComponentArt:GridColumn DataField="HeaderID" Visible="False" />
                                                       
                                                        <ComponentArt:GridColumn DataField="HeaderID" HeadingText="Invoice ID" SortedDataCellCssClass="SortedDataCell" Width="130" />

                                                       <ComponentArt:GridColumn DataField="Name" Visible="true" HeadingText="Customer Name"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="MobileNo" Visible="true" HeadingText="Mobile No"
                                                            Width="100" />
                                                        ...
                                                        <ComponentArt:GridColumn AllowGrouping="False" DataCellServerTemplateId="Invoice" HeadingText="PDF Invoice" SortedDataCellCssClass="SortedDataCell" Width="50" />
                                                    </Columns>
                                            ...
                                            <ClientTemplates>
                                                   ...
                                                   <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:edit(## DataItem.GetMember('HeaderID').Value ##);">
                                                        Edit</a>
                                             ...
                                             <ServerTemplates>
                                                <ComponentArt:GridServerTemplate ID="Invoice">
                                                    <Template>
                                                        <asp:LinkButton ID="LinkButtonInvoice" runat="server" Text="Generate Invoice" CommandName="PurchaseOrder"></asp:LinkButton>
                                                    </Template>
