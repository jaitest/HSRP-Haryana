<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoidEntry.aspx.cs" Inherits="HSRP.Master.VoidEntry" %>
             ...
             <table style="background-color:White" width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                ...
                <td colspan="7">
                   ...
                   <td class="form_text" style="padding-bottom: 10px"> Laser Plate Box No. </td> 
                     ...
                     <tr>
                      <td class="form_text" style="padding-bottom: 10px; margin-left: 120px;"> <asp:Label ID="Label1" runat="server" class="form_text" Text="Order Book By :"></asp:Label></td> 
                       ...
                       <td></td>
                        ...
                        <td class="form_text" style="padding-bottom: 10px">Void Entry By :</td>
                         <td></td>
                       <td class="form_text" style="padding-bottom: 10px">   <asp:Label ID="lblvoidentryby" runat="server" class="form_text" ></asp:Label></td>
                         </tr>


                         <tr>
                         <td class="form_text" style="padding-bottom: 10px">Void Entry Date Time :</td>
                         <td></td>
                         <td class="form_text" style="padding-bottom: 10px">   <asp:Label ID="lblDateTime" runat="server" class="form_text" ></asp:Label></td>
                       <td></td>

                        <td class="form_text" style="padding-bottom: 10px">Void Remarks :</td>
                         <td></td>
                       <td class="form_text" style="padding-bottom: 10px">   <asp:TextBox ID="txtVoidRemarks" runat="server" TextMode="MultiLine" Width="186px"></asp:TextBox></td>
                         </tr>
                    ...
                    <asp:Button ID="btnUpdate" runat="server" class="button"  Text="Update" TabIndex="4" 
