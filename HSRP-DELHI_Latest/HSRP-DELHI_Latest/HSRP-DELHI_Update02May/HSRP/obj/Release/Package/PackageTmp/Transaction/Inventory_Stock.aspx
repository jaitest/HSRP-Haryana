<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Inventory_Stock.aspx.cs" Inherits="HSRP.Transaction.Inventory_Stock" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function validate() {
            ...
            var qty = document.getElementById("<%=textboxQuantity.ClientID%>").value;
            var tt = (qty > 500) ? "No" : "Yes";
            if (tt == "No")
             {
                alert("Please Enter Quantity Less Than 500");
     ...
     <td colspan=6>
        <fieldset>
           <legend> 
                ...
                <div>
                    <table style="background-color: #FFFFFF; width: 100%;" border="0" align="left" 
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="textboxLaserCodeFrom" runat="server" class="form_textbox" 
                    MaxLength="8" TabIndex="4"></asp:TextBox>
            </td>
            <td>
            </td>
            <td class="form_text" style="padding-bottom: 10px">
            ...
            <td>
                <asp:TextBox ID="textboxQuantity" runat="server" class="form_textbox" 
                    MaxLength="15" onkeypress="return isNumberKey(event)" TabIndex="5"></asp:TextBox>
            </td>
        </tr>
        <%--<tr >
            <td class="form_text" style="padding-bottom: 10px">
            ...
            <td>
                <asp:TextBox ID="textboxInvNo" runat="server" class="form_textbox" TabIndex="6" 
        ...
        <tr>
            ...
            <td colspan="4" class="form_text" style="padding-bottom: 10px">
