<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="LaserQuickClosed_AP.aspx.cs" Inherits="HSRP.Master.LaserQuickClosed_AP" %>
...
//            
    ...
    <ContentTemplate>
                ...
                <tr>
                        ...
                        <td><asp:Label ID="lblauthno" runat="server" Font-Bold="true" Text=" "></asp:Label></td>

                        <td>
                           <font color="black"> RTOLOCATION : </font>
                        </td>
                        <td><asp:Label ID="lblrto" runat="server" Font-Bold="true" Text=" "></asp:Label></td>
                    ...
                    <tr id="DivFirst" runat="server" visible="false">
                        ...
                        <td><font color="black"><asp:Label ID="lblFrontLaserPlate" CssClass="" runat="server"></asp:Label></font></td>
                          
                   <td></td>
                        <td class="form_text_View" style="padding-bottom: 10px"> <font color="black">Rear Plate Laser No :   </td>
                         <td><font color="black"><asp:Label ID="lblRearLaserPlate" CssClass="" runat="server"></asp:Label></font></td>
                ...
                <tr  id="DivSecond" runat="server" visible="false">
                   ...
                   <td></td>
                    ...
                    <asp:Button ID="btnSave" runat="server"   class="button"  Text=" Close Order" TabIndex="4" OnClientClick="return ValidationQuick()"  Visible="false"
