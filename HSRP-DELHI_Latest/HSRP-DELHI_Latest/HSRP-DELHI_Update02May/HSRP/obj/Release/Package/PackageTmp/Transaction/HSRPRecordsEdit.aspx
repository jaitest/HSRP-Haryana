<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSRPRecordsEdit.aspx.cs" ValidateRequest="false"
    Inherits="HSRP.Transaction.HSRPRecordsEdit" %>
...
//            var fromDate = CashDate.getSelectedDate();
//            CalendarHSRPAuthDate.setSelectedDate(fromDate);
...
//            }
//            else {
//                CalendarHSRPAuthDate.setSelectedDate(CashDate.getSelectedDate());
//                CalendarHSRPAuthDate.show();
//            }
//        }
        ...
        function CheckVehicleRegNo() 
          {
            ...
            if (!ValidRegNo(document.getElementById("TextBoxVehicleRegNo").value, document.getElementById("<%=LabelCreatedID.ClientID%>").innerHTML)) {
                alert("Please Provide Valid Registration No.");
                document.getElementById("TextBoxVehicleRegNo").focus();
                return false;
            }
                                                            ...
                                                            <td>
                                                                <asp:UpdatePanel runat="server" ID="UpdatePanelAuthNo" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <asp:AutoCompleteExtender UseContextKey="true" ServiceMethod="GetCustomers1Edit"
                                                                            MinimumPrefixLength="1" ServicePath="~/WCFService/ServiceForSuggestion.svc" CompletionInterval="10"
                                                                            EnableCaching="false" TargetControlID="textBoxAuthorizationNo" ID="AutoCompleteExtender1"
                                                            ...
                                                            <td>
                                                                <asp:UpdatePanel runat="server" ID="UpdatePanelCashReceiptNo" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <asp:AutoCompleteExtender ServiceMethod="GetCashReceiptNosEdit" MinimumPrefixLength="1"
                                            ...
                                            <tr valign="top">
                                                <td colspan="6" style="margin-left: 50px;" align="left" class="form_text">
                                                    ...
                                                    <asp:TextBox Visible="false" Width="1px" ID="textBoxAddress2" runat="server" class="form_textbox11"
                                                        TabIndex="9"></asp:TextBox>
                                                    <asp:Label runat="server" ForeColor="Blue" Font-Italic="true" Font-Size="Small" Text="Note: HSRP Auth No. and Vehicle Reg No. can't be changed."></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <%--  <asp:UpdatePanel runat="server" ID="UpdatePanelVehicleMake" UpdateMode="Conditional"
                                                        ...
                                                        <ContentTemplate>
                                                            <asp:DropDownList Style="margin-left: 8px" EnableViewState="true" Font-Size="Small"
                                                                ...
                                                                DataValueField="VehicleMakerID" runat="server" TabIndex="15" OnSelectedIndexChanged="DropDownList44_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="buttonGo" EventName="Click" />
                                                            ...
                                                            <td nowrap="nowrap">
                                                                <asp:UpdatePanel runat="server" ID="UpdatePanelVehicleRegNo" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <asp:AutoCompleteExtender ServiceMethod="GetVehicleRegsEdit" UseContextKey="true"
                                                                            MinimumPrefixLength="1" ServicePath="~/WCFService/ServiceForSuggestion.svc" CompletionInterval="10"
                                                                            EnableCaching="false" TargetControlID="TextBoxVehicleRegNo" ID="AutoCompleteExtender2"
                                                                            runat="server" FirstRowSelected="false" CompletionSetCount="12" CompletionListCssClass="AutoExtender"
                                                                            CompletionListItemCssClass="AutoExtenderList" CompletionListHighlightedItemCssClass="AutoExtenderHighlight"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                        <ContentTemplate>
                                                            <asp:Button ID="buttonSave" runat="server" TabIndex="24" OnClientClick="javascript:return ValidateForm();"
                                                                class="button" Text="Update" OnClick="buttonSave_Click" />&nbsp;
                                                            <a id="LinkButtonCashReceipt" visible="false" runat="server" class="button" target="_self">
                                                                Download Cash Receipt</a>
                                                            <%-- <asp:LinkButton ID="LinkButtonCashReceipt" runat="server" Visible="false" 
                                                                Text="Download Cash Receipt" class="button" onclick="LinkButtonCashReceipt_Click">--%>&nbsp;
