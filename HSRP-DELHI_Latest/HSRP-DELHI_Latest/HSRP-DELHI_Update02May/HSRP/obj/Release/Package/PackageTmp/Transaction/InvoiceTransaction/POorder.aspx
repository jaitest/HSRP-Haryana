<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="POorder.aspx.cs" Inherits="HSRP.Master.InvoiceMaster.POorder" %>
...
<head id="Head1" runat="server">
    <script language="javascript" type="text/javascript">
        function validate() {
            if (document.getElementById("<%=ddlVendorName.ClientID%>").value == "0") {
                alert("Please Provide Vendor Name ");
                document.getElementById("<%=ddlVendorName.ClientID%>").focus();
                return false;
            }
            ...
            if (invalidChar(document.getElementById("ddlVendorName"))) {
                alert("Your can't enter special characters in Plant Address. \nThese are not allowed.\n Please remove them.");
                document.getElementById("ddlVendorName").focus();
                return false;
            }
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="midtable">
        <tr>
            <td valign="top">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <%-- <a onclick="AddNewPop(); " title="Add New HSRP State" class="button">Add New Order</a>--%>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <table align="center" style="padding-top: 20px; width: 800px;">
                                <tr>
                                ...
                                <tr>
                                    <td style="width: 150px" class="Label_user">
                                        Vendor Name<span style="color: Red">*</span>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlVendorName" class="form_textbox" Width="220px" runat="server">
                                        </asp:DropDownList>
                                    </td>
                                    <%--  <td style=" width:150px" class ="Label_user">Vendor produts<span style=" color:Red">*</span>--%>
                        </td>
                        <td>
                            <%-- <asp:TextBox ID="txtTransportName" runat="server" class="form_textbox"></asp:TextBox>--%>
                            <%--  <asp:DropDownList ID="ddlTransportName" class="form_textbox" Width="220px" runat="server" >
                                 <asp:ListItem Value="0">Select</asp:ListItem>
                                  <asp:ListItem Value="1">By Logistics</asp:ListItem>
                                  <asp:ListItem Value="2">By Bontreger</asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td>
                            <%--  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                              <ContentTemplate>--%>
                            <asp:TextBox ID="txtBillingAddress" runat="server" class="form_textbox" Height="100px"
                        ...
                        <td>
                            <%--  <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                              <ContentTemplate>--%>
                            <asp:TextBox ID="txtShippingAddress" runat="server" class="form_textbox" Height="100px"
                                TextMode="MultiLine"></asp:TextBox>
                            <%--   </ContentTemplate>
                           <Triggers>--%>
                            <%--  <asp:AsyncPostBackTrigger ControlID="ddlCustomerName" EventName="Click" />--%>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPaymentTerm" runat="server" class="form_textbox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <%--  <td class="Label_user">
                        ...
                        <td class="Label_user">
                            Active Status
                            <asp:TextBox ID="txtDate" runat="server" class="form_textbox" Visible="false"></asp:TextBox>
                        </td>
                        <td>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="35" align="right" valign="middle">
                            <asp:Button ID="btnUpdate" runat="server" Text="Update Inline Data" CssClass="button"
                                OnClick="btnUpdate_Click1" OnClientClick="return validate()" />
                            <asp:Button ID="btnShowPopup" runat="server" Text="Add Inline Data" CssClass="button"
                                OnClick="btnShowPopup_Click" OnClientClick="return validate()" />
        ...
        <div id="divGrid" runat="server" visible="false">
            <asp:GridView ID="gvEG" runat="server" AutoGenerateColumns="False" CssClass="grid"
                ...
                OnRowEditing="gvEG_RowEditing" OnRowUpdating="gvEG_RowUpdating" DataKeyNames="POorderID">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Unit" HeaderStyle-HorizontalAlign="Left">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtMesurementUnit" runat="server" Text='<%# Bind("MesurmentUnit") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <%# Eval("MesurmentUnit")%>
                        </ItemTemplate>
            ...
            <tr>
                <td align="center">
                    <asp:Button ID="btnSavePO" runat="server" Text="Generate PO" CssClass="button" OnClick="btnSavePO_Click" />
                </td>
            </tr>
        </div>
    </table>
