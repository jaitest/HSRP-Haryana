<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReportDelhiDealerStatus.aspx.cs" Inherits="HSRP.Report.ReportDelhiDealerStatus" %>
    ...
    <table style="width: 85%; height: 51px; left: 50px;">
        <tr>
            ...
            <td style="width: 80px; ">
                    ...
                    <ContentTemplate>
                        <asp:DropDownList ID="DropDownListStateName" runat="server"  Visible="true"
            ...
            <td style="width: 40px; ">
                    ...
                    <asp:Label Text="From:" runat="server" ID="labelDate" Font-Bold="True" Visible="true"
                                                        ForeColor="Black" /> 
                
            </td>
            <td style="width: 80px; ">
                
                                                    <ComponentArt:Calendar ID="OrderDate" runat="server" PickerFormat="Custom" PickerCustomFormat="dd/MM/yyyy" Visible="true"
