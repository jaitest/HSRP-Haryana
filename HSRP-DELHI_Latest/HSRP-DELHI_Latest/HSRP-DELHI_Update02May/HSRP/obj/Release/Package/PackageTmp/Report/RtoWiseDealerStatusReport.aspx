<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RtoWiseDealerStatusReport.aspx.cs" Inherits="HSRP.DLReports.RtoWiseDealerStatusReport" %>
            ...
            <td valign="top">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                       ...
                                       <%-- <asp:DropDownList Visible="true" ID="ddlBothDealerHHT" CausesValidation="false" Width="140px"
                                        ...
                                        <asp:DropDownList Visible="true" ID="ddlBothDealerHHT" CausesValidation="false" Width="140px"
                                         DataTextField="NAME OF THE DEALER" DataValueField="NAME OF THE DEALER"  
                                            ...
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="DropDownListStateName" EventName="SelectedIndexChanged" />
                                                <asp:PostBackTrigger ControlID="ddlBothDealerHHT"   /> 
                                            </Triggers>
                                        </asp:UpdatePanel>
                                                ...
                                                <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()" align="left" style="width: 120px">
                                                    <ComponentArt:Calendar ID="HSRPAuthDate" runat="server" PickerFormat="Custom" Visible="true" PickerCustomFormat="dd/MM/yyyy"
                                                        ControlType="Picker" PickerCssClass="picker">
                                                        <ClientEvents>
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="View" ToolTip="Please Click for Report" Width="100px"
                                                        class="button" OnClick="btnExportToExcel_Click" />
                                                </td>

                                                <td></td>
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnDetails" runat="server" Text="Details" Visible="false" ToolTip="Please Click for Report" Width="100px"
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor="#669999" BorderColor="White" AutoGenerateColumns="false"
                            BorderStyle="Solid" ForeColor="#000000">
                    <Columns>
     ...
     <itemtemplate>
          <%#Container.DataItemIndex + 1 %>                                                    
                 ...
                 <asp:BoundField ReadOnly="True" 
                                ...
                                SortExpression="vehicleregno"/>

                <asp:BoundField HeaderText="AuthorizationNo" 
                                DataField="HSRPRecord_AuthorizationNo"
                                SortExpression="HSRPRecord_AuthorizationNo"/>  
                ...
                <asp:BoundField HeaderText="ChassisNo" 
                        ...
                        <asp:BoundField HeaderText="front_lasercode" 
                                DataField="hsrp_front_lasercode"
                                SortExpression="hsrp_front_lasercode"/>  
                        
                         <asp:BoundField HeaderText="rear_lasercode" 
                                DataField="hsrp_rear_lasercode"
                                SortExpression="hsrp_rear_lasercode"/>                
            </Columns>
                            </asp:GridView>
                    </td>
                    </tr>
