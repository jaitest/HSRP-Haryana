<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="DownloadDelhiProductionWithDate.aspx.cs" Inherits="HSRP.Master.DownloadDelhiProductionWithDate" %>
                        ...
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" class="form_text">
                                        <asp:UpdatePanel runat="server" ID="UpdateRTOLocation" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:DropDownList Visible="true" ID="dropDownListClient" CausesValidation="false"
                                                    Width="140px" runat="server" DataTextField="NAVEMBID" DataValueField="NAVEMBID"  AutoPostBack="true"  OnSelectedIndexChanged="dropDownListClient_SelectedIndexChanged1">
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                            <Triggers>
                                    ...
                                    <td>
                                        <asp:DropDownList Visible="true" ID="DropDownList1" CausesValidation="false" Width="140px" AutoPostBack="true"
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        ...
                                        <asp:Button ID="btnDownloadRecords" Width="114px" runat="server" Text="Download In PDF"
                                            ToolTip="Please Click for Report" class="button" OnClick="btnDownloadRecords_Click" OnClientClick=" return validate()" /><%--OnClientClick="validate()" --%>
                                            <br />
                            ...
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                              <%--  <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="lblErrMsg" runat="server"  Font-Names="Arial" Font-Size="10pt" ForeColor="#FF3300" ></asp:Label>
                                    </td>
                                </tr>--%>
                                <tr>
                                    <td>
