...
namespace HSRP.HPReports
{
    public partial class DailyRegisteringAuthority : System.Web.UI.Page
    {
        ...
        private void FilldropDownListOrganization()
        {
            ...
            {
                SQLString = "select HSRPStateName,HSRP_StateID from HSRPState  where hsrp_stateID in ('3') and ActiveStatus='Y' Order by HSRPStateName";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               // row.Index = 7; 
                ...
                SQLString = "Report_Monthly_Statement_Registering_Authority'" + FromDate + "','" + ToDate + "','3','687'";
