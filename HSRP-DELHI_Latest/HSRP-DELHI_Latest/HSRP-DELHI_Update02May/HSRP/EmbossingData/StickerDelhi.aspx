<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StickerDelhi.aspx.cs" Inherits="HSRP.EmbossingData.StickerDelhi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function editMakeLaserFree(i) { // Define This function of Send Assign Laser ID 
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "LaserCodeEmbossing.aspx?Mode=Embossing&HSRPRecordID=" + i, "Updae Laser Details", "width=950px,height=550px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                //window.location.href = "AssignLaserCode.aspx";
                return true;
            }
                        ...
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr id="TR1" runat="server">
                                    <td>
                                        <asp:Label ID="Label4" class="headingmain" runat="server">Sticker</asp:Label>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" class="form_text">
                                     ...
                                     <td valign="middle" class="form_text" nowrap="nowrap">
                                         <asp:Label Text="Dealer :" runat="server" ID="label1" /></td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:DropDownList Visible="true" ID="DropDownList2" CausesValidation="false" Width="140px"
                                            runat="server" >
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                     ...
                                     <td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:Button ID="btntest" Width="58px" runat="server" Visible="false" Text="test" ToolTip="Please Click for Report"
                                            class="button" OnClientClick=" return validate()" OnClick="btntest_Click"  />
                                        &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:Label Text="Production Sheet" Visible="false" runat="server" ID="labelOrderStatus" />&nbsp;&nbsp;
                                    </td>
                                    <td valign="middle">
                                        <asp:DropDownList DataTextField="pdffilename" Style="margin-top: 10px;" DataValueField="pdffilename"
                                            Visible="false" AutoPostBack="true" ID="dropdownDuplicateFIle" CausesValidation="false"
                                            runat="server" OnSelectedIndexChanged="dropdownDuplicateFIle_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        &nbsp;
                                    </td>
