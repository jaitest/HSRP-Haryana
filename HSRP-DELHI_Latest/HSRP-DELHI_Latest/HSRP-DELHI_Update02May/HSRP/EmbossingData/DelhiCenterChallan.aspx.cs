...
{
    public partial class DelhiCenterChallan : System.Web.UI.Page
    {
        ...
        private void ShowGrid( string strFromdate,string strToDate)
        {
            ...
            try
            {
                ...
                else
                {
                    SQLString = "select e.[EmbCenterName], Row_Number() over(order by orderstatus) as SNo, hsrprecordid,HSRPRecord_AuthorizationNo,vehicleregno,hsrp_rear_lasercode,hsrp_Front_lasercode,OrderStatus " +
                   "from hsrprecords  as h,[rtolocation] as e where h.rtolocationid=E.rtolocationid AND h.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and Invoice_Flag='N'  and e.NAVEMBID='" + ddlemb.SelectedValue + "'  " +
                    " and orderstatus ='Embossing Done' and ChallanNo is null and Hsrprecord_creationdate between '" + strFromdate + "' and '" + strToDate + "' and Addrecordby!='Dealer' and h.rtolocationid='" + rtoid + "'  and (hsrp_rear_lasercode is not null or hsrp_Front_lasercode is not null) " +
                   "order by VehicleClass,VehicleType,VehicleRegNo";
                }
        ...
        protected void btnChalan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    string strSelectEmbStation = "SELECT DISTINCT [NAVEMBID],[EmbCenterName],RTOLocationName,city FROM [vw_RTOLocationWiseEmbosingCenters] WHERE RTOLocationId='" + ddlrto.SelectedValue + "'";
                ...
                if (true)
                {
                    ...
                    string strLocId = ddlrto.SelectedValue;
                    ...
                    if (ddlrto.SelectedItem.Text != "")
                    {
                        string dealername = ddlrto.SelectedItem.Text;
