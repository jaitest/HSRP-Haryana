<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="MPRTORecord.aspx.cs" Inherits="HSRP.Master.MPRTORecord" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">View Records Recived from Transport Department </span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" class="form_text">
                                       <asp:UpdatePanel runat="server" ID="UpdateRTOLocation" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:Label Text="Location:"  Visible="false" runat="server" ID="labelClient" />&nbsp;&nbsp;
                                             <asp:DropDownList AutoPostBack="false"  Visible="false" ID="dropDownListClient" CausesValidation="false"
                                    ...
                                    <td style="width:352px"  class="form_text">   </td>

                                    <td style="width:82px"  class="form_text"> <asp:Label Text="From:" Visible="true" runat="server" ID="labelDate" /> </td>
                                    <td style="width:42px" valign="top" onmouseup="OrderDate_OnMouseUp()" align="left">
                                                            ...
                                                            <td style="width:74px"  valign="top" align="left">
                                                                <img id="calendar_from_button" tabindex="3" alt="" onclick="OrderDate_OnClick()"
                                                                    onmouseup="OrderDate_OnMouseUp()" class="calendar_button" src="../images/btn_calendar.gif" />
                                                            </td>
                                    <td style="width:74px"   class="form_text"> <asp:Label Text="To:" Visible="true" runat="server" ID="labelTO" /> </td>
                                   <td style="width:42px"  valign="top" onmouseup="HSRPAuthDate_OnMouseUp()" align="left">
                                                            ...
                                                            <td style="width:74px"  style valign="top" align="left">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ComponentArt:Grid ID="Grid1" RTOLocationIDMode="AutoID" runat="server" ImagesBaseUrl="~/images"
                                            ...
                                            PagerTextCssClass="GridFooterText" PageSize="60" GroupByTextCssClass="GroupByText"
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel DataKeyField="RTO_NAME" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    SortImageHeight="19">
                                                    <Columns>
                                                    <ComponentArt:GridColumn DataField="SNo" HeadingText="SNo." SortedDataCellCssClass="SortedDataCell" Width="10" /> 
                                                       <ComponentArt:GridColumn DataField="RTO_NAME" Visible="False" /> 
                                                        <ComponentArt:GridColumn DataField="RTO_NAME" HeadingText="RTO Name" SortedDataCellCssClass="SortedDataCell"
                                                            Width="120" />
                                                        <ComponentArt:GridColumn DataField="records" HeadingText="Total Records"
                                                            SortedDataCellCssClass="SortedDataCell" Width="230" /> 
                                                       ...
                                                       <ComponentArt:GridColumn AllowGrouping="False" DataCellServerTemplateId="Sticker" HeadingText="Sticker" SortedDataCellCssClass="SortedDataCell" Width="50" />--%>
