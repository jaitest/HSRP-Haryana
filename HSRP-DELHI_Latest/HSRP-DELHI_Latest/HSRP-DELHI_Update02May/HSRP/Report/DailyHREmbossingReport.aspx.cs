...
namespace HSRP.Report
{
    public partial class DailyHREmbossingReport : System.Web.UI.Page
    {
        ...
        private void ExportToPDF()
        {
            ...
            var colWidthPercentages = new[] { 17f, 80f, 40f, 45f, 40f, 40f, 50f, 50f, 20f, 25f,25f};
            table.SetWidths(colWidthPercentages);
            //string sqlquery="select distrelation from rtolocation where rtolocationid='"+
            string SqlQuery = string.Empty;


            SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo,  b.ProductColor, a.HSRPRecord_AuthorizationNo as vh1,a.VehicleRegNo as vh2, a.OrderEmbossingDate, a.HSRPRecordID, a.OwnerName, a.VehicleType, a.HSRP_Front_LaserCode,Product_1.ProductColor,a.HSRP_Rear_LaserCode, a.VehicleClass, case when a.StickerMandatory='N' then 'N/A' else a.StickerMandatory end as StickerMandatory, Product_1.ProductCode AS FrontPlateSize, a.RearPlateSize, b.ProductCode AS RearPlateSize1,a.FrontPlateSize AS FrontPlateSize ,a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '4' AND a.hsrprecord_creationdate  between '" + FromDate + "' and '" + ToDate + "'";
        ...
        private void ExportToPDFAll()
        {
             ...
             for (int iRowNo = 0; iRowNo < dtrto.Rows.Count; iRowNo++)
             {
                ...
                // string PdfFolder = ConfigurationManager.AppSettings["PdfFolder"].ToString() + filename;
                 ...
                 document.Open();
                 PdfPTable table = new PdfPTable(11);
                 var colWidthPercentages = new[] { 17f, 80f, 45f,40f, 45f, 40f, 40f, 50f, 50f, 20f, 25f};
                 table.SetWidths(colWidthPercentages);
                 //string sqlquery="select distrelation from rtolocation where rtolocationid='"+
                 string SqlQuery = string.Empty;


                 SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo,  b.ProductColor, a.HSRPRecord_AuthorizationNo as vh1,a.VehicleRegNo as vh2, a.OrderEmbossingDate, a.HSRPRecordID, a.OwnerName, a.VehicleType, a.HSRP_Front_LaserCode,Product_1.ProductColor,a.HSRP_Rear_LaserCode, a.VehicleClass, case when a.StickerMandatory='N' then 'N/A' else a.StickerMandatory end as StickerMandatory, Product_1.ProductCode AS FrontPlateSize, a.RearPlateSize, b.ProductCode AS RearPlateSize1,a.FrontPlateSize AS FrontPlateSize ,a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '4' and a.rtolocationid='" + RTOCode + "' AND a.hsrprecord_creationdate  between '" + FromDate + "' and '" + ToDate + "'";
                 DataTable dt = Utils.GetDataTable(SQLString, CnnString);
                 ...
                 GenerateCell(table, 11, 0, 0, 0, 0, 1, 0, "SCHEDULE-C : Daily Report from Embossing Stations to Registering Authority", 20, 0);
                 GenerateCell(table, 2, 0, 0, 0, 0, 1, 0, "State Name : HARYANA", 20, 0);
