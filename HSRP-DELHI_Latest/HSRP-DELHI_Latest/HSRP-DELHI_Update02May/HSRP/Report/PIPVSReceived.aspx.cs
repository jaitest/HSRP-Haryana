    ...
    public partial class PIPVSReceived : System.Web.UI.Page
    {
        ...
        protected void grdid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day1")
            {
                ...
                Label Day1 = (Label)grdid.Rows[RowIndex].FindControl("lblDay1Date");
                day1date = Day1.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "'  and convert(date,aptgvehrecdate,103) between '" + day1date + "' and '" + ReportDate2 + "' and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day2")
            {
                ...
                Label Day2 = (Label)grdid.Rows[RowIndex].FindControl("lblDay2Date");
                day2date = Day2.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and embcentername='" + embcentername + "' and convert(date,aptgvehrecdate,103) between  '" + day2date + "' and dateadd(day,-1,'" + day1date + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day1")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,aptgvehrecdate,103)=dateadd(day,0,'" + ReportDate2 + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day2")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,aptgvehrecdate,103)=dateadd(day,-1,'" + ReportDate2 + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day3")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,aptgvehrecdate,103)=dateadd(day,-2,'" + ReportDate2 + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
            }
            if (e.CommandName == "Day4")
            {
                ...
                Label rtolocation = (Label)GridView1.Rows[RowIndex].FindControl("lblRtolocation");
                rtolocationname = rtolocation.Text.ToString();
                strSQL.Append("select convert(date,erpassigndate,103) as erpassigndate,embcentername,rtolocationname,vehicleregno,hsrp_front_lasercode, hsrp_rear_lasercode,OrderStatus,challanno,challandate,RejectFlag,isnull(NewPdfRunningNo,PdfRunningNo) as NewPdfRunningNo,PdfDownloadDate,isnull(convert(varchar(15),aptgvehrecdate,103),convert(varchar(15),OrderDate,103)) aptgvehrecdate,RecievedAtAffixationDateTime from hsrprecords a, rtolocation b  where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID='" + state + "' and RTOLocationname='" + rtolocationname + "' and convert(date,aptgvehrecdate,103)=dateadd(day,-3,'" + ReportDate2 + "')  and (convert(date,RecievedAtAffixationDateTime)>'" + ReportDate2 + "' or isnull(RecievedAtAffixationDateTime,'')='')");
