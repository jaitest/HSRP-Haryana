<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="DailyDUMPReport.aspx.cs" Inherits="HSRP.Report.DailyDUMPReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Dump Data Report</span>
                                    </td>
                        ...
                        <td>
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                ...
                                <div style=" height:20px"></div>
                                   ...
                                   <tr>
                                   <td style="position: relative; right: 0px; top: 0px; wh">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="Report In Excel From Master" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="btnExportToExcel_Click" />
                                                </td>
                                            <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnDealer" runat="server" 
                                                        Text="Report In Excel From Dealer Data" ToolTip="Please Click for Report"
                                                        class="button" onclick="btnDealer_Click"  />
                                                </td>
                                                  <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnExpence" runat="server" 
                                                          Text="Report In Excel From Expense Data" ToolTip="Please Click for Report"
                                                        class="button" onclick="btnExpence_Click" />
                                                </td>
                                                <td>
                                                <asp:Button ID="HHTData" runat="server" 
                                                          Text="Report In Excel From HHT Data" ToolTip="Please Click for Report"
                                                        class="button" onclick="HHTData_Click" Visible="False"  />
                                                </td>
                                                <td>
                                                <asp:Button ID="HHTSummary" runat="server" 
                                                          Text="HHT Summary Report" ToolTip="Please Click for Report"
                                                        class="button" onclick="HHTSummary_Click" Visible="False"   />
                                                </td>
                                                </tr>
                                                </table>
