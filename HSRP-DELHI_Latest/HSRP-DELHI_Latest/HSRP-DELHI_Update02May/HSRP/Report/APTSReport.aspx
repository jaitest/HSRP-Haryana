                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="width:105px"; onmouseup="OrderDate_OnMouseUp()">
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="DownloadReport" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="btnExportToExcel_Click" />
                                                </td>
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnSummary" runat="server" Text="Rejection Report" ToolTip="Please Click for Report" Visible="false"
