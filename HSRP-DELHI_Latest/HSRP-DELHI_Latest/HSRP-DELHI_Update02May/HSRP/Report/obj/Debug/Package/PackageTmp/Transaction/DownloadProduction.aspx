<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="DownloadProduction.aspx.cs" Inherits="HSRP.Master.DownloadProduction" %>
                        ...
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td valign="middle"  Visible="false" class="form_text" nowrap="nowrap">&nbsp;&nbsp; <asp:Label Text="From:" Visible="false" runat="server" ID="labelDate" /> &nbsp;&nbsp;</td>
                                   ...
                                   <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()"   align="left">
                                                                <ComponentArt:Calendar ID="HSRPAuthDate" runat="server" PickerFormat="Custom" PickerCustomFormat="dd/MM/yyyy" Visible="false"
                                                                    ControlType="Picker" PickerCssClass="picker">
                                                                    <ClientEvents>
                                   ...
                                   <td valign="middle" class="form_text" nowrap="nowrap"> <asp:Label Text="Order Status" Visible="false" runat="server" ID="labelOrderStatus" />&nbsp;&nbsp; </td>
