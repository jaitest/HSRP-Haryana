<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="DelhiDealerOldDateCashCollection.aspx.cs" Inherits="HSRP.Transaction.DelhiDealerOldDateCashCollection" %>
            ...
            <div style="width: 100%; height:443px; margin: 0px auto 0px auto">
                ...
                <td style="width: 347px">
                    ...
                    <tr>
                        ...
                        <td  >
                            <%--<asp:TextBox ID="txtVehicleRegNo"    runat="server" Width="160" class="form_text"  MaxLength="10"></asp:TextBox> --%>
                            <table>
                                                        <tr>
                                                            <td > 
                    ...
                    <tr>
                        <td class="form_text" style="width: 128px">
                            ...
                            Authorization No : <span class="alert">* </span></td>
                        <td style="width: 347px">
                           
                           <asp:TextBox ID="txtAuthorizationNo" runat="server" Width="160" class="form_text" ></asp:TextBox></td>
                    ...
                    <tr>
                        ...
                        <td class="form_text" style="width: 128px">
                            Reference</td>
                        <td style="width: 347px">
                            <asp:TextBox ID="txtReference" runat="server" Height="22px" Width="167px"></asp:TextBox>
                        </td>
