<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReportMonthly.aspx.cs" Inherits="HSRP.Report.ReportMonthly" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Report : Monthly Report  </span>
                                    </td>
                                    ...
                                    <td valign="top" style="width:105px"; onmouseup="OrderDate_OnMouseUp()">
                                                ...
                                                <td valign="top" onmouseup="OrderDate_OnMouseUp()" align="left">
                                                    <asp:DropDownList ID="ddlMonth" runat="server">
                                                        ...
                                                        <asp:ListItem Value="04">Appril</asp:ListItem>
