...
{
    public partial class Yu_Ar_age_Report : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            string filename = "Ar_Age_Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
            ...
            Export(strOrderType, book, 1, "[hsrp_agingreport_20May]");
            //  Export("D", book, 2);
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet,string strProcName)
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@hsrp_stateid", ddlState.SelectedValue));
              ...
              //  row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                ...
                WorksheetCell cell = row.Cells.Add("Ar Age Report");
