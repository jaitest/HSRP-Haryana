...
{
    public partial class ComplainReportGov : System.Web.UI.Page
    {
       ...
       protected void ButtonGo_Click(object sender, EventArgs e)
        {
            ...
            ToDate = HSRPAuthDate.SelectedDate.ToString("yyyy-MM-dd");
               ...
               // DataTable dt = new DataTable();
                ...
                SQLString = "SELECT [id],[ComplaintNo],[Region],[StateId],[OwnerName],[MobileNo],[Email],[Regno],[EngineNo],[ChasisNo],left([Remarks],50) as Remarks,[IPAddress],[ComplaintDate],[Status],[Solution],[SolutionDate] FROM [Complaint] where StateId='2' and ComplaintDate between '" + fromdate + "' and  '" + ToDate + "'";
       ...
       { 
        ...
        private void InitialSetting()
        {
            ...
            string Mindate = "2016-4-01";//System.DateTime.Now.Year.ToString() + "-" + System.DateTime.Now.Month.ToString() + "-" + (System.DateTime.Now.Day - 3).ToString();
