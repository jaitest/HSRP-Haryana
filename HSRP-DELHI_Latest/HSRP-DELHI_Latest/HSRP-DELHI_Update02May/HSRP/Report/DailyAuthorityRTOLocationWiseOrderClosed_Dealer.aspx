<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyAuthorityRTOLocationWiseOrderClosed_Dealer.aspx.cs" Inherits="HSRP.Report.DailyAuthorityRTOLocationWiseOrderClosed_Dealer" %>
                                ...
                                <td></td>
                                 <td valign="middle" class="form_text" nowrap="nowrap">
                                    ...
                                    <td valign="middle" class="form_text">
                                        ...
                                        <td valign="middle" class="form_text" nowrap="nowrap">
                                         <asp:Label Text="Dealer :" runat="server" Visible="false" ID="lbldealer" /></td>
                                                <td>
                                                <asp:DropDownList Visible="true" ID="ddlBothDealerHHT" CausesValidation="false" Width="100px"
