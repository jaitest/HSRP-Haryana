<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyCashCollectionRTOLocationWise_WithDateGov.aspx.cs" Inherits="HSRP.Report.DailyCashCollectionRTOLocationWise_WithDateGov" %>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle" class="form_text">
                                                    <asp:UpdatePanel runat="server" ID="UpdateRTOLocation" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:Label Text="Location:" Style="display:none;" Visible="false" runat="server" ID="labelClient" />&nbsp;&nbsp;
                                                ...
                                                <td valign="top" style="padding-top: 6px;" onmouseup="OrderDate_OnMouseUp()" align="left">
                                                ...
                                                <td valign="top" style="padding-top: 6px;" onmouseup="HSRPAuthDate_OnMouseUp()" align="left">
