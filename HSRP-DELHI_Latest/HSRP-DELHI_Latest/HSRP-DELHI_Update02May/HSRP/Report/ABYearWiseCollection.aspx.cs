...
{
    public partial class ABYearWiseCollection : System.Web.UI.Page
    {
        int UserType1;
        ...
        protected void DropDownListStateName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                string strYearQuery = "Select distinct datename(year,hsrprecord_creationdate) as year from hsrprecords where hsrp_stateid='" + ddlState.SelectedValue + "' order by year";
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet)
        {
            try
            {
                ...
                cmd = new SqlCommand("[ABReport_LocationAndMonthWiseCollection]", con);
