...
{
    public partial class TGCashSummary : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            ...
            //string strcashdate = fromdate + "00:00:00";
            //string strcashdateto = fromdate + "23:59:59";
            //string date = strcashdate + strcashdateto;
           // ToDate = HSRPAuthDate.SelectedDate.ToString("yyyy/MM/dd 23:59:59");
            ToDate = OrderDate.SelectedDate.ToString("yyyy/MM/dd 23:59:59");

            strsqlgonew = "select convert(varchar(15),HSRPRecord_CreationDate,103) as Date, HSRPRecord_AuthorizationNo,VehicleRegNo,OwnerName,EngineNo,ChassisNo,TotalAmount,Remarks from hsrprecords where hsrp_stateid=11 and hsrprecord_creationdate between '" + fromdate + "' and '" + ToDate + "' order by HSRPRecord_AuthorizationNo";
        ...
        private void ExportToPDF()
        {
            ...
            string filename = "TG_Cash_Summary" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".pdf";
            string SQLString = String.Empty;
           ...
           // document.SetPageSize(iTextSharp.text.PageSize.A4.Rotate());
            ...
            var colWidthPercentages = new[] {30f,  80f, 50f, 90f, 80f, 90f, 50f, 50f};
            table.SetWidths(colWidthPercentages);
            //string sqlquery="select distrelation from rtolocation where rtolocationid='"+
            string SqlQuery = string.Empty;


            SqlQuery = "select convert(varchar(15),HSRPRecord_CreationDate,103) as Date,HSRPRecord_AuthorizationNo,VehicleRegNo,OwnerName,EngineNo,ChassisNo,TotalAmount,Remarks from hsrprecords where hsrp_stateid=11 and hsrprecord_creationdate between '" + FromDate + "' and '" + ToDate + "' order by HSRPRecord_AuthorizationNo";
            ...
            table.LockedWidth = true;
              GenerateCell(table, 8, 0, 0, 0, 0, 1, 0, "TG Cash Summary", 20, 0);
           ...
           // GenerateCell(table, 16, 0, 0, 0, 0, 0, 0, "State Name : HIMACHAL PRADESH                 " + "RTO Location Name:" + DropDownListStateName.SelectedItem.ToString(), 20, 0);
            GenerateCell(table, 8, 0, 0, 0, 0, 0, 0, "Date :" + OrderDate.SelectedDate.ToString("dd-MM-yyyy"), 20, 0);
           ...
           // GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Date", 20, 0);
            ...
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Reg No", 20, 0);
