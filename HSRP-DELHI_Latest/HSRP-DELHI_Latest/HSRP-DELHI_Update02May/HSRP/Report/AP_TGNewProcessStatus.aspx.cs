...
{
    public partial class AP_TGNewProcessStatus : System.Web.UI.Page
    {
        ...
        public void getreport()
        {
            ...
            strsqlgonew = "select District,rtolocationname as Location,count(*) as APCollectionWithoutVehicleNo, sum(roundoff_netamount) as Amount from hsrprecords a,RTOLocation b where a.rtolocationid=b.rtolocationid and  a.HSRP_StateID in (9) and hsrprecord_creationdate between '" + date + "' and '" + date1 + "' group by District,rtolocationname order by 1,3 desc";
        ...
        public void Gettotalorder()
        {
            ...
            strsqlgonew = "select count(*) as TotalOrders,sum(roundoff_netamount) as TotalAmount from hsrprecords a,RTOLocation b  where a.rtolocationid=b.rtolocationid and a.hsrp_stateid in (9,11)  and hsrprecord_creationdate between '" + date + "' and '" + date1 + "'";
