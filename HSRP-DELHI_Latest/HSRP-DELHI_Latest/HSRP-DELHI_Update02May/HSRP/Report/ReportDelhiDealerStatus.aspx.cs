...
{
    public partial class ReportDelhiDealerStatus : System.Web.UI.Page
{
    int UserType1;
    ...
    private void Export()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("[Report_Delhi_Dealer_Status]", con);
           ...
           // cmd.Parameters.Add(new SqlParameter("@addrecordby", ddlBothDealerHHT.SelectedItem.Text));
            ...
            row.Cells.Add(new WorksheetCell("Report :", "HeaderStyle3"));
                ...
                row.Cells.Add(new WorksheetCell("Dealer Report", "HeaderStyle3"));
