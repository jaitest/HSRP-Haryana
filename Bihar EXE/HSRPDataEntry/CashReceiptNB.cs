...
namespace HSRPDataEntry
{
    public partial class CashReceiptNB : Form
    {
        ...
        public void pd_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            string GSTIN = dt1.Rows[0]["GSTIN"].ToString(), TIME = System.DateTime.Now.ToString("HH:MM");
            ...
            DataTable GSTDetail = objHSRP.GetGSTDetail(txtVehRegNo.Text.Trim().ToString());
            ...
            e.Graphics.DrawString("Receipt No : " + CashReceiptNo, font3, solidBrush, pointF3, stringFormat);
            ...
            e.Graphics.DrawString("GSTIN: " + GSTIN, font3, solidBrush, pointF5, stringFormat);
            ...
            PointF pointF193 = new PointF(70, 300);   // left side
            PointF pointF194 = new PointF(500, 300);   // right side
            e.Graphics.DrawString("DESCRIPTION OF GOODS ", font3, solidBrush, pointF193, stringFormat);
            e.Graphics.DrawString("HSRP (HSN8310) ", font3, solidBrush, pointF194, stringFormat);
            ...
            e.Graphics.DrawString("HSRP Fee (RS.) ", font3, solidBrush, pointF28, stringFormat);
            e.Graphics.DrawString(GSTDetail.Rows[0]["gstbasicamount"].ToString(), font3, solidBrush, pointF29, stringFormat);
          

            PointF pointF88 = new PointF(70, 360);   // left side
            PointF pointF89 = new PointF(500, 360);   // right side
            e.Graphics.DrawString("CGST @"+Convert.ToInt32(Convert.ToDecimal( GSTDetail.Rows[0]["CGSTPer"].ToString()))+"%", font3, solidBrush, pointF88, stringFormat);
            e.Graphics.DrawString( GSTDetail.Rows[0]["CGSTAmount"].ToString(), font3, solidBrush, pointF89, stringFormat);



            PointF pointF98 = new PointF(70, 360);   // left side
            PointF pointF99 = new PointF(500, 360);   // right side
            e.Graphics.DrawString("SGST @"+Convert.ToInt32( Convert.ToDecimal( GSTDetail.Rows[0]["SGSTPer"].ToString()))+"%" , font3, solidBrush, pointF98, stringFormat);
            e.Graphics.DrawString(GSTDetail.Rows[0]["SGSTAmount"].ToString(), font3, solidBrush, pointF99, stringFormat);
            ...
            e.Graphics.DrawString("TOTAL AMOUNT(ROUND OFF)", font3, solidBrush, pointF30, stringFormat);
            ...
            e.Graphics.DrawString("Receipt No : " + CashReceiptNo, font3, solidBrush, pointF41, stringFormat);
            ...
            e.Graphics.DrawString("GSTIN : " + GSTIN, font3, solidBrush, pointF43, stringFormat);
            ...
            PointF pointF1933 = new PointF(70, 300);   // left side
            PointF pointF1943= new PointF(500, 300);   // right side
            e.Graphics.DrawString("DESCRIPTION OF GOODS ", font3, solidBrush, pointF1933, stringFormat);
            e.Graphics.DrawString("HSRP (HSN8310) ", font3, solidBrush, pointF1943, stringFormat);
            ...
            e.Graphics.DrawString("HSRP Fee (RS.)", font3, solidBrush, pointF66, stringFormat);
            e.Graphics.DrawString(GSTDetail.Rows[0]["gstbasicamount"].ToString(), font3, solidBrush, pointF67, stringFormat);


            PointF pointF100 = new PointF(70, 870);   // left side
            PointF pointF101 = new PointF(500, 870);   // right side
            e.Graphics.DrawString("CGST @" + Convert.ToInt32(Convert.ToDecimal(GSTDetail.Rows[0]["CGSTPer"].ToString())) + "%", font3, solidBrush, pointF100, stringFormat);
            e.Graphics.DrawString(GSTDetail.Rows[0]["CGSTAmount"].ToString(), font3, solidBrush, pointF101, stringFormat);


            PointF pointF102 = new PointF(70, 870);   // left side
            PointF pointF103 = new PointF(500, 870);   // right side
            e.Graphics.DrawString("SGST @" + Convert.ToInt32(Convert.ToDecimal( GSTDetail.Rows[0]["SGSTPer"].ToString())) + "%", font3, solidBrush, pointF66, stringFormat);
            e.Graphics.DrawString(GSTDetail.Rows[0]["SGSTAmount"].ToString(), font3, solidBrush, pointF67, stringFormat);
        ...
        private void PrintDocument()
        {
            ...
            p.PrintPage += delegate(object sender1, PrintPageEventArgs ee)
            {
                ...
                ee.Graphics.DrawString(CompanyName, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 20, 950, 950));
                ...
                ee.Graphics.DrawString("GSTIN         :  " + dt1.Rows[0]["GSTIN"].ToString(), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 100, 300, 300));
                ee.Graphics.DrawString("Authorization No :  " + txtAuthorizationNo.Text, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 120, 300, 300));
                ee.Graphics.DrawString("Vehicle Reg No   :  " + txtVehRegNo.Text, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 140, 300, 300));
                ee.Graphics.DrawString("Owner Name       :  " + txtOwnerName.Text, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 160, 300, 300));
                ee.Graphics.DrawString("Mobile No          :  " + txtMobileNo.Text, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 180, 300, 300));
                ee.Graphics.DrawString("Vehicle Class      :  " + ddlVehicleClass.Text, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 200, 300, 300));
                ee.Graphics.DrawString("DESCRIPTION OF GOODS :  " +"HSRP(HSN8310)", new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 220, 300, 300));
                ee.Graphics.DrawString("Vehicle Type      :  " + ddlVehType.Text, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 240, 300, 300));
                ee.Graphics.DrawString("Order Type         :  " + DDLOrderType.Text, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 260, 300, 300));
                ee.Graphics.DrawString("HSRP Fee(RS.)               :" + GSTDetail.Rows[0]["gstbasicamount"].ToString(), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 280, 300, 100));
                ee.Graphics.DrawString("CGST" + "@" + Convert.ToInt32(Convert.ToDecimal(  GSTDetail.Rows[0]["CGSTPer"].ToString())) + "%" + "                :  " + GSTDetail.Rows[0]["CGSTAmount"].ToString(), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 300, 300, 300));
                ee.Graphics.DrawString("SGST" + "@" + Convert.ToInt32(Convert.ToDecimal( GSTDetail.Rows[0]["SGSTPer"].ToString())) + "%" + "                :  " + GSTDetail.Rows[0]["SGSTAmount"].ToString(), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 320, 300, 300));
                ee.Graphics.DrawString("Total Amount (ROUND OFF)  :  " + System.Math.Round(Convert.ToDecimal(txtAmount.Text), 0), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 340, 300, 300));
                ee.Graphics.DrawString("Disclaimer : ", new Font("Times New Roman", 9), new SolidBrush(Color.Black), new Rectangle(0, 360, 300, 300));
                ee.Graphics.DrawString("For Affixation Kindly visit :-" + clsINI.strAffexaddress, new Font("Times New Roman", 8), new SolidBrush(Color.Black), new Rectangle(0, 380, 300, 300));
                ...
                ee.Graphics.DrawString("Vehicle Owner is requested to please check the Correctness of the cash slip. The company shall not be responsible for any clerical mistake what so ever.", new Font("Times New Roman", 8), new SolidBrush(Color.Black), new Rectangle(0, 450, 300, 300));
                ee.Graphics.DrawString("For Any Query,complaint and suggestion and tracking Your Vehicle Please Visit www.hsrpbr.com", new Font("Times New Roman", 8), new SolidBrush(Color.Black), new Rectangle(0, 500, 210, 300));
                ee.Graphics.DrawString(Login.username, new Font("Times New Roman", 8), new SolidBrush(Color.Black), new Rectangle(0, 530, 300, 300));

                ee.Graphics.DrawString(".", new Font("Times New Roman", 5), new SolidBrush(Color.Black), new Rectangle(0, 550, 300, 300));
