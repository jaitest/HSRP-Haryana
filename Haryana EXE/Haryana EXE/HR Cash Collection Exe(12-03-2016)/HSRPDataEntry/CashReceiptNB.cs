    ...
    public partial class CashReceiptNB : Form
    {
        ...
        private void btnAuthGO_Click(object sender, EventArgs e)
        {
            ...
            if (i == true)
            {
                ...
                if (utils.RtoLocationId == "520" || utils.RtoLocationId == "522")
                { 
                    DateTime dateTimePicker1 = Convert.ToDateTime("2017/02/23");
                    DateTime srtdate = Convert.ToDateTime(dt1.Rows[0]["Hsrprecord_Creationdate"].ToString());

                    DateTime fromdate = DateTime.Parse(Convert.ToDateTime(dateTimePicker1).ToString());
                    DateTime todate = DateTime.Parse(Convert.ToDateTime(srtdate).ToString());

                    if (dateTimePicker1 <= srtdate)
                    {
                        MessageBox.Show("You are not authorized to collect your cash.");
                ...
                if (utils.RtoLocationId == "483" || utils.RtoLocationId == "484" || utils.RtoLocationId == "485")
                {
                    DateTime dateTimePicker1 = Convert.ToDateTime("2017/04/10");
                    DateTime srtdate = Convert.ToDateTime(dt1.Rows[0]["Hsrprecord_Creationdate"].ToString());
                ...
                if (utils.RtoLocationId == "529" || utils.RtoLocationId == "531")
                {
                    DateTime dateTimePicker1 = Convert.ToDateTime("2017/04/10");
                    DateTime srtdate = Convert.ToDateTime(dt1.Rows[0]["Hsrprecord_Creationdate"].ToString());
