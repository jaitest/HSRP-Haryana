...
{
    public partial class CashReceiptOB : Form
    {
        ...
        public CashReceiptOB(String strUserId)
        {
            CreatedBy = strUserId;
            InitializeComponent();
            ...
            //if (objHSRP.ACTextBoxValidation("4", CreatedBy) != "")
            //{
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (i == true)
            {
                ...
                //    {
                //        string msg;
                //        msg = objHSRP.ACandAmountValidation(textBox1.Text, CreatedBy, "4");
                //        if (msg == "AC No. Invalid.")
                //        {
                //            MessageBox.Show("AC No. Invalid.");
                //            return;
                //        }
                //        else if (msg == "Please Contact With Administrator.")
                //        {
                //            MessageBox.Show("Please Contact With Administrator.");
                //            return;
                //        }
                //        else if (msg == "WebDirect")
                //        {
                //            Addrecordby = "WebDirect";
                //            CounterNo = textBox1.Text;
                //        }
                //    }
                //    else
                //    {
                //        MessageBox.Show("Required AC No.");
                //        return;
                //    }
                //} 
                ...
                else
                {
                    ...
                    if (save1[0].ToString() == "Record Saved")
                    {
                        ...
                        //Query = "select * from OrderStatusTable where Regno='" + txtVehRegNo.Text + "'";
                        //DataTable dtCheckRecord=utils.GetDataTable(Query, StrConnLocalApp);
                        //if (dtCheckRecord.Rows.Count == 0)
                        //{
                        //    #region Inserting Data into OrderStatusTable
                        //    Query = "INSERT INTO [OrderStatusTable] ([Auth_no],[regno],[OrderStatus],[OrderPushDateTime],[RTO_CD],isRecordSentToServer)" +
                        //          "values" +
                        //          "('" + txtAuthorizationNo.Text + "','" + txtVehRegNo.Text + "','New Order',getdate(),'" + RTO_CD + "','Y')";
                        ...
                        #region Commented Code
                        //Query = "Update [OrderStatusTable] set [OrderPushDateTime]=getdate(),[isRecordSentToServer]='Y' where [Auth_no] ='" + txtAuthorizationNo.Text + "'";
                        //utils.ExecNonQuery(Query, StrConnLocalApp);
        ...
        {
            startDate = Convert.ToString(RegistrationDate.Value);
