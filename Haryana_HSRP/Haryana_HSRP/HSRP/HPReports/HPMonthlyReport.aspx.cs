...
namespace HSRP.HPReports
{
    public partial class HRMonthlyReport : System.Web.UI.Page
    {
        ...
        private void FilldropDownListOrganization()
        {
            if (UserType.Equals(0))
            {
                SQLString = "Select [RTOLocationID],[RTOLocationName] from RTOLocation  where [HSRP_StateID]=3 and RTOLocationID in (select distRelation from RTOLocation where [HSRP_StateID]=3)  order by [RTOLocationName]";
                Utils.PopulateDropDownList(ddlRTOLocation, SQLString.ToString(), CnnString, "--Select State--");
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int.TryParse(ddlRTOLocation.SelectedValue, out intHSRPStateID);
                ...
                string filename = ddlRTOLocation.SelectedItem.ToString()+"    Schedule-F-Monthly_Report_From_Concessionaire_to_Registering_Authority_" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                row = sheet.Table.Rows.Add();
                //  Skip one row, and add some text7
                row.Index = 6;
                row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                row.Cells.Add(new WorksheetCell("RTO LocationName:", "HeaderStyle2"));
                row.Cells.Add(new WorksheetCell(ddlRTOLocation.SelectedItem.ToString(), "HeaderStyle2"));
                ...
                SQLString = "SELECT   a.Address1,a.OrderType ,a.ManufacturerName, convert(varchar,a.OrderDate,110)as OrderDate ,convert(varchar,a.OrderClosedDate,110)as OrderClosedDate,convert(varchar,a.HSRPRecord_AuthorizationDate,110)as HSRPRecord_AuthorizationDate, b.ProductColor, a.HSRPRecord_AuthorizationNo, convert(varchar,a.OrderEmbossingDate,110)as OrderEmbossingDate, a.HSRPRecordID, a.OwnerName, a.VehicleType, a.HSRP_Front_LaserCode,Product_1.ProductColor,a.HSRP_Rear_LaserCode, a.VehicleClass, a.StickerMandatory, Product_1.ProductCode AS FrontPlateSize, a.RearPlateSize, b.ProductCode AS RearPlateSize1,a.FrontPlateSize AS FrontPlateSize, a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '3' AND a.RTOLocationID='"+ddlRTOLocation.SelectedValue.ToString()+"' and a.OrderClosedDate  between '" + FromDate + "' and '" + ToDate + "'";
