...
{
    public partial class CollectionSummaryForTG : System.Web.UI.Page
{
    int UserType1;
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            //GenerateCell(table, 10, 1, 1, 1, 1, 1, 0, "State-AP", 30, 0);
            //GenerateCell(table, 10, 1, 1, 0, 1, 1, 0, "Collection Summary Report", 30, 0);
            ...
            GenerateCell(table, 10, 1, 1, 0, 1, 1, 0, "Collection Summary Report " + period, 30, 0);
