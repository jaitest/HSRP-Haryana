<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RtoEmbossingCenterWiseEmbossingStatusDealer.aspx.cs" Inherits="HSRP.BusinessReports.RtoEmbossingCenterWiseEmbossingStatusDealer" %>
...
<script type="text/javascript">
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Rto Embossing Center Wise Embossing Report</span>
                                    </td>
            ...
            <td style="height: 40px;" width="80">               
             ...
             <td style="width: 10px; height: 20px;">               
                    ...
                    <asp:Label ID="label3" runat="server" Font-Bold="True" ForeColor="Black" 
                        Text="Embossing Center:" Width="100px" />
             ...
             <td style="height: 40px;" width="80">               
                    ...
                    <asp:DropDownList ID="dropDownListClient" Height="20px" Width="187px" 
                                                ...
                                                <td style="height: 20px" width="10"> <asp:Label Text="From:" runat="server" 
                                                        ID="labelDate" Font-Bold="True" 
                                                        ForeColor="Black" Width="40px" /> </td>
    ...
    ControlType="Picker" PickerCssClass="picker" Height="22px" Width="79px">
                                                ...
                                                <td style="height: 40px" width="30">
                                                    <%--<asp:Button ID="btnexport" runat="server" onclick="btnexport_Click" Text="PIP VS ASSIGNMENT"  Visibl="false"                                                        Font-Bold="True" ForeColor="#3333FF"/>--%>
                                                </td>

               <td style="height: 40px" width="30">
                                                    <asp:Button ID="btnassign" runat="server"  Text="Embossing Center Wise Report" 
