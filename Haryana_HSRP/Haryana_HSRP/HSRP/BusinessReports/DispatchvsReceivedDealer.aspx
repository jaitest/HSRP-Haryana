<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DispatchvsReceivedDealer.aspx.cs" Inherits="HSRP.BusinessReports.DispatchvsReceivedDealer" %>
...
<script type="text/javascript">
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Dispatch VS Received</span>
                                    </td>
    ...
    <table style="height: 51px; width: 92%;">
        <tr>
    ...
    ControlType="Picker" PickerCssClass="picker" Height="22px" Width="79px">
                                                ...
                                                <td style="height: 40px" width="30">
                                                    <asp:Button ID="btnexport" runat="server" onclick="btnexport_Click" Text="DispatchVSReceived" 
                                               ...
                                               <td style="height: 40px" width="30">
                                                    <asp:Button ID="btnproctiondispatch" runat="server"  Text="DispatchVSReceived(Summary)"  Visible="true"
                                                        Font-Bold="True" ForeColor="#3333FF" Height="21px" Width="212px" OnClick="btnproctiondispatch_Click"/>
                                                </td>
                                              
                                                 <td>
                                                    <asp:Button ID="btnnDetails" runat="server"  Text="DispatchVSReceived(Detail)"  Visible="true"
                                                        Font-Bold="True" ForeColor="#3333FF" Height="21px" Width="212px" OnClick="btnnDetails_Click"/>
                                                </td>
                 ...
                 <Columns>
                                ...
                                <%--     <asp:BoundField HeaderText="Embossing Center" DataField="Embossing Center" />
                                      ...
                                      <%--<asp:TemplateField HeaderText="RTOLocation" HeaderStyle-ForeColor="Blue">
                                       ...
                                       <asp:TemplateField HeaderText="TodayDispatch" HeaderStyle-ForeColor="Blue">
                                            <ItemTemplate>
                                               <asp:Label ID="lblToDayProd" runat="server" Text=<%#Eval("TodayDispatch")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                           <asp:TemplateField HeaderText="TodayReceived" HeaderStyle-ForeColor="Blue">
                                            <ItemTemplate>
                                               <asp:Label ID="lblTodayDispatch" runat="server" Text=<%#Eval("TodayReceived")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
                                       <asp:TemplateField HeaderText="PendingforReceiving" HeaderStyle-ForeColor="Blue">
                                            <ItemTemplate>
                 ...
                 <Columns>
                                ...
                                <%--     <asp:BoundField HeaderText="Embossing Center" DataField="Embossing Center" />
                                                    ...
                                                    <asp:BoundField HeaderText="Day3" DataField="Day3" />
                                                     <asp:BoundField HeaderText="Day4" DataField="Day4" />--%>
                                                   <%-- <asp:BoundField HeaderText="Day5orMore" DataField="Day5 or More" />--%>
                                       <asp:TemplateField HeaderText="Zone" HeaderStyle-ForeColor="Blue">
                                            <ItemTemplate>
                                               <asp:Label ID="lblzonalmanager" runat="server" Text=<%#Eval("Zone")%>></asp:Label>
                                        </ItemTemplate>
                                         </asp:TemplateField>
