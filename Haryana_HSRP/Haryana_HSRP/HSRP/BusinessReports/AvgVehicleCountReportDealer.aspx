<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AvgVehicleCountReportDealer.aspx.cs" Inherits="HSRP.BusinessReports.AvgVehicleCountReportDealer" %>
...
<script type="text/javascript">
    ...
    <table style="width: 78%; height: 51px;">
        <tr>
            ...
            <td style="height: 59px; width: 10px;">
                </td>
            ...
            <td valign="middle" class="Label_user_batch" nowrap="nowrap" 
                            style="width: 7px; height: 59px;">
                                                ...
                                                <td>
                <asp:Label Text="Order Type" 
                                runat="server" ID="labelClient0" ForeColor="Black" 
                    Font-Bold="True" />
            </td>
            <td>
                ...
                <asp:DropDownList ID="ddlOrderType" runat="server">
                    ...
                    <asp:ListItem>Affixation</asp:ListItem>
                </asp:DropDownList>
                       ...
                       BorderColor="#99FF99" SearchOnKeyPress="true" ShowSearchBox="true"
                                            ...
                                            <Levels>
                                             ...
                                             <ComponentArt:GridColumn DataCellCssClass="maintext" DataField="MONTHNAME" HeadingText="MONTH"
                                                SortedDataCellCssClass="SortedDataCell" IsSearchable="True" />
                                                <ComponentArt:GridColumn DataCellCssClass="maintext" DataField="Vehicletype" HeadingText="Vehicletype"
                                                SortedDataCellCssClass="SortedDataCell" IsSearchable="True" />
                                                <ComponentArt:GridColumn DataCellCssClass="maintext" DataField="VehicleClass" HeadingText="VehicleClass"
                                                SortedDataCellCssClass="SortedDataCell" IsSearchable="True" />
