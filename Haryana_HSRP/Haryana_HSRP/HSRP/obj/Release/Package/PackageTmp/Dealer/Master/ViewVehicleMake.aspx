<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="ViewVehicleMake.aspx.cs" Inherits="HSRP.Dealer.Master.ViewVehicleMake" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function editpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "VehicleMake.aspx?Mode=Edit&VehicleMakeID=" + i, "Update Product Details", "width=950px,height=300px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location.href = "ViewVehicleMake.aspx";
                return true;
            }
        }
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "VehicleMake.aspx?Mode=New", "Add New Vehicle Make", "width=950px,height=300px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location = 'ViewVehicleMake.aspx';
                return true;
            }
        }
    </script>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        <span class="headingmain">View Vehicle Make </span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New Hub" class="button">Add New Product</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ComponentArt:Grid ID="Grid1" RTOLocationIDMode="AutoID" runat="server" ImagesBaseUrl="~/images"
                                            ...
                                            PagerTextCssClass="GridFooterText" PageSize="20" GroupByTextCssClass="GroupByText"
                                    ...
                                    <Levels>
                                                <ComponentArt:GridLevel DataKeyField="VehicleMakerID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    SortImageHeight="19">
                                                    <Columns>
                                                        <ComponentArt:GridColumn DataField="VehicleMakerID" Visible="False" />
                                                        <ComponentArt:GridColumn DataField="VehicleMakerDescription" HeadingText="Vehicle Make" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" /> 
                                            ...
                                            <ClientTemplates>
                                                 <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:editpage(## DataItem.GetMember('VehicleMakerID').Value ##);">
