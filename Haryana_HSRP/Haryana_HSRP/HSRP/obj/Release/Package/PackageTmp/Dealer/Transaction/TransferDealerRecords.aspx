<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TransferDealerRecords.aspx.cs" Inherits="HSRP.Dealer.Transaction.TransferDealerRecords" %>
                    ...
                    <tr>
                        <td height="27" style="background-image: url(../images/midtablebg.jpg)">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Dealer Chalan </span>
                                    </td>
                ...
                <table width="99%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                    ...
                    <tr>
                        ...
                        <td align="center" style="padding-top: 10px">
                            ...
                            <asp:Button ID="Button1" runat="server" Text="Test" CssClass="button" OnClick="Button1_Click" />
                        </td>
                    </tr>
                </table>
            </td>
