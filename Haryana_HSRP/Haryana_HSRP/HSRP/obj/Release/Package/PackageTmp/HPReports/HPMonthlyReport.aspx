<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HPMonthlyReport.aspx.cs" Inherits="HSRP.HPReports.HRMonthlyReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("<%=ddlRTOLocation.ClientID%>").value == "--Select State--") {
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">HP : Monthly Report From Concessionaire to Registering Authority</span>
                                    </td>
