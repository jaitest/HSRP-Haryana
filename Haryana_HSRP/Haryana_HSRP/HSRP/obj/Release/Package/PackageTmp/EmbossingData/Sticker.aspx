<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Sticker.aspx.cs" Inherits="HSRP.EmbossingData.Sticker1" %>
                            ...
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                     ...
                                     <td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:Button ID="btntest" Width="58px" runat="server" Visible="false" Text="test" ToolTip="Please Click for Report" BackColor="Orange" ForeColor="#000000"
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <%-- <asp:DropDownList Visible="true" ID="ddlBothDealerHHT" CausesValidation="false" Width="140px"
                                        ...
                                        <asp:DropDownList Visible="false" ID="ddlBothDealerHHT"  
                                            CausesValidation="false" Width="140px"
                                         DataTextField="NAME OF THE DEALER" DataValueField="NAME OF THE DEALER"  
                                            AutoPostBack="true" runat="server" 
                                            onselectedindexchanged="ddlBothDealerHHT_SelectedIndexChanged">  
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
