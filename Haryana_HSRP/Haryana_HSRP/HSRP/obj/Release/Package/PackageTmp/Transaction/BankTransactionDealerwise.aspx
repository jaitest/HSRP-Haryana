<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BankTransactionDealerwise.aspx.cs" Inherits="HSRP.Transaction.BankTransactionDealerwise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <script type="text/javascript">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            if (document.getElementById("<%=DropDownListDealer.ClientID%>").value == "--Select Dealer Name---") {
                alert("Please Select Dealer Name. ");
                document.getElementById("<%=DropDownListDealer.ClientID%>").focus();
                return false;
            }
...
<body>
    ...
    <div style=" width:100%;">
        <fieldset>
            <legend>
                <div style="margin-left: 10px; font-size: medium; color: Black"> Bank Deposit</div>
            </legend>
            <br />
            <br />
            ...
            <table  border="0" align="right"  style="height: 348px; width:85%;">
                ...
                <tr>
                     ...
                     <td>
                           ...
                           <asp:DropDownList ID="DropDownListDealer" runat="server" 
                            Style="margin-left: 8px" TabIndex="3" Width="165px" AutoPostBack="false" >                           
               ...
               <tr>                  
                    ...
                    <td>
                        <table id="Table1" runat="server" style="margin-left: 8px;" align="left" cellspacing="0"
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                   <%-- <img id="calendar_from_button" TabIndex="1" alt="" onclick="DepositDate_OnClick()"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxDepositAmount" class="form_textbox12" runat="server"  onkeypress="return isNumberKey(event)" MaxLength="30" TabIndex="2"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style4">
                 ...
                 <tr>
                    <td class="style4"> Payment Mode <span class="alert">* </span>
                    </td>
                    <td> 
                  
                          <asp:DropDownList ID="DdltransactionMode" runat="server"  Style="margin-left: 8px" TabIndex="3" Width="165px" AutoPostBack="false">  </asp:DropDownList>
                ...
                <tr>
                  ...
                  <asp:TextBox ID="txtChecqNo" runat="server" class="form_textbox12" MaxLength="30" TabIndex="5" ></asp:TextBox>
