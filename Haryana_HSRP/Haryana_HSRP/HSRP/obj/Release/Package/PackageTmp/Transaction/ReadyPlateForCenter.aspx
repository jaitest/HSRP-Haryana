    ...
    <script language="javascript" type="text/javascript">
        ...
        function validate() {
            if (document.getElementById("<%=txtVehicleRegNo.ClientID%>").value) {
                ...
                document.getEleme
                ntById("<%=txtVehicleRegNo.ClientID%>").focus();
                return false;
            }
    ...
    <table style="background-color:White; height:223px"  width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
       ...
       <tr>
                ...
                <tr>
                   ...
                   <tr>
                        <td class="form_text_View" style="padding-bottom: 10px"> <font color="black" size="3px">
                            Rear Plate&nbsp; : <span class="alert">* </span></font>  </td>
                        <td></td>
                        <td>
                       ...
                       <tr>
                        ...
                        <td></td>
                        <td>
                        <asp:TextBox class="form_textbox11"   TabIndex="1" Width="150" textmode="MultiLine" ID="txtRemarks" 
                                runat="server"></asp:TextBox>
