<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="InventoryPurchaseOrder.aspx.cs" Inherits="HSRP.Transaction.InventoryPurchaseOrder" %>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="textboxQuantity" runat="server" class="form_textbox" 
                    MaxLength="6" onkeypress="return isNumberKey(event)" TabIndex="5"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="form_text" style="padding-bottom: 10px">
