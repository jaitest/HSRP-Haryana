<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="SingleSticker.aspx.cs" Inherits="HSRP.Master.SingleSticker" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td >
                                    <asp:Label ID="lblmes" CssClass="headingmain" runat="server">Download Sticker</asp:Label> 
                                   ...
                                   <td valign="middle" class="form_text" nowrap="nowrap"> <asp:Label Text="Order Status" Visible="true" runat="server" ID="labelOrderStatus" />&nbsp;&nbsp; </td>
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:LinkButton ID="LinkbuttonSearch" runat="server" Text="GO" class="button"  OnClientClick=" return validate()"
                                            ...
                                            <asp:Button ID="btnExportToExcel"  Width="100px" Visible="false"  runat="server" Text="Report In Excel" ToolTip="Please Click for Report"
