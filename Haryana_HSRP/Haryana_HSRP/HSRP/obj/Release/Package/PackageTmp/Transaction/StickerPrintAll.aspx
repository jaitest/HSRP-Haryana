<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="StickerPrintAll.aspx.cs" Inherits="HSRP.Master.StickerPrintAll" %>
                        ...
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                   ...
                                   <td valign="middle" class="form_text" nowrap="nowrap"> <asp:Label Text="Printer Typer"  runat="server" ID="labelOrderStatus" />&nbsp;&nbsp; </td>
                                    <td> <asp:DropDownList AutoPostBack="false" 
                                            ID="dropDownListorderStatus" CausesValidation="false" runat="server"  >
                                        <asp:ListItem>-- Select Printer --</asp:ListItem>
                                        <asp:ListItem  Value="TVS Printer"  >TVS Printer</asp:ListItem> 
                                        <asp:ListItem  Value="Zebra Printer"  >Zebra Printer</asp:ListItem> 
                                                </asp:DropDownList>&nbsp; </td>
