<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="UploadDealerDataDamageBoth.aspx.cs" Inherits="HSRP.Transaction.UploadDealerDataDamageBoth" %>
...
7. Price Column should contain only number. (Eg.1000).</span>
                         ...
                         <td colspan="2">
                                <span nowrap="nowrap" style="color: Maroon; font: verdana arial 12px;">
8.     After uploading SYNC ON SERVER is compulsory.<br /><br />
                                9. Duplicate Records :<asp:TextBox runat="server" id="txtDuplicateRecords"></asp:TextBox></span>
                                <br />
                             <br />
                             <span nowrap="nowrap" style="color: Maroon; font: verdana arial 12px;">
                              10. Block Records : &nbsp;&nbsp;<asp:TextBox runat="server" id="txtblockrecords"></asp:TextBox></span>
                                <br />
