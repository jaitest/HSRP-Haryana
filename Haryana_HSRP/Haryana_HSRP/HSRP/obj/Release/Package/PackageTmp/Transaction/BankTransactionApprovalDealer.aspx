<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankTransactionApprovalDealer.aspx.cs"
    Inherits="HSRP.Master.BankTransactionApprovalDealer" %>
             ...
             <tr>
                  <td nowrap="nowrap" align="right"  >
                                             ...
                                             <asp:Button ID="btnApproval" runat="server" TabIndex="10" class="button" Visible="true"
                                                                 Text="Approved"  OnClientClick="return validate()" OnClick="btnApproval_Click" Height="26px" 
                                                                 />
