<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewVendorRegistration.aspx.cs" Inherits="HSRP.Master.ViewVendorRegistration" %>
...
<script type="text/javascript">
 function edit(i) { // Define This function of Send Assign Laser ID 
     ...
     googlewin = dhtmlwindow.open("googlebox", "iframe", "VendorRegistration.aspx?Mode=Edit&VendorID=" + i, "Update Vendor Registration", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
        googlewin.onclose = function () {
            window.location.href = "ViewVendorRegistration.aspx";
            return true;
        }
    }
    ...
    function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
        ...
        googlewin = dhtmlwindow.open("googlebox", "iframe", "VendorRegistration.aspx?Mode=New", "Add New Vendor Registration", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
        googlewin.onclose = function () {
            window.location = 'ViewVendorRegistration.aspx';
            return true;
        }
    }
    </script>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">View Vendor</span>
                                    </td>
                             ...
                             <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New HSRP State" class="button">Add New Vendor</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table width="99%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <ComponentArt:Grid ID="Grid1" VendorIDMode="VendorID" runat="server" ImagesBaseUrl="~/images" 
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel DataKeyField="VendorID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    SortImageHeight="19">
                                                    <Columns>
                                                       <ComponentArt:GridColumn DataField="VendorID" Visible="False" />
                                                        <ComponentArt:GridColumn DataField="Name" HeadingText="Vendor Name" SortedDataCellCssClass="SortedDataCell"
                                                            Width="120" />
                                                        <ComponentArt:GridColumn DataField="Address1" HeadingText="Address"
                                            ...
                                            <ClientTemplates>
                                                   ...
                                                   <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:edit(## DataItem.GetMember('VendorID').Value ##);">
                                                        Edit</a>
