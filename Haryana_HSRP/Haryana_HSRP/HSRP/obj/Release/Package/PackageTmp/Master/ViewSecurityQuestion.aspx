<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="ViewSecurityQuestion.aspx.cs" Inherits="HSRP.Master.ViewSecurityQuestion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function editpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            //  alert(i);
            googlewin = dhtmlwindow.open("googlebox", "iframe", "SecurityQuestion.aspx?Mode=Edit&QID=" + i, "Update Security Question", "width=950px,height=300px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location.href = "ViewSecurityQuestion.aspx";
                return true;
            }
        }
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "SecurityQuestion.aspx?Mode=New", "Add New Security Question", "width=950px,height=300px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location = 'ViewSecurityQuestion.aspx';
                return true;
            }
        }
    </script>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Security Question Master </span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    <%--<td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:Label Text="" Visible="false" runat="server" ID="labelOrganization" />
                                    </td>--%>
                                    <%--<td valign="middle">
                                    ...
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New Hub" class="button">Add New Security Question</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table width="99%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <tr>
                                        ...
                                        <%--<ComponentArt:Grid ID="Grid1" RTOLocationIDMode="AutoID" runat="server" ImagesBaseUrl="~/images"
                                                ...
                                                <ComponentArt:GridLevel DataKeyField="ProductID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <ComponentArt:GridColumn DataField="ProductCode" HeadingText="Product Code" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="ProductDimension" HeadingText="Product Dimension"
                                                        ...
                                                        <ComponentArt:GridColumn DataField="ProductColor" Visible="true" HeadingText="Product Color"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="ActiveStatus" HeadingText="ActiveStatus" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
                                            ...
                                            <ClientTemplates>
                                                <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:editpage(## DataItem.GetMember('ProductID').Value ##);">
                                    ...
                                    <Levels>
                                                <ComponentArt:GridLevel DataKeyField="QuestionID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    DataCellCssClass="DataCell" HeadingCellCssClass="HeadingCell" HeadingCellHoverCssClass="HeadingCellHover"
                                                    HeadingCellActiveCssClass="HeadingCellActive" HeadingRowCssClass="HeadingRow"
                                                    HeadingTextCssClass="HeadingCellText" SelectedRowCssClass="SelectedRow" GroupHeadingCssClass="GroupHeading"
                                                    SortAscendingImageUrl="asc.gif" SortDescendingImageUrl="desc.gif" SortImageWidth="10"
                                                    SortImageHeight="19">
                                                    <Columns>
                                                        <ComponentArt:GridColumn DataField="QuestionID" Visible="False" />
                                                        <ComponentArt:GridColumn DataField="QuestionText" HeadingText="Question Text" SortedDataCellCssClass="SortedDataCell" Width="100" />
                                                        <ComponentArt:GridColumn DataField="CreationDate" HeadingText="Create Date"
                                                            SortedDataCellCssClass="SortedDataCell" Width="100" /> 
                                                        <ComponentArt:GridColumn DataField="UpdationDate" HeadingText="Updation Date"
                                                            SortedDataCellCssClass="SortedDataCell" Width="100" /> 
                                            ...
                                            <ClientTemplates>
                                                 <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:editpage(## DataItem.GetMember('QuestionID').Value ##);">
                                                        Edit</a></ComponentArt:ClientTemplate>
