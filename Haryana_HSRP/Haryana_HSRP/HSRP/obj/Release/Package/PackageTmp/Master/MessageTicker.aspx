<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MessageTicker.aspx.cs" Inherits="HSRP.Master.MessageTicker" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function validate() { 
            ...
            if (document.getElementById("<%=textboxMessageTextURL.ClientID%>").value == "") {
                alert("Please Provide Message Text URL");
                document.getElementById("<%=textboxMessageTextURL.ClientID%>").focus();
                return false;
            }
...
<body>
    ...
    <fieldset>
        ...
        <tr>
            ...
            <tr>
                <td class="form_text" style="padding-bottom: 10px"> Message Text : <span class="alert">* </span></td>
