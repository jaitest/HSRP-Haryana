<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="LaserMonitor.aspx.cs" Inherits="HSRP.Report.LaserMonitor" %>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                              &nbsp;<span class="headingmain">Laser Monitor</span>&nbsp;</td>
                    </tr>
...
<%--                                    <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            hsrpstatename</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lbllocation" runat="server" Text='<%#Eval("hsrpstatename") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            LaserMonitor</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lbllocation" runat="server" Text='<%#Eval("LaserMonitor") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
...
<%--                                    <asp:TemplateField>
                                    ...
                                    <td style="width: 25%" align="center" style=" padding:10px" valign="top">
                                    <asp:Button ID="btnBeforeErp" runat="server" Text="LaserMonitorBeforeErp" 
                                            onclick="btnBeforeErp_Click"></asp:Button>
                                    </td>

                                   <td style="width: 25%" align="center" style=" padding:10px" valign="top">
                             <asp:Button ID="btnAfterErp" runat="server" Text="LaserMonitorAfterErp" 
                                           onclick="btnAfterErp_Click"></asp:Button>
                                    </td>
