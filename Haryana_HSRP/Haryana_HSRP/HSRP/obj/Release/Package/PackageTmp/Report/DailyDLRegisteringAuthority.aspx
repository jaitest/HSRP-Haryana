<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyDLRegisteringAuthority.aspx.cs" Inherits="HSRP.DLReports.DailyRegisteringAuthority" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">DL : Registering Authority Monthly Report </span>
                                    </td>
                                        ...
                                        <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                                ...
                                                <td valign="middle" class="form_text" nowrap="nowrap">
                                                    <asp:Label Text="RTO LOCATION:" runat="server" ID="lblRTOLocation" />
                                                </td>
                                                <td valign="middle">
                                                    <asp:DropDownList Visible="true"  ID="ddlRtolocation"
