...
<%--<script type="text/javascript">
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">&nbsp;Collection Report-Dealer/NonDealer</span>
                                    </td>
    ...
    <table style="width: 100%; height: 51px;">
        ...
        <tr>
             <td colspan="8"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="Label1" runat="server"  ForeColor="#CC3300" Font-Bold="true" Visible="False"></asp:Label>                                   </td>
