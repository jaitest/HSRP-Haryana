<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyRevenueCollectionVehCentreWise.aspx.cs" Inherits="HSRP.Report.DailyRevenueCollectionVehCentreWise" Title="Revenue Collection"%>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Daily Vehicle & Location - Wise Summary</span>
                                    </td>
                                ...
                                <td></td>
                                 <td valign="middle" class="form_text" nowrap="nowrap">
                                    ...
                                    <td valign="middle" class="form_text">
                                        ...
                                        <asp:Label Text="Select Date:" Visible="true" runat="server" ID="labelDate" /> 
                                        
                                    </td>
                                    <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; "
                                        ;> 
