<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="YearWiseCollection.aspx.cs" Inherits="HSRP.Report.YearWiseCollection" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Total Year Wise Collection</span>
                                    </td>
            ...
            <td style="height: 59px;">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:DropDownList ID="ddlYear" runat="server" CausesValidation="false" Height="22px" 
                           
                            Width="148px" DataTextField="years" DataValueField="years">
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
