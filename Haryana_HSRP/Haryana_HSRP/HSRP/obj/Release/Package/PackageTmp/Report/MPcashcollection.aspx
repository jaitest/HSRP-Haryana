<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MPcashcollection.aspx.cs" Inherits="HSRP.Report.MPcashcollection" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">&nbsp;MP Cash Collection Report</span>
                                    </td>
            ...
            <td style="height: 25px;" valign="middle" width="195">
                    ...
                    <img id="calendar_from_button"  alt="" onclick="OrderDatefrom_OnClick()"
                        ...
                        <asp:Button ID="btnexport" runat="server" Font-Bold="True" ForeColor="#3333FF" 
                            onclick="btnexport_Click" Text="Go" Width="70px" />
