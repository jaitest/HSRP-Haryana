<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComplainReportResolution.aspx.cs" Inherits="HSRP.Report.ComplainReportResolution" %>
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#Button2').click(function () {
                alert('sdsdfsd');
                //$('#googlebox').hide();
                //$('.dhtmlwindow').css('visibility', 'false');
                $("#googlebox").removeAttr("style")
            });
        });
     </script>--%>
    ...
    <div style="margin:auto;"  align="center">
        <fieldset>
            <legend>
                <div align="left" style="margin-left: 10px; font-size: medium; color: Black" >
                   Complaint Report Resolution</div>
            </legend>
            <br />
        ...
        <asp:Button ID="btnUpdate" runat="server" Text="Close"  Width="150px" 
                onclick="btnUpdate_Click"/>
            </td>
            <td>      
                <%--<input id="Button2" type="button" Width="150px" Text="Cancel" />                              --%>
            <asp:Button ID="Button2" runat="server" class="button" Width="150px" Text="Cancel"  onclientclick='window.close'/>

                <%-- <asp:Button ID="Button2" runat="server" class="button" Width="150px" Text="Cancel" OnClientClick="return CloseWin();"/>--%>
            </td>
