<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyVehicleCollection.aspx.cs" Inherits="HSRP.Report.DailyVehicleCollection" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Daily Vehicle Collection Report</span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                ...
                                <td></td>
                                 <td valign="middle" class="form_text" nowrap="nowrap">
                                    ...
                                    <td>
                                        <asp:CheckBox ID="CheckBoxStateName" Visible="false" runat="server" Text="Select For All State" />
                                    </td>
