<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VehicleWiseOrderstatusReport.aspx.cs" Inherits="HSRP.Report.VehicleWiseOrderstatusReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Vehicle Wise OrderStatus Report</span>
                                    </td>
                                            ...
                                            <tr>
                                                 ...
                                                 <td valign="middle" class="form_text">
                                                  <asp:UpdatePanel runat="server" ID="UpdateUser" UpdateMode="Conditional">
                                                   ...
                                                   <Triggers>
                                                        ...
                                                        <ContentTemplate>
                                                     <asp:Label Text="Order Type" runat="server" ID="lblOderType"  
                                                                AssociatedControlID = "dropDownListOrderType" />&nbsp;&nbsp;
                                                            <asp:DropDownList ID="dropDownListOrderType" Visible="True"
                                                                ...
                                                                <asp:ListItem>--Select Order Type--</asp:ListItem>
                                                                <asp:ListItem>New Order</asp:ListItem>
                                                                <asp:ListItem>Embossing Done</asp:ListItem>
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="Report In Excel" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="btnExportToExcel_Click" OnClientClick="javascript:return validate();" />
                                                </td>
                                                <tr>
                                                    <td colspan="9">
