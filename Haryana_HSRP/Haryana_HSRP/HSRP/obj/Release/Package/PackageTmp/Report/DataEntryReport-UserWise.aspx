<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DataEntryReport-UserWise.aspx.cs" Inherits="HSRP.Report.DataEntryReport_UserWise" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Report : Data Entry Report - Operator Wise  </span>
                                    </td>
                                        ...
                                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                                ...
                                                <td valign="middle" style=" width:200px">
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;
                                                    <asp:Label ID="lbllocation" runat="server" CssClass="Label_user" 
