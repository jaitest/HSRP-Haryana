<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyCountAllState.aspx.cs" Inherits="HSRP.DLReports.DailyCountAllState" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Daily Count</span>
                                    </td>
                                            ...
                                            <tr>
                                               ...
                                               <%-- <td valign="middle" class="form_text" nowrap="nowrap" style="width: 100px">
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="Show" ToolTip="Please Click for Report" Width="100px"
     ...
     <itemtemplate>
          <%#Container.DataItemIndex + 1 %>                                                    
                 ...
                 <asp:BoundField ReadOnly="True" 
                                HeaderText="HsrpStateName"
                                DataField="hsrpstatename"
                                SortExpression="hsrpstatename"/>
