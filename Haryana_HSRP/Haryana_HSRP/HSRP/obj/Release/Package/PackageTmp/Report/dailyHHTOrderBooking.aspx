<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="dailyHHTOrderBooking.aspx.cs" Inherits="HSRP.Report.dailyHHTOrderBooking" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">HHT Order Booking
                                        </span>
                                    </td>
                                ...
                                <tr>
                                   ...
                                   <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()" align="left">
                                                ...
                                                <td style="position: relative; Left: 0px; top: 0px; width:150px">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="Matched Report" ToolTip="Please Click for Report" OnClientClick="return validate()" 
                                                        class="button"  OnClick="btnExportToExcel_Click" />
                                                </td>
                                                   <td style="position: relative; left: 0px; top: 0px;">
                                                    <asp:Button ID="btlExportToEscel1" runat="server" Text="UnMatched Report" ToolTip="Please Click for Report" OnClientClick="return validate()" 
                                                        class="button" onclick="btlExportToEscel1_Click"  />
                                                </td>
                                              <td style="position: relative; left: 0px; top: 0px;">
                                                    <asp:Button ID="btnAllReport" runat="server" Text="All Report" 
                                                        ToolTip="Please Click for Report" OnClientClick="return validate()" 
                                                        class="button" onclick="btnAllReport_Click"  />
                                                </td>
                                                <tr>
                                                    <td colspan="9">
