<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AgingReportOrderToEmbossing.aspx.cs" Inherits="HSRP.Report.AgingReportOrderToEmbossing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <script type="text/javascript">
      ...
      function editpage(i, j, k, l) { //Define arbitrary function to run desired DHTML Window widget codes
          // alert(i);
          googlewin = dhtmlwindow.open("googlebox", "iframe", "AgingReportOrderToEmbossingDetail.aspx?CommandName=" + i + "&StateName=" + j + "&Location=" + k + "&Date=" + l, "Aging Report Order To Embossing Details", "width=900px,height=400px,resize=1,scrolling=1,center=1", "recal")
            ...
            <td valign="top">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                         <tr id="TR1" runat="server">
                                    <td > 
                                          <asp:Label ID="Label4" class="headingmain" runat="server"  >Aging Report Order To Embossing</asp:Label> 
                                    </td> 
                                </tr>
                    <tr>
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td valign="bottom"  style="width: 112px" class="span3" >
                                    ...
                                    <td valign="middle"  Visible="false" class="Label_user_batch" nowrap="nowrap" 
                                        style="width: 69px" align="left">&nbsp;&nbsp; <asp:Label Text="Date" runat="server" 
                                            ID="labelDate" /> &nbsp;&nbsp;</td>
                                    <td valign="bottom" onmouseup="OrderDate_OnMouseUp()" align="center" 
                                        class="span3" style="width: 106px">
                                                            ...
                                                            <td valign="middle" align="left" class="span3" 
                                        style="width: 36px">
                                                                <img id="calendar_from_button" tabindex="3" alt="" onclick="OrderDate_OnClick()"
                                                                     onmouseup="OrderDate_OnMouseUp()" class="calendar_button" src="../images/btn_calendar.gif" />
                                                                     </td><td valign="middle">
                                        <asp:LinkButton ID="LinkbuttonSearch" runat="server" Text="GO" class="button" BackColor="Orange" ForeColor="#000000"
                                        ...
                                        <table style="width:100%;">
                                            <tr>
                                                <td colspan="3" align="center" class="form_text" nowrap="nowrap">
                                                    <asp:Label ID="Label7" runat="server" Text="Aging Report Order To Embossing" 
