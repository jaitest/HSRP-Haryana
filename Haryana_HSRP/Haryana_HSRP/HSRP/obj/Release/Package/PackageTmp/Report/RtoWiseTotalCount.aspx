<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RtoWiseTotalCount.aspx.cs" Inherits="HSRP.Report.RtoWiseTotalCount" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Collection Report</span>
                                    </td>
    ...
    <table style="height: 51px;" width="80%">
        <tr>
            ...
            <td style="width: 50px; height: 40px;">               
                    ...
                    <asp:Label Text="Location:" Visible="true" runat="server" ForeColor="Black" Font-Bold="True" ID="labelClient" />&nbsp;&nbsp;
