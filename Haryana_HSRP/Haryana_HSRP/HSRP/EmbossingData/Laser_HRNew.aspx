<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Laser_HRNew.aspx.cs" Inherits="HSRP.EmbossingData.Laser_HRNew" %>
                        ...
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr id="TR1" runat="server">
                                    <td>
                                        <asp:Label ID="Label4" class="headingmain" runat="server">HSRP Haryana </asp:Label>
                                    </td>
                                </tr>
                                            ...
                                            <Columns>
                                               <%-- <asp:TemplateField>
                                                ...
                                                <HeaderTemplate>
                                                 ...
                                                 <ItemTemplate>
                                                <asp:Label ID="lblnewprocess" runat="server" Text='<%#Eval("remarks") %>'></asp:Label>
                                                </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:TemplateField>
                                                <HeaderTemplate>
