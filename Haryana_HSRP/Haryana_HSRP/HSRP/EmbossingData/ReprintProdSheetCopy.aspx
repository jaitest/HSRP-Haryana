<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReprintProdSheetCopy.aspx.cs" Inherits="HSRP.EmbossingData.ReprintProdSheetCopy" %>
                                   ...
                                   <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()"   align="left">
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                        ...
                                        &nbsp;&nbsp;&nbsp;  
                                             ...
                                             <asp:Button ID="btnGO"  Width="58px"  runat="server" BackColor="Orange" ForeColor="#000000"
                                ...
                                <tr>    <td valign="middle" class="form_text" nowrap="nowrap"> 
                                   <asp:Label Text="Production Sheet No:" Visible="False" runat="server" 
                                    ...
                                    <td valign="top" colspan="2" > 
                                        <asp:DropDownList   DataTextField ="pdfrunningno" 
                                            DataValueField="pdfrunningno" Visible="false"
