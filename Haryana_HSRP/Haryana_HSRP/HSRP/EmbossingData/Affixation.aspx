                                ...
                                <tr>    <td valign="middle" class="form_text" nowrap="nowrap"> 
                                   <asp:Label Text="Production Sheet" Visible="false" runat="server" ID="labelOrderStatus" />&nbsp;&nbsp; </td>
                                    <td valign="middle" > <asp:DropDownList   DataTextField ="pdffilename" style=" margin-top:10px;"
                                     ...
                                     <td valign="middle" class="form_text" nowrap="nowrap" > <asp:Label Text="Not Closed Vehicle Reg No" Visible="false" Font-Size="10pt" ForeColor="#FF3300" runat="server" ID="lblvehicle" />&nbsp;&nbsp;       </td>

                                     <td valign="middle" colspan="5" ><asp:TextBox ID="txtvehicleregNo" runat="server" Width="576px" Visible="false"></asp:TextBox></td>
                                </tr>
                            </table>
                        </td> 
                    </tr>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false">
                                     ...
                                     <asp:TemplateField Visible="false">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lablRecievedAffixationStatus" runat="server" Text='<%#Eval("RecievedAffixationStatus") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
