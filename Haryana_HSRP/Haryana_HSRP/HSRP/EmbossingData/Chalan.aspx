<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Chalan.aspx.cs" Inherits="HSRP.EmbossingData.Chalan1" %>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                ...
                                <tr>    <td valign="middle" class="form_text" nowrap="nowrap"> 
                                   <asp:Label Text="Production Sheet:" Visible="False" runat="server" 
                                        ID="labelOrderStatus" />&nbsp;&nbsp; </td>
                                    <td valign="top" > <asp:DropDownList   DataTextField ="pdffilename" 
                                   ...
                                   <asp:Label Text="Vehicle No." runat="server" ID="label1" Font-Size="11pt" 
                                    ...
                                    <asp:TextBox ID="txtVehicleNo" runat="server" 
                                            ontextchanged="txtVehicleNo_TextChanged"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="center" style="padding-top: 10px">
                            ...
                            <asp:Button ID="btnChalan" runat="server" Text="Update and Print Invoice" 
                                CssClass="button" Visible="false" BackColor="Orange" ForeColor="#000000"
                               OnClick="btnChalan_Click" Width="154px"  />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="Button1" runat="server" CssClass="button" BackColor="Orange" ForeColor="#000000"
                                onclick="Button1_Click" Text="Download Challan" Visible="False" />
                        &nbsp;&nbsp;
                            <asp:Button ID="Button2" runat="server" CssClass="button" BackColor="Orange" ForeColor="#000000"
                                onclick="Button2_Click" Text="Invoice Details" Visible="False" />
                        </td>
                        <td align="center" style="padding-top: 10px">
