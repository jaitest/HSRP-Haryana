<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="ViewPrefix.aspx.cs" Inherits="HSRP.Master.ViewPrefix" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function editpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            //  alert(i);
            googlewin = dhtmlwindow.open("googlebox", "iframe", "Prefix.aspx?Mode=Edit&PrefixID=" + i, "Update Prefix Details", "width=950px,height=300px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                //window.location.href = "ViewPrefix.aspx";
                return true;
            }
        }
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "Prefix.aspx?Mode=New", "Add New Prefix", "width=950px,height=300px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                //window.location = 'ViewPrefix.aspx';
                return true;
            }
        }
    </script>
                                ...
                                <tr>
                                    ...
                                    <td valign="middle">
                                       <%-- <asp:DropDownList Visible="true" CausesValidation="false" ID="dropDownListOrg"
                                        ...
                                        <asp:DropDownList ID="DropDownListState" DataValueField="HSRP_StateID" DataTextField="HSRPStateName" runat="server" AutoPostBack="True" 
                        ...
                        <td>
                            <table width="99%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <tr>
                                    ...
                                    <Levels>
                                                <ComponentArt:GridLevel DataKeyField="SerialPrefixID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    DataCellCssClass="DataCell" HeadingCellCssClass="HeadingCell" HeadingCellHoverCssClass="HeadingCellHover"
                                                    HeadingCellActiveCssClass="HeadingCellActive" HeadingRowCssClass="HeadingRow"
                                                    HeadingTextCssClass="HeadingCellText" SelectedRowCssClass="SelectedRow" GroupHeadingCssClass="GroupHeading"
                                                    SortAscendingImageUrl="asc.gif" SortDescendingImageUrl="desc.gif" SortImageWidth="10"
                                                    SortImageHeight="19">
                                                    <Columns>
                                                        <ComponentArt:GridColumn DataField="SerialPrefixID" Visible="False" />
                                                        <ComponentArt:GridColumn DataField="HSRPStateName" HeadingText="HSRP State Name" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" /> 
                                                        <ComponentArt:GridColumn DataField="RTOLocationName" Visible="true" HeadingText="RTO Location Name"
                                                            Width="100" /> 
                                                        <ComponentArt:GridColumn DataField="PrefixFor" HeadingText="Prefix For" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="PrefixText" HeadingText="Prefix Text" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
                                            ...
                                            <ClientTemplates>
                                                 <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:editpage(## DataItem.GetMember('SerialPrefixID').Value ##);">
                                                        Edit</a></ComponentArt:ClientTemplate>
