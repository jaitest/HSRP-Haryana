...
{
    public partial class ViewSecurityQuestion : System.Web.UI.Page
    {
        ...
        public void buildGrid()
        {
            try
            {
                //SQLString = "SELECT   (Users.UserFirstName+' '  +Users.UserLastName+'') as UserName, SecurityQuestion.ModifyBy,  SecurityQuestion.QuestionID, SecurityQuestion.QuestionText, SecurityQuestion.CreationDate FROM SecurityQuestion INNER JOIN Users ON SecurityQuestion.ModifyBy = Users.UserID  where SecurityQuestion.ModifyBy=" + UserID;
                SQLString = "SELECT   (Users.UserFirstName+' '  +Users.UserLastName+'') as UserName, SecurityQuestion.ModifyBy,  SecurityQuestion.QuestionID, SecurityQuestion.QuestionText, SecurityQuestion.CreationDate, SecurityQuestion.UpdationDate FROM SecurityQuestion INNER JOIN Users ON SecurityQuestion.ModifyBy = Users.UserID";
