<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorRegistration.aspx.cs"
    Inherits="HSRP.Master.VendorRegistration" %>
        ...
        <fieldset style="background-color: #faf7f7">
            ...
            <table align="center" style="padding-top: 20px; padding-left: 20px; padding-right: 20px;
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtVendorName" runat="server" class="form_textbox"></asp:TextBox>
                    </td>
                    <td class="Label_user">
                    </td>
                    <td>
            ...
            <table align="center" style="padding-top: 20px; padding-left: 20px; padding-right: 20px; float:left ;
                ...
                <td colspan="4" align="center">
                    ...
                    <asp:CheckBox ID="CheckBox1" runat="server" Text="Check IF Same" onclick="return copytext()" ForeColor="#660066" Font-Bold="true" Font-Size="15px" Visible="false" />
                    </td>
                </tr>
                <tr>
                    <td class="Label_user">
