<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="ViewCustomerRegistration.aspx.cs" Inherits="HSRP.Master.ViewCustomerRegistration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function edit(i) { // Define This function of Send Assign Laser ID 
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "CustomerRegistration.aspx?Mode=Edit&CustomerID=" + i, "Update Customer Registration", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location.href = "ViewCustomerRegistration.aspx";
                return true;
            }
        }
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "CustomerRegistration.aspx?Mode=New", "Add New Customer Registration", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location = 'ViewCustomerRegistration.aspx';
                return true;
            }
        }
    </script>
                    ...
                    <tr>
                        <td height="27" background="../../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">View Customer</span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New HSRP State" class="button">Add New Customer</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <table width="99%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ComponentArt:Grid ID="Grid1" CustomerIDMode="CustomerID" runat="server" ImagesBaseUrl="~/images"
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel DataKeyField="CustomerID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    SortImageHeight="19">
                                                    <Columns>
                                                        <ComponentArt:GridColumn DataField="CustomerID" Visible="False" />
                                                        <ComponentArt:GridColumn DataField="Name" HeadingText="Customer Name" SortedDataCellCssClass="SortedDataCell"
                                                            Width="120" />
                                                        <ComponentArt:GridColumn DataField="Address1" HeadingText="Address" SortedDataCellCssClass="SortedDataCell"
                                                            Width="130" />
                                                        <%-- <ComponentArt:GridColumn DataField="City" Visible="true" HeadingText="City"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="State" Visible="true" HeadingText="State"
                                                            Width="100" />--%>
                                                        <ComponentArt:GridColumn DataField="MobileNo" HeadingText="Mobile No" SortedDataCellCssClass="SortedDataCell"
                                                            Width="60" />
                                                        <ComponentArt:GridColumn DataField="EmailID" HeadingText="EmailID" SortedDataCellCssClass="SortedDataCell"
                                                            Width="45" />
                                            ...
                                            <ClientTemplates>
                                                <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:edit(## DataItem.GetMember('CustomerID').Value ##);">
                                                        Edit</a>
