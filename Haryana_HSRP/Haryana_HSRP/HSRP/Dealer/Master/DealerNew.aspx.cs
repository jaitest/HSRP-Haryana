...
{
    public partial class DealerNew : System.Web.UI.Page
    {
        ...
        string Stringdealer = String.Empty;
        string StringOEM = String.Empty;
        string Stringbusinessentity = String.Empty;
        string StringPanno = String.Empty;
        string Stringcstno = String.Empty;
        string Stringvatno = String.Empty;
        ...
        protected void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            Stringdealer = ddltypeofdear.SelectedValue.Trim().Replace("'", "''").ToString();           
            StringOEM = txtoem.Text.Trim().Replace("'", "''").ToString();
            Stringbusinessentity = ddltypeofbusinessentity.SelectedValue.Trim().Replace("'", "''").ToString();
            StringPanno = txtincometxtpanno.Text.Trim().Replace("'", "''").ToString();
            Stringcstno = txtcstno.Text.Trim().Replace("'", "''").ToString();
            Stringvatno = txtvatno.Text.Trim().Replace("'", "''").ToString();
            ...
            "ChargingType='" + StringChargingType + "',erpclientcode='" + txtERPClientCode.Text.ToString().ToUpper() + "',erpembcode='" + txtERPEmbossingCode.Text.ToString().ToUpper() + "',DealerType='" + Stringdealer + "',OemName='" + StringOEM + "',PanNo='" + StringPanno + "',CstNo='"+Stringcstno+"',VatTinNo='"+Stringvatno+"',BusinessType='"+Stringbusinessentity+"',IsActive=" + ActiveStatus + " where DealerID=" + DealerID + " ";
            if (Utils.ExecNonQuery(SQLString, CnnString) <= 0)
            {
        ...
        private void BindStateDDL()
        {
            ...
            ddlState.DataBind();
            ddlState.Items.Insert(0, new System.Web.UI.WebControls.ListItem("--Select State--", "--Select State--"));
          ...
          //  StringDealerCode = textBoxDealerCode.Text.Trim().Replace("'", "''").ToString();
            ...
            if (HsrpStateId == "4")
            {
                ...
                SQLString = "insert into  DealerMaster (erpembcode,DealerName,Address,City,[State],ContactPerson," +
                    ...
                    "ChargingType,IsActive,ContactPersionID,HSRP_StateID ,RTOLocationID,erpclientcode,DealerType,OemName,PanNo,CstNo,VatTinNo,BusinessType) values" +
                 ...
                 "" + StringcheckBoxFourWheeler + "," + StringcheckBoxCommercialVehicle + ",'" + StringChargingType + "','" + ActiveStatus + "','" + contactPersionID + "', '" + Session["UserHSRPStateID"] + "','" + StringrtolocationId + "','" + txtERPClientCode.Text.ToString().ToUpper() + "','" + Stringdealer + "','" + StringOEM + "','" + Stringbusinessentity + "','" + StringPanno + "','" + Stringcstno + "','" + Stringvatno + "')";
            }
            else
            {
                SQLString = "insert into  DealerMaster (DealerName,Address,City,[State],ContactPerson," +
                    "ContactMobileNo,AreaOfDealer,IsDealingInTwoWheeler,IsDealingInFourWheeler,IsDealingInCommercial," +
                    "ChargingType,IsActive,ContactPersionID,HSRP_StateID ,RTOLocationID,erpclientcode,erpembcode,DealerType,OemName,PanNo,CstNo,VatTinNo,BusinessType) values" +
                 "('" + StringDealerName + "','" + StringAddress + "','" + StringCity + "'," +
                 "'" + StringState + "','" + StringPersonName + "','" + StringMobileNo + "','" + StringAreaDealer + "'," + StringcheckBoxTwoWheeler + "," +
                 "" + StringcheckBoxFourWheeler + "," + StringcheckBoxCommercialVehicle + ",'" + StringChargingType + "','" + ActiveStatus + "','" + contactPersionID + "', '" + Session["UserHSRPStateID"] + "','" + StringrtolocationId + "','" + txtERPClientCode.Text.ToString().ToUpper() + "','" + txtERPEmbossingCode.Text.ToString().ToUpper() + "','" + Stringdealer + "','" + StringOEM + "','" + Stringbusinessentity + "','" + StringPanno + "','" + Stringcstno + "','" + Stringvatno + "')";
