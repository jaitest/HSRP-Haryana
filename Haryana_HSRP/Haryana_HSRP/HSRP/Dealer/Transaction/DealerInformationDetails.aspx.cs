...
{
    public partial class DealerInformationDetails : System.Web.UI.Page
    {
            ...
            else
            {
               ...
               lblErrMsg.Text = string.Empty;
                ...
                if (!IsPostBack)
                {
                    ...
                    bl.DailyEnityDeatail(Session["UID"].ToString(), "DealerInformationDetails.aspx");
                    try
                    {
                        InitialSetting();
        ...
        private void FilldropDownListOrganization()
        {
            ...
            Utils.PopulateDropDownList(ddlDealerName, SQLString.ToString(), CnnString, "--Select State--");
