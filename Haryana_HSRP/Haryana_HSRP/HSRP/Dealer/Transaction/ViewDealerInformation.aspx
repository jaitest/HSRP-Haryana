<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewDealerInformation.aspx.cs" Inherits="HSRP.Dealer.Transaction.ViewDealerInformation" %>
...
<script type="text/javascript"> 
    function edit(i) { // Define This function of Send Assign Laser ID  
        googlewin = dhtmlwindow.open("googlebox", "iframe", "DealerInformationDetails.aspx?Mode=Edit&ImperestID=" + i, "Edit Details Information", "width=950px,height=600px,resize=1,scrolling=1,center=1", "recal")
    ...
    function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
        ...
        googlewin = dhtmlwindow.open("googlebox", "iframe", "DealerInformationDetails.aspx?Mode=New", "Add New Details Information", "width=950px,height=600px,resize=1,scrolling=1,center=1", "recal")
        googlewin.onclose = function () {
                ...
                <tr>
                        <td height="27" background="../../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">View Dealer Information </span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New HSRP State" class="button">Add Imperest</a>
                                    </td>
                                                ...
                                                <ComponentArt:GridLevel DataKeyField="ImperestID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    <Columns>
                                                       <ComponentArt:GridColumn DataField="ImperestID" Visible="False" />
                                                        ...
                                                        <ComponentArt:GridColumn DataField="DateOfIssue" HeadingText="Dealer Name" SortedDataCellCssClass="SortedDataCell"
                                                            Width="120" />
                                                            
                                                            <ComponentArt:GridColumn DataField="ImperestAmt" FormatString="" HeadingText="Sales Person Name"
