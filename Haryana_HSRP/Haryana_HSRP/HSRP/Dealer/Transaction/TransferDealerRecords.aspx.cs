...
{
    public partial class TransferDealerRecords : System.Web.UI.Page
    {
        ...
        {
            string SQLString = "select DealerID,DealerName from dbo.dealerMaster order by DealerID";
...
" a.vehicleregno=b.vehicleregno where a.hsrp_stateid='" + HSRPStateID + "' and a.inv_status ='N' and  a.dealername='" + ddlDealerName.SelectedItem.ToString() + "' and a.HSRPRecord_CreationDate between '" + AuthorizationDate + "' and '" + OrderDate1 + "' ";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow di in GridView1.Rows)
            {
                ...
                if (chkBx != null && chkBx.Checked)
                {
                    ...
                    PdfPCell cell1209340 = new PdfPCell(new Phrase(VehicleRegNo[0].ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                    ...
                    PdfPCell cell1209340z = new PdfPCell(new Phrase(LaserFront[0].ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                    cell1209340z.Colspan = 14;
                    ...
                    PdfPCell cell1209340zq = new PdfPCell(new Phrase(LaserRear[0].ToString(), new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                    cell1209340zq.Colspan = 14;
        ...
        private void printInvoice1(int invoNo)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                PdfPCell cell122 = new PdfPCell(new Phrase("Link Utsav Registration Pvt. Ltd.", new iTextSharp.text.Font(bfTimes, 12f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell122.Colspan = 7;
                ...
                PdfPCell cell123 = new PdfPCell(new Phrase("1st Floor RTA Office, Main BusStand Sector-5 Phase I Panchkula Panchkula HARYANA 134107", new iTextSharp.text.Font(bfTimes, 10f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell123.Colspan = 7;
                ...
                PdfPCell cell125 = new PdfPCell(new Phrase("07460419550", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell125.Colspan = 2;
                ...
                PdfPCell cell126 = new PdfPCell(new Phrase("Range  :", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell126.Colspan = 2;
                ...
                PdfPCell cell127 = new PdfPCell(new Phrase("III of division - Delhi - I Comte/03", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell127.Colspan = 2;
                ...
                PdfPCell cell129 = new PdfPCell(new Phrase("AAFCR7758GEM001", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell129.Colspan = 2;
                ...
                PdfPCell cell130 = new PdfPCell(new Phrase("Division  :", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell130.Colspan = 2;
                ...
                PdfPCell cell131 = new PdfPCell(new Phrase("division- I /01", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell131.Colspan = 2;
                ...
                PdfPCell cell134 = new PdfPCell(new Phrase("Commissionerate :", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell134.Colspan = 2;
                ...
                PdfPCell cell135 = new PdfPCell(new Phrase("Delhi-I/04", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell135.Colspan = 2;
                ...
                PdfPCell cell120617 = new PdfPCell(new Phrase("", new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell235 = new PdfPCell(new Phrase("Vat Output 12.5% (1,514.62)", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell235.Colspan = 2;
                ...
                PdfPCell cell231 = new PdfPCell(new Phrase("12.50%", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell231.Colspan = 1;
                ...
                VO = Math.Round(double.Parse(to.ToString()) * 12.50 / 100, 2);
                ...
                PdfPCell cell1348 = new PdfPCell(new Phrase("Amount of Duty (in words) : " + totalinwords + " Paise Only", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell1348.Colspan = 7;
                ...
                PdfPCell cell13455 = new PdfPCell(new Phrase("Amount chargeable (in words) : " + Duty1 + " Paise Only", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell13455.Colspan = 7;
                ...
                double Cess = double.Parse(VO.ToString());
                string Cess1 = trans.changeNumericToWords(Cess);
