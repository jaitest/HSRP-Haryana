<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="AffixationScreen_TG.aspx.cs" Inherits="HSRP.Master.AffixationScreen_TG" %>
    ...
    <ContentTemplate>
                ...
                <tr>
                       ...
                       <%-- <td>
                        ...
                        <td>
                            <asp:Label ID="lblrto" runat="server" Font-Bold="true" Text=" "></asp:Label>
                    ...
                    <tr id="DivFirst" runat="server" visible="false">
                        ...
                        <td class="style4" style="padding-bottom: 10px"> 
                            <font color="black">Front Plate Laser No : </font>
                        </td>

                        <td>
                            <font color="black">
                                <asp:Label ID="lblFrontLaserPlate" CssClass="" runat="server"></asp:Label>
                            </font>
                        </td>
                          
                        <%--<td></td>--%>
                        <td class="form_text_View" style="padding-bottom: 10px"> 
                            <font color="black">Rear Plate Laser No :   </font>
                        </td>
                         <td>
                             <font color="black">
                                 <asp:Label ID="lblRearLaserPlate" CssClass="" runat="server"></asp:Label>
                    ...
                    <tr>
                     ...
                     <tr>
                       <td class="style4"> &nbsp;</td>
                        ...
                        <td align="right" > 
                        <asp:Button ID="btnAssignLaser" runat="server" Visible="false"  class="button" BackColor="Orange"
                                Text="Embossing" TabIndex="4"   
                              onclick="btnAssignLaser_Click" />&nbsp;&nbsp;
                               <asp:Button ID="btnDownloadInvoice" runat="server"  class="button" Visible="false" BackColor="Orange"
                                Text="Download Delivery Challan" TabIndex="4" 
                                OnClientClick=" return ValidationQuick()" 
                                onclick="btnDownloadInvoice_Click"   />&nbsp;&nbsp;
                    <asp:Button ID="btnSave" runat="server"   class="button"  Text="Order Closed" TabIndex="4" BackColor="Orange" OnClientClick="return ValidationQuick()"  Visible="false"
