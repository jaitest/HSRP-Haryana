                                   ...
                                   <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()"   align="left">
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap">
                                                  ...
                                                  <asp:Button ID="btnpdf" runat="server" 
                                                        Text="Print PreClosedtoClosed PDF" ToolTip="Please Click for Report" BackColor="Orange" ForeColor="#000000"  class="button" onclick="btnpdf_Click" Visible="true"/>
                                    ...
                                    <asp:TemplateField Visible="false">
                                     ...
                                     <asp:TemplateField Visible="false">
                                      ...
                                      <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                             <asp:TextBox ID="txtOS" runat="server" Text='<%#Eval("orderstatus") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
