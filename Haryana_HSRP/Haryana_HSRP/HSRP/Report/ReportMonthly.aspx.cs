    ...
    public partial class ReportMonthly : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                WorksheetCell cell = row.Cells.Add("Monthly Report From Approved Contractor to Transport Department");
                ...
                WorksheetCell cell3 = row.Cells.Add("Heigh Security Registration Plates Supplied");
                ...
                SQLString = "Report_rtoreport_embossed'" + FromDate + "','" + ToDate + "','" + DropDownListStateName.SelectedValue + "'";
                ...
                if (ds.Rows.Count > 0)
                {
                    foreach (DataRow dtrows in ds.Rows) // Loop over the rows.
                    {
                       ...
                       // row.Cells.Add(new WorksheetCell(dtrows["id"].ToString(), DataType.String, "HeaderStyle1"));
                        ...
                        row.Cells.Add(new WorksheetCell("", DataType.Number, "HeaderStyle15"));
                    }
                    row = sheet.Table.Rows.Add();
