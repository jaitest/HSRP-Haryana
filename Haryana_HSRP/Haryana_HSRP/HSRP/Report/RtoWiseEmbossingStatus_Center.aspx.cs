...
{
    public partial class RtoWiseEmbossingStatus_Center : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void FilldropDownListClient()
        {
            //if (UserType1.Equals(0))
           // {
           SQLString = "SELECT  distinct (a.EmbCenterName) as EmbCenterName, (a.NAVEMBID) as NAVEMBID FROM UserRTOLocationMapping INNER JOIN RTOLocation a ON UserRTOLocationMapping.RTOLocationID = a.RTOLocationID where UserRTOLocationMapping.UserID='" + strUserID1 + "' and a.RtoLocationID='"+RTOLocationID1+"' and ActiveStatus='Y' order by EmbCenterName ";
          ...
          //  dropDownListClient.Items.Insert(0, new System.Web.UI.WebControls.ListItem("--Select Embossing Center--", "--Select Embossing Center--"));
                
           // }
           // else
           // {
           //     SQLString = "SELECT  distinct (a.EmbCenterName) as EmbCenterName, (a.NAVEMBID) as NAVEMBID FROM UserRTOLocationMapping INNER JOIN RTOLocation a ON UserRTOLocationMapping.RTOLocationID = a.RTOLocationID where UserRTOLocationMapping.UserID='" + strUserID1 + "' and a.RtoLocationID='"+RTOLocationID1+"' and ActiveStatus='Y' order by EmbCenterName ";
           //     DataSet dts = Utils.getDataSet(SQLString, CnnString1);
        ...
        private void PIPVSProduction()
        {
            ...
            Exportpip(strOrderType, book, 1, "Business_report_PIPVSProduction_EmbossingCenter_Summary");
        ...
        protected void btndetail_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("Business_report_PIPVSProduction_EmbossingCenter_Summary", con);
