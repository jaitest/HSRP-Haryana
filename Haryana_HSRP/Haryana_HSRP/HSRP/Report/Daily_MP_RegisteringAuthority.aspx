<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Daily_MP_RegisteringAuthority.aspx.cs" Inherits="HSRP.Report.Daily_MP_RegisteringAuthority" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Report : Registering Authority Monthly Report </span>
                                    </td>
                                    ...
                                    <td>
                                        <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                                ...
                                                <td valign="middle" class="form_text" nowrap="nowrap" width="10">
                                                    &nbsp;</td>
                                                <td valign="middle" class="form_text" nowrap="nowrap">
