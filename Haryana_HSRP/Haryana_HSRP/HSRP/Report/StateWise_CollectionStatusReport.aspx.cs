...
{
    public partial class StateWise_CollectionStatusReport : System.Web.UI.Page
    {
        ...
        {
            lblError.Text = "";
            strSqlString = "[ReportPendenacyStateWise] '" + ddlStateName.SelectedValue + "','" + ddlMonth.SelectedValue + "','" + ddlYear.SelectedValue + "'";
        ...
        public void FillMonth()
        {
            ...
            ListItem lii = new ListItem("--Select Month--", "-1");
            ddlMonth.Items.Add(lii);
            for (int iMonthNo = 1; iMonthNo <= 12; iMonthNo++)
            {
                ListItem li=new ListItem(CultureInfo.CurrentCulture.DateTimeFormat.GetMonthName(iMonthNo),iMonthNo.ToString());
        ...
        {
            ddlYear.Items.Clear();
            ListItem lii = new ListItem("--Select Year--", "-1");
            ddlYear.Items.Add(lii);
        ...
        {
            lblError.Text = "";
            string filename = ddlStateName.SelectedItem.ToString()+"_CollectionReport_"+ddlMonth.SelectedItem.ToString()+"_" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
            ...
            book.Properties.Title = "HSRP Collection Report State Wise";
            ...
            Worksheet sheet = book.Worksheets.Add("HSRP Collection Report State Wise");

            #region Commented Code Column Declaration
            ...
            WorksheetCell cell = row.Cells.Add("HSRP Collection Report State Wise");
