...
{
    public partial class ChallanNoDetails_Report : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(book, 1, "GetChallanNoDetails");
        ...
        private void Export(Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                string filename = "Challan No Details" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                book.Properties.Title = "Challan No Details";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    WorksheetCell cell = row.Cells.Add("Challan No Details");
