...
{
    public partial class DailyCashCollectionRTOLocationWise_WithDateForHR : System.Web.UI.Page
    {
        ...
        private void ExportToPDF(string SqlQuery)
        {
            ...
            string filename = "DailyCashCollectionForHR_Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".pdf";
            string SQLString = String.Empty;
            ...
            var colWidthPercentages = new[] { 65f, 65f, 55f, 65f, 50f, 50f, 65f, 70f, 70f, 65f, 65f, 65f, 65f, 65f, 55f };
            ...
            GenerateCell(table, 15, 0, 0, 0, 0, 1, 0, "Report: HSRP Daily Cash Collection", 20, 0);
            GenerateCell(table, 8, 0, 0, 0, 0, 0, 0, "State: HARYANA", 20, 0);
            GenerateCell(table, 7, 0, 0, 0, 0, 0, 0, "Location:  '" + dropDownListClient.SelectedItem.ToString() + "'", 20, 0);
            string strVehicleRef = string.Empty;
            if (ddlVehicleReference.SelectedItem.ToString().ToUpper() == "BOTH")
            {
                strVehicleRef = "New, Old";
            }
            else
            {
                strVehicleRef = ddlVehicleReference.SelectedItem.ToString();
            }
            GenerateCell(table, 15, 0, 0, 0, 0, 0, 0, "Vehicle Reference:  " + strVehicleRef, 20, 0);

            string strVehicleType = string.Empty;
            if (DropDownListVehicleModel.SelectedItem.ToString().ToUpper() == "ALL")
            {
                strVehicleType = "SCOOTER, MOTOR CYCLE, TRACTOR, THREE WHEELER, LMV, LMV(CLASS), MCV/HCV/TRAILERS";
            }
            else
            {
                strVehicleType = DropDownListVehicleModel.SelectedItem.ToString().ToUpper();
            }
            GenerateCell(table, 15, 0, 0, 0, 0, 0, 0, "Vehicle Type:  " + strVehicleType, 20, 0);
            ...
            GenerateCell(table, 1, 1, 1, 1, 1, 1, 0, "Cash Receipt No.",40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Authorisation Date", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Order Date", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Vehicle Reg. No", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Owner's Name", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Vehicle Type", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Vehicle Class", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Front", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Rear", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Front Plate Size", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Rear Plate Size", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Affixation Status", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Embossed Date", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Affixation Date", 40, 0);
            ...
            {
                GenerateCell(table, 1, 1, 1, 0, 1, 1, 1, dt.Rows[i]["CashReceiptNo"].ToString(), 40, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["HsrpRecord_AuthorizationDate"].ToString(), 40, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["NewOrderDate"].ToString(), 40, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["VehicleRegNo"].ToString(), 40, 0);

                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["OwnerName"].ToString(), 40, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["VehicleClass"].ToString(), 40, 0);

                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["VehicleType"].ToString(), 40, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["hsrp_front_lasercode"].ToString(), 40, 0);

                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["hsrp_rear_lasercode"].ToString(), 40, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["frontplatesize"].ToString(), 40, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["rearplatesize"].ToString(), 40, 0);

                if (DropDownListStateName.SelectedItem.ToString().ToUpper() == "HARYANA")
                {
                    string status = string.Empty;
                    if (dt.Rows[i]["OrderStatus"].ToString().ToUpper() == "NEW ORDER")
                    {
                        status = "";
                    }
                    else
                    {
                        status = dt.Rows[i]["OrderStatus"].ToString().ToUpper() == "CLOSED" ? "AFFIXED" : "CUSTOMER NOT COME .";
                    }
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, status, 20, 0);
                    GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["embdate"].ToString(), 20, 0);

                }

                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["AffixDate"].ToString(), 20, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["NetAmount"].ToString(), 20, 0);
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            if (ddlVehicleReference.SelectedItem.Text == "Both" && DropDownListVehicleModel.SelectedItem.Text == "All")
            {
                SQLString = "SELECT  HSRP_StateID,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,convert(varchar(10),ordercloseddate,103) as AffixDate" +
                    ...
                    ",hsrp_front_lasercode,hsrp_rear_lasercode,ownername" +
                    " FROM HSRPRecords h where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + dropDownListClient.SelectedValue + "' and  OwnerName is not null and OwnerName <> '' and Address1 is not null and Address1 <> '' and HsrpRecord_creationdate between '" + StringOrderDate.ToString() + "' and '" + StringAuthDate.ToString() + "' and NetAmount <> 0 order by OrderDate";
            }
            ...
            else if (ddlVehicleReference.SelectedItem.Text == "New" || ddlVehicleReference.SelectedItem.Text == "Old" && DropDownListVehicleModel.SelectedItem.Text == "All")
            {
                SQLString = "SELECT  HSRP_StateID,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,convert(varchar(10),ordercloseddate,103) as AffixDate" +
                    ...
                    ",(select p.ProductCode from product p where h.rearPlateSize = p.ProductID) as rearplatesize" +
                    ",hsrp_front_lasercode,hsrp_rear_lasercode,ownername" +
                    " FROM HSRPRecords h where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + dropDownListClient.SelectedValue + "' and  OwnerName is not null and OwnerName <> '' and Address1 is not null and Address1 <> '' and vehicleref='" + ddlVehicleReference.SelectedItem.ToString() + "' and HsrpRecord_creationdate between '" + StringOrderDate.ToString() + "' and '" + StringAuthDate.ToString() + "' and NetAmount <> 0 order by OrderDate";
            }
            else
            {
                SQLString = "SELECT  HSRP_StateID,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,convert(varchar(10),ordercloseddate,103) as AffixDate" +
        ...
        private void ExportRecordExcel(string strquery, string RtoName = null, string RtoCode = null)
        {
            ...
            try
            {
                ...
                string filename = DropDownListStateName.SelectedItem.ToString() + "_CollectionReport_" + strRtoName + "_" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(dtrows["frontplatesize"].ToString(), DataType.String, "HeaderStyle"));
                        row.Cells.Add(new WorksheetCell(dtrows["rearplatesize"].ToString(), DataType.String, "HeaderStyle"));

                        if (DropDownListStateName.SelectedItem.ToString().ToUpper() == "DELHI")
                        {
                            string status = string.Empty;
                            if (dtrows["OrderStatus"].ToString().ToUpper() == "NEW ORDER")
                            {
                                status = "";
                            }
                            else
                            {
                                status = dtrows["OrderStatus"].ToString().ToUpper() == "CLOSED" ? "AFFIXED" : "CUSTOMER NOT COME .";
                            }
                        ...
                        row.Cells.Add(new WorksheetCell(dtrows[""].ToString(), DataType.String, "HeaderStyle"));
        ...
        protected void btnAllLocationPdf_Click(object sender, EventArgs e)
        {
            ...
            for (int iRowNo = 0; iRowNo < dtrto.Rows.Count; iRowNo++)
            {
                ...
                string filename = "CollectionReport-" + RTOName + "-" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";

                if (ddlVehicleReference.SelectedItem.Text == "Both" && DropDownListVehicleModel.SelectedItem.Text == "All")
                {
                    SQLString = "SELECT  HSRP_StateID,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,convert(varchar(10),ordercloseddate,103) as AffixDate FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "' and HsrpRecord_creationdate between '" + StringOrderDate.ToString() + "' and '" + StringAuthDate.ToString() + "' and NetAmount <> 0 order by OrderDate";
                }
                else if (ddlVehicleReference.SelectedItem.Text == "Both")
                {
                    SQLString = "SELECT  HSRP_StateID,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,convert(varchar(10),ordercloseddate,103) as AffixDate FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "' and VehicleType='" + DropDownListVehicleModel.SelectedItem.ToString() + "'  and HsrpRecord_creationdate between '" + StringOrderDate.ToString() + "' and '" + StringAuthDate.ToString() + "' and NetAmount <> 0 order by OrderDate";
                }
                else if (ddlVehicleReference.SelectedItem.Text == "New" || ddlVehicleReference.SelectedItem.Text == "Old" && DropDownListVehicleModel.SelectedItem.Text == "All")
                {
                    SQLString = "SELECT  HSRP_StateID,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,convert(varchar(10),ordercloseddate,103) as AffixDate FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "'  and vehicleref='" + ddlVehicleReference.SelectedItem.ToString() + "' and HsrpRecord_creationdate between '" + StringOrderDate.ToString() + "' and '" + StringAuthDate.ToString() + "' and NetAmount <> 0 order by OrderDate";
                }
                else
                {
                    SQLString = "SELECT  HSRP_StateID,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,convert(varchar(10),ordercloseddate,103) as AffixDate FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "' and vehicleref='" + ddlVehicleReference.SelectedItem.ToString() + "' and VehicleType='" + DropDownListVehicleModel.SelectedItem.ToString() + "'  and HsrpRecord_creationdate between '" + StringOrderDate.ToString() + "' and '" + StringAuthDate.ToString() + "' and NetAmount <> 0 order by OrderDate";
                }
                ExportRecordExcel(SQLString, RTOName, RTOCode);
            }

        }

        protected void btn_ExportInPDF_Click(object sender, EventArgs e)
        {
            String StringOrderDate = OrderDate.SelectedDate.ToString("yyyy/MM/dd") + " 00:00:00";
            String StringAuthDate = HSRPAuthDate.SelectedDate.ToString("yyyy/MM/dd") + " 23:59:59";
            DateTime StartDate = Convert.ToDateTime(OrderDate.SelectedDate);
