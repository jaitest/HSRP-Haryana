<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyAPEmbossingReportNEW.aspx.cs" Inherits="HSRP.Report.DailyAPEmbossingReportNEW" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Andhra Pradesh: Daily Report form Embossing Stations to Registering Authority</span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    <td>
                                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                                ...
                                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 55px">
                                                ...
                                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 100px">
                                                    <asp:Label Text="RTO Location:" runat="server" ID="labelOrganization" 
                                                        Visible="False" />
                                                </td>
                                                ...
                                                <td valign="middle" style="width: 200px">
                                                    <asp:DropDownList CausesValidation="false" ID="DropDownListStateName"
                                                        ...
                                                        DataValueField="RTOLocationID" Visible="False">
                                                    </asp:DropDownList>
                                                </td>
                                    ...
                                    <td valign="top" style="width:105px"; onmouseup="OrderDate_OnMouseUp()">
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px; width: 321px; left: 932px;">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="Report In Excel" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="btnExportToExcel_Click" Visible="true"/>
                                                </td>
                                                <tr>
                                                    <td colspan="9">
