<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HRCollection_Detail_Report.aspx.cs" Inherits="HSRP.Report.HRCollection_Detail_Report" %>
   ...
   <%-- <script type="text/javascript">
    ...
    <div style="width: 1107px; height: 500px;">
        ...
        <table width="100%">
           <tr>
               <td style="float:left;">
                   <asp:Button ID="btnPdfDownload" runat="server" Text="PDFDownload" OnClick="btnPdfDownload_Click" />
               </td>
           </tr>
            <tr>
