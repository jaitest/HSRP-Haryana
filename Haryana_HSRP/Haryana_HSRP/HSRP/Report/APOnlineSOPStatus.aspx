<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="APOnlineSOPStatus.aspx.cs" Inherits="HSRP.Report.APOnlineSOPStatus" %>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                              &nbsp;<span class="headingmain">AP Online SOP Status</span>&nbsp;</td>
                    </tr>
...
<%--                                    <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lbllocation" runat="server" Text='<%#Eval("District") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            RTOLocationName</HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            Auth Received</HeaderTemplate>
                                        <ItemTemplate>
                                          
                                           <asp:Label ID="lblAuthReceived" runat="server" Text='<%#Eval("AuthReceived") %>'></asp:Label>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            Embossed</HeaderTemplate>
                                        <ItemTemplate>
                                        <asp:Label ID="lblEmbossed" runat="server" Text='<%#Eval("Embossed") %>'></asp:Label>
                                   ...
                                   <asp:TemplateField>
                                        <HeaderTemplate>
                                                Challan Prepared</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblChallanPrepared" runat="server" Text='<%#Eval("ChallanPrepared") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                  <asp:TemplateField >
                                        <HeaderTemplate>
                                         Received at Affixation Center</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblReceived" runat="server" Text='<%#Eval("ReceivedatAffixationCenter") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
