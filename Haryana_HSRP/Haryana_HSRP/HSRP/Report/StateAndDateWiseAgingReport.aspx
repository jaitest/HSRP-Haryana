<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StateAndDateWiseAgingReport.aspx.cs" Inherits="HSRP.Report.StateAndDateWiseAgingReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Total Pendency Count</span>
                                    </td>
    ...
    <table style="width: 95%; height: 51px;">
        <tr>
            <td style="height: 59px;" width="100">
                &nbsp;</td>
            <td class="style3" style="width: 100px; height: 59px;">
