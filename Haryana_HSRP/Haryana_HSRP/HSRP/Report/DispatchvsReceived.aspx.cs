    ...
    public partial class DispatchvsReceived : System.Web.UI.Page
    {
        ...
        protected void grdid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Day4")
            {
               ...
               // DataTable dt = Utils.GetDataTable(strSQL.ToString(), CnnString1);
                ...
                SqlCommand cmd = new SqlCommand();
                string strParameter = string.Empty;
                cmd = new SqlCommand("Business_report_DispatchvsReceived_Summary_forDayswise_Detail", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@reportDate", OrderDatefrom.SelectedDate));
                cmd.Parameters.Add(new SqlParameter("@StateId", Convert.ToInt32(DropDownListStateName.SelectedValue)));
                cmd.Parameters.Add(new SqlParameter("@embcentername", embcentername.ToString()));
                cmd.Parameters.Add(new SqlParameter("@reptype", Days));
                cmd.Parameters.Add(new SqlParameter("@BusinessReportStartDate", BusinessReportStartDate));
                con.Open();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    row.Cells.Add(new WorksheetCell("Creted By", "HeaderStyle"));
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
           ...
           // DataTable dt = Utils.GetDataTable(strSQL.ToString(), CnnString1);
            ...
            SqlCommand cmd = new SqlCommand();
            string strParameter = string.Empty;
            cmd = new SqlCommand("Business_report_DispatchvsReceived_Summary_forDays", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(new SqlParameter("@reportDate", OrderDatefrom.SelectedDate));
            cmd.Parameters.Add(new SqlParameter("@StateId", Convert.ToInt32( DropDownListStateName.SelectedValue)));
            cmd.Parameters.Add(new SqlParameter("@rtolocationname", rtolocationname.ToString()));            
            cmd.Parameters.Add(new SqlParameter("@reptype", Days));
            cmd.Parameters.Add(new SqlParameter("@BusinessReportStartDate", BusinessReportStartDate));
            con.Open();
            SqlDataReader dr = cmd.ExecuteReader();
