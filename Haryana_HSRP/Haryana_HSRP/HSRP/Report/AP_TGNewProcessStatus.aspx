<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="AP_TGNewProcessStatus.aspx.cs" Inherits="HSRP.Report.AP_TGNewProcessStatus" %>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                              &nbsp;<span class="headingmain">AP TG New Process Status </span>&nbsp;</td>
                    </tr>
                            ...
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                              ...
                              <asp:GridView ID="GrdAP" runat="server" BackColor="White" AutoGenerateColumns="false"
                                ...
                                <%--<asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            AP Orders</HeaderTemplate>
                                        <ItemTemplate>
                                          
                                           <asp:Label ID="lblcollection" runat="server" Text='<%#Eval("APCollectionWithoutVehicleNo") %>'></asp:Label>
...
<%--                                     <asp:TemplateField Visible="false">
                                    ...
                                    <td style="width: 25%" align="center" style=" padding:10px" valign="top">
                              <asp:GridView ID="grdTG" runat="server" BackColor="White" AutoGenerateColumns="false"
                                PageSize="25" AllowPaging="false" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                                CellPadding="3">
...
<%--                                    <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            TS Orders</HeaderTemplate>
                                        <ItemTemplate>
                                          
                                           <asp:Label ID="lblcollection" runat="server" Text='<%#Eval("TSCollectionWithoutVehicleNo") %>'></asp:Label>
...
<%--                                     <asp:TemplateField Visible="false">
                                    ...
                                    <td style="width: 25%" align="center" style=" padding:10px" valign="top">
                              <asp:GridView ID="GridTS" runat="server" BackColor="White" AutoGenerateColumns="false"
                                PageSize="25" AllowPaging="false" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                                CellPadding="3">
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
...
<%--                                    <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            TotalOrderswithoutVehicle</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotalOrderswithoutVehicle" runat="server" Text='<%#Eval("TotalOrderswithoutVehicle") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            Total Amount Without Vehicle</HeaderTemplate>
                                        <ItemTemplate>
                                          
                                           <asp:Label ID="lblTotalAmountWithoutVehicle" runat="server" Text='<%#Eval("TotalAmountWithoutVehicle") %>'></asp:Label>
                            ...
                            <br />
                             <asp:GridView ID="grdWVAP" runat="server" BackColor="White" AutoGenerateColumns="false"
                                PageSize="25" AllowPaging="false" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                                CellPadding="3" >
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
...
<%--                                    <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            AP Without Vehicle</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotalOrders" runat="server" Text='<%#Eval("APTotalOrders") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            AP Total Amount</HeaderTemplate>
                                        <ItemTemplate>
                                          
                                           <asp:Label ID="lblTotalAmount" runat="server" Text='<%#Eval("APTotalAmount") %>'></asp:Label>
                            ...
                            <asp:GridView ID="GRDWVTG" runat="server" BackColor="White" AutoGenerateColumns="false"
                                PageSize="25" AllowPaging="false" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                                CellPadding="3" >
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
...
<%--                                    <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            TG Without Vehicle</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotalOrders" runat="server" Text='<%#Eval("TGTotalOrders") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            TG Total Amount</HeaderTemplate>
                                        <ItemTemplate>
                                          
                                           <asp:Label ID="lblTotalAmount" runat="server" Text='<%#Eval("TGTotalAmount") %>'></asp:Label>
...
<%--                                    <asp:TemplateField>
                            ...
                            <br />
                             <asp:GridView ID="TotalorderAP" runat="server" BackColor="White" AutoGenerateColumns="false"
                                PageSize="25" AllowPaging="false" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                                CellPadding="3" >
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
...
<%--                                    <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            AP Total Orders</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotalOrders" runat="server" Text='<%#Eval("APTotalOrders") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:GridView ID="totalorderTG" runat="server" BackColor="White" AutoGenerateColumns="false"
                                PageSize="25" AllowPaging="false" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                                CellPadding="3" >
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
...
<%--                                    <asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            TG Total Orders</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotalOrders" runat="server" Text='<%#Eval("TGTotalOrders") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
