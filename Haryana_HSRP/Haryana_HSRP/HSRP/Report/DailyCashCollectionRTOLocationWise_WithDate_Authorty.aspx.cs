...
{
    public partial class DailyCashCollectionRTOLocationWise_WithDate_Authorty : System.Web.UI.Page
    {
        ...
        private void FilldropDownListClient()
        {
           // if (strUserID == "3064")
            ...
            SQLString = "select distinct Reportgroup,reportgroup from RTOLocation Where HSRP_StateID=" + intHSRPStateID + " and ActiveStatus!='N'  Order by 1";
            ...
            //    //SQLString = "SELECT  distinct Reportgroup,reportgroup FROM UserRTOLocationMapping INNER JOIN RTOLocation a ON UserRTOLocationMapping.RTOLocationID = a.RTOLocationID where  a.LocationType!='District' and UserRTOLocationMapping.UserID='" + strUserID + "' Order by RTOLocationName ";
            //    SQLString = "select distinct Reportgroup,reportgroup from RTOLocation Where HSRP_StateID=" + intHSRPStateID + " and ActiveStatus!='N'  Order by 1";
            //    Utils.PopulateDropDownList(dropDownListClient, SQLString.ToString(), CnnString, "--Select Location--");
        ...
        private void ExportRecordExcel(Workbook book, DataTable dt, string RtoName = null, string RtoCode = null)
        {
            ...
            try
            {
               ...
               // row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                ...
                row.Cells.Add(new WorksheetCell(StringOrderDate, "HeaderStyle2"));
                row.Cells.Add(new WorksheetCell("Report Date To:", "HeaderStyle2"));
                row.Cells.Add(new WorksheetCell(StringAuthDate, "HeaderStyle2"));
                row = sheet.Table.Rows.Add();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(dtrows["Order Date"].ToString(), DataType.String, "HeaderStyle"));
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            #region Query
            if (ddlVehicleReference.SelectedItem.Text == "Transport")
            {
               // SQLString = "SELECT  HSRP_StateID,convert(varchar(15),HSRPRecord_CreationDate,103) as CashReceiptDateTime,(select (userfirstname+' '+UserLastName) as Name from users u where h.createdby=u.userid) as username,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,convert(varchar(10),ordercloseddate,103) as AffixDate FROM HSRPRecords h where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + dropDownListClient.SelectedValue + "' and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 order by OrderDate";
                SQLString = "SELECT  h.HSRP_StateID,convert(varchar(15),HSRPRecord_CreationDate,103) as 'Order Date', HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,EngineNo,ChassisNo,h.MobileNo FROM HSRPRecords h, rtolocation r  where h.rtolocationid=r.rtolocationid and  h.HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and r.Reportgroup='" + dropDownListClient.SelectedValue + "' and h.HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and vehicleclass='Transport' and NetAmount <> 0 order by OrderDate";
            }
            else if (ddlVehicleReference.SelectedItem.Text == "Non-Transport")
            {
                SQLString = "SELECT  h.HSRP_StateID,convert(varchar(15),HSRPRecord_CreationDate,103) as 'Order Date', HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,EngineNo,ChassisNo,h.MobileNo FROM HSRPRecords h, rtolocation r  where h.rtolocationid=r.rtolocationid and  h.HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and r.Reportgroup='" + dropDownListClient.SelectedValue + "' and h.HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and vehicleclass='Non-Transport' and NetAmount <> 0 order by OrderDate";
                //SQLString = "SELECT  HSRP_StateID,convert(varchar(15),HSRPRecord_CreationDate,103) as CashReceiptDateTime,(select (userfirstname+' '+UserLastName) as Name from users u where h.createdby=u.userid) as username,OrderStatus,case when orderstatus='Closed' and (orderembossingdate is null or orderembossingdate='') then convert(varchar(10),dateadd(dd,2,orderdate),103) else convert(varchar(10),orderembossingdate,103)end as embdate, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,convert(varchar(10),ordercloseddate,103) as AffixDate FROM HSRPRecords h where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + dropDownListClient.SelectedValue + "' and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 order by OrderDate";
            }
            //else if (ddlVehicleReference.SelectedItem.Text == "Both")
            //{
