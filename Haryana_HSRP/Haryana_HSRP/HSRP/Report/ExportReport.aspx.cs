...
{
    public partial class ExeportReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
              ...
              //  String From1 = StringOrderDate[2].Split(' ')[0] + "/" + StringOrderDate[1] + "/" + StringOrderDate[0];
                ...
                string filename = "Export_Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                book.Properties.Title = "Export Report";
                ...
                row.Cells.Add(new WorksheetCell("ID", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("state Name", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Zone Name", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Location Name", "HeaderStyle"));
                  row.Cells.Add(new WorksheetCell("Collection Count", "HeaderStyle"));
                  row.Cells.Add(new WorksheetCell("Emb Count", "HeaderStyle"));
                  row.Cells.Add(new WorksheetCell("Close Count", "HeaderStyle"));
                ...
                SQLString = "exec [Report_MIS_Ash]  '" + FromDate + "','" + ToDate + "','" + DropDownListStateName.SelectedValue + "'  ";
                ...
                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(dtrows["statename"].ToString(), DataType.String, "HeaderStyle1"));
                        row.Cells.Add(new WorksheetCell(dtrows["zonename"].ToString(), DataType.String, "HeaderStyle1"));
                        // row.Cells.Add(new WorksheetCell(dtrows["ManufacturerName"].ToString(), DataType.String, "HeaderStyle1"));

                        row.Cells.Add(new WorksheetCell(dtrows["collectioncount"].ToString(), DataType.String, "HeaderStyle1"));
                         row.Cells.Add(new WorksheetCell(dtrows["embcount"].ToString(), DataType.String, "HeaderStyle1"));
                         row.Cells.Add(new WorksheetCell(dtrows["closecount"].ToString(), DataType.String, "HeaderStyle1"));
