    ...
    private void Export(string strStateId, string strStateName)
    {
        try
        {
          ...
          string  FromDate = OrderDate.SelectedDate.ToString("MM/dd/yy 00:00:00");
           ...
           string SQLString = "select u.UserLoginName,EmbCode,Designation,TimeIN,TimeOUT from DailyAttandenceEmp d,users u where d.HSRP_ID=u.HSRP_StateID and u.userid='" + strUserID1 + "'";
           ...
           dt = Utils.GetDataTable(SQLString, CnnString1);
            ...
            row.Cells.Add(new WorksheetCell(" Daily Attendance Report", "HeaderStyle3"));
