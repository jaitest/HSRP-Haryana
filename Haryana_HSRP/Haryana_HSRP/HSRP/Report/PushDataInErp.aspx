<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"   CodeBehind="PushDataInErp.aspx.cs" Inherits="HSRP.Report.PushDataInErp" %>
                            ...
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:Button ID="btnUpdate" runat="server" Text="Update" class="button"  Width="100px" onclick="btnUpdate_Click"></asp:Button>
                                    ...
                                    <td>
                                    <asp:Button ID="btnhsrperp" runat="server" Text="HSRP TO ERP" class="button"  Width="100px" OnClick="btnhsrperp_Click"></asp:Button>
                                    </td>
