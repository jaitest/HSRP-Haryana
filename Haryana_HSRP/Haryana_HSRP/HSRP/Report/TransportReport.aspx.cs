    ...
    public partial class TransportReport : System.Web.UI.Page
    {
        ...
        private void FilldropDownListClient()
        {
            if (UserType.Equals(0))
            {
                ...
                SQLString = "select RTOLocationName,RTOLocationcode from RTOLocation Where HSRP_StateID=" + intHSRPStateID + " and ActiveStatus!='N' and RTOLocationcode is not null and RTOLocationcode !='' and rtotype='RTA'  Order by RTOLocationName";
                DataSet dss = Utils.getDataSet(SQLString, CnnString);
                ddlRtoLocation.DataSource = dss;
                ddlRtoLocation.DataTextField = "RTOLocationName";
                ddlRtoLocation.DataValueField = "RTOLocationcode";
            ...
            {
                SQLString = "select RTOLocationName,RTOLocationcode from RTOLocation Where (RTOLocationID=" + RTOLocationID + " or distRelation=" + RTOLocationID + " ) and ActiveStatus!='N'  and RTOLocationcode is not null and RTOLocationcode !='' and  Order by RTOLocationName";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                book.Properties.Title = "TransPort Report";
                ...
                Worksheet sheet = book.Worksheets.Add("AP TS Report");
                ...
                row.Cells.Add(new WorksheetCell(" ", "HeaderStyle3"));
                WorksheetCell cell = row.Cells.Add("TransPort  Report");
                ...
                row.Cells.Add(new WorksheetCell("Description of Vehicle", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Registration No. of the Vehicle", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Date  of HSRP Fee Collection", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Affixation Date]", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Fitness Certificate granted or not", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Permit issued or not", "HeaderStyle"));
                ...
                {
                    SQLString = "select VEHICLETYPE as [Description of Vehicle],vehicleregno as [Registration No. of the Vehicle],convert(varchar,hsrprecord_creationdate,103) as [Date  of HSRP Fee Collection] ,convert(varchar,OrderClosedDate,103) as [Affixation Date],  '' as [Fitness Certificate granted or not], '' as[Permit issued or not] from hsrprecords a,rtolocation b where a.rtolocationid=b.rtolocationid and a.hsrp_stateid='" + DropDownListStateName.SelectedValue + "' and left(VehicleRegNo,4)='" + ddlRtoLocation.SelectedValue + "' and convert(date,hsrprecord_creationdate) between convert(date,'" + OrderDate.SelectedDate + "') and convert(date,'" + HSRPAuthDate.SelectedDate + "') and vehicleclass='Transport' order by vehicletype ";
                }
                else
                {
                    SQLString = "select VEHICLETYPE as [Description of Vehicle],vehicleregno as [Registration No. of the Vehicle],convert(varchar,hsrprecord_creationdate,103) as [Date  of HSRP Fee Collection],convert(varchar,OrderClosedDate,103) as [Affixation Date],  '' as [Fitness Certificate granted or not], '' as[Permit issued or not] from hsrprecords a,rtolocation b where a.rtolocationid=b.rtolocationid and a.hsrp_stateid='" + DropDownListStateName.SelectedValue + "' and b.rtotype='RTA' and convert(date,hsrprecord_creationdate) between convert(date,'" + OrderDate.SelectedDate + "') and convert(date,'" + HSRPAuthDate.SelectedDate + "') and vehicleclass='Transport' order by vehicletype ";
                }
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count;i++) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["Description of Vehicle"].ToString(), DataType.String, "HeaderStyle1"));
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["Registration No. of the Vehicle"].ToString(), DataType.String, "HeaderStyle1"));
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["Date  of HSRP Fee Collection"].ToString(), DataType.String, "HeaderStyle1"));
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["Affixation Date"].ToString(), DataType.String, "HeaderStyle1"));
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["Fitness Certificate granted or not"].ToString(), DataType.String, "HeaderStyle1"));
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["Permit issued or not"].ToString(), DataType.String, "HeaderStyle1"));
