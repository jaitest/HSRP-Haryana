<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DownloadCashRegisterReport.aspx.cs" Inherits="HSRP.Report.DownloadCashRegisterReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Cash Register</span>
                                    </td>
        ...
        <tr>
            ...
            <td style="width: 15%">
                        ...
                        CausesValidation="false" DataTextField="RtoLocationName" 
                                    ...
                                    Height="25px" Width="148px" AutoPostBack="True" 
                            onselectedindexchanged="ddlRto_SelectedIndexChanged1">
                        </asp:DropDownList>
                    </td>
           ...
           <%-- <td style="width: 20px; ">
            ...
            <td style="width: 10%">
                ...
                <asp:Label Text="Cashier:" runat="server" ID="lblCashier" 
                                            ForeColor="Black" Font-Bold="True" 
                    Visible="False" />
            </td>
            <td style="width: 15%">
                        ...
                        CausesValidation="false" DataTextField="UserLoginName" 
                                                                              DataValueField="userid" 
                                    Height="25px" Width="148px" Visible="False">
                        </asp:DropDownList>
                    </td>
             
                <td style="width: 15%">
                    <asp:Label Text="From:" runat="server" ID="labelDate" Font-Bold="True" 
                                                        ForeColor="Black" /> 
            ...
            <td style="width: 20px; ">
                                                ...
                                                <td width="15%">
                                                    <asp:Button ID="btnPDF" runat="server" onclick="btnPDF_Click" Text="Export To PDF" 
