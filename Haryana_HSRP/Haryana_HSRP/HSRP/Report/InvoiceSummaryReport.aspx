<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="InvoiceSummaryReport.aspx.cs" Inherits="HSRP.Report.InvoiceSummaryReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Collection Summary and Pendency</span>
                                    </td>
    ...
    <table style="width: 85%; height: 51px; left: 50px;">
        <tr>
            ...
            <td style="height: 40px;" width="80">               
                    ...
                    <asp:DropDownList ID="DropDownListOrderType" runat="server" CausesValidation="false" Height="22px" Width="100px">
                        
                        <asp:ListItem>Dealer</asp:ListItem>
                        <asp:ListItem>Non Dealer</asp:ListItem>
                    </asp:DropDownList>
            ...
            <td style="width: 20px; ">
                    ...
                    <asp:Label Text="To:" runat="server" ID="labelTO" Font-Bold="True" 
                                                        ForeColor="Black" /> 
