...
namespace HSRP.DLReports
{
    public partial class DailyRegisteringAuthority : System.Web.UI.Page
    {
        ...
        {
                SQLString = "select rtolocationname,rtolocationid from rtolocation  where hsrp_stateid='2' and rtolocationid in (select distinct distrelation from rtolocation where  hsrp_stateid=2) Order by rtolocationname";
                Utils.PopulateDropDownList(ddlRtolocation, SQLString.ToString(), CnnString, "--Select RTO--");          
        }
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string filename = "Schedule-E-MonthlyStatementFromConcessionaireToRegisteringAuthority-MonthWise-"+ddlRtolocation.SelectedItem.ToString() + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
               ...
               // row.Index = 7; 
                ...
                //SQLString = "Report_Monthly_Statement_Registering_Authority'" + FromDate + "','" + ToDate + "','2','"+ddlRtolocation.SelectedValue+"'";
                SQLString = "Report_Monthly_StatementLocationWiseRegisteringAuthority'" + FromDate + "','" + ToDate + "','2','" + ddlRtolocation.SelectedValue + "'";
                ...
                if (ds.Rows.Count > 0)
                {
                    ...
                    SQLString = "SELECT ProductCost.Cost FROM  Product  INNER JOIN ProductCost ON Product.ProductID = ProductCost.ProductID where Product.productcode ='SNAP LOCK' and ProductCost.hsrp_stateID='2'";
