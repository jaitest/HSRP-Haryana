...
{
    public partial class DailyTGRegisteringAuthorityNEW : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               // cellA.MergeAcross = 3; // Merge two cells togetherto 
                ...
                row.Cells.Add(new WorksheetCell("Month", "HeaderStyle2"));
               WorksheetCell cell1= row.Cells.Add(ddlMonth.SelectedItem.ToString() + "-" + ddlYear.SelectedValue.ToString());
               cell1.MergeAcross = 1;
         ...
         //       row.Cells.Add(new WorksheetCell(ddlMonth.SelectedItem.ToString() + "-" + ddlYear.SelectedValue.ToString(), "HeaderStyle2"));
               ...
               // row.Index = 7; 
                ...
                row.Cells.Add(new WorksheetCell("Price Charged", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Replacement", "HeaderStyle"));
                row.Cells.Add(new WorksheetCell("Price Charged", "HeaderStyle"));
                ...
                SQLString = "exec Report_Monthly_Statement_Registering_Authority'" + FromDate + "','" + ToDate + "','11','"+ ddllocation.SelectedValue +"'";
                ...
                if (ds.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dtrows in ds.Rows) // Loop over the rows.
                    {
                        ...
                        if (Type == "2W")
                        { 
                            row.Cells.Add(new WorksheetCell("Complete Set of Registration Plates Inclusive of Snap Lock and fixing for 2 Wheelers- Schooters, Motorcycles, Mopeds,Agricultural Tractors", DataType.String, "HeaderStyle1"));
                    ...
                    row = sheet.Table.Rows.Add();
                    WorksheetCell cell123 = row.Cells.Add("* Price Charged-HSRP Prices as per the PIA.");
                    cell123.MergeAcross = 8;
