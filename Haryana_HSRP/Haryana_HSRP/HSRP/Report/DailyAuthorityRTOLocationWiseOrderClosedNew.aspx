<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyAuthorityRTOLocationWiseOrderClosedNew.aspx.cs" Inherits="HSRP.Report.DailyAuthorityRTOLocationWiseOrderClosedNew" %>
                                   ...
                                   <td valign="top" onmouseup="HSRPAuthDate_OnMouseUp()" align="left">
                                    ...
                                    <td style="Position:relative; right:0px; top: 0px;"> 
                                        ...
                                        <asp:Button ID="btnExportToExcel" runat="server" Text="Report In Excel" ToolTip="Please Click for Report"
                                            class="button"  style="background-color:orange"
                                            onclick="btnExportToExcel_Click"    />
                                    </td>
                                    <td>
                                                                                      <asp:Button ID="btnAllLocationPdf" runat="server" 
                                                        Text="For All Location" ToolTip="Please Click for Report" style="background-color:orange"
