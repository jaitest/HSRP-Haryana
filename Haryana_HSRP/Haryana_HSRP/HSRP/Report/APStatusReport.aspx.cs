...
{
    public partial class APStatusReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "CollectionEmbsoongAffixactionReport-" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                book.Properties.Title = "CollectionEmbsoongAffixactionReport";
                ...
                Worksheet sheet = book.Worksheets.Add("CollectionEmbsoongAffixactionReport");
                ...
                WorksheetCell cell = row.Cells.Add("CollectionEmbsoongAffixactionReport");
                ...
                if (dropDownListClient.SelectedItem.Text == "--ALL--")
                {
                    ...
                    row.Cells.Add(new WorksheetCell("Vehicles", "HeaderStyle6"));
                    row.Cells.Add(new WorksheetCell("Collection", "HeaderStyle6"));
                    row.Cells.Add(new WorksheetCell("Production", "HeaderStyle6"));
                    row.Cells.Add(new WorksheetCell("Affixation", "HeaderStyle6"));
                    //row.Cells.Add(new WorksheetCell("Total Record", "HeaderStyle6"));
                    ...
                    SQLString = "exec Report_AllStateLocationWise12'" + ReportDate1 + "','" + ReportDate2 + "','" + DropDownListStateName.SelectedValue + "'";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                        {
                            ...
                            row.Cells.Add(new WorksheetCell(dtrows["Date"].ToString(), DataType.String, "HeaderStyle"));
                            ...
                            row.Cells.Add(new WorksheetCell(dtrows["Noofvehicles"].ToString(), DataType.String, "HeaderStyle"));
                            row.Cells.Add(new WorksheetCell(dtrows["coll_amt"].ToString(), DataType.String, "HeaderStyle"));
                            row.Cells.Add(new WorksheetCell(dtrows["Production"].ToString(), DataType.String, "HeaderStyle"));
                            row.Cells.Add(new WorksheetCell(dtrows["Affixation"].ToString(), DataType.String, "HeaderStyle"));
                ...
                else
                {
                    ...
                    row.Cells.Add(new WorksheetCell("Date", "HeaderStyle6"));
                    // row.Cells.Add(new WorksheetCell("Location Name", "HeaderStyle6"));
                    row.Cells.Add(new WorksheetCell("Collection Order", "HeaderStyle6"));
                    row.Cells.Add(new WorksheetCell("Embossing Order", "HeaderStyle6"));
                    row.Cells.Add(new WorksheetCell("Affixation Order", "HeaderStyle6"));
                    row = sheet.Table.Rows.Add();
                    DateTime OrderDate3 = Convert.ToDateTime(ReportDate1);

                    SQLString = "exec Report_AllStateLocationWise1'" + ReportDate1 + "','" + ReportDate2 + "','" + DropDownListStateName.SelectedValue + "','" + dropDownListClient.SelectedValue + "'";
                }
               ...
               // decimal TotalRecordSum = 0;
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        //row.Cells.Add(new WorksheetCell(dtrows["Dailyneworder"].ToString(), DataType.String, "HeaderStyle"));
                        row.Cells.Add(new WorksheetCell(dtrows["Collectionorder"].ToString(), DataType.String, "HeaderStyle"));
                        row.Cells.Add(new WorksheetCell(dtrows["Embossing"].ToString(), DataType.String, "HeaderStyle"));
                        row.Cells.Add(new WorksheetCell(dtrows["Affixation"].ToString(), DataType.String, "HeaderStyle"));
                       // int intNewOrder = int.Parse(dtrows["Dailyneworder"].ToString());
                        // int intEmbOrder=int.Parse(dtrows["Dailyemborder"].ToString());
                        // int intCloseOrder=int.Parse(dtrows["Dailycloseorder"].ToString());
