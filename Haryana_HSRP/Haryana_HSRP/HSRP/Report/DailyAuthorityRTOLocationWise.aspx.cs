...
{
    public partial class DailyAuthorityRTOLocationWise : System.Web.UI.Page
    {
        ...
        protected void btnAllLocationPdf_Click(object sender, EventArgs e)
        {
            ...
            for (int iRowNo = 0; iRowNo < dtrto.Rows.Count; iRowNo++)
            {
                ...
                SQLString = "SELECT CONVERT(varchar(20), a.HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), a.OrderDate, 103) AS OrderDate, a.HSRPRecordID,a.CashReceiptNo, VehicleClass,CONVERT(numeric,round(a.RoundOff_NetAmount,0)) as NetAmount, a.HSRPRecord_AuthorizationNo, a.OwnerName, a.VehicleClass, a.VehicleType, a.VehicleRegNo, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.StickerMandatory,  (select P.productCode from Product P Where P.ProductID =a.FrontPlateSize) as FrontPlateCode, (select P.productCode from Product P Where P.ProductID =a.RearPlateSize) as RearPlateCode  FROM HSRPRecords a  where a.HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + RTOCode + "' and a.HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and orderstatus in ('New Order','Embossing Done') order by OrderEmbossingDate";               
                DataTable dtRecord = Utils.GetDataTable(SQLString, CnnString);
                if (dtRecord.Rows.Count > 0)
                {
        ...
        private static void StyleForTheFirstTime(Workbook book)
        {
            ...
            book.Properties.Title = "HSRP Authority Report";
        ...
        private void ExportRecordExcel(Workbook book, DataTable dt, string RtoName = null, string RtoCode = null)
        {
            try
            {
                ...
                WorksheetCell cell = row.Cells.Add("HSRP Authority Report");
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    cell1.MergeAcross = 13;
                    cell1.StyleID = "HeaderStyle2";
                    row.Cells.Add(new WorksheetCell(totalAmount.ToString(), DataType.String, "HeaderStyle"));
                    row = sheet.Table.Rows.Add();
                }
                else
                {
