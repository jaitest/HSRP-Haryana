<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MPCashReport.aspx.cs" Inherits="HSRP.Report.MPCashReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Bank&nbsp; - Pay in Slip</span></td>
                                    ...
                                    <td valign="top" style="width:105px"; onmouseup="OrderDate_OnMouseUp()">
                                                ...
                                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 100px">
                                                    ...
                                                    <asp:DropDownList ID="ddlLocation" runat="server" AutoPostBack="false" 
                                                            CausesValidation="false"  DataTextField="RTOLocationName" style="width: 140px" 
                                                ...
                                                <td><asp:Button ID="Button1" runat="server" class="button" onclick="Button1_Click" Width="200px" Text="Report In PDF" /></td>
                                                <td style="position: relative; right: -25px; top: 0px; width: 224px;">
                                                    &nbsp;</td>
                                                <tr>
                                                    <td colspan="9">
