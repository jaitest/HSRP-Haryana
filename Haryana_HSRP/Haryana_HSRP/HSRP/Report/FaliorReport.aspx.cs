...
{
    public partial class FaliorReport : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(book, 1, "Falior_report_with_Detail");
        ...
        private void Export(Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                string filename = "FailureRecordsatEmobossig" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                book.Properties.Title = "Failure Report";
                ...
                int Month = now.Month;
                int Year = now.Year;
                string FromDate = Month+"/" + 1+ "/" + Year + " " + "00:00:00";

                 var yesterday = DateTime.Today.AddDays(-1);
                 string ToDate = yesterday.ToString("MM/dd/yyyy");
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    WorksheetCell cell = row.Cells.Add("Faliure Report");
                    ...
                    string Mon = CurrentDate.ToString("MMM");
                    int Yr = now.Year;
                    string StartDate =  1 + "/" +Mon+"/"+ Yr ;                    
                    string Date = DateTime.Today.AddDays(-1).ToString("dd/MMM/yyyy");
                    //========================================================


                    AddNewCell(row, "Report Date from:", "HeaderStyle2", 1);

                    AddNewCell(row, StartDate, "HeaderStyle2", 1);

                    AddNewCell(row, "Report Date To:", "HeaderStyle2", 1);
                    AddNewCell(row, Date, "HeaderStyle2", 1);
        ...
        #region  BtnFliutre_Click

        protected void BtnFliutre_Click(object sender, EventArgs e)
        {
            this.SaveAndDownloadFile1();
        }
        private void SaveAndDownloadFile1()
        {
            Workbook book = new Workbook();
            Exports(book, 1, "Falior_report");

        }
        public void Exports(Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {

                string filename = "FailureRecord" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
