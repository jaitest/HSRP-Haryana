...
{
    public partial class DailyCashCollectionRTOLocationWise_HHT_Book : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
              ...
              //  row.Cells.Add(new WorksheetCell("Close Date", "HeaderStyle6"));
                ...
                row.Cells.Add(new WorksheetCell("HHT Receipt No", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Cash Receipt No", "HeaderStyle6"));

                row.Cells.Add(new WorksheetCell("Order Book By", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Order Closed By", "HeaderStyle6"));
                        ...
                        { 
                            ...
                            { 
                              ...
                              //  row.Cells.Add(new WorksheetCell(dtrows["OrderDate"].ToString(), DataType.String, "HeaderStyle"));
                                ...
                                string Addrecordby = dtrows["Addrecordby"].ToString();
                                if (Addrecordby == "")
                                { 
                                    row.Cells.Add(new WorksheetCell("HSRP", DataType.String, "HeaderStyle"));
                                    row.Cells.Add(new WorksheetCell("", DataType.String, "HeaderStyle")); 
                                }
                                else
                                { 
                                    row.Cells.Add(new WorksheetCell(dtrows["Addrecordby"].ToString(), DataType.String, "HeaderStyle"));
                                    row.Cells.Add(new WorksheetCell(dtrows["CashReceiptNo_HHT"].ToString(), DataType.String, "HeaderStyle"));
                                }

                                row.Cells.Add(new WorksheetCell(dtrows["CashReceiptNo"].ToString(), DataType.String, "HeaderStyle")); 
                                row.Cells.Add(new WorksheetCell(dtrows["OrderBookName"].ToString(), DataType.String, "HeaderStyle"));
                                row.Cells.Add(new WorksheetCell(dtrows["OrderClosedName"].ToString(), DataType.String, "HeaderStyle")); 
