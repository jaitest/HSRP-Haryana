...
namespace HSRP.Report
{
    public partial class DailyHREmbossingReport : System.Web.UI.Page
    {
        ...
        private void InitialSetting()
        {
            ...
            HSRPAuthDate.MinDate = DateTime.Parse("2015-04-01");
            ...
            OrderDate.MinDate = DateTime.Parse("2015-04-01");
        }
        #region DropDown
        ...
        private void FilldropDownListOrganization()
        {
            ...
            if (UserType.Equals(0))
            {
                SQLString = "select HSRPStateName,HSRP_StateID from HSRPState  where ActiveStatus='Y' and HSRP_StateID=4  Order by HSRPStateName";
        ...
        {
            SQLString = "select rtolocationname,rtolocationcode from rtolocation  where hsrp_stateid='4' and rtolocationid in (select distinct distrelation from rtolocation where  hsrp_stateid='4') Order by rtolocationname";
        ...
        {
            LabelError.Text = "";
             TimeSpan ts = Convert.ToDateTime(HSRPAuthDate.SelectedDate )- Convert.ToDateTime(OrderDate.SelectedDate);
             if (ts.Days <= 7)
             {
                 ExportToPDF();
             }
        ...
        private void BindGrid()
        {
            ...
            SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo,  a.HSRPRecord_AuthorizationNo +' / '+ a.VehicleRegNo as 'Application No',  convert(varchar(10),  hsrprecord_creationdate, 105) as[ Order Date],  a.VehicleType,a.OwnerName,a.HSRP_Front_LaserCode as FrontLaserNo,  a.HSRP_Rear_LaserCode as RearLaserNo,  Product_1.ProductCode AS FrontPlateSize,  b.ProductCode AS RearPlateSize,   case when a.StickerMandatory='N' then 'NA' else a.StickerMandatory end  as [3RD RP Y/N],    b.ProductColor as [Color BackGround],	 '' as Remarks	 FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID 	 WHERE  a.HSRP_StateID= 4 AND a.OrderEmbossingDate  between '" + FromDate + "' and '" + ToDate + "' and left(VehicleRegNo,4)='" + dropDownListClient.SelectedValue.ToString() + "'";
            //SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo, a.HSRPRecord_AuthorizationNo +' / '+ a.VehicleRegNo as 'Application No',a.VehicleType,a.OwnerName,a.HSRP_Front_LaserCode as FrontLaserNo,a.HSRP_Rear_LaserCode as RearLaserNo,Product_1.ProductCode AS FrontPlateSize,b.ProductCode AS RearPlateSize1, a.StickerMandatory, b.ProductColor,a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '4' AND a.OrderEmbossingDate  between '" + FromDate + "' and '" + ToDate + "'";
        ...
        private void ExportToPDF()
        {
           ...
           // SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo,  b.ProductColor, a.HSRPRecord_AuthorizationNo as vh1,a.VehicleRegNo as vh2, a.OrderEmbossingDate,convert(varchar,a.hsrprecord_creationdate,103) as hsrprecord_creationdate, a.HSRPRecordID, a.OwnerName, a.VehicleType, a.HSRP_Front_LaserCode,Product_1.ProductColor,a.HSRP_Rear_LaserCode, a.VehicleClass, case when a.StickerMandatory='N' then 'N' else a.StickerMandatory end as StickerMandatory, Product_1.ProductCode AS FrontPlateSize, a.RearPlateSize, b.ProductCode AS RearPlateSize1,a.FrontPlateSize AS FrontPlateSize ,a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '4' AND a.hsrprecord_creationdate  between '" + FromDate + "' and '" + ToDate + "'";

            //SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo,  a.HSRPRecord_AuthorizationNo +' / '+ a.VehicleRegNo as vh1, convert(varchar(10),hsrprecord_creationdate,105) as OrderDate ,  a.VehicleType,a.OwnerName,a.HSRP_Front_LaserCode as FrontLaserNo,  a.HSRP_Rear_LaserCode as RearLaserNo,  Product_1.ProductCode AS FrontPlateSize,  b.ProductCode AS RearPlateSize,   a.StickerMandatory  as RDRPYN,    b.ProductColor as ColorBackGround,	 '' as Remarks	 FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID 	 WHERE  a.HSRP_StateID= 4 AND a.OrderEmbossingDate  between '" + FromDate + "' and '" + ToDate + "' and left(VehicleRegNo,4)='" + dropDownListClient.SelectedValue.ToString() + "'";
            SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo,  a.HSRPRecord_AuthorizationNo +' / '+ a.VehicleRegNo as vh1, convert(varchar(10),hsrprecord_creationdate,105) as OrderDate ,  a.VehicleType,a.OwnerName,a.HSRP_Front_LaserCode as FrontLaserNo,  a.HSRP_Rear_LaserCode as RearLaserNo,  Product_1.ProductCode AS FrontPlateSize,  b.ProductCode AS RearPlateSize,   case when a.StickerMandatory='N' then 'NA' else a.StickerMandatory end  as RDRPYN,    b.ProductColor as ColorBackGround,	 '' as Remarks	 FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID 	 WHERE  a.HSRP_StateID= 4 AND a.OrderEmbossingDate  between '" + FromDate + "' and '" + ToDate + "' and left(VehicleRegNo,4)='" + dropDownListClient.SelectedValue.ToString() + "'";
            DataTable dt = Utils.GetDataTable(SQLString, CnnString);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["vh1"].ToString(), 30, 0);
                ...
                GenerateCell(table, 1, -2, 1, 0, 1, 1, 1, dt.Rows[i]["VehicleType"].ToString(), 20, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["OwnerName"].ToString(), 20, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["FrontLaserNo"].ToString(), 10, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["RearLaserNo"].ToString(), 10, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["FrontPlateSize"].ToString(), 10, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["RearPlateSize"].ToString(), 10, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["RDRPYN"].ToString(), 20, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["ColorBackGround"].ToString(), 20, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["Remarks"].ToString(), 20, 0);
        ...
        private void ExportToPDFAll()
        {
            ...
            for (int iRowNo = 0; iRowNo < dtrto.Rows.Count; iRowNo++)
            {
                ...
                HttpContext context = HttpContext.Current;
                string filename = "" + RTOName + "ER" + "_" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + "HRS-C" + ".pdf";
                string SQLString = String.Empty;
                Document document = new Document();
                ...
                SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo,  a.HSRPRecord_AuthorizationNo +' / '+ a.VehicleRegNo as 'Application No',  hsrprecord_creationdate as[ Order Date],  a.VehicleType,a.OwnerName,a.HSRP_Front_LaserCode as FrontLaserNo,  a.HSRP_Rear_LaserCode as RearLaserNo,  Product_1.ProductCode AS FrontPlateSize,  b.ProductCode AS RearPlateSize,   case when a.StickerMandatory='N' then 'NA' else a.StickerMandatory end  as [3RD RP Y/N],    b.ProductColor as [Color BackGround],	 '' as Remarks	 FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID 	 WHERE  a.HSRP_StateID= 4 AND a.OrderEmbossingDate  between '" + FromDate + "' and '" + ToDate + "' and left(VehicleRegNo,4)='" + dropDownListClient.SelectedValue.ToString() + "'";
                //SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo,  b.ProductColor, a.HSRPRecord_AuthorizationNo as vh1,a.VehicleRegNo as vh2,convert(varchar,a.hsrprecord_creationdate,103) as hsrprecord_creationdate, a.OrderEmbossingDate, a.HSRPRecordID, a.OwnerName, a.VehicleType, a.HSRP_Front_LaserCode,Product_1.ProductColor,a.HSRP_Rear_LaserCode, a.VehicleClass, case when a.StickerMandatory='N' then 'N' else a.StickerMandatory end as StickerMandatory, Product_1.ProductCode AS FrontPlateSize, a.RearPlateSize, b.ProductCode AS RearPlateSize1,a.FrontPlateSize AS FrontPlateSize ,a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '4' and a.rtolocationid='" + RTOCode + "' AND a.hsrprecord_creationdate  between '" + FromDate + "' and '" + ToDate + "'";
                DataTable dt = Utils.GetDataTable(SQLString, CnnString);
                ...
                GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Application No.", 40, 0);
                //GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Vehicle Reg No", 20, 0);
                //GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Cash Collection Date", 20, 0);
                GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Vehicle Type", 20, 0);
                GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Owner Name", 20, 0);
                GenerateCell(table, 2, 0, 1, 1, 1, 1, 0, "Laser Identification No", 20, 0);

                GenerateCell(table, 2, 0, 1, 1, 1, 1, 0, "RP Size", 20, 0);
                GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Sticker Mandatory", 20, 0);
                GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Color", 20, 0);
                GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Remark", 20, 0);
               ...
               // GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "", 20, 0);
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    // GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["vh2"].ToString(), 20, 0);
                    //GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["Hsrprecord_CreationDate"].ToString(), 20, 0);
