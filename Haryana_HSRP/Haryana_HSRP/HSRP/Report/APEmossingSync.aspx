<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="APEmossingSync.aspx.cs" Inherits="HSRP.Report.APEmossingSync" %>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                              &nbsp;<span class="headingmain">Embossing Sync</span>&nbsp;</td>
                    </tr>
                                    ...
                                    <td valign="middle" class="Label_user_batch" style="width: 119px">
                                      ...
                                      <td valign="middle" class="Label_user_batch" style="width: 119px">
                                        ...
                                        style="width: 100px">
                                                    ...
                                                    <asp:Button ID="btnGo" runat="server" Text="Go" class="button"  Width="100px" BackColor="Orange" ForeColor="#000000" onclick="btnGo_Click"></asp:Button>
                                                    &nbsp;
                                                </td>
                                        ...
                                        align="left" style="width: 138px">
                                                ...
                                                <td valign="middle" class="Label_user_batch" style="width: 120px">
                                                    <%--<img id="ImgPollution" tabindex="4" alt="" onclick="HSRPAuthDate_OnClick()" onmouseup="HSRPAuthDate_OnMouseUp()"
                                                        ...
                                                        <asp:Button ID="btnpdf" runat="server" Text="DownloadInPdf" class="button" BackColor="Orange" ForeColor="#000000" Width="100px" Visible="false" onclick="btnpdf_Click"></asp:Button>
                                                </td>
                        ...
                        <td>
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 114px">
                                    &nbsp;
                                    <asp:Button ID="btnSync" runat="server" Text="Sync" class="button"  
                                        Width="100px" Visible="false" BackColor="Orange" ForeColor="#000000" onclick="btnSync_Click" ></asp:Button></td>
                                ...
                                <asp:GridView ID="grdpending" runat="server" CellPadding="8" ForeColor="#333333"  AutoGenerateColumns="false"
                                    ...
                                    <asp:TemplateField HeaderText="S.No">
                                     ...
                                     <asp:BoundField HeaderText="RTOName" DataField="RTO" />
                                     <asp:BoundField HeaderText="OrderCount" DataField="OrderCount" />
                                     <asp:BoundField HeaderText="AssignedCount" DataField="AssignedCount" />
