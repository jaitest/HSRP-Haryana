...
namespace HSRP.Report
{
    public partial class HRMonthlyReport : System.Web.UI.Page
    {
        ...
        private void FilldropDownListClient()
        {
            SQLString = "select rtolocationname,rtolocationid from rtolocation  where hsrp_stateid='4' and rtolocationid in (select distinct distrelation from rtolocation where  hsrp_stateid='4') Order by rtolocationname";
        ...
        private void ExportToPDF()
        {
            ...
            string RTOName = dropDownListClient.SelectedItem.Text.ToString();
            string RTOCode = dropDownListClient.SelectedValue.ToString();
            ...
            SQLString = "SELECT ROW_NUMBER() over( order by  HSRPRecord_AuthorizationNo) as 'SNo',HSRP_Front_LaserCode as 'FrontLaserNo',HSRP_Rear_LaserCode as 'RearLaserNo',  VehicleRegNo, OwnerName,rtrim(ltrim(Address1)) as 'Address1',vehicletype,   case  when  OrderType = 'NB' then 'New'  when  OrderType =  'OB' then 'Old'    when OrderType =  'DB' then 'Damage Both'  when OrderType =  'DF' then 'Damage Front'  when OrderType =  'DR' then 'Damage Rear'   else '' end   as  'OrderType' ,  case when hsrprecord_Authorizationdate ='1900-01-01 00:00:00.000' then '' else convert(varchar(20),hsrprecord_Authorizationdate,103) end  as 'AuthorizationDate',convert(varchar,OrderDate,103)as 'OrderDate' ,convert(varchar,OrderClosedDate,103)as 'ClosedDate' FROM HSRPRecords   WHERE  HSRP_StateID= '4' and rtolocationid='" + RTOCode + "' AND OrderClosedDate  between '" + FromDate + "' and '" + ToDate + "' ";
          //  SQLString = "SELECT ROW_NUMBER() over( order by  HSRPRecord_AuthorizationNo) as 'SNo',HSRP_Front_LaserCode as 'FrontLaserNo',HSRP_Rear_LaserCode as 'RearLaserNo',VehicleRegNo, OwnerName,rtrim(ltrim(Address1)) as 'Address1',vehicletype,OrderType as 'OrderType',case when hsrprecord_Authorizationdate ='1900-01-01 00:00:00.000' then '' else convert(varchar(20),hsrprecord_Authorizationdate,103) end as 'AuthorizationDate',convert(varchar,OrderDate,103)as 'OrderDate' ,convert(varchar,OrderClosedDate,103)as 'ClosedDate' FROM HSRPRecords   WHERE  HSRP_StateID= '4' and rtolocationid='" + RTOCode + "' AND hsrprecord_creationdate  between '" + FromDate + "' and '" + ToDate + "'";
            ...
            GenerateCell(table, 12, 0, 0, 0, 0, 1, 0, "SCHEDULE-F", 20, 0);
            GenerateCell(table, 12, 0, 0, 0, 0, 0, 0, "", 20, 0);
            GenerateCell(table, 12, 0, 0, 0, 0, 1, 0, "Monthly Report From Concessionaire to Registering Authority", 20, 0);
            ...
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Registration No", 40, 0);
            ...
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Price Collection Date", 40, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Affixation Date", 40, 0);
           // GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Embossing Date", 40, 0);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
              ...
              //  GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["OrderEmbossingDate"].ToString(), 20, 0);
        ...
        private void ExportToAllPDF()
        {
             ...
             // string RTOCode = dtrto.Rows[iRowNo]["RTOLocationid"].ToString();
                 ...
                 string filename = "" + RTOName + "RA" + "_" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + "HRS-F" + ".pdf";
                  ...
                  SQLString = "SELECT ROW_NUMBER() over( order by  HSRPRecord_AuthorizationNo) as 'SNo',HSRP_Front_LaserCode as 'FrontLaserNo',HSRP_Rear_LaserCode as 'RearLaserNo',  VehicleRegNo, OwnerName,rtrim(ltrim(Address1)) as 'Address1',vehicletype,   case  when  OrderType = 'NB' then 'New'  when  OrderType =  'OB' then 'old'    when OrderType =  'DB' then 'Damage Both'  when OrderType =  'DF' then 'Damage Front'  when OrderType =  'DR' then 'Damage Rear'      else '' end   as  'OrderType' ,  case when hsrprecord_Authorizationdate ='1900-01-01 00:00:00.000' then '' else convert(varchar(20),hsrprecord_Authorizationdate,103) end  as 'AuthorizationDate',convert(varchar,OrderDate,103)as 'OrderDate' ,convert(varchar,OrderClosedDate,103)as 'ClosedDate' FROM HSRPRecords   a  inner join   RTOLocation b on b.rtolocationid = a.rtolocationid    WHERE  a.HSRP_StateID= '4'  and  OrderClosedDate  between '" + FromDate + "' and '" + ToDate + "'";
                 // SQLString = "SELECT ROW_NUMBER() over( order by  HSRPRecord_AuthorizationNo) as 'SNo',HSRP_Front_LaserCode as 'FrontLaserNo',HSRP_Rear_LaserCode as 'RearLaserNo',VehicleRegNo, OwnerName,rtrim(ltrim(Address1)) as 'Address1',vehicletype,OrderType as 'OrderType',case when hsrprecord_Authorizationdate ='1900-01-01 00:00:00.000' then '' else convert(varchar(20),hsrprecord_Authorizationdate,103) end as 'AuthorizationDate',convert(varchar,OrderDate,103)as 'OrderDate' ,convert(varchar,OrderClosedDate,103)as 'ClosedDate' FROM HSRPRecords   WHERE  HSRP_StateID= '4' and rtolocationid='" + RTOCode + "' AND hsrprecord_creationdate  between '" + FromDate + "' and '" + ToDate + "'";
                  DataTable dt = Utils.GetDataTable(SQLString, CnnString);
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            if (ts.Days <= 7)
            {
                ...
                //OrderDate1 = new DateTime(Convert.ToInt32(StringOrderDate[2].Split(' ')[0]), Convert.ToInt32(StringOrderDate[0]), Convert.ToInt32(StringOrderDate[1]));
                string ToDate = From1 + " 23:59:59";
                SQLString = "SELECT ROW_NUMBER() over( order by  HSRPRecord_AuthorizationNo) as 'SNo',HSRP_Front_LaserCode as 'FrontLaserNo',HSRP_Rear_LaserCode as 'RearLaserNo',  VehicleRegNo, OwnerName,rtrim(ltrim(Address1)) as 'Address1',vehicletype,   case  when  OrderType = 'NB' then 'New'  when  OrderType =  'OB' then 'Old'    when OrderType =  'DB' then 'Damage Both'  when OrderType =  'DF' then 'Damage Front'  when OrderType =  'DR' then 'Damage Rear'   else '' end   as  'OrderType' ,  case when hsrprecord_Authorizationdate ='1900-01-01 00:00:00.000' then '' else convert(varchar(20),hsrprecord_Authorizationdate,103) end  as 'AuthorizationDate',convert(varchar,OrderDate,103)as 'Price Collection Date' ,convert(varchar,OrderClosedDate,103)as 'Affixation Date' FROM HSRPRecords   WHERE  HSRP_StateID= '4' and rtolocationid='" + dropDownListClient.SelectedValue.ToString() + "' AND OrderClosedDate  between '" + FromDate + "' and '" + ToDate + "' ";
                DataTable dt = Utils.GetDataTable(SQLString, CnnString);
                if (dt.Rows.Count > 0)
                {
