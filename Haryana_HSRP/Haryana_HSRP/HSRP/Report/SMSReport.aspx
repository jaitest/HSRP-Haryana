<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="SMSReport.aspx.cs" Inherits="HSRP.Report.SMSReport" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">SMS Report</span>
                                    </td>
    ...
    <table style="width: 85%; height: 51px; left: 50px;">
        <tr>
            ...
            <td width="80">
                <asp:Button ID="btGO" runat="server" Text="GO" Font-Bold="True" ForeColor="#3333FF"
                    OnClick="btGO_Click" />
            </td>
            <td width="80">
        ...
        <%-- <td height="35" align="right" valign="middle" class="footer">
                    ...
                    <tr>
                        <td >
                            <asp:GridView ID="grdSMS" runat="server" CssClass="maintext" CellPadding="4" 
