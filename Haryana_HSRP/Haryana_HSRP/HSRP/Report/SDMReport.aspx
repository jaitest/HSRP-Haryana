<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SDMReport.aspx.cs" Inherits="HSRP.Report.SDMReport"%>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">SDM Report</span>
                                    </td>
                                            ...
                                            <tr>
                                                ...
                                                <td valign="middle" style="width:  50px">
                                                    <asp:DropDownList CausesValidation="false" ID="DropDownListStateName"
                                                        runat="server" DataTextField="HSRPStateName" AutoPostBack="true" DataValueField="HSRP_StateID" OnSelectedIndexChanged="DropDownListStateName_SelectedIndexChanged">
                                                    </asp:DropDownList><br />
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Select State" ControlToValidate="DropDownListStateName" ValidationGroup="Excel" InitialValue="--Select State--"></asp:RequiredFieldValidator>
                                                </td>
                                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 100px">
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="SDMReport"  ToolTip="Please Click for Report" ValidationGroup="Excel" BackColor="Orange" ForeColor="#000000"
