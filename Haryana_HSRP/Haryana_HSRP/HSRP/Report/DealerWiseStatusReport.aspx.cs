...
{
    public partial class DealerWiseStatusReport : System.Web.UI.Page
    {
        int UserType1;
        ...
        protected void btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //change sp Name
                cmd = new SqlCommand("[Business_Online_Datewise_DealerWise_StatusReport]", con);//Business_ReportTypewisesummary_report
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "[Business_Online_Datewise_DealerWise_StatusReport]");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                string filename = "Datewise_DealerWise_StatusReport" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                book.Properties.Title = "Datewise DealerWise StatusReport";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    WorksheetCell cell = row.Cells.Add("Datewise DealerWise StatusReport");
