...
namespace HSRP.UTKReports
{
    public partial class DailyRegisteringAuthority : System.Web.UI.Page
    {
        ...
        private void FilldropDownListOrganization()
        {
            ...
            {
                SQLString = "select HSRPStateName,HSRP_StateID from HSRPState  where hsrp_stateID in ('6') and ActiveStatus='Y' Order by HSRPStateName";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SQLString = "Report_Monthly_Statement_Registering_Authority'" + FromDate + "','" + ToDate + "','6','"+dropDownListClient.SelectedValue+"'";
