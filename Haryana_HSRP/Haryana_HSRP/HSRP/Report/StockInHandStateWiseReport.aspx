<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StockInHandStateWiseReport.aspx.cs" Inherits="HSRP.Report.StockInHandStateWiseReport" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Stock In Hand State Wise Report</span>
                                    </td>
                                        ...
                                        <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                            <tr>
                                                ...
                                                <td valign="middle" style="width:  50px">
                                                    ...
                                                    <td valign="middle" class="form_text" nowrap="nowrap" style="width: 100px"> 
                                                        <asp:Label Text="Plate Status:" runat="server" ID="lblplatestatus" />     </td>
                                                    
                                                    <td>
                                                        <asp:DropDownList ID="ddlplatestatus" runat="server">
                                                            <asp:ListItem>Blank Plate</asp:ListItem>
                                                            <asp:ListItem>Embossed Plate</asp:ListItem>
                                                            <asp:ListItem>Closed Plate</asp:ListItem>
                                                        </asp:DropDownList>
                                                </td>
                                                </td> 
                                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 100px">
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="EXP In Excel" ToolTip="Please Click for Report"
