    ...
    public partial class AvgVehicleCountReport : System.Web.UI.Page
    {
        ...
        public void BuildGrid1()
        {
            try
            {
                ...
                {
                    SQLString = "select convert(varchar(5),DATEPART(YEAR, ORDERDATE)) as [YEAR],DATENAME(MONTH, ORDERDATE) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and hsrprecord_creationdate    between '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED','E-RICKSHAW') group by vehicletype,VehicleClass,DATEPART(YEAR, ORDERDATE),DATENAME(MONTH, ORDERDATE)";
                }
                else if (ddlOrderType.SelectedItem.ToString() == "Production")
                {

                    SQLString = "select convert(varchar(5),DATEPART(YEAR, OrderEmbossingDate)) as [YEAR],DATENAME(MONTH, OrderEmbossingDate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and OrderEmbossingDate  between '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED','E-RICKSHAW') and Orderstatus in('Embossing Done','closed') group by vehicletype,VehicleClass,DATEPART(YEAR, OrderEmbossingDate),DATENAME(MONTH, OrderEmbossingDate)";
                }
                else
                {

                    SQLString = "select convert(varchar(5),DATEPART(YEAR, OrderClosedDate)) as [YEAR],DATENAME(MONTH, OrderClosedDate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and OrderClosedDate between   '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED','E-RICKSHAW') and Orderstatus in('closed') group by vehicletype,VehicleClass,DATEPART(YEAR, OrderClosedDate),DATENAME(MONTH, OrderClosedDate)";
                }
        ...
        public void BuildGrid()
        {
            try
            {
                ...
                if (ddlOrderType.SelectedItem.ToString()=="Booking")
                {
                    SQLString = "select convert(varchar(5),DATEPART(YEAR, ORDERDATE)) as [YEAR],DATENAME(MONTH, ORDERDATE) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and RTOLocationID=" + dropDownListClient.SelectedValue.ToString() + " and hsrprecord_creationdate    between '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED','E-RICKSHAW') group by vehicletype,VehicleClass,DATEPART(YEAR, ORDERDATE),DATENAME(MONTH, ORDERDATE)";
                }
                else if (ddlOrderType.SelectedItem.ToString()=="Production")
                {
                    SQLString = "select convert(varchar(5),DATEPART(YEAR, OrderEmbossingDate)) as [YEAR],DATENAME(MONTH, OrderEmbossingDate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and RTOLocationID=" + dropDownListClient.SelectedValue.ToString() + " and OrderEmbossingDate  between '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED','E-RICKSHAW') and Orderstatus in('Embossing Done','closed') group by vehicletype,VehicleClass,DATEPART(YEAR, OrderEmbossingDate),DATENAME(MONTH, OrderEmbossingDate)";
                }

                else
                {

                    SQLString = "select convert(varchar(5),DATEPART(YEAR, OrderClosedDate)) as [YEAR],DATENAME(MONTH, OrderClosedDate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and RTOLocationID=" + dropDownListClient.SelectedValue.ToString() + " and OrderClosedDate between  '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED','E-RICKSHAW') and Orderstatus in('closed') group by vehicletype,VehicleClass,DATEPART(YEAR, OrderClosedDate),DATENAME(MONTH, OrderClosedDate)";
                }
                ...
                try
                {
                    ...
                    if (dropDownListClient.SelectedItem.Text == "ALL")
                    {
                        ...
                        else
                        {
                            ...
                            SQLString = "select convert(varchar(5),DATEPART(YEAR, OrderClosedDate)) as [YEAR],DATENAME(MONTH, OrderClosedDate) AS [MONTHNAME],Vehicletype,VehicleClass,  count(*) as Total from HSRPRecords"
                            + " where hsrp_stateid=" + DropDownListStateName.SelectedValue.ToString() + " and OrderClosedDate between   '" + ReportDate1 + "' and '" + ReportDate2 + "' and VEHICLETYPE in ('LMV MCV/HCV/TRAILERS','MOTOR CYCLE','SCOOTER','THREE WHEELER','TRACTOR','L.M.V. (CAR)','LMV','LMV(CLASS)','MCV/HCV/TRAILERS','SCOOTER/MOPED','E-RICKSHAW') and Orderstatus in('closed') group by vehicletype,VehicleClass,DATEPART(YEAR, OrderClosedDate),DATENAME(MONTH, OrderClosedDate)";
                        }
