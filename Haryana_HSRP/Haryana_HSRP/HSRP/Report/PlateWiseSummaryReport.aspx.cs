...
{
    public partial class PlateWiseSummaryReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                row.Cells.Add(new WorksheetCell("New Order Details", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Old Order Details", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Damage Order Details", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Total Order", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Collection", "HeaderStyle6"));
   
                row.Cells.Add(new WorksheetCell("285X45-(W)", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("200X100-(W)", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("500X120-(W)", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("340X200-(W)", "HeaderStyle6"));

                row.Cells.Add(new WorksheetCell("285X45-(Y)", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("200X100-(Y)", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("500X120-(Y)", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("340X200-(Y)", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("Total Plates", "HeaderStyle6"));
                ...
                SQLString = "[PlateSummaryReport]'" + OrderDate1 + "'";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(dtrows["DailyOrderNew"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["DailyOrderOld"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["DailyDamageOrder"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["DailyTotalorder"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["DailyCollection"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Daily_285X45_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Daily_200X100_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Daily_500X120_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Daily_340X200_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Daily_285X45_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Daily_200X100_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Daily_500X120_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Daily_340X200_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["DailyTotal_Plates"].ToString(), DataType.Number, "HeaderStyle5"));
                    ...
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(dtrows["MonthlyOrderNew"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["MonthlyOrderOld"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["MonthlyDamageOrder"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["MonthlyTotalorder"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["MonthlyCollection"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Monthly_285X45_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Monthly_200X100_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Monthly_500X120_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Monthly_340X200_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Monthly_285X45_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Monthly_200X100_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Monthly_500X120_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Monhly_340X200_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["MomthlyTotal_Plates"].ToString(), DataType.Number, "HeaderStyle5"));
                    ...
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(Convert.ToInt16(sno).ToString(), DataType.String, "HeaderStyle"));
                        row.Cells.Add(new WorksheetCell(dtrows["Statename"].ToString(), DataType.String, "HeaderStyle7"));
                        row.Cells.Add(new WorksheetCell(dtrows["YearlyOrderNew"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["YearlyOrderOld"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["YearlyDamageOrder"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["YearlyTotalorder"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["YearlyCollection"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Yearly_285X45_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Yearly_200X100_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Yearly_500X120_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Yearly_340X200_W"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Yearly_285X45_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                         row.Cells.Add(new WorksheetCell(dtrows["Yearly_200X100_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Yearly_500X120_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["Yearly_340X200_Y"].ToString(), DataType.Number, "HeaderStyle5"));
                        row.Cells.Add(new WorksheetCell(dtrows["YearlyTotal_Plates"].ToString(), DataType.Number, "HeaderStyle5"));
