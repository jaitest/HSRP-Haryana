...
{
    public partial class VehicleWiseOrderstatusReport : System.Web.UI.Page
    {
        ...
        //        SQLString = "select userID, (userFirstName +' ' +UserLastName) as UserName from Users Where HSRP_StateID=" + DropDownListStateName.SelectedValue + "and RTOLocationID=" + dropDownListClient.SelectedValue + " and usertype='7'  and ActiveStatus!='N'  Order by userFirstName";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String DatePrint = DatePrint2 + " To " + DatePrint1;
               ...
               // OrderDate1 = new DateTime(Convert.ToInt32(StringOrderDate[2].Split(' ')[0]), Convert.ToInt32(StringOrderDate[0]), Convert.ToInt32(StringOrderDate[1]));
                ...
                book.Properties.Title = "Vehicle Wise Order Status Report";
                ...
                Worksheet sheet = book.Worksheets.Add("Vehicle Wise Order Status Report");
               ...
               // WorksheetCell cell = row.Cells.Add("HSRP Daily Cash Collection");
                WorksheetCell cell = row.Cells.Add("Vehicle Wise Order Status Report");
                ...
                row.Cells.Add(new WorksheetCell(dropDownListOrderType.SelectedItem.ToString(), "HeaderStyle2"));
               ...
               // row.Cells.Add(new WorksheetCell("Location Name", "HeaderStyle6"));
                ...
                OrderType = dropDownListOrderType.SelectedValue.ToString();
                //if (OrderType == "Select Order Type")
                //{
                //    LabelError.Text = "Please Select Order Type";
                //}
                //if (OrderType == "New Order" && OrderType == "Embossing Done" )
                //{
               ...
               // if (UserType.Equals(0))
                ...
                //    SQLString = "SELECT HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), OrderDate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,HSRP_Front_LaserCode, HSRP_Rear_LaserCode,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + dropDownListClient.SelectedValue + "'  and OrderStatus!='Closed' and OrderDate between '" + FromDate + "' and '" + ToDate + "' order by OrderDate";

                //}
                if(OrderType=="New Order"||OrderType=="Embossing Done" || OrderType=="Closed")
                 {

                     SQLString = "SELECT  HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), OrderDate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,HSRP_Front_LaserCode,HSRP_Rear_LaserCode,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + dropDownListClient.SelectedValue + "' and  OrderStatus ='" + OrderType + "' and OrderDate between '" + FromDate + "' and '" + ToDate + "' order by OrderDate";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    row.Cells.Add(new WorksheetCell("", "HeaderStyle8"));
                    row.Cells.Add(new WorksheetCell("", "HeaderStyle8"));
                    row.Cells.Add(new WorksheetCell("", "HeaderStyle8"));// yudhvir(24aug) 
                    row.Cells.Add(new WorksheetCell("", "HeaderStyle8"));
                   // row.Cells.Add(new WorksheetCell("", "HeaderStyle8"));//yudhvir
                   // row.Cells.Add(new WorksheetCell("", "HeaderStyle8"));
