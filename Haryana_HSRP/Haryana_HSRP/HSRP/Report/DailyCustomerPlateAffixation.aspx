<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DailyCustomerPlateAffixation.aspx.cs" Inherits="HSRP.Report.DailyCustomerPlateAffixation" %>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Daily Plate Affixation Report Customer-Wise</span>
                                    </td>
                                ...
                                <td></td>
                                 <td valign="middle" class="form_text" nowrap="nowrap">
                                    ...
                                    <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 97px;";> 
                                        <asp:Label Text="From:" runat="server" ID="labelDate" /> </td>
                                    <td valign="top" style="width:105px"; onmouseup="OrderDate_OnMouseUp()">
                                                            ...
                                                            <td style="color: #828282; font: 11pt tahoma,arial,verdana; text-decoration: none; width: 97px;";> <asp:Label Text="To:" Visible="true" runat="server" ID="labelDateTo" /> </td>
                                    
                                                               <td valign="top" style="width:105px"; onmouseup="HSRPAuthDate_OnMouseUp()">
                                                            ...
                                                            <td valign="top" style="width:44px";>
                                                                <img id="Img1"  alt="" onclick="HSRPAuthDate_OnClick()"
                                                                    onmouseup="HSRPAuthDate_OnMouseUp()" class="calendar_button" src="../images/btn_calendar.gif" /></td>  
