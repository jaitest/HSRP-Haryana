<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CollectionAndSummary.aspx.cs" Inherits="HSRP.Report.CollectionAndSummary" %>
        ...
        <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="labelOrder" runat="server" Font-Bold="True" ForeColor="Black" 
                            style="font-size: small" Text="Order Status:" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td valign="middle" class="Label_user_batch" nowrap="nowrap" 
                            style="width: 7px; height: 59px;">
                                                    &nbsp;&nbsp;
                                                    &nbsp;&nbsp;<asp:DropDownList ID="dropDownListorder" runat="server" AutoPostBack="True" 
                            CausesValidation="false" DataTextField="RTOOrderStatus" 
                            DataValueField="RTOOrderID" Height="21px" 
