<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewComplainReport.aspx.cs" Inherits="HSRP.Report.ViewComplainReport" %>
...
display:block;
    ...
    <%--//--------------change for ViweComplainReport for windows close-----------------------%>
                            ...
                            <table style="background-color: #FFFFFF" width="85%" border="0" align="center" cellpadding="3" cellspacing="1">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <table width="100%" border="0" align="left" cellpadding="3" cellspacing="1">
                                            <tr valign="top">
                                                <td colspan="1" nowrap="nowrap" align="left" style="margin-left: 50px" width="200px" class="form_text">Request Generated By:
                                                </td>
            ...
            <asp:Label ID="lblRemarks" runat="server" Text="LabelRemarks" Font-Bold="True" 
                    ForeColor="Black"></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="style1">
                                        <asp:Label ID="lblresolution" runat="server" Text="lableresolution" Font-Bold="True"
                                            ForeColor="Black"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" class="style4" >
                                        ...
                                        <input type="button" onclick="javascript: googlewin.close();" name="buttonClose" id="buttonClose" value="Close" class="button" tabindex="11" />

                                         <%--<input type="button"  name="buttonClose" id="buttonClose" value="Close" class="button" tabindex="11"  onclick="return CloseWin();"/>--%>
                                    </td>
                                    <td class="style1"></td>
