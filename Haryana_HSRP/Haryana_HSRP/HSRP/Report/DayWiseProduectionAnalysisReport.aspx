<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="DayWiseProduectionAnalysisReport.aspx.cs" Inherits="HSRP.Report.DayWiseProduectionAnalysisReport" %>
    ...
    <table style="width: 85%; height: 51px; left: 50px;">
        <tr>
            ...
            <td style="width: 3px">
             ...
             <td width="100">
                <asp:Label Text="Embossing Center:" runat="server" ID="lblemb" Visible="false" ForeColor="Black" Font-Bold="True" />
            </td>
            <td style="width: 80px; ">
                
                    <ContentTemplate>
                    <asp:DropDownList ID="ddlembcenter" Height="20px" Width="228px" Tabindex="1"
