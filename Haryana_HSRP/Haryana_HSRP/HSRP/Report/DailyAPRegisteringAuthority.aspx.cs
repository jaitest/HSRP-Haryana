...
{
    public partial class DailyAPRegisteringAuthority : System.Web.UI.Page
    {
        ...
        private void FilldropDownListOrganization()
        {
            ...
            {
                SQLString = "select HSRPStateName,HSRP_StateID from HSRPState  where hsrp_stateID in ('9') and ActiveStatus='Y' Order by HSRPStateName";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (ddlMonth.SelectedValue.ToString() == "01")
                {
                    ...
                    FromDate = yy + "/" + mm + "/" + "01 00:00:00";
                    ToDate = yy + "/" + mm + "/" + "31 23:59:59";
                }
                else if (ddlMonth.SelectedValue.ToString() == "02")
                {
                    ...
                    {
                        FromDate = yy + "/" + mm + "/" + "01 00:00:00";
                        ToDate = yy + "/" + mm + "/" + "29 23:59:59";
                    }
                    else
                    {
                        FromDate = yy + "/" + mm + "/" + "01 00:00:00";
                        ToDate = yy + "/" + mm + "/" + "28 23:59:59";
                    }
                }
               ...
               // cellA.MergeAcross = 3; // Merge two cells togetherto 
                ...
                row.Cells.Add(new WorksheetCell("Report Month : " + ddlMonth.SelectedItem.ToString() + "-" + ddlYear.SelectedValue.ToString(), "HeaderStyle2"));
                row = sheet.Table.Rows.Add();
                //row.Index = 7;
                ////row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                ////row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                //WorksheetCell cell5 = row.Cells.Add("Report Month : "+ddlMonth.SelectedItem.ToString() + "-" + ddlYear.SelectedValue.ToString());
               
                //cell5.MergeAcross = 9; // Merge two cells togetherto 
         ...
         //       row.Cells.Add(new WorksheetCell(ddlMonth.SelectedItem.ToString() + "-" + ddlYear.SelectedValue.ToString(), "HeaderStyle2"));
               ...
               // row.Index = 7; 
                ...
                SQLString = "exec Report_Monthly_Statement_Registering_Authority'" + FromDate + "','" + ToDate + "','9','"+ ddllocation.SelectedValue +"'";
                ...
                if (ds.Rows.Count > 0)
                {
                    ...
                    Int32 total1 = 0;
                    string NewVehicle = ds.Compute("sum(newvehicleorder)", "").ToString();// Convert.ToInt32(dtrows["newvehicleorder"].ToString());
                    string NewPriceCharged = ds.Compute("sum(newvehiclecash)", "").ToString();
                    string ExistingVehicle = ds.Compute("sum(oldvehicleorder)", "").ToString();
                    string ExistingPriceCharged = ds.Compute("sum(oldvehiclecash)", "").ToString();
                    string Replacements = ds.Compute("sum(replacevehicle)", "").ToString();
                    string ReplacePriceCharged = ds.Compute("sum(replaceveihclecash)", "").ToString(); 
                    ...
                    Int64 NewVehicle1 = Convert.ToInt64(NewVehicle) + totalNewscnaplock;
                    Int64 NewPriceCharged1 = Convert.ToInt64(NewPriceCharged) + Convert.ToInt64(totalPriceNewscnaplock);
                    Int64 ExistingVehicle1 = Convert.ToInt64(ExistingVehicle) + Convert.ToInt64(totaloldscnaplock);
                    Int64 ExistingPriceCharged1 = Convert.ToInt64(ExistingPriceCharged) + Convert.ToInt64(totalPriceOldcnaplock);
                    Int64 Replacements1 = Convert.ToInt64(Replacements) + Convert.ToInt64(totalReplacementScnaplock);
                    Int64 ReplacePriceCharged1 = Convert.ToInt64(ReplacePriceCharged) + Convert.ToInt64(totalReplacementScnaplock);

                    row.Cells.Add(new WorksheetCell("", DataType.String, "HeaderStyle16"));
                    row.Cells.Add(new WorksheetCell("Grand Total", DataType.String, "HeaderStyle16"));
                    row.Cells.Add(new WorksheetCell(NewVehicle1.ToString(), DataType.Number, "HeaderStyle16"));
                    row.Cells.Add(new WorksheetCell(NewPriceCharged1.ToString(), DataType.Number, "HeaderStyle16"));
                    row.Cells.Add(new WorksheetCell(ExistingVehicle1.ToString(), DataType.Number, "HeaderStyle16"));
                    row.Cells.Add(new WorksheetCell(ExistingPriceCharged1.ToString(), DataType.Number, "HeaderStyle16"));
                    row.Cells.Add(new WorksheetCell(Replacements1.ToString(), DataType.Number, "HeaderStyle16"));
                    row.Cells.Add(new WorksheetCell(ReplacePriceCharged1.ToString(), DataType.Number, "HeaderStyle16"));
                    row.Cells.Add(new WorksheetCell(total1.ToString(), DataType.String, "HeaderStyle16"));
