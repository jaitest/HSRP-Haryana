...
{
    public partial class DatewiseStatecollectionReport : System.Web.UI.Page
    {
        int UserType;
            ...
            try
                {
                    ...
                    string filename = "DateWise_State_Collection_Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                    ...
                    book.Properties.Title = "DateWise_State_Collection_Report";
                    ...
                    Worksheet sheet = book.Worksheets.Add("DateWise_State_Collection");
                    ...
                    WorksheetCell cell = row.Cells.Add("DateWise_State_Collection");
                   ...
                   // row.Cells.Add(new WorksheetCell("", "HeaderStyle6"));
                    ...
                    //row.Cells.Add(new WorksheetCell("Order Month", "HeaderStyle6"));
                    row.Cells.Add(new WorksheetCell("CollectionCount", "HeaderStyle6"));
                ...
                //            + "sum(CASE WHEN  (VehicleType = 'LMV' OR VehicleType ='LMV(CLASS)') AND (OrderClosedDate between '" + ReportDate3 + "' and '" + ReportDate2 + "')and (orderstatus='Closed' or OrderStatus='Close') THEN 1 else 0 END ) AS [a4W],"
                //            + "sum(CASE WHEN  (VehicleType = 'MCV/HCV/TRAILERS' or VehicleType ='TRACTOR') AND (OrderClosedDate between '" + ReportDate3 + "' and '" + ReportDate2 + "')and (orderstatus='Closed' or OrderStatus='Close') THEN 1 else 0 END ) AS aComm,"
                //            + "sum(CASE WHEN  ((VehicleType='MOTOR CYCLE' OR VehicleType='SCOOTER' or VehicleType ='THREE WHEELER' or VehicleType = 'LMV' or VehicleType ='LMV(CLASS)' or VehicleType = 'MCV/HCV/TRAILERS'or VehicleType ='TRACTOR')) AND (OrderClosedDate between '" + ReportDate3 + "' and '" + ReportDate3ReportDate3ReportDate3 + "')and (orderstatus='Closed' or OrderStatus='Close') THEN 1 else 0  END) as aTotal,"
                ...
                //            + "GROUP BY  rtolocation.rtolocationname order by rtolocation.rtolocationname";
                    ...
                    int sno = 0;
                    SQLString = "select convert(varchar(20),hsrprecord_creationdate,103) as Collectiondate ,count(*) AS collectionCount,SUM(roundoff_netamount) as Amount from hsrprecords where hsrp_stateid='" + DropDownListStateName.SelectedValue.ToString() + "' and  Hsrprecord_creationdate between '" + ReportDate3 + "' and '" + ReportDate2 + "' GROUP BY convert(varchar(20),hsrprecord_creationdate,103)";
                          ...
                          if (dt.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                            {
                                ...
                                row.Cells.Add(new WorksheetCell(dtrows["Collectiondate"].ToString(), DataType.String, "HeaderStyle"));
                                row.Cells.Add(new WorksheetCell(dtrows["collectionCount"].ToString(), DataType.String, "HeaderStyle"));
