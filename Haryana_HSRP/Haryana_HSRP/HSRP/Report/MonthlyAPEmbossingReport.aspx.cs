...
{
    public partial class MonthlyAPEmbossingReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               // row = sheet.Table.Rows.Add();
                ...
                WorksheetCell cell = row.Cells.Add("Monthly Report from Embossing Stations");
                ...
                //row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                //row.Cells.Add(new WorksheetCell("", "HeaderStyle2"));
                WorksheetCell cell12345=row.Cells.Add("Month :");
                cell12345.StyleID = "HeaderStyle2";
                WorksheetCell cell123456=row.Cells.Add(ddlMonth.SelectedItem.ToString());
                cell123456.MergeAcross = 2;
