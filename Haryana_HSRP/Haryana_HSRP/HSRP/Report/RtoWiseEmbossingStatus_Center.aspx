<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RtoWiseEmbossingStatus_Center.aspx.cs" Inherits="HSRP.Report.RtoWiseEmbossingStatus_Center" %>
...
<script type="text/javascript">
    ...
    <table style="height: 51px;" width="80%">
        <tr>
            ...
            <td style="width: 150px; height: 40px;" valign="middle">               
                        ...
                        CausesValidation="false" DataTextField="HSRPStateName" DataValueField="HSRP_StateID"     
             ...
             <td style="width: 10px; height: 20px;">               
                    ...
                    <asp:Label ID="label3" runat="server" Font-Bold="True" ForeColor="Black"  Visible="true"
                        Text="Embossing Center:" Width="130px" />
                
            </td>

             <td style="height: 40px;" width="80">               
                   
                    <asp:DropDownList ID="dropDownListClient" Height="20px" Width="187px"  Visible="true"
    ...
    ControlType="Picker" PickerCssClass="picker" Height="22px" Width="79px">
            ...
            <td style="height: 40px" width="30">
                   <asp:Button ID="btndetail" runat="server"  Text="Detail" Font-Bold="True" ForeColor="#3333FF" OnClick="btndetail_Click" />
                                                ...
                                                <td style="height: 40px" width="15">
                                                    <asp:Button ID="btnexport" runat="server" onclick="btnexport_Click" Text="PIP VS ASSIGNMENT" Visible="false"
            ...
            <td>
               ...
               <td style="height: 40px"  width="30">
                                                    <asp:Button ID="btnassign" runat="server"  Text="ASSIGNMENT VS PRODUCTION" Visible="false"
                                                        Font-Bold="True" ForeColor="#3333FF" OnClick="btnassign_Click"/>
                   </td>
             <td style="height: 40px" width="30">
                   <asp:Button ID="Button1" runat="server"  Text="Detail" Visible="false"
                ...
                <AlternatingRowStyle BackColor="White" />
                 <Columns>
                                ...
                                <%--     <asp:BoundField HeaderText="Embossing Center" DataField="Embossing Center" />
                                        ...
                                        <asp:TemplateField HeaderText="PIP" HeaderStyle-ForeColor="Blue">
                                            <ItemTemplate>
