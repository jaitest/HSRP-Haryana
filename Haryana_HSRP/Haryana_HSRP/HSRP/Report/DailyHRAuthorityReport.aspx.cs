    ...
    public partial class DailyHRAuthorityReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //    LabelError.Text = " Please Select State Name .";
                //    return;
                //}
                ...
                string filename = "Schedule-D-HR_Authority_Report" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
               ...
               // row.Cells.Add(new WorksheetCell("", "HeaderStyle6"));
                ...
                //WorksheetCell cell2 = row.Cells.Add("Opening");
                ...
                WorksheetCell cell2 = row.Cells.Add("Opening Back log");
                cell2.MergeAcross = 1; // Merge two cells togetherto 
                cell2.StyleID = "HeaderStyle6"; 
                ...
                WorksheetCell cell22 = row.Cells.Add("Applicaton Received");
                cell22.MergeAcross = 1; // Merge two cells togetherto 
                cell22.StyleID = "HeaderStyle6";
               ...
               //
                ...
                row.Cells.Add(new WorksheetCell("old Registration", "HeaderStyle6"));
                //
                ...
                //if ( Convert.ToDateTime(FromDate.ToString())< Convert.ToDateTime("04/01/2015 00:00:00"))
                //{
                //    LabelError.Visible = true;
                //    LabelError.Text = " You have Wrong Year  and Month.";
                //    return;
                //}

                SQLString = "Report_rtoreport_embossed_HR'" + FromDate + "','" + ToDate + "', 4 ";
                 ...
                 if (ds.Rows.Count > 0)
                {
                    foreach (DataRow dtrows in ds.Rows) // Loop over the rows.
                    {
                       ...
                       // row = sheet.Table.Rows.Add();
                        ...
                        row.Cells.Add(new WorksheetCell(dtrows["openingnew"].ToString(), DataType.Number, "HeaderStyle15"));
                        row.Cells.Add(new WorksheetCell(dtrows["openingold"].ToString(), DataType.Number, "HeaderStyle15"));
                        ...
                        row.Cells.Add(new WorksheetCell("", DataType.String, "HeaderStyle15"));
                        row = sheet.Table.Rows.Add();
