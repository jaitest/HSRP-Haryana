<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="BiharNewProcessStatus.aspx.cs" Inherits="HSRP.Report.BiharNewProcessStatus" %>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                              &nbsp;<span class="headingmain">Bihar New Process Status </span>&nbsp;</td>
                    </tr>
                            ...
                            <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                              ...
                              <asp:GridView ID="GrdAP" runat="server" BackColor="White" AutoGenerateColumns="false"
                                ...
                                <%--<asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            Bihar Locations</HeaderTemplate>
                                        <ItemTemplate>
