<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DownloadProductionReport.aspx.cs" Inherits="HSRP.Report.DownloadProductionReport" %>
                        ...
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="400px" height="26" align="center" nowrap>
                                    <asp:RadioButton ID="HSRP" Checked="true" class="headingmain" Text="HSRP Record" runat="server" GroupName="Chack" /> &nbsp; 
                                    <asp:RadioButton ID="Dealersc" class="headingmain" Text="HSRP & Dealer Record" runat="server" GroupName="Chack"  />

                                         </td>
                                    <td width="200px" height="26" align="center" nowrap>
                                         </td>
                                </tr>
                            </table>
                        </td>
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnExportToExcel" runat="server" Text="Report In Excel" ToolTip="Please Click for Report"
                                                        class="button"  OnClick="btnExportToExcel_Click" /> &nbsp; &nbsp;
                                                         <asp:Button ID="btnExportTOPDF" runat="server" Text="Report In PDF" ToolTip="Please Click for Report" Visible="false"
                                                        class="button" onclick="btnExportTOPDF_Click"  />
                                                </td>
                                                <tr>
                                                    <td colspan="9">
