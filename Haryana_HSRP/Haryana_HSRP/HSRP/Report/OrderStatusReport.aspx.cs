       ...
       protected void Page_Load(object sender, EventArgs e)
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "OrderStatusReport-" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                ...
                WorksheetCell cell = row.Cells.Add("Order Status Report");
                ...
                row.Cells.Add(new WorksheetCell("Zonal Manager", "HeaderStyle6"));
                row.Cells.Add(new WorksheetCell("EmbCenter Name", "HeaderStyle6"));
              ...
              //  row.Cells.Add(new WorksheetCell("New Order", "HeaderStyle6"));
                ...
                row.Cells.Add(new WorksheetCell("Closed Order", "HeaderStyle6"));
                ...
                SQLString = "exec Report_AllStateLocationWise'" + ReportDate1 + "','" + ReportDate2 + "','" + DropDownListStateName.SelectedValue + "'";
                       ...
                       decimal totalAmount =0;
                        ...
                        { 
                            ...
                            { 
                                ...
                                row.Cells.Add(new WorksheetCell(dtrows["ZonalManager"].ToString(), DataType.String, "HeaderStyle"));
                                row.Cells.Add(new WorksheetCell(dtrows["EmbcenterName"].ToString(), DataType.String, "HeaderStyle"));
                                ...
                                row.Cells.Add(new WorksheetCell(dtrows["Dailyemborder"].ToString(), DataType.String, "HeaderStyle"));
                                row.Cells.Add(new WorksheetCell(dtrows["Dailycloseorder"].ToString(), DataType.String, "HeaderStyle"));
