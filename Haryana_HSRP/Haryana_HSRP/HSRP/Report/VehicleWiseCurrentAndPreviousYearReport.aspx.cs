...
{
    public partial class VehicleWiseCurrentAndPreviousYearReport : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            string filename = "NewOrderBooking" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
            ...
            Export(strOrderType, book, 1, "[New_ReportNewOrder]");
            //  Export("D", book, 2);
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet,string strProcName)
        {
            try
            {
              ...
              //  row.Cells.Add(new WorksheetCell("", "HeaderStyle3"));
                ...
                WorksheetCell cell = row.Cells.Add("Booking Report");
              ...
              //  dt.Columns["rtolocationname"].ColumnName = "Location";
                for (int i = 0; i < dt.Columns.Count; i++)
                {
                    if (dt.Columns[i].ColumnName.ToString().EndsWith("1") || dt.Columns[i].ColumnName.ToString().EndsWith("2") || dt.Columns[i].ColumnName.ToString().EndsWith("3") || dt.Columns[i].ColumnName.ToString().EndsWith("4") )
                        //|| dt.Columns[i].ColumnName.ToString().EndsWith("5") || dt.Columns[i].ColumnName.ToString().EndsWith("6") || dt.Columns[i].ColumnName.ToString().EndsWith("7") || dt.Columns[i].ColumnName.ToString().EndsWith("8") || dt.Columns[i].ColumnName.ToString().EndsWith("9") || dt.Columns[i].ColumnName.ToString().EndsWith("10") || dt.Columns[i].ColumnName.ToString().EndsWith("11") || dt.Columns[i].ColumnName.ToString().EndsWith("12"))
                    {//|| dt.Columns[i].ColumnName.ToString().EndsWith("5") || dt.Columns[i].ColumnName.ToString().EndsWith("6"))
               ...
               row.Index = iIndex++;
                for (int j = 0; j < dt.Rows.Count; j++)
                {
                        ...
                        for (int i = 0; i < dt.Columns.Count; i++)
                        {
                             ...
                             if (dt.Rows[j]["Location"].ToString().Equals("Z") && i.Equals(0))
                             {
