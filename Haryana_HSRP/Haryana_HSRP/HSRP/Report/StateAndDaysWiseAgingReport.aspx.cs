        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet)
        {
            try
            {
              ...
              //  row.Cells.Add(new WorksheetCell(OrderDatefrom.SelectedDate.ToString("dd/MMM/yyyy"), "HeaderStyle2"));
                ...
                AddNewCell(row, "Zonal Manager", "HeaderStyle6", 1);
                AddNewCell(row, "EmbCenterName", "HeaderStyle6", 1);
                ...
                AddNewCell(row, "4WClass", "HeaderStyle6", 1);
                AddNewCell(row, "Comm", "HeaderStyle6", 1);
                AddNewCell(row, "E-Rickshaw", "HeaderStyle6", 1);                
                AddNewCell(row, "Tractor", "HeaderStyle6", 1);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        if (!dtrows["ZonalManager"].ToString().Equals("z"))
                        {
                        ...
                        if (!dtrows["EmbCentername"].ToString().Equals("z"))
                        {
                        ...
                        if (!dtrows["location"].ToString().Equals("z"))
                        {
                        ...
                        AddNewCell(row, dtrows["E-Rickshaw"].ToString(), "HeaderStyle", 1);
