...
{
    public partial class DailyAPAffixingReportNEW : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               // row.Index = 1;
                ...
                WorksheetCell cell6 = row.Cells.Add("Date: " + From.ToString() + " - " + From1.ToString());
                row = sheet.Table.Rows.Add();
