<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="APTSStockAtAffixation.aspx.cs" Inherits="HSRP.DLReports.APTSStockAtAffixation" %>
                                       ...
                                       <%--      <td valign="middle" class="form_text" nowrap="nowrap">
                                        <asp:UpdatePanel runat="server" ID="UpdateClient" UpdateMode="Conditional">
                                            ...
                                            <asp:DropDownList ID="ddlTCReport" runat="server" Visible="true" 
                                               ...
                                               <asp:ListItem Text = "Pending for Affixation" Value = "1"></asp:ListItem>
                                                    </asp:DropDownList>
                                            </td>
                                                <td>
                                              </td>
                                               ...
                                               <%-- <td style="position: relative; right: 0px; top: 0px;">
                                                ...
                                                <td style="position: relative; right: 0px; top: 0px;">
                                                    <asp:Button ID="btnexportall" runat="server" Text="ExportToAll"  Visible="true"
                                                        ToolTip="Please Click for Report" Width="100px" BackColor="Orange" ForeColor="#000000"
