<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="CaptureStock.aspx.cs" Inherits="HSRP.Master.CaptureStock" %>
    ...
    <table style="background-color:White; height:223px"  width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
       ...
       <tr>
                ...
                <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtVehicleRegNo" TabIndex="0" 
                                onblur="this.value=removeSpaces(this.value);" Style="text-transform: uppercase" 
                    ...
                    <tr>
                        <td class="form_text_View" style="padding-bottom: 10px"> <font color="black"  size="3px">
                            Front Plate: <span class="alert">* </span></font> 
                         
                        </td>
                        <td align="left">  
                                                               
                        <asp:TextBox TabIndex="1" Width="150" ID="textBoxFrontPlate" onblur="this.value=removeSpaces(this.value);"  EnableViewState="true" runat="server"></asp:TextBox>
                                                                     
                        </td>   
                   </tr>
                   <tr>
                        <td style="padding-bottom: 10px"> <font color="black" size="3px">Rear Plate: <span class="alert">* </span></font>  </td>
                        <td>
                                                                <asp:TextBox onblur="this.value=removeSpaces(this.value);"  TabIndex="1" Width="150" ID="textBoxRearPlate" onlosefocus=" return sameLaserNo();"
                    ...
                    <tr>
                        <td class="form_text_View" style="padding-bottom: 10px">
                            <font color="black" size="3px">Remarks : </font>
                        </td>
                        <td align="left" style="padding-left: 25px">
                            <asp:TextBox ID="txtRemarks" runat="server" onblur="this.value=removeSpaces(this.value);"
                                
                                 TabIndex="1" TextMode="MultiLine" 
                                Width="150"></asp:TextBox>
                        </td>
        </tr>
                    <tr> <td colspan="3"></td></trt> <tr>
                        <td colspan="3">
                        </td>
                        </trt>
                        <tr>
                            ...
                            <td>
                               <%-- <asp:Button ID="btnSave" runat="server" class="button" onclick="btnSave_Click" 
                                ...
                                <asp:LinkButton ID="btnSaveStockinHand" runat="server" class="button" 
                                    ...
                                    TabIndex="4" Text="Go"></asp:LinkButton>
                                &nbsp;&nbsp;
