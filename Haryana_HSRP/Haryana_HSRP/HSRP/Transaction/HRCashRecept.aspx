      ...
      <fieldset>
            <legend>
                <div style="margin-left: 10px; font-size: medium; color: Black">
                  Download Cash Collection Receipt</div>
            </legend>
          <table>
              <tr>
              ...
              <tr>
                     <td style="padding-left: 314px;"><asp:Label runat="server" ID="lbldealerid" Visible="false" Text="Dealer Id">
                      </asp:Label>
                      <span style="color:red">*</span>
                  </td>
                  <td style="padding-left: 10px;"> 
                      <asp:TextBox ID="txtdealerid" Visible="false"  runat="server"></asp:TextBox>

                  </td>

                  <td style="padding-left: 10px;"> 
                     
                           <asp:Button ID="Btnepson" runat="server" visible="false"  CssClass="button" Height="23px" 
                            onclick="Btnepson_Click" TabIndex="12" Text="Epson Print"/>
                  </td>
              </tr>
