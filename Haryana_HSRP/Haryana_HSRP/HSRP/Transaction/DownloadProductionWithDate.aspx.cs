    ...
    public partial class DownloadProductionWithDate : System.Web.UI.Page
    {
        ...
        private void FilldropDownListClient()
        {
            ...
            else
            {
                ...
                SQLString = "SELECT  distinct (a.RTOLocationName) as RTOLocationName, (a.RTOLocationCode+', ') as RTOCode, a.RTOLocationID FROM UserRTOLocationMapping INNER JOIN RTOLocation a ON UserRTOLocationMapping.RTOLocationID = a.RTOLocationID where UserRTOLocationMapping.UserID='" + UserID + "' and ActiveStatus!='N' order by RTOLocationName ";
