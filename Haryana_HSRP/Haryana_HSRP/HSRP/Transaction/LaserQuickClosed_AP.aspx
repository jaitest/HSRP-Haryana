...
//            
    ...
    <div align="left" style="margin-left: 10px; font-size: medium; color: Black">
                                <span>Affication Entry Close</span>
                            </div>
                     ...
                     <tr>
                       <td class="style4"> &nbsp;</td>
                        <td align="center">
                            ...
                            <asp:Label ID="lblErrMess" runat="server" Font-Size="15px" ForeColor="Red"></asp:Label>
                            ...
                            <asp:Label ID="lblErrMessvehicleFront" runat="server" Font-Size="12px" 
                                ForeColor="Red"></asp:Label>
                            <asp:Label ID="lblSucMess" runat="server" Font-Size="15px" ForeColor="red"></asp:Label>
