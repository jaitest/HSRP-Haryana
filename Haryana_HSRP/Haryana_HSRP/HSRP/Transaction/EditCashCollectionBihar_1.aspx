<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="EditCashCollectionBihar_1.aspx.cs" Inherits="HSRP.Transaction.EditCashCollectionBihar" %>
                ...
                <div style="border: 0px solid; width: 730px; padding-top:30px; float: right">
                    <div>
                        ...
                        <asp:Button ID="buttonSave" runat="server" TabIndex="9" class="button" Text="Save"
                            ...
                            ID="btnUpdate" runat="server" CssClass="button" Text="Update" 
