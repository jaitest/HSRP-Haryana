...
{
    public partial class DownloadProductionWithDateERP : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                else if (HSRPStateID == "4")
                {
                    ...
                    if (ddlBothDealerHHT.SelectedItem.Text == "Both")
                    {
                        ...
                        {
                           //10feb SQLString = "Select   a.hsrprecordID,a.roundoff_netamount as netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo, a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID   where a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and HsrpRecord_creationdate between '" + OrderDate.SelectedDate + "' and  '" + HSRPAuthDate.SelectedDate+"' and a.orderstatus='New Order' and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null order by a.VehicleClass,a.VehicleType,a.VehicleRegNo ";
                            SQLString = "Select   a.hsrprecordID,a.RoundOff_NetAmount as netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo,a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID  "+
                                "where convert(date,a.hsrprecord_creationdate)>'2014/03/13' and  a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and convert(date,erpassigndate) between '" + OrderDate.SelectedDate + "' and  '" + HSRPAuthDate.SelectedDate+"' and a.orderstatus='New Order' and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null order by a.VehicleClass,a.VehicleType,a.HSRP_Front_LaserCode,a.hsrp_rear_lasercode";
                        }
                        else if (DropDownList1.SelectedItem.ToString().ToUpper() == "TWO WHEELER")
                        {
                            SQLString = "Select   a.hsrprecordID,a.roundoff_netamount as netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo, a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID   "+
                                "where convert(date,a.hsrprecord_creationdate)>'2014/03/13' and   a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and convert(date,erpassigndate) between '" + OrderDate.SelectedDate + "' and  '" + HSRPAuthDate.SelectedDate+"' and a.orderstatus='New Order' and vehicletype in ('MOTOR CYCLE','SCOOTER') and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null order by a.VehicleClass,a.VehicleType,a.HSRP_Front_LaserCode,a.hsrp_rear_lasercode ";
                           // SQLString = "Select   a.hsrprecordID,a.RoundOff_NetAmount as netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo, a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID where a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and hsrprecord_CreationDate between '" + OrderDate.SelectedDate + "' and  '" + HSRPAuthDate.SelectedDate+"' and a.orderstatus='New Order' and vehicletype in ('MOTOR CYCLE','SCOOTER') and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null order by a.VehicleClass,a.VehicleType,a.VehicleRegNo";
                        }
                        ...
                        //SQLString = "Select   a.hsrprecordID,a.netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo, a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID   where a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and PlateAffixationDate between '" + OrderDate.SelectedDate + "' and  '" + HSRPAuthDate.SelectedDate+"' order by a.VehicleClass,a.VehicleType,a.VehicleRegNo ";
                    }
                    else if (ddlBothDealerHHT.SelectedItem.Text == "Dealer Data")
                    {
                        if (DropDownList1.SelectedItem.ToString().ToUpper() == "ALL")
                        {
                            SQLString = "Select   a.hsrprecordID,a.roundoff_netamount as netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate, a.dealerid as ID, left(a.OwnerName,19) as OwnerName, a.MobileNo, a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate,a.mobileNo, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID "+
                                "where convert(date,a.hsrprecord_creationdate)>'2014/03/13' and  a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and convert(date,erpassigndate) between '" + OrderDate.SelectedDate + "' and  '" + HSRPAuthDate.SelectedDate+"' and   a.orderstatus='New Order' and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null AND a.Addrecordby like'%dealer%' order by a.VehicleClass,a.VehicleType,a.dealerid, a.HSRP_Front_LaserCode,a.hsrp_rear_lasercode";
                            //SQLString = "Select   a.hsrprecordID,a.RoundOff_NetAmount as netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo,a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID  where a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and hsrprecord_CreationDate between '" + OrderDate.SelectedDate + "' and  '" + HSRPAuthDate.SelectedDate+"' and a.orderstatus='New Order' and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null order by a.VehicleClass,a.VehicleType,a.VehicleRegNo";
                        }
                        else if (DropDownList1.SelectedItem.ToString().ToUpper() == "TWO WHEELER")
                        {
                        ...
                        //SQLString = "Select   a.hsrprecordID,a.netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo, a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate,a.mobileNo, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID where a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and PlateAffixationDate between '" + OrderDate.SelectedDate + "' and  '" + HSRPAuthDate.SelectedDate+"' and a.Addrecordby like'%dealer%' order by a.VehicleClass,a.VehicleType,a.VehicleRegNo";
                    }
                    else if (ddlBothDealerHHT.SelectedItem.Text == "HHT Data")
                    {
                        if (DropDownList1.SelectedItem.ToString().ToUpper() == "ALL")
                    ...
                    else if (ddlBothDealerHHT.SelectedItem.Text == "Other")
                    {
                        ...
                        {
                            SQLString = "Select   a.hsrprecordID,a.roundoff_netamount as netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo, a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate,a.mobileNo, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID  "+
                                "where convert(date,a.hsrprecord_creationdate)>'2014/03/13' and  a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and convert(date,erpassigndate) between '" + OrderDate.SelectedDate + "' and  '" + HSRPAuthDate.SelectedDate + "' and a.orderstatus='New Order' and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null AND vehicletype in ('MOTOR CYCLE','SCOOTER') AND a.Addrecordby is null order by a.VehicleClass,a.VehicleType,a.HSRP_Front_LaserCode,a.hsrp_rear_lasercode";
                            //SQLString = "Select   a.hsrprecordID,a.RoundOff_NetAmount as netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo, a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID where a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and hsrprecord_CreationDate between '" + OrderDate.SelectedDate + "' and  '" + HSRPAuthDate.SelectedDate+"' and a.orderstatus='New Order' and vehicletype in ('MOTOR CYCLE','SCOOTER') and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null order by a.VehicleClass,a.VehicleType,a.VehicleRegNo";
                        }
                        else if (DropDownList1.SelectedItem.ToString().ToUpper() == "THREE WHEELER")
                        {
...
// yha tak                  
                else if (HSRPStateID == "5")
                {
                    ...
                    if (ddlBothDealerHHT.SelectedItem.Text == "Both")
                    {
                        SQLString = "Select   a.hsrprecordID,a.netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo, a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID   where a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and erpassigndate between '" + AuthorizationDate + "' and  '" + ToDate + "' order by a.VehicleClass,a.VehicleType,a.VehicleRegNo ";
                    }
                    else if (ddlBothDealerHHT.SelectedItem.Text == "Dealer Data")
                    {
                ...
                {
                    //SQLString = "Select   a.hsrprecordID,a.netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo,Af.AffixCenterDesc, a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID INNER JOIN AffixationCenters Af on a.affix_id=Af.Affix_id where a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and hsrprecord_CreationDate between '" + AuthorizationDate + "' and  '" + ToDate + "' and a.orderstatus='New Order' and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null order by Af.AffixCenterDesc";
                    if (DropDownList1.SelectedItem.ToString().ToUpper() == "ALL")
                    {
                       SQLString = "Select   a.hsrprecordID,a.RoundOff_NetAmount as netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo,a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID  where a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and orderdate between '" + AuthorizationDate + "' and  '" + ToDate + "' and a.orderstatus='New Order' and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null order by a.VehicleClass,a.VehicleType,a.HSRP_Front_LaserCode,a.hsrp_rear_lasercode";
                       // commented On 22 april  on the instruction of naveen sir SQLString = "Select   a.hsrprecordID,a.RoundOff_NetAmount as netamount, a.HSRPRecord_AuthorizationNo,convert(varchar, OrderClosedDate, 105) as OrderClosedDate, CONVERT(varchar(20),orderdate ,103) AS OrderBookDate,CONVERT(varchar(20),OrderEmbossingDate ,103) AS OrderEmbossingDate,  left(a.OwnerName,19) as OwnerName, a.MobileNo,a.HSRPRecordID, CONVERT(varchar(20), HSRPRecord_AuthorizationDate,103) AS OrderDateAuth, a.OrderDate, a.EngineNo, a.ChassisNo, b.RTOLocationName,  a.VehicleRegNo,  case a.VehicleType when 'MCV/HCV/TRAILERS' then 'Trailers' when 'THREE WHEELER' then 'T.Whe.' when 'SCOOTER' then 'SCOO' when 'TRACTOR' then 'TRAC' when 'LMV(CLASS)' then 'L.CL' when 'LMV' then 'LMV'  when 'MOTOR CYCLE' then 'MO.C' end as VehicleType, case a.VehicleClass when 'Transport' then 'T' else 'N.T.' end as VehicleClass,  a.HSRP_StateID, s.HSRPStateName, left (replace (Product_1.ProductCode,'MM-',''),9) AS RearProductCode, left (replace (Product.ProductCode,'MM-',''),9) AS FrontProductCode, a.FrontPlateSize, a.HSRP_Front_LaserCode, a.HSRP_Rear_LaserCode, a.RearPlateSize FROM HSRPRecords AS a INNER JOIN HSRPState AS s ON a.HSRP_StateID = s.HSRP_StateID INNER JOIN Product ON a.FrontPlateSize = Product.ProductID INNER JOIN Product AS Product_1 ON a.RearPlateSize = Product_1.ProductID INNER JOIN RTOLocation AS b ON a.RTOLocationID = b.RTOLocationID  where a.hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and a.RTOLocationID='" + dropDownListClient.SelectedValue + "' and erpassigndate between '04/14/14 00:00:00' and  '04/14/14 23:59:59' and a.orderstatus='New Order' and OrderDate between '04/07/14 00:00:00' and '04/07/14 23:58:00' and [HSRP_Front_LaserCode] is not null and [HSRP_Rear_LaserCode] is not null order by a.VehicleClass,a.VehicleType,a.HSRP_Front_LaserCode,a.hsrp_rear_lasercode";
                    }
                    else if (DropDownList1.SelectedItem.ToString().ToUpper() == "TWO WHEELER")
                    {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (HSRPStateID == "1")
                    {
                        ...
                        var colWidthPercentages = new[] { 7f, 20f, 20f, 8f, 20f, 10f, 33f, 35f, 35f, 20f, 20f, 30f, 20f, 30f, 13f };
                    ...
                    {
                        PdfPCell cell120000 = new PdfPCell(new Phrase("ID", new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                    ...
                    for (int i = 0; i <= dt.Rows.Count - 1; i++)
                    {
                        ...
                        if (total == 44)
                        {
                            ...
                            if (HSRPStateID == "4" && ddlBothDealerHHT.SelectedItem.Text == "Dealer Data")
                            {
                                PdfPCell cell120933b = new PdfPCell(new Phrase("ID", new iTextSharp.text.Font(bfTimes, 6f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                        ...
                        PdfPCell cell1209329 = new PdfPCell(new Phrase(dt.Rows[i]["netAmount"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
