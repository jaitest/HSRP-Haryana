...
{
    public partial class BiharDealerDownloadProductionWithDate_old1 : System.Web.UI.Page
    {
        ...
        private void FilldropDownListClient()
        {
            if (UserType == "0")
            {
                if (DropDownListStateName.SelectedItem.Text.ToString() != "--Select State--" || DropDownListStateName.SelectedValue.ToString() != "--Select State--")
                {
        ...
        private void Filldropdowndealer()
        {
            if (DropDownListStateName.SelectedItem.Text.ToString() != "--Select State--" || DropDownListStateName.SelectedValue.ToString() != "--Select State--")
            {
                SQLString = "select distinct dealerid,(select [dealername] from dealermaster a where a.DealerId=hsrprecords.dealerid and IsActive='1' and isnull(a.dealername,'')!='' and HSRP_StateID='" + DropDownListStateName.SelectedValue.ToString() + "') as DealerName from hsrprecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and Addrecordby='Dealer'";
        ...
        protected void btnDownloadRecords_Click(object sender, EventArgs e)
        {
            ...
            string strStateID = DropDownListStateName.SelectedValue.ToString();
                 ...
                 if (dt.Rows.Count > 0)
                 {
                     ...
                     var colWidthPercentages = new[] { 55f, 125f, 55f, 200f, 75f,  155f, 110f, 210f, 105f, 210f, 105f };
            ...
            if (dropDownListClient.SelectedItem.Text == "--ALL--")
            {
                ...
                for (int iRowNo = 0; iRowNo < dtrto.Rows.Count; iRowNo++)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        else if (HSRPStateID == "1" || HSRPStateID == "2" || HSRPStateID == "3" || HSRPStateID == "6"  || (HSRPStateID == "4" && ddlBothDealerHHT.SelectedItem.Text.Equals("Both") || ddlBothDealerHHT.SelectedItem.Text.Equals("Other")))
                        {
