<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewInventory.aspx.cs" Inherits="HSRP.Transaction.ViewInventory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function edit(i) { // Define This function of Send Assign Laser ID 
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "Inventory.aspx?Mode=Edit&InventoryID=" + i, "Update Inventory", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location.href = "ViewInventory.aspx";
                return true;
            }
        }
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "Inventory.aspx?Mode=New", "Add New Inventory", "width=950px,height=500px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location = 'ViewInventory.aspx';
                return true;
            }
        }
    </script>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">View Inventory </span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New Inventory" class="button">Add New Inventory </a>
                                    </td>
                                        ...
                                        <ComponentArt:Grid ID="Grid1" RTOLocationIDMode="AutoID" runat="server" ImagesBaseUrl="~/images"
                                                    ...
                                                    <Columns>
                                                       <ComponentArt:GridColumn DataField="InventoryID" Visible="False" />
                                                        <ComponentArt:GridColumn DataField="ProductCode" HeadingText="Product" SortedDataCellCssClass="SortedDataCell"
                                                            Width="120" />
                                                        <ComponentArt:GridColumn DataField="BatchID" HeadingText="Batch Code"
                                                            SortedDataCellCssClass="SortedDataCell" Width="130" />
                                                        <ComponentArt:GridColumn DataField="Prefix" Visible="true" HeadingText="Prefix"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="invoiceno" Visible="true" HeadingText="Invoice No."
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="invoicefrom" HeadingText="Invoice From" SortedDataCellCssClass="SortedDataCell"
                                                            Width="60" />
                                                        <ComponentArt:GridColumn DataField="totalqty" HeadingText="Quantity" SortedDataCellCssClass="SortedDataCell"
                                                            Width="45" /> 
                                                        <ComponentArt:GridColumn DataField="CurrentCost" HeadingText="Current Cost" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" /> 
                                                        <ComponentArt:GridColumn DataField="Weight" HeadingText="Weight" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" /> 
                                            ...
                                            <ClientTemplates>
                                                   ...
                                                   <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:edit(## DataItem.GetMember('InventoryID').Value ##);">
                                                        Edit</a>
