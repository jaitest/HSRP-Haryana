<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="TGReAssignAuthNo.aspx.cs" Inherits="HSRP.Transaction.TGReAssignAuthNo" %>
    ...
    <td width="900"><table id="Table1" width="100%" align="center" style="font-size: 16px; color:Black; font-family:@Batang; background-color:#fff" >
      ...
      <tr>
        ...
        <td class="form_text">New Authorization Number</td>
         <td><asp:TextBox ID="txtnewAuthNo" runat="server" class="form_textbox12"></asp:TextBox></td>
      </tr>
      <tr>
        <td class="form_text"> Authorization Number </td>
