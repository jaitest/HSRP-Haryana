...
{
    public partial class VoidEntry : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
           ...
           // SQLString = "update hsrprecords set VoidEntryBy='" + UID + "', VoidEntryDateTime='"+strdatetime+"' , VoidRemarks='"+txtVoidRemarks.Text+"' where HSRP_StateID='" + State_ID + "' ";
