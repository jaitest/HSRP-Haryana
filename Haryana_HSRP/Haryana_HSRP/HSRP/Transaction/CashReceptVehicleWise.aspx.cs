...
{
    public partial class CashReceptVehicleWise : System.Web.UI.Page
    {
        ...
        public void EpsionPrint()
        {
            ...
            string SQLString = "select hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,a.HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType,TinNo,ROUND(NetAmount,0) AS roundAmt from hsrprecords a,hsrpstate b where a.HSRP_StateID=b.HSRP_StateID and VehicleRegNo='" + txtVehicleregno.Text + "'  and a.HSRP_StateID='4' and left(vehicleregno,4) in(Select parametertext from HRParameter_master c where parametertype='VehicleWiseCashReceipt' and activestatus='Y' and c.HSRP_StateID=4)";
            ...
            string filename="";
            string PdfFolder = "";
            filename = "CASHRECEIPT_"+"_"+System.DateTime.Now+".pdf";
        ...
        {
            string SQLString = "select hsrprecordID,CashReceiptNo, convert(varchar,HSRPRecord_CreationDate,103) as HSRPRecord_CreationDate,a.HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,convert(varchar,HSRPRecord_AuthorizationDate,103) as HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType,TinNo,ROUND(NetAmount,0) AS roundAmt from hsrprecords a,hsrpstate b where a.HSRP_StateID=b.HSRP_StateID and VehicleRegNo='" + txtVehicleregno.Text + "'  and a.HSRP_StateID='4'";

            DataTable dataSetFillHSRPDeliveryChallan = Utils.GetDataTable(SQLString, ConnectionString);
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                //gridTD.Visible = true;
                grd.DataSource = dataSetFillHSRPDeliveryChallan;
                grd.DataBind();
                grd.Visible = true;
            }
            else
