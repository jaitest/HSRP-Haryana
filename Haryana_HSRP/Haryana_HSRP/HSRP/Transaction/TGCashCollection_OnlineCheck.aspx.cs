...
namespace HSRP.Transaction
{
    public partial class TGCashCollection_OnlineCheck : System.Web.UI.Page
    {
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            string sqry = "select cashreceiptno from TGOnlinePayment where   HSRP_StateID='11' and HSRPRecord_AuthorizationNo ='" + strAuthNo + "'";
            sqry = Utils.getDataSingleValue(sqry, ConnectionString, "cashreceiptno");
            lblmsg1.Text = sqry;
            SQLString = "select  HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,RTOLocationID,OwnerName,EmailID,Address1,VehicleType,OrderType,VehicleClass,MobileNo,ManufacturerName,ManufacturerModel,EngineNo,ChassisNo from TGOnlinePayment where HSRPRecord_AuthorizationNo='" + txtAuthNo.Text + "' and  HSRP_StateID='11'";
        ...
        protected void btnSync_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string orderdate = "select convert(varchar(50),hsrprecord_creationdate,103) as hsrprecord_creationdate from TGOnlinePayment where HSRP_StateID='11' and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'";
                orderdate = Utils.getDataSingleValue(orderdate, ConnectionString, "hsrprecord_creationdate");

                string collectionamount = "select roundoff_netamount from TGOnlinePayment where HSRP_StateID='11' and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'";
                ...
                int sqry11 = Utils.ExecNonQuery("update TGOnlinePayment set apwebserviceresp='" + AuthData + "' where HSRP_StateID='11' and HSRPRecord_AuthorizationNo ='" + lblAuthNo.Text + "'  ", ConnectionString);
