<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="DownloadProductionWithDate_Pending.aspx.cs" Inherits="HSRP.Master.DownloadProductionWithDate_Pending" %>
                            ...
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td valign="middle" class="form_text" colspan="2" nowrap="nowrap">
                                        <asp:Label Text="Select Type :" runat="server" ID="labelSelectType" Visible="true" />
                                    </td>
                                    <td>
                                        <asp:DropDownList Visible="true" ID="ddlBothDealerHHT" CausesValidation="false" Width="140px"
                                            ...
                                            <asp:ListItem Text="HHT Data">HHT Data</asp:ListItem>
                                                ...
                                                <ComponentArt:GridLevel DataKeyField="pdffilename" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%--<ComponentArt:GridColumn DataField="SNo." HeadingText="S-No" SortedDataCellCssClass="SortedDataCell"
                                                            Width="120" />--%>
                                                        <ComponentArt:GridColumn DataField="pdfdownloadDate" HeadingText="FileDate" SortedDataCellCssClass="SortedDataCell"
                                                            Width="120" />
                                                        <ComponentArt:GridColumn DataField="pdffilename" HeadingText="File Name" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="userName" HeadingText="Generated By" SortedDataCellCssClass="SortedDataCell"
                                                            Width="120" />
                                                        <ComponentArt:GridColumn DataCellCssClass="maintext" DataCellClientTemplateId="Assign"
                                                            HeadingText="Download File" SortedDataCellCssClass="SortedDataCell" Width="50" />
