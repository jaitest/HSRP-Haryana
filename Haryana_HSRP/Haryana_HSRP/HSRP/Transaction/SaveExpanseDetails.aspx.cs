...
namespace HSRP.Transaction
{
    public partial class SaveExpanseDetails : System.Web.UI.Page
    {
        ...
        public void FillDropDownEmployee()
        {
            ...
            {
                int.TryParse(dropDownListOrg.SelectedValue, out intHSRP_StateID);
                SQLString = "select UserFirstName+' '+UserLastName as 'UserName',UserId from Users Where HSRP_StateID=" + intHSRP_StateID + " and RTOLocationID='" + dropDownListClient.SelectedValue + "' and ActiveStatus!='N' and isnull(dealerid,'')='' Order by UserName ";
            ...
            else
            {
               ...
               // Utils.PopulateDropDownList(dropDownListEmployee, SQLString.ToString(), CnnString, "--Select Employee--");
                ...
                dropDownListOrg.SelectedIndex = 0;
                //dropDownListEmployee.Items.Add(0,ListItem())
            }
        ...
        {
            txtClaimedBy.Text = dropDownListEmployee.SelectedItem.ToString();
        }       
    }
}