...
{
    public partial class ViewExpenseMaster : System.Web.UI.Page
    {
        ...
        public void buildGrid()
        {
            try
            {
                string SQLString = "SELECT [ExpenceID],[ExpenseName],case when ActiveStatus IN ('Y') then 'Active' else 'Inactive' end as ActiveStatus FROM [ExpenseMaster] order by ExpenseName";
