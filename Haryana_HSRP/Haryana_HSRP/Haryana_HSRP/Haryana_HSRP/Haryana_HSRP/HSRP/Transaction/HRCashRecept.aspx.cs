...
namespace HSRP.Transaction
{
    public partial class HRCashRecept : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (USERID == "7455" || USERID == "3075")
                {
                    lbldealerid.Visible = true;
                    txtdealerid.Visible = true;
                    Btnepson.Visible = true;
        ...
        public void EpsionPrint()
        {
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                //Chages By  Vimal for Long Cash Reciipt No .    
                float imageWidth = 221;
                float imageHeight = 365;
        ...
        protected void Btnepson_Click(object sender, EventArgs e)
        {
            String ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ConnectionString"].ToString();
            DataTable GetAddress;
            string Address;
            ...
            string SQLString = "select hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType from hsrprecords where CreatedBy='" +USERID+ "' and  HSRP_StateID='4'  and dealerid = '"+txtdealerid.Text.ToString()+"' and APwebserviceresp is null order by  HSRPRecord_CreationDate desc";
