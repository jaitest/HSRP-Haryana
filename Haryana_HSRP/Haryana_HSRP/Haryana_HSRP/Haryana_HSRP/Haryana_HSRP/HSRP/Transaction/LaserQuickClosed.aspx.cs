    ...
    public partial class LaserQuickClosed : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSqlQuery = "select OrderType, OrderEmbossingDate,OwnerName from hsrprecords where hsrp_stateid='" + HSRPStateID + "' and VehicleRegNo='" + textBoxVehicleRegNo.Text + "'  and orderstatus='Embossing Done' ";
                ...
                else
                {
                    ...
                    if (NewEmbossingDate == strClosedDate)
                    {
                        ...
                        else
                        {
                            ...
                            if (Exists != "0")
                            {
                                SQLString = "select hsrprecordid from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and orderstatus not in('Closed') and RecievedAffixationStatus='Y' and hsrp_front_lasercode='" + lblFrontLaserPlate.Text + "' and hsrp_rear_lasercode='" + lblRearLaserPlate.Text + "' order by orderembossingdate desc";
                                ...
                                if (Convert.ToInt32(hsrpid) > 0)
                                {
                                    if (txtClosedDate.Text != "")
                                    {
                                        ...
                                        //SQLString = "update hsrprecords set orderstatus='Closed',orderclosedDate='" + txtClosedDate.Text + "', ActualClosedOrderDate=GETDATE(),hsrp_front_lasercode='" + lblFrontLaserPlate.Text + "' ,hsrp_rear_lasercode= '" + lblRearLaserPlate.Text + "' ,closeduserid='" + useridfromsession + "'   where hsrprecordid ='" + hsrpid + "' ";
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (Exists != "0")
                                {
                                    ...
                                    {
                                        SQLString = "select hsrprecordid from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and orderstatus = 'Embossing Done' and HSRPrecord_CreationDate between '2013-04-01 00:00:00' and  '2014-12-31 00:00:00'";
                                        ...
                                        if (hsrpid == "0")
                                        {
                                            if (HSRPStateID == "1" || HSRPStateID == "4" || HSRPStateID == "3" || HSRPStateID == "6")
                                            {
                                                ...
                                                if (hsrpid == "0")
                                                {
                                                    SQLString = "select hsrprecordid from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and orderstatus = 'Embossing Done' and  HSRPRecord_CreationDate <= '2015-01-01 00:00:00' ";
                                    ...
                                    SQLString = "select hsrprecordid from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and hsrp_front_lasercode='" + lblFrontLaserPlate.Text + "' and hsrp_rear_lasercode='" + lblRearLaserPlate.Text + "' and orderstatus not in('Closed') order by orderembossingdate desc";
                                    hsrpid = Utils.getDataSingleValue(SQLString, CnnString, "hsrprecordid");
                                    ...
                                    if (Convert.ToInt32(hsrpid) > 0)
                                    {
                                        if (txtClosedDate.Text != "")
                                        {
                                            ...
                                            SQLString = "update hsrprecords set orderstatus='Closed',orderclosedDate='" + txtClosedDate.Text + "', ActualClosedOrderDate=GETDATE(),closeduserid='" + useridfromsession + "' where hsrprecordid ='" + hsrpid + "'  ";
                                            //SQLString = "update hsrprecords set orderstatus='Closed',orderclosedDate='" + txtClosedDate.Text + "', ActualClosedOrderDate=GETDATE(),hsrp_rear_lasercode= '" + lblRearLaserPlate.Text + "',hsrp_front_lasercode='" + lblFrontLaserPlate.Text + "',closeduserid='" + useridfromsession + "' where hsrprecordid ='" + hsrpid + "' ";
        ...
        protected void btnGO_Click(object sender, EventArgs e)
        {
            ...
            string strQuery = string.Empty;
             strQuery = "Select top 1 OrderStatus from hsrprecords where VehicleRegNo ='" + textBoxVehicleRegNo.Text + "'  order by hsrprecord_creationDate desc ";
            ...
            SQLStringall = " select top 1  hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus='Embossing Done' and (isnull(HSRP_Front_LaserCode,'')='' or HSRP_Front_LaserCode is null) and (isnull(HSRP_Rear_LaserCode,'')='' or HSRP_Rear_LaserCode is null) order by hsrprecord_creationDate desc";
           ////SQLStringall = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus in('New Order','Embossing Done')";
            ...
            #region haryana
                ...
                SQLString = "select top 1 hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus ='Embossing Done' and RecievedAffixationStatus='Y' and recievedatAffixationDatetime is not null order by hsrprecordid desc";
                ...
                {
                    SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus ='Embossing Done' and RecievedAffixationStatus='N' and isnull(recievedatAffixationDatetime,'')!='' and HSRPrecord_CreationDate >= '2015-01-01 00:00:00'";
                    ...
                    else
                    {
                        ...
                        else
                        {
                           ...
                           // SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus ='Embossing Done' and HSRPrecord_CreationDate between '2013-04-01 00:00:00' and  '2014-12-31 00:00:00'";

                            SQLString = "select top 1 hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus ='Embossing Done' and HSRPrecord_CreationDate <= '2015-01-01 00:00:00' order By HSRPrecord_CreationDate,hsrprecordid desc";
