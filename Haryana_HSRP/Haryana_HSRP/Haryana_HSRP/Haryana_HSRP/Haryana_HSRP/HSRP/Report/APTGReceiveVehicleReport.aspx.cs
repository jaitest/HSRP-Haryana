...
{
    public partial class APTGReceiveVehicleReport : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet)
        {
            try
            {
                ...
                #region Fetch Data
                string sql = "select * from hsrprecords where erpassigndate is null and aptgvehrecdate is not null and HSRPRecord_CreationDate>'01-Jan-2015 00:00:00' and HSRP_StateID='" + HSRP_StateID1 + "'";
                DataTable dt = Utils.GetDataTable(sql, CnnString1);
                #endregion
