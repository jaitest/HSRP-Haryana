...
{
    public partial class All_TaxRoyalty_DailyCashCollectionRTOLocationWise_WithDate : System.Web.UI.Page
    {
        ...
        private void FilldropDownListClient()
        {
            ...
            else
            {
                ...
                SQLString = "SELECT  distinct (a.RTOLocationName) as RTOLocationName, a.RTOLocationID FROM UserRTOLocationMapping INNER JOIN RTOLocation a ON UserRTOLocationMapping.RTOLocationID = a.RTOLocationID where  a.LocationType!='District' and UserRTOLocationMapping.UserID='" + strUserID + "' and ActiveStatus!='N'";
        ...
        protected void btnAllLocationPdf_Click(object sender, EventArgs e)
        {
            ...
            Workbook book = new Workbook();
            StyleForTheFirstTime(book);
            DataTable dtrto = Utils.GetDataTable("select rtolocationname,rtolocationid from rtolocation where rtolocationid in (select distinct distrelation from rtolocation where HSRP_StateID='" + DropDownListStateName.SelectedValue + "')", CnnString);
        ...
        private string MakeQueryOnTheBasisOfSeletedOption(String StringOrderDate, String StringAuthDate, string RTOCode)
        {
            ...
            {
                //SQLString = "SELECT  h.HSRP_StateID, CONVERT(varchar(20), h.HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), h.HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), h.OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), h.InvoiceDateTime, 103) AS InvoiceDateTime,  h.HSRPRecord_AuthorizationNo,h.CashReceiptNo, h.HSRPRecordID, h.VehicleRegNo,r.RTOLocationName as 'RtoLocationName',h.ordertype,h.OwnerName, h.VehicleType, h.VehicleClass,CONVERT(numeric,round( h.RoundOff_NetAmount,0)) as NetAmount,h.OrderDate,h.EngineNo,h.ChassisNo,h.MobileNo,h.vat_amount FROM HSRPRecords h , RTOLocation r  where h.HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and h.RTOLocationID=r.RTOLocationID and RTOLocationID='" + RTOCode + "' and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 and  OwnerName is not null and OwnerName <> '' order by OrderDate";
                SQLString = "SELECT  HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,vat_amount FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "' and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 and  OwnerName is not null and OwnerName <> '' order by OrderDate";
            }
            else if (ddlVehicleReference.SelectedItem.Text == "Both")
            {
                SQLString = "SELECT  HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,vat_amount FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "'  and VehicleType='" + DropDownListVehicleModel.SelectedItem.ToString() + "'  and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 and   OwnerName is not null and OwnerName <> ''  order by OrderDate";
            }
            ...
            {
                SQLString = "SELECT  HSRP_StateID, CONVERT(varchar(20), HsrpRecord_AuthorizationDate, 103) AS HsrpRecord_AuthorizationDate,  CONVERT(varchar(20), HsrpRecord_creationdate, 103) AS NewOrderDate,CONVERT(varchar(20), OrderEmbossingDate, 103) AS OrderEmbossingDate,CONVERT(varchar(20), InvoiceDateTime, 103) AS InvoiceDateTime,  HSRPRecord_AuthorizationNo,CashReceiptNo, HSRPRecordID, VehicleRegNo, OwnerName, VehicleType, VehicleClass,CONVERT(numeric,round( RoundOff_NetAmount,0)) as NetAmount,OrderDate,EngineNo,ChassisNo,MobileNo,vat_amount FROM HSRPRecords where HSRP_StateID='" + DropDownListStateName.SelectedValue + "' and RTOLocationID='" + RTOCode + "' and vehicleref='" + ddlVehicleReference.SelectedItem.ToString() + "' and HsrpRecord_creationdate between '" + StringOrderDate + "' and '" + StringAuthDate + "' and NetAmount <> 0 and  OwnerName is not null and OwnerName <> '' order by OrderDate";
            }
            else
            {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dtrows in dt.Rows) // Loop over the rows.
                    {
                        ...
                        {
                            tax = Math.Round((Convert.ToDouble(amount) * 13.5) / 113.5, 2);
                            exicse = Math.Round(((Convert.ToDouble(amount) - tax) * 12.50) / 112.5, 2);
                            royalty = Math.Round(((Convert.ToDouble(amount) - tax) * 5) / 100.00, 2);
