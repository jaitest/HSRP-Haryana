...
{
    public partial class SDMReport : System.Web.UI.Page
    {
        ...
        private void FilldropDownListClient()
        {
            if (UserType.Equals(0))
            {
                ...
                SQLString = "select RTOLocationName,RTOLocationcode from RTOLocation Where HSRP_StateID=" + intHSRPStateID + " and ActiveStatus!='N' and RTOLocationcode is not null and RTOLocationcode !='' and rtotype='SDM'  Order by RTOLocationName";
            ...
            {
                SQLString = "select RTOLocationName,RTOLocationcode from RTOLocation Where (RTOLocationID=" + RTOLocationID + " or distRelation=" + RTOLocationID + " ) and ActiveStatus!='N'  and RTOLocationcode is not null and RTOLocationcode !=''  Order by RTOLocationName";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                book.Properties.Title = "AP TS Report";
                ...
                Worksheet sheet = book.Worksheets.Add("SDM Report");
                ...
                row.Cells.Add(new WorksheetCell(" ", "HeaderStyle3"));
                WorksheetCell cell = row.Cells.Add("SDM Report");
                ...
                row.Cells.Add(new WorksheetCell("3rd Sticker", "HeaderStyle"));
                ...
                {
                    SQLString = "select VEHICLETYPE as [Description of Vehicle],vehicleregno as [Registration No. of the Vehicle],HSRP_Front_LaserCode as [Front Laser Code],HSRP_Rear_LaserCode as [Rear Laser Code],StickerMandatory as [3rd Sticker],convert(varchar,OrderClosedDate,103) as [Affixation Date] from hsrprecords a,rtolocation b where  a.rtolocationid=b.rtolocationid and a.hsrp_stateid='" + DropDownListStateName.SelectedValue + "' and left(VehicleRegNo,4)='" + ddlRtoLocation.SelectedValue + "' and convert(date,hsrprecord_creationdate) between convert(date,'" + OrderDate.SelectedDate + "') and convert(date,'" + HSRPAuthDate.SelectedDate + "') and vehicleclass='Non-Transport' order by vehicletype";
                }
                else
                {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count;i++) // Loop over the rows.
                    {
                        ...
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["Front Laser Code"].ToString(), DataType.String, "HeaderStyle1"));
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["Rear Laser Code"].ToString(), DataType.String, "HeaderStyle1"));
                        row.Cells.Add(new WorksheetCell(dt.Rows[i]["3rd Sticker"].ToString(), DataType.String, "HeaderStyle1"));
