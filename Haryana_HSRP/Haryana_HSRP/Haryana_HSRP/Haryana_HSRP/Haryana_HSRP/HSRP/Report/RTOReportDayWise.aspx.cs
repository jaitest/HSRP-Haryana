...
{
    public partial class RTOReportDayWise : System.Web.UI.Page
{
    int UserType1;
    ...
    private void Export()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("[Report_HR_TCReport_DayWise]", con);
           ...
           // cmd.Parameters.Add(new SqlParameter("@addrecordby", ddlBothDealerHHT.SelectedItem.Text));
            ...
            row.Cells.Add(new WorksheetCell("RTO Report daywise", "HeaderStyle3"));
