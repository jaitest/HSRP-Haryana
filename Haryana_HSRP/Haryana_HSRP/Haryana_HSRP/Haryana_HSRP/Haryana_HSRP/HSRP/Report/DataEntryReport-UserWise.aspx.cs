...
{
    public partial class DataEntryReport_UserWise : System.Web.UI.Page
    {
               ...
               // dt = Utils.GetDataTable(SQLString, CnnString);
                ...
                if (ds.Rows.Count > 0)
                {
                    foreach (DataRow dtrows in ds.Rows) // Loop over the rows.
                    {
                        ...
                        orderentry = orderentry + checked1(dtrows["orderentry"].ToString());
                        Embossingentry = Embossingentry + checked1(dtrows["Embossingentry"].ToString());
                        Closedentry = Closedentry + checked1(dtrows["Closedentry"].ToString());
                    }

                    row = sheet.Table.Rows.Add();
                    row.Cells.Add(new WorksheetCell("Total", DataType.String, "HeaderStyle15"));
                    row.Cells.Add(new WorksheetCell("", DataType.String, "HeaderStyle15"));
                    row.Cells.Add(new WorksheetCell("", DataType.String, "HeaderStyle15"));
                    row.Cells.Add(new WorksheetCell(orderentry.ToString(), DataType.String, "HeaderStyle15"));
                    row.Cells.Add(new WorksheetCell(Embossingentry.ToString(), DataType.String, "HeaderStyle15"));
                    row.Cells.Add(new WorksheetCell(Closedentry.ToString(), DataType.String, "HeaderStyle15"));
