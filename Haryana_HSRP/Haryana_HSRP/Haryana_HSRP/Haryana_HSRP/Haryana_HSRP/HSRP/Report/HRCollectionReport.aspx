<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HRCollectionReport.aspx.cs" Inherits="HSRP.Report.HRCollectionReport" %>
...
<%--                                                                                <td align="left">
                                       ...
                                       <%-- <td>
                                        ...
                                        <td>
                                            <asp:Label Text="From:" runat="server" Visible="false"
                                        ...
                                        <td>
                                            ...
                                            <asp:Button ID="btn_download" runat="server" Text="Export PDF"
            ...
            <tr>
                <td colspan="8" align="center" id="gridTD" runat="server">
                    <asp:Panel runat="server" ID="Panel1" ScrollBars="Vertical" Font-Bold="True" Height="700px" BorderColor="#FF9966" BorderStyle="Groove" BorderWidth="0px">
                        <asp:GridView ID="grd" runat="server" CellPadding="4" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="false"
                            ...
                            <Columns>  
                                    <asp:BoundField HeaderText="S.NO" DataField="S.NO" />
                                            ...
                                            <ItemTemplate>
                                            <asp:LinkButton runat="server" ID="lnkView" ClientIDMode="Static" CommandArgument='<%#Eval("RTOLocationCode") %>'
                                             CommandName="Edit">ViewDetail</asp:LinkButton>
                                             </ItemTemplate>
                                          </asp:TemplateField>
