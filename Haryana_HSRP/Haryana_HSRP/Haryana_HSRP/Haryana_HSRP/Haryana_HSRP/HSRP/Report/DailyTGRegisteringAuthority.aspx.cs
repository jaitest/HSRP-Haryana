...
{
    public partial class DailyTGRegisteringAuthority : System.Web.UI.Page
    {
        ...
        private void FilldropDownListOrganization()
        {
            ...
            {
                SQLString = "select HSRPStateName,HSRP_StateID from HSRPState  where hsrp_stateID in ('11') and ActiveStatus='Y' Order by HSRPStateName";
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
         ...
         //       row.Cells.Add(new WorksheetCell(ddlMonth.SelectedItem.ToString() + "-" + ddlYear.SelectedValue.ToString(), "HeaderStyle2"));
               ...
               // row.Index = 7; 
                ...
                SQLString = "exec Report_Monthly_Statement_Registering_Authority_TG'" + FromDate + "','" + ToDate + "','11','"+ ddllocation.SelectedValue +"'";
