...
{
    public partial class AvgCollectionCount : System.Web.UI.Page
    {
        int UserType;
        ...
        public void BuildGrid1()
        {
            try
            {
                ...
                SQLString = " SELECT convert(varchar(5),DATEPART(YEAR, ORDERDATE)) as [YEAR],DATENAME(MONTH, ORDERDATE) AS [MONTHNAME],"
                          ...
                          + "  SUM(CASE WHEN  (VehicleType = 'MOTOR CYCLE' OR VehicleType ='SCOOTER') and (orderType='DR' or orderType ='DF') THEN RoundOff_NetAmount ELSE 0 END ) AS [2W Single Plate],"
                          + "  SUM(CASE WHEN  VehicleType = 'THREE WHEELER' and (orderType='DR' or orderType ='DF') THEN RoundOff_NetAmount ELSE 0 END ) AS [3W Single Plate],"
                          + "  SUM(CASE WHEN  (VehicleType = 'LMV' OR VehicleType = 'LMV(CLASS)') and (orderType='DR' or orderType ='DF') THEN RoundOff_NetAmount ELSE 0 END ) AS [4W Single Plate],"
                          + "  SUM(CASE WHEN  (VehicleType = 'MOTOR CYCLE' OR VehicleType ='SCOOTER') and (orderType='NB' or orderType ='OB' or orderType='DB')  THEN RoundOff_NetAmount ELSE 0 END ) AS [2W],"
                          + "  SUM(CASE WHEN  VehicleType = 'THREE WHEELER'  and (orderType='NB' or orderType ='OB' or orderType='DB') THEN RoundOff_NetAmount ELSE 0 END ) AS [3W],"
                          + "  SUM(CASE WHEN  (VehicleType = 'LMV' OR VehicleType = 'LMV(CLASS)')  and (orderType='NB' or orderType ='OB' or orderType='DB') THEN RoundOff_NetAmount ELSE 0 END ) AS [4W],"
                          + "  SUM(CASE WHEN  VehicleType = 'MCV/HCV/TRAILERS' THEN RoundOff_NetAmount ELSE 0 END ) AS [MCV/HCV/TRAILERS],"
                          ...
                          //+ "  SUM(CASE WHEN  VehicleType = 'THREE WHEELER' and (orderType='DR' or orderType ='DF') THEN RoundOff_NetAmount ELSE 0 END ) AS [3W Single Plate],"
                          //+ "  SUM(CASE WHEN  (VehicleType = 'LMV' OR VehicleType = 'LMV(CLASS)') and (orderType='DR' or orderType ='DF') THEN RoundOff_NetAmount ELSE 0 END ) AS [4W Single Plate], "
                          //+ "  SUM(CASE WHEN  (VehicleType = 'MOTOR CYCLE' OR VehicleType ='SCOOTER') and (orderType='NB' or orderType ='OB')  THEN RoundOff_NetAmount ELSE 0 END ) AS [2W], "
                          //+ "  SUM(CASE WHEN  VehicleType = 'THREE WHEELER'  and (orderType='NB' or orderType ='OB') THEN RoundOff_NetAmount ELSE 0 END ) AS [3W],"
                          //+ "  SUM(CASE WHEN  (VehicleType = 'LMV' OR VehicleType = 'LMV(CLASS)')  and (orderType='NB' or orderType ='OB') THEN RoundOff_NetAmount ELSE 0 END ) AS [4W], "
                          //+ "  SUM(CASE WHEN  VehicleType = 'MCV/HCV/TRAILERS' THEN RoundOff_NetAmount ELSE 0 END ) AS [MCV/HCV/TRAILERS],"
                          //+ "  SUM(CASE WHEN  VehicleType = 'TRACTOR' THEN RoundOff_NetAmount ELSE 0 END ) AS [TRACTOR]"
                          //+ "  FROM hsrprecords"
                          //+ "  WHERE OrderDate between '" + ReportDate1 + "' and '" + ReportDate2 + "' and  hsrp_stateid='" + DropDownListStateName.SelectedValue.ToString() + "'"
        ...
        protected void btnexport_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string filename = "Total_Collection_Count" + System.DateTime.Now.Day.ToString() + System.DateTime.Now.Month.ToString() + System.DateTime.Now.Year.ToString() + System.DateTime.Now.Hour.ToString() + System.DateTime.Now.Minute.ToString() + ".xls";
                    ...
                    book.Properties.Title = "HSRP Total Collection Count";
                    ...
                    Worksheet sheet = book.Worksheets.Add("HSRP Total Collection Count");
                    ...
                    WorksheetCell cell = row.Cells.Add("HSRP Total Collection Count");
                    ...
                    else
                    {
                        ...
                        //+ "  FROM hsrprecords"
                        //+ "  WHERE OrderDate between '" + ReportDate1 + "' and '" + ReportDate2 + "' and  hsrp_stateid='" + DropDownListStateName.SelectedValue.ToString() + "' AND RTOLocationID=" + dropDownListClient.SelectedValue.ToString() + " "
                        //+ "  ORDER BY [YEAR], ORDERMONTH ";            dt1 = Utils.GetDataTable(SQLString, CnnString);
                        if (dt1.Rows.Count > 0)
                        {
