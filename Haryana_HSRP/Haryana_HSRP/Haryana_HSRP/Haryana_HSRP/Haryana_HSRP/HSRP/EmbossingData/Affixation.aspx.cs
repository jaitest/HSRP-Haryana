            ...
            try
            {
                ...
                for (int i = 0; i < GridView1.Rows.Count; i++)
                {
                    ...
                    if (chk.Checked == true)
                    {
                        ...
                        Label lablRecievedAffixationStatus = GridView1.Rows[i].Cells[1].FindControl("lablRecievedAffixationStatus") as Label;

                        if (lablRecievedAffixationStatus.Text.ToString().Trim().ToUpper() !="Y")
                        {
                            ArrVehicle = ArrVehicle + "|" + lblVehicleRegNo;
                            lblvehicle.Visible = true;
                            txtvehicleregNo.Visible = true;                           
                            txtvehicleregNo.Text = ArrVehicle;
                        }
                        else
                        {
