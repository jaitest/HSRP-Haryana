<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="AllStateHsrpData.aspx.cs" Inherits="HSRP.Report.AllStateHsrpData" %>

<%@ Register TagPrefix="ComponentArt" Namespace="ComponentArt.Web.UI" Assembly="ComponentArt.Web.UI" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    uk<script type="text/javascript" src="../windowfiles/dhtmlwindow.js"></script><link rel="stylesheet" href="../windowfiles/dhtmlwindow.css" type="text/css" /><script type="text/javascript">
            ...
            <td valign="top">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <td>
                            <table width="100%" border="0px solid" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                        ...
                                        <asp:DropDownList AutoPostBack="true" Visible="true" CausesValidation="false" ID="DropDownListStateName"
                                            ...
                                            <asp:DropDownList ID="ddllasercode" runat="server" Visible="true" 
                                               ...
                                               <asp:ListItem  Text = "--Select--" Value = "0"></asp:ListItem>
                                                    <asp:ListItem Text = "HSRPRECORDID" Value = "1"></asp:ListItem>
                                                    <asp:ListItem Text = "VehicleRegNo" Value = "2"></asp:ListItem>
                                    ...
                                    <td valign="middle" class="form_text" nowrap="nowrap" style="width: 119px">
                                                  &nbsp; &nbsp;&nbsp;
                                         <asp:Button ID="btnGO" runat="server" class=button Text="GO" Width="100px" OnClick="btnGO_Click" 
                                                        BackColor="Orange" ForeColor="#000000" ></asp:Button>
                   ...
                   <%--<asp:Label Text="PFA:Pending For Assignment FLA:Front Laser Assigned RLA:Rear Laser Assigned" Visible="true" Font-Bold="true" ForeColor="#333333" runat="server" ID="label3" />--%>
                                ...
                                <td valign="middle" class="form_text" nowrap="nowrap" style="width: 200px">
                                    &nbsp;</td>
