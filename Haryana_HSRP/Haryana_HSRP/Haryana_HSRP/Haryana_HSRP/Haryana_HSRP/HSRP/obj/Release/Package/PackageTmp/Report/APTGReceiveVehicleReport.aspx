<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="APTGReceiveVehicleReport.aspx.cs" Inherits="HSRP.Report.APTGReceiveVehicleReport" %>
    ...
    <table style="height: 51px;" width="80%">
        <tr>
            ...
            <td style="width: 50px; height: 40px;">               
                    ...
                    <asp:Label ID="label2" runat="server" Font-Bold="True" ForeColor="Black"  Visible="false"
            ...
            <td style="height: 40px;" width="80">               
                    ...
                    <asp:DropDownList ID="DropDownListOrderType" runat="server" 
                        CausesValidation="false" DataTextField="HSRPStateName"  Visible="false"
                        ...
                        <asp:ListItem Value="N">Non Dealer</asp:ListItem>
                                                ...
                                                <td style="height: 40px" width="20"> <asp:Label Text="From:" runat="server" Visible="false"
                                                        ID="labelDate" Font-Bold="True" 
                                                        ForeColor="Black" Width="60px" /> </td>
                                                <td style="height: 40px" width="140">
                                                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                    <ContentTemplate>
                                                                        <ComponentArt:Calendar ID="OrderDatefrom" runat="server" PickerFormat="Custom" PickerCustomFormat="dd/MM/yyyy" Visible="false"
