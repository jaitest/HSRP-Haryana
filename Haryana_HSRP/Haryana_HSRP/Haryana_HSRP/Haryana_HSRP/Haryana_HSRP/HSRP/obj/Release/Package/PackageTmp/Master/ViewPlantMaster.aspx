<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewPlantMaster.aspx.cs" Inherits="HSRP.Master.ViewPlantMaster" %>
...
<script type="text/javascript" src="../windowfiles/dhtmlwindow.js"></script>
    ...
    <script type="text/javascript">
        function editpage(i) { //Define arbitrary function to run desired DHTML Window widget codes
            //  alert(i);
            googlewin = dhtmlwindow.open("googlebox", "iframe", "PlantMaster.aspx?Mode=Edit&PlantID=" + i, "Update Plant Details", "width=650px,height=330px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location.href = "ViewPlantMaster.aspx";
                return true;
            }
        }
        ...
        function AddNewPop() { //Define arbitrary function to run desired DHTML Window widget codes
            ...
            googlewin = dhtmlwindow.open("googlebox", "iframe", "PlantMaster.aspx?Mode=New", "Add New Plant detail", "width=650px,height=330px,resize=1,scrolling=1,center=1", "recal")
            googlewin.onclose = function () {
                window.location = 'ViewPlantMaster.aspx';
                return true;
            }
        }
    </script>
                    ...
                    <tr>
                        <td height="27" background="../images/midtablebg.jpg">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <span class="headingmain">Plant Master </span>
                                    </td>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="topheader">
                                <tr>
                                    ...
                                    <td height="35" align="right" valign="middle" class="footer">
                                        <a onclick="AddNewPop(); return false;" title="Add New Hub" class="button">Add New Plant Detail</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table width="99%" align="center" cellpadding="0" cellspacing="0" class="borderinner">
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <ComponentArt:Grid ID="Grid1" PlantIDMode="PlantID" runat="server" ImagesBaseUrl="~/images"
                                            ...
                                            <Levels>
                                                <ComponentArt:GridLevel DataKeyField="PlantID" RowCssClass="Row" ColumnReorderIndicatorImageUrl="reorder.gif"
                                                    ...
                                                    SortImageHeight="19">
                                                    <Columns>
                                                        <ComponentArt:GridColumn DataField="PlantID" Visible="False" />
                                                        <ComponentArt:GridColumn DataField="PlantAddress" HeadingText="Plant Address" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="PlantCity" HeadingText="Plant City"
                                                            SortedDataCellCssClass="SortedDataCell" Width="100" />
                                                        <ComponentArt:GridColumn DataField="HSRPStateName" Visible="true" HeadingText="Plant State"
                                                            Width="100" />
                                                        <ComponentArt:GridColumn DataField="PlantZip" Visible="true" HeadingText="Plant Zip"
                                                            Width="100" />
                                                            <ComponentArt:GridColumn DataField="ContactPersonName" Visible="true" HeadingText="Contact Person Name"
                                                            Width="100" />
                                                            <ComponentArt:GridColumn DataField="MobileNo" Visible="true" HeadingText="Mobile No"
                                                            Width="100" />

                                                            <ComponentArt:GridColumn DataField="LandlineNo" Visible="true" HeadingText="Landline No"
                                                            Width="100" />
                                                            <ComponentArt:GridColumn DataField="EmailID" Visible="true" HeadingText="Email-ID"
                                                            Width="100" />

                                                        <ComponentArt:GridColumn DataField="ActiveStatus" HeadingText="Active Status" SortedDataCellCssClass="SortedDataCell"
                                                            Width="100" />
                                            ...
                                            <ClientTemplates>
                                                <ComponentArt:ClientTemplate ID="edit">
                                                    <a style="color: Red" onclick="javascript:editpage(## DataItem.GetMember('PlantID').Value ##);">
