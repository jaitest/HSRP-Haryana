<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OnlinePayment.aspx.cs"
    Inherits="OnlinePayment" %>
...
<body style="background-color: #F0F0F0">
    ...
    <div>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            Width="650px" 
                                                   Font-Names="Arial" 
            Font-Size="Small" ForeColor="Black" Height="700px" 
                                                    ...
                                                    <div align="left">
                                                        ...
                                                        <tr>
                                                                <td align="center" colspan="3">
                                                                    <asp:Label ID="Label1" runat="server" Text="ONLINE PAYMENT" Font-Bold="True" ForeColor="#000099"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" colspan="3">
                                                            ...
                                                            <tr>
                                                                <td align="center" colspan="3" style="background-color: #9F9F35">
                                                                    <span class="headingmain">Step-1:Please fill Vehicle info for Online Payment of HSRP</span>&nbsp;
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="200">&nbsp;
                                                            ...
                                                            <tr>
                                                                <td width="125">
                                                                    <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="Black" 
                                                                        Text="Authorization Slip No:"></asp:Label>
                                                            ...
                                                            <tr>
                                                                <td width="110">
                                                                    <asp:Label ID="Label10" runat="server" Font-Bold="True" ForeColor="Black" 
                                                                        Text="Vehicle Class :" Width="100px"></asp:Label>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                  <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                                                    ...
                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" 
                                                                        ...
                                                                        ValidationExpression="^[a-zA-Z0-9 ]+$" ValidationGroup="v"></asp:RegularExpressionValidator>--%>                                                                </td>
                                                            </tr>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td class="style7">
                                                                    <asp:TextBox ID="TextBox1" runat="server" TextMode="MultiLine" Height="40px"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                  <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                                                        ControlToValidate="txtRemarks" ErrorMessage="This Field can not be empty" 
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td class="style7">
                                                                    <asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" Height="40px"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                  <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                                                        ControlToValidate="txtRemarks" ErrorMessage="This Field can not be empty" 
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td class="style7">
                                                                    <asp:TextBox ID="TextBox3" runat="server" TextMode="MultiLine" Height="40px"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                  <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                                                        ControlToValidate="txtRemarks" ErrorMessage="This Field can not be empty" 
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td class="style7">
                                                                    <asp:TextBox ID="TextBox4" runat="server" TextMode="MultiLine" Height="40px"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                  <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                                                        ControlToValidate="txtRemarks" ErrorMessage="This Field can not be empty" 
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td class="style7">
                                                                    <asp:TextBox ID="TextBox5" runat="server" TextMode="MultiLine" Height="40px"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                  <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                                                        ControlToValidate="txtRemarks" ErrorMessage="This Field can not be empty" 
