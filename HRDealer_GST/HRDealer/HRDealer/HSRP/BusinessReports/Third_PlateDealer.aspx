<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Third_PlateDealer.aspx.cs" Inherits="HSRP.BusinessReports.Third_PlateDealer" %>
        ...
        <tr>
                <td colspan="8" align="center" id="gridTD" runat="server">
                    ...
                    <asp:GridView ID="grdthirdplate" runat="server" CellPadding="4" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False"                         
                        ShowHeader="False" Width="100%" BackColor="White" BorderColor="#FFCC99" BorderStyle="Solid" BorderWidth="1px" OnRowCommand="grdthirdplate_RowCommand" OnSelectedIndexChanging="grdthirdplate_SelectedIndexChanging" >
                        <AlternatingRowStyle BackColor="White" />
                    
                        <Columns>      
                             <asp:TemplateField HeaderText="Affixation Center" HeaderStyle-ForeColor="Blue" ItemStyle-HorizontalAlign="Left" HeaderStyle-Height="60px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Assign Laser Code" HeaderStyle-ForeColor="Blue" HeaderStyle-Height="60px">
                                <ItemTemplate> 
                            ...
                            <asp:TemplateField HeaderText="Today Production" HeaderStyle-ForeColor="Blue" HeaderStyle-Height="60px">
                                <ItemTemplate>                          
                            ...
                            <asp:TemplateField HeaderText="Day1" HeaderStyle-ForeColor="Blue" HeaderStyle-Height="60px">
                                <ItemTemplate>                                    
                            ...
                            <asp:TemplateField HeaderText="Day2" HeaderStyle-ForeColor="Blue" HeaderStyle-Height="60px">
                                <ItemTemplate>
                              ...
                              <asp:TemplateField HeaderText="Day4" HeaderStyle-ForeColor="Blue" HeaderStyle-Height="60px">
                                <ItemTemplate>
                              ...
                              <asp:TemplateField HeaderText="Day5orMore" HeaderStyle-ForeColor="Blue" HeaderStyle-Height="60px">
                                <ItemTemplate>
