...
namespace HSRP.Report
{
    public partial class HRMonthlyReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
              ...
              //  row.Cells.Add(new WorksheetCell("Date of receipt of Authorization for HSRP", "HeaderStyle"));
                ...
                SQLString = "SELECT   a.Address1,a.OrderType ,a.ManufacturerName, convert(varchar,a.OrderDate,110)as OrderDate ,convert(varchar,a.OrderClosedDate,110)as OrderClosedDate,convert(varchar,a.HSRPRecord_AuthorizationDate,110)as HSRPRecord_AuthorizationDate, b.ProductColor, a.HSRPRecord_AuthorizationNo, convert(varchar,a.OrderEmbossingDate,110)as OrderEmbossingDate, a.HSRPRecordID, a.OwnerName, a.VehicleType, a.HSRP_Front_LaserCode,Product_1.ProductColor,a.HSRP_Rear_LaserCode, a.VehicleClass, a.StickerMandatory, Product_1.ProductCode AS FrontPlateSize, a.RearPlateSize, b.ProductCode AS RearPlateSize1,a.FrontPlateSize AS FrontPlateSize, a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '4' and Addrecordby='Dealer' AND a.OrderClosedDate  between '" + FromDate + "' and '" + ToDate + "'";
        ...
        private void ExportToPDF()
        {
            ...
            var colWidthPercentages = new[] { 25f, 70f, 45f, 50f, 45f, 60f, 60f };
            table.SetWidths(colWidthPercentages);
            //string sqlquery="select distrelation from rtolocation where rtolocationid='"+
            string SqlQuery = string.Empty;


            SQLString = "SELECT ROW_NUMBER() over( order by  HSRPRecord_AuthorizationNo) as 'SNo',HSRP_Front_LaserCode as 'FrontLaserNo',HSRP_Rear_LaserCode as 'RearLaserNo', OwnerName,rtrim(ltrim(Address1)) as 'Address1',OrderType as 'OrderType'," +" convert(varchar,OrderDate,103)as 'OrderDate' ,convert(varchar,OrderClosedDate,103)as 'ClosedDate' FROM HSRPRecords   WHERE  HSRP_StateID= '4' AND OrderClosedDate  between '" + FromDate + "' and '" + ToDate + "'";
            DataTable dt = Utils.GetDataTable(SQLString, CnnString);

            table.TotalWidth = 780f;
            table.LockedWidth = true;
            //  GenerateCell(table, 10, 0, 0, 0, 0, 1, 1, "", 50, 0);
            GenerateCell(table, 7, 0, 0, 0, 0, 1, 0, "SCHEDULE-F", 20, 0);
            GenerateCell(table, 7, 0, 0, 0, 0, 0, 0, "", 20, 0);
            GenerateCell(table, 7, 0, 0, 0, 0, 1, 0, "Monthly Report From Concessionaire to Registering Authority", 20, 0);
            GenerateCell(table, 2, 0, 0, 0, 0, 0, 0, "State Name : HARYANA", 20, 0);
           ...
           // GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Vehicle NO", 30, 0);
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Owner Name", 20, 0);
        ...
        private void ExportToAllPDF()
        {
              ...
              for (int iRowNo = 0; iRowNo < dtrto.Rows.Count; iRowNo++)
              {
                 ...
                 // HttpContext context = HttpContext.Current;
                  ...
                  table.LockedWidth = true;
                  //  GenerateCell(table, 10, 0, 0, 0, 0, 1, 1, "", 50, 0);
                  GenerateCell(table, 8, 0, 0, 0, 0, 1, 0, "SCHEDULE-F", 20, 0);
                  GenerateCell(table, 8, 0, 0, 0, 0, 0, 0, "", 20, 0);
                  GenerateCell(table, 8, 0, 0, 0, 0, 1, 0, "Monthly Report From Concessionaire to Registering Authority", 20, 0);
                  GenerateCell(table, 2, 0, 0, 0, 0, 0, 0, "State Name : HARYANA", 15, 0);
