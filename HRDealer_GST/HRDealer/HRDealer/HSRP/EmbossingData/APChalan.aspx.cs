        ...
        public void Showgridfun()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(txtTransporter.Text))
                {
                    ...
                    //return "Please Enter Transporter";
                    return;
                }
                else 
                {
                ...
                //strInvoiceNo =  (Utils.getScalarValue(strGetFinYear, CnnString)).Replace("20", string.Empty) + "/" + strInvoiceNo;
                ...
                string strdealer = "select dealername from dealermaster where dealerid = '" + DDlDealerName.SelectedValue.ToString() + "' ";
                DataTable dealername = Utils.GetDataTable(strdealer, CnnString);
                string strdelearname;
                if (dealername.Rows.Count > 0)
                {
                    strdelearname = dealername.Rows[0]["dealername"].ToString();
                    strdname = "DealerName: -" + strdelearname + "";
                }
                else 
                {
                    strdelearname = "";
