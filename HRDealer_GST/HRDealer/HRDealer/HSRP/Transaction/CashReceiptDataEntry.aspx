    ...
    <fieldset>
        ...
        <table id="Table1" width="80%" align="center" style="font-size: 16px; color: Black; font-family: @Batang; background-color: #fff">
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <asp:Label ID="Lblgstin" runat="server" Text="GSTIN"></asp:Label>
                       ...
                       <asp:TextBox ID="Txtgistin" runat="server" CssClass="text_box" OnTextChanged="Txtgistin_TextChanged"></asp:TextBox>
                    <%----%>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:Button ID="btngstin" runat="server" Text=" Update GSTIN "  Width="150px" OnClick="btngstin_Click"  />
                    </td>
