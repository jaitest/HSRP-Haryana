...
{
    public partial class orderbookingdamage : System.Web.UI.Page
    {
        ...
        protected void btnDownloadReceipt_Click(object sender, EventArgs e)
        {
            ...
            string SQLString = " select  top 1 hsrprecordID, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType,CashReceiptNo , Engineno  from hsrprecords where  ChassisNo ='" + txtChassisno.Text.Trim() + "'  order by HSRPRecord_CreationDate desc ";
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                PdfPCell cell2221 = new PdfPCell(new Phrase(": " + dataSetFillHSRPDeliveryChallan.Rows[0]["Engineno"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell2221.Colspan = 3;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddlOrderType.SelectedItem.Text == "-Select Order Type-")
                {
                    lblErrMess.Visible = true;
                ...
                Query = "select ChassisNo from hsrprecords where hsrp_stateid='4' and  ChassisNo ='" + txtChassisno.Text.Trim().Replace(" ", "") + "' and vehicleregno='" + txtRegNumber.Text.Trim().Replace(" ","")+ "' and  orderstatus='CLOSED' ";
                ...
                else
                {
                    lblSucMess.Visible = false;
                    lblErrMess.Visible = true;
                    lblErrMess.Text = "Chassis No. Not Exist";
                    return;
                }
                ...
                if (dt11.Rows.Count > 0)
                {
                    ...
                    {
                        if (ddlVehicleclass.SelectedItem.Text.ToUpper().Trim() == "NON-TRANSPORT" && ddlVehicletype.SelectedItem.Text.Trim().ToUpper() == "SCOOTER" || ddlVehicletype.SelectedItem.Text.Trim().ToUpper() == "MOTOR CYCLE" || ddlVehicletype.SelectedItem.Text.Trim().ToUpper() == "TRACTOR")
                        {
                            fixcharge = "118.00";
                        }

                        if (ddlVehicleclass.SelectedItem.Text.Trim() == "NON-TRANSPORT" && ddlVehicletype.SelectedItem.Text.Trim() == "L.M.V. (CAR)" || ddlVehicletype.SelectedItem.Text.Trim().ToUpper() == "LMV" || ddlVehicletype.SelectedItem.Text.Trim().ToUpper() == "LMV(CLASS)" || ddlVehicletype.SelectedItem.Text.Trim() == "MCV/HCV/TRAILERS" )
                        {
                            fixcharge = "295.00";
                        }
                        ...
                        if (ddlVehicletype.SelectedItem.Text.Trim().ToUpper() == "THREE WHEELER")
                        {
                            fixcharge = "118.00";
                        }
                ...
                string sql = "exec [getPlatesData] '" + HSRPStateID + "','" + ddlVehicletype.SelectedItem.ToString() + "','" + ddlVehicleclass.SelectedItem.ToString() + "','" + ddlOrderType.SelectedValue.ToString() + "'";
                ...
                string FrontPlateCost ;
                string rearplatecost ;
                if (string.IsNullOrEmpty(dt.Rows[0]["FrontPlateCost"].ToString().ToString().Trim()))
                {
                    FrontPlateCost = "0";
                }
                else
                {
                  FrontPlateCost=dt.Rows[0]["FrontPlateCost"].ToString();
                }
                ...
                {
                    rearplatecost = dt.Rows[0]["rearplatecost"].ToString();
                }
                ...
                string q = "select SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount	 , Roundoff_NetAmount  from tax where OrderType	 ='DB' and VehicleType ='" + ddlVehicletype.SelectedItem.ToString() + "' and   HSRP_StateID= '" + HSRPStateID + "'";
                DataTable dttax = Utils.GetDataTable(q, ConnectionString);
                if (dttax.Rows.Count > 0)
                {
                    int amount1 = Convert.ToInt32(dttax.Rows[0]["Roundoff_NetAmount"].ToString());
                    int amt1 = Convert.ToInt32(Math.Round(decimal.Parse(lblAmount.Text), 0));

                    if (amount1 != amt1)
                    {
                        lblSucMess.Visible = false;
                        lblErrMess.Visible = true;
                        lblErrMess.Text = "Please Contact With Administrator Round Off Amount Not Match.";
                        return;
                ...
                string strQuery = "insert into HSRPRecords (hsrprecord_authorizationno,hsrprecord_authorizationdate,SaveMacAddress,DeliveryChallanNo,ISFrontPlateSize,ISRearPlateSize,invoiceno, address1," +
                        ...
                        "VAT_Amount,RoundOff_NetAmount,VAT_Percentage,PlateAffixationDate,DateOfInsurance,ReceiptNo,Exshowroomprice,vehicleregno,dealerid,addrecordby,fixingcharge, StickerMandatory,userrtolocationid ,SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount	) " +
                        "values('" + hsrprecord_authorizationno + "',GetDate(),'" + macbase + "','" + DC + "', '" + dt.Rows[0]["frontplateflag"].ToString() + "','" + dt.Rows[0]["rearplateflag"].ToString() + "', '" + Invoice +
                        ...
                        "','" + ddlOrderType.SelectedValue.ToString()+ "','" + lblAmount.Text + "','" + ddlVehicletype.SelectedItem.ToString() + "','New Order','" + cashrc +
                        ...
                        "','New','" + FrontPlateCost + "','" + rearplatecost + "','" + dt.Rows[0]["stickercost"].ToString() +
                        "','" + dt.Rows[0]["snaplockcost"].ToString() + "','" + dt.Rows[0]["totalamount"].ToString() + "','" + dt.Rows[0]["vatamount"].ToString() + "','" +
                        Math.Round(decimal.Parse(lblAmount.Text), 0) + "','" + dt.Rows[0]["vatper"].ToString() + "','" + date1 + "','" + DepositDate.SelectedDate + "','','" + txtexprice.Text + "','" + txtRegNumber.Text.Replace(" ", "").Trim() + "','" + dealerid + "','Dealer', " + fixcharge + " ,'" + StickerMandatory + "' ,'" + Session["UserRTOLocationID"].ToString() + "' , '" + dttax.Rows[0]["SGSTPer"].ToString() + "'  , '" + dttax.Rows[0]["SGSTAmount"].ToString() + "'  , '" + dttax.Rows[0]["CGSTPer"].ToString() + "'  , '" + dttax.Rows[0]["CGSTAmount"].ToString() + "')";
        ...
        //    string SQLString = " select  Top 1 hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType , EngineNo from hsrprecords where  ChassisNo ='" + txtChassisno.Text.Trim() + "'  order by HSRPRecord_CreationDate desc  ";
        //    DataTable dataSetFillHSRPDeliveryChallan = Utils.GetDataTable(SQLString, ConnectionString);
        ...
        //        PdfPCell cell622 = new PdfPCell(new Phrase("Customer Care No : 18002702709", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));

        //        cell622.Colspan = 2;
        //        cell622.BorderWidthLeft = 0f;
        //        cell622.BorderWidthRight = 0f;
        //        cell622.BorderWidthTop = 0f;
        //        cell622.BorderWidthBottom = 0f;
        //        cell622.HorizontalAlignment = 2; //0=Left, 1=Centre, 2=Right
        //        table.AddCell(cell622);
        ...
        public void EpsionPrint()
        {
            ...
            string SQLString = " select top 1  hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType , EngineNo , SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount	 , gstbasicamount  from hsrprecords where  ChassisNo ='" + txtChassisno.Text.Trim() + "' order by hsrprecord_creationdate desc ";
            DataTable dataSetFillHSRPDeliveryChallan = Utils.GetDataTable(SQLString, ConnectionString);
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                PdfPCell cell1205 = new PdfPCell(new Phrase(" " + Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["gstbasicamount"].ToString()), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell1205.Colspan = 0;
                cell1205.BorderWidthLeft = 0f;
                cell1205.BorderWidthRight = 0f;
                cell1205.BorderWidthTop = 0f;
                ...
                PdfPCell cellNet120SGST = new PdfPCell(new Phrase("* SGST@" + Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["SGSTPer"]) + "%", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell1205SGST = new PdfPCell(new Phrase(" " + Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["SGSTAmount"]), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cellNet120CGSTPer = new PdfPCell(new Phrase("* CGST@" + Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["CGSTPer"]) + "%", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell1205CGSTAmount = new PdfPCell(new Phrase(" " + Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["CGSTAmount"].ToString()), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell65anew1 = new PdfPCell(new Phrase("WebSite: www.hsrphr.com", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                cell622.BorderWidthTop = 0f;
                cell622.BorderWidthBottom = 0f;
                cell622.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                table.AddCell(cell622);
           ...
           // btnDownload.Visible = false;
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (StrNICVehicleType.ToString() == "M-Cycle/Scooter(2WN)")
                    {
                        ddlVehicletype.Enabled = true;
                        ddlVehicleclass.Enabled = true;
                    }
                    ...
                    if(!string.IsNullOrEmpty(StrTransactonType))
                    {
                        if(StrTransactonType.ToUpper().Trim().Replace(" ","")=="NB")
                        {
                            ddlOrderType.SelectedValue = "DB";
                        }
                        ...
                        for (int i = 0; i < dtAcuserid.Rows.Count; i++)
                        {
                            ...
                            if (USERID == dtAcuserid.Rows[i]["userid"].ToString().Trim())
                            {
                                ...
                                for (int j = 0; j < dtAcuserid.Rows.Count; j++)
                                {
                                    ...
                                    string sqlquery = "select count (ChassisNo)as no from hsrprecords where  hsrp_stateid = 4 and  LTRIM(RTRIM(ChassisNo))= '" + txtChassisno.Text.ToString().Trim() + "' and createdby = '" + dtAcuserid.Rows[j]["userid"].ToString().Trim() + "'";
        ...
        {
          Response.Redirect("UploadDealerDataDamage.aspx");
