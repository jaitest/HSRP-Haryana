...
{
    public partial class ViewSearchHR_Engingno : System.Web.UI.Page
    {
        ...
        //        PdfPCell cell62 = new PdfPCell(new Phrase("(AUTH.SIGH.)" + " " + Authname, new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
        //        cell62.Colspan = 2;
        //        cell62.BorderWidthLeft = 0f;
        //        cell62.BorderWidthRight = 0f;
        //        cell62.BorderWidthTop = 0f;
        ...
        public void EpsionPrint(string hsrpRecordID)
        {
            ...
            //DataTable dataSetFillHSRPDeliveryChallan = Utils.GetDataTable(SQLString, ConnectionString);
            string SQLString = " select top 1  hsrprecordID,CashReceiptNo, HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,convert(varchar(12),OwnerName)as OwnerName,MobileNo,VehicleClass,OrderType,StickerMandatory,IsVIP,NetAmount,VehicleType , EngineNo , SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount	 , gstbasicamount  from hsrprecords where HSRPRecordID='" + hsrpRecordID + "'";
            DataTable dataSetFillHSRPDeliveryChallan = Utils.GetDataTable(SQLString, ConnectionString);
