...
namespace HSRP.Transaction
{
    public partial class CashReceiptDataEntry : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
         ...
         DataTable dtdealergstin = Utils.GetDataTable("select  gstin from dealerMaster  where DealerId ='" + dealerid + "' and  HSRP_StateID= 4", ConnectionString);
          if(string.IsNullOrEmpty( dtdealergstin.Rows[0]["gstin"].ToString()))
          {
              Lblgstin.Visible=true;
              Txtgistin.Visible=true;
              btngstin.Visible = true;
           ...
           else
          {
              ...
              Txtgistin.Visible = false;
              btngstin.Visible = false;
          }
        ...
        //        PdfPCell cell22111 = new PdfPCell(new Phrase(": " + GetAddress.Rows[0]["GSTIN"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
        //        cell22111.Colspan = 1;
        ...
        //        PdfPCell cell6222 = new PdfPCell(new Phrase("Customer Care No : 18002702709", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
        //        cell6222.Colspan = 4;
        //        cell6222.BorderWidthLeft = 0f;
        //        cell6222.BorderWidthRight = 0f;
        //        cell6222.BorderWidthTop = 0f;
        //        cell6222.BorderWidthBottom = 0f;
        //        cell6222.HorizontalAlignment = 2; //0=Left, 1=Centre, 2=Right
        //        table5.AddCell(cell6222);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               string q = "select gstbasicamount ,  SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount	 , Roundoff_NetAmount  from tax where OrderType	 ='NB' and VehicleType ='" + ddlVehicletype.SelectedItem.ToString() + "' and   HSRP_StateID= '" + HSRPStateID + "'";
               ...
               string strQuery = "insert into HSRPRecords (hsrprecord_authorizationno,hsrprecord_authorizationdate,SaveMacAddress,DeliveryChallanNo,ISFrontPlateSize,ISRearPlateSize,invoiceno, address1," +
                       ...
                       "VAT_Amount,RoundOff_NetAmount,VAT_Percentage,PlateAffixationDate,DateOfInsurance,ReceiptNo,Exshowroomprice,vehicleregno,dealerid,addrecordby,fixingcharge, StickerMandatory, userrtolocationid, SGSTPer,	SGSTAmount,	CGSTPer	,CGSTAmount, gstbasicamount) " +
        ...
        public void EpsionPrint()
        {
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                PdfPCell cell65anew1 = new PdfPCell(new Phrase("WebSite: www.hsrphr.com", new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell622 = new PdfPCell(new Phrase("Customer Care No : 18002702709", new iTextSharp.text.Font(bfTimes, 7f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell622.Colspan = 4;
                cell622.BorderWidthLeft = 0f;
                cell622.BorderWidthRight = 0f;
                cell622.BorderWidthTop = 0f;
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    StrChasisNo = dt.Rows[0]["ChassisNo"].ToString();
                       ...
                       if (dt.Rows[0]["hsrpflag1"].ToString().Trim() == "V4")
                       {
                           ddlVehicleclass.Enabled = true;
                       }
        ...
        protected void Txtgistin_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            if (string.IsNullOrEmpty(Txtgistin.Text.Trim().ToString()))
            {
                lblErrMess.Visible = true;
                lblErrMess.Text = "Please Enter GSTIN No.";
                return;

            }
            else
            {
                string q = "update  dealerMaster set  gstin='" + Txtgistin.Text + "'  where    DealerId ='" + dealerid + "' and  HSRP_StateID= 4 ";
                int j = Utils.ExecNonQuery(q, ConnectionString);
                if (j > 0)
                {
                    lblSucMess.Visible = true;
                    lblSucMess.Text = "GSTIN Updaed Succesfull.";
                }
                else
                {
                    lblErrMess.Visible = true;
                    lblErrMess.Text = "GSTIN Not Updaed.";
                    return;
