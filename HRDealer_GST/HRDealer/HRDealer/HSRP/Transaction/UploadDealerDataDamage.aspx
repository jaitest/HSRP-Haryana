<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="UploadDealerDataDamage.aspx.cs" Inherits="HSRP.Transaction.UploadDealerDataDamage" %>
...
8.     After uploading Confirm is compulsory.<br />                            
                            </td>
                        </tr>
                        ...
                        <tr>
                         ...
                         <tr>
                         <td> <asp:Label Text="Records Not found For Damage:"  runat="server" ID="label2" ForeColor="Black" />&nbsp;&nbsp; </td>
                ...
                <table id="tblgrid">
                      ...
                      <tr>
                           <td style=" color:Black;">No. of Records Not Exist:</td>
                            <td colspan="3" align="left" 
                                  style="font-family: Verdana,tahoma, arial; font-size: medium;" >
