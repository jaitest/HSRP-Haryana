...
namespace HSRP.Master
{
    public partial class LaserQuickClosed : System.Web.UI.Page
    {
        ...
        string useridfromsession = string.Empty;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            useridfromsession = Session["UID"].ToString();
            if (!Page.IsPostBack)
            {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSqlQuery = "select OrderType, OrderEmbossingDate,OwnerName from hsrprecords where hsrp_stateid='" + HSRPStateID + "'and addrecordby = 'Dealer' and  VehicleRegNo='" + textBoxVehicleRegNo.Text + "'  and orderstatus='Embossing Done' ";
                DataTable dtResult = Utils.GetDataTable(strSqlQuery, CnnString);

                if (dtResult.Rows.Count < 0)
                {
                    lblErrMess.Text = " Record Not Available !!";
                    return;
                }
                ...
                String hourMinutsecond;

                hourMinutsecond = DateTime.Now.ToString("HH:mm:ss");
                string OrdercloseDate = txtClosedDate.Text +" "+hourMinutsecond;

                if (Convert.ToDateTime(OrdercloseDate) < Convert.ToDateTime(StrEmbossingDate) || Convert.ToDateTime(txtClosedDate.Text) > Convert.ToDateTime(System.DateTime.Now))
                {
                    lblErrMess.Text = "";
                    lblErrMess.Text = "Please Check Order Close Date !!";
                    return;
                }               
                ...
                else
                {
                    ...
                    if (NewEmbossingDate == strClosedDate)
                    {
                        ...
                        else
                        {
                            ...
                            SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,vehicleregno from hsrprecords where HSRP_STATEID='" + HSRPStateID + "'  and addrecordby = 'Dealer' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus='Embossing Done'";
                            DataTable dtRecord = Utils.GetDataTable(SQLString.ToString(), CnnString);
                            if (dtRecord.Rows.Count > 0)
                            {
                                SQLString = "select top 1 vehicleRegNo, recordid from LaserAssignQuick where orderstatus='Embossing Done' and vehicleRegNo='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and addrecordby = 'Dealer'  order by recordid desc";
                            ...
                            if (Exists != "0")
                            {
                                SQLString = "select hsrprecordid from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and orderstatus not in('Closed')  and addrecordby = 'Dealer'and  RecievedAffixationStatus='Y' and hsrp_front_lasercode='" + lblFrontLaserPlate.Text + "' and hsrp_rear_lasercode='" + lblRearLaserPlate.Text + "' order by orderembossingdate desc";
                                ...
                                if (Convert.ToInt32(hsrpid) > 0)
                                {
                                    if (txtClosedDate.Text != "")
                                    {
                                        SQLString = "update hsrprecords set orderstatus='Closed',orderclosedDate='" + txtClosedDate.Text + "', ActualClosedOrderDate=GETDATE(), closeduserid='" + useridfromsession + "'   where hsrprecordid ='" + hsrpid + "' and addrecordby = 'Dealer' ";
                                ...
                                {
                                    lblErrMess.Text = "Record Not Closed";
                                    return;
                                }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,vehicleregno, orderdate from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and hsrp_front_lasercode='" + lblFrontLaserPlate.Text + "' and hsrp_rear_lasercode='" + lblRearLaserPlate.Text + "' AND orderstatus='Embossing Done' and  addrecordby = 'Dealer'";
                                    DataTable dtRecord = Utils.GetDataTable(SQLString.ToString(), CnnString);
                                ...
                                if (Exists != "0")
                                {
                                    SQLString = "select hsrprecordid from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and orderstatus = 'Embossing Done' and addrecordby = 'Dealer'  and HSRPrecord_CreationDate between '2013-04-01 00:00:00' and  '2014-12-31 00:00:00'";
                                        hsrpid = Utils.getDataSingleValue(SQLString, CnnString, "hsrprecordid");
                                        if (hsrpid == "0")
                                        {
                                            if (HSRPStateID == "1" || HSRPStateID == "4" || HSRPStateID == "3" || HSRPStateID == "6")
                                            {
                                                SQLString = "select hsrprecordid from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and orderstatus = 'Embossing Done' and addrecordby = 'Dealer'  and RecievedAffixationStatus='Y' and HSRPRecord_CreationDate >= '2015-01-01' ";

                                                hsrpid = Utils.getDataSingleValue(SQLString, CnnString, "hsrprecordid");

                                                if (hsrpid == "0")
                                                {
                                                    SQLString = "select hsrprecordid from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and orderstatus = 'Embossing Done'  and addrecordby = 'Dealer' and  HSRPRecord_CreationDate <= '2015-01-01 00:00:00' ";
                                        ...
                                        SQLString = "select hsrprecordid from hsrprecords where HSRP_StateID='" + HSRPStateID + "' and vehicleregno='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and hsrp_front_lasercode='" + lblFrontLaserPlate.Text + "' and hsrp_rear_lasercode='" + lblRearLaserPlate.Text + "' and orderstatus not in('Closed') and addrecordby = 'Dealer'  order by orderembossingdate desc";
                                    hsrpid = Utils.getDataSingleValue(SQLString, CnnString, "hsrprecordid");
                                    ...
                                    if (Convert.ToInt32(hsrpid) > 0)
                                    {
                                        if (txtClosedDate.Text != "")
                                        {
                                            ...
                                            SQLString = "update hsrprecords set orderstatus='Closed',orderclosedDate='" + txtClosedDate.Text + "', ActualClosedOrderDate=GETDATE(),closeduserid='" + useridfromsession + "' where hsrprecordid ='" + hsrpid + "'  ";
        ...
        protected void btnGO_Click(object sender, EventArgs e)
        {
            ...
            strQuery = "Select top 1 OrderStatus from hsrprecords where VehicleRegNo ='" + textBoxVehicleRegNo.Text + "'  and addrecordby = 'Dealer'  order by hsrprecord_creationDate desc ";
            ...
            SQLStringall = " select top 1  hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and addrecordby = 'Dealer'  AND orderstatus='Embossing Done' and (isnull(HSRP_Front_LaserCode,'')='' or HSRP_Front_LaserCode is null) and (isnull(HSRP_Rear_LaserCode,'')='' or HSRP_Rear_LaserCode is null) order by hsrprecord_creationDate desc";
            ...
            if (HSRPStateID == "4" || HSRPStateID == "3" || HSRPStateID == "1" || HSRPStateID == "6")
            {
                ...
                SQLString = "select top 1 hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and addrecordby = 'Dealer'  AND orderstatus ='Embossing Done' and RecievedAffixationStatus='Y' and recievedatAffixationDatetime is not null order by hsrprecordid desc";
                ...
                {
                    SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' and addrecordby = 'Dealer'  AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus ='Embossing Done' and RecievedAffixationStatus='N' and isnull(recievedatAffixationDatetime,'')!='' and HSRPrecord_CreationDate >= '2015-01-01 00:00:00'";
                    DataTable dtcount123 = Utils.GetDataTable(SQLString.ToString(), CnnString);
                    if (dtcount123.Rows.Count > 0)
                    {
                        lblErrMess.Text = "Please do Received at affixation Entry";
                        lblSucMess.Visible = false;
                    ...
                    {
                        SQLString = "select hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "'  and addrecordby = 'Dealer' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus='New Order' and HSRP_Front_LaserCode  is not null and HSRP_Rear_LaserCode is not null";
                        ...
                        {
                            SQLString = "select count(VehicleRegNo) as Record from hsrprecords where  HSRP_STATEID='" + HSRPStateID + "'  and addrecordby = 'Dealer'  AND  VehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' and orderStatus='Closed'";
                            ...
                            SQLString = "select top 1 hsrpRecordID,hsrp_Front_Lasercode,hsrp_rear_Lasercode,orderstatus from hsrprecords where HSRP_STATEID='" + HSRPStateID + "' and addrecordby = 'Dealer' AND vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim().ToUpper() + "' AND orderstatus ='Embossing Done' and HSRPrecord_CreationDate <= '2015-01-01 00:00:00' order By HSRPrecord_CreationDate,hsrprecordid desc";
                                                     
                            
                            DataTable dtcount01 = Utils.GetDataTable(SQLString.ToString(), CnnString);
                            if (dtcount01.Rows.Count > 0)
                            {
                                OrderClosedfun(dtcount01);
                                btnDownloadInvoice.Visible = false;
                                btnSave.Visible = true;
                                lblFrontLaserPlate.Visible = true;
                                lblRearLaserPlate.Visible = true;
        ...
        private void printDelevryChalan(string update)
        {
            ...
            SQLString = "select top 1 hsrprecordID,OrderStatus from hsrprecords where vehicleRegNo ='" + textBoxVehicleRegNo.Text.Trim() + "' and addrecordby = 'Dealer'  and OwnerName is not NULL and OrderStatus='Closed' and VehicleClass is not NULL and OrderType is not NULL and VehicleType is not NULL order by hsrprecordID desc";
            ...
            if (dtrecrodID.Rows.Count > 0)
            {
                ...
                if (OrderStatus == "Closed")
                {
                    ...
                    if (obj.FillHSRPRecordDeliveryChallan(HSRPRecordID, ref dataSetFillHSRPDeliveryChallan))
                    {
                        ...
                        PdfPCell cell1317 = new PdfPCell(new Phrase( System.Decimal.Round(  Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["VAT_Amount"]),2).ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                        cell1317.Colspan = 1;
                        ...
                        vat = System.Decimal.Round(vat, 2);
