<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="orderbookingdamage.aspx.cs" Inherits="HSRP.Transaction.orderbookingdamage" %>
            ...
            <tr>
                ...
                <td>
                 ...
                 <%--<td align="left">
                    ...
                    <asp:Button ID="btnupload" runat="server" Text=" Upload Data For Damage "  Visible="false" OnClick="btnupload_Click" Width="281px"  />
