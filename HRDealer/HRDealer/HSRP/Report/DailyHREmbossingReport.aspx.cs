...
namespace HSRP.Report
{
    public partial class DailyHREmbossingReport : System.Web.UI.Page
    {
        ...
        private void ExportToPDF()
        {
            ...
            SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo,  b.ProductColor, a.HSRPRecord_AuthorizationNo as vh1,a.VehicleRegNo as vh2, a.OrderEmbossingDate,convert(varchar,a.hsrprecord_creationdate,103) as hsrprecord_creationdate, a.HSRPRecordID, a.OwnerName, a.VehicleType, a.HSRP_Front_LaserCode,Product_1.ProductColor,a.HSRP_Rear_LaserCode, a.VehicleClass, case when a.StickerMandatory='N' then 'N' else a.StickerMandatory end as StickerMandatory, Product_1.ProductCode AS FrontPlateSize, a.RearPlateSize, b.ProductCode AS RearPlateSize1,a.FrontPlateSize AS FrontPlateSize ,a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '4' and Addrecordby='Dealer' AND a.hsrprecord_creationdate  between '" + FromDate + "' and '" + ToDate + "'";
           ...
           table.TotalWidth = 820f;
            ...
            GenerateCell(table, 1, 0, 1, 1, 1, 1, 0, "Colour Background", 20, 0);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["HSRP_Front_LaserCode"].ToString(), 10, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["HSRP_Rear_LaserCode"].ToString(), 10, 0);

                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["FrontPlateSize"].ToString(), 10, 0);
                GenerateCell(table, 1, 0, 1, 0, 1, 1, 1, dt.Rows[i]["RearPlateSize1"].ToString(), 10, 0);
        ...
        private void ExportToPDFAll()
        {
             ...
             for (int iRowNo = 0; iRowNo < dtrto.Rows.Count; iRowNo++)
             {
                ...
                // string PdfFolder = ConfigurationManager.AppSettings["PdfFolder"].ToString() + filename;
                 ...
                 PdfPTable table = new PdfPTable(12);
                 var colWidthPercentages = new[] { 20f, 88f, 42f, 40f, 45f, 40f, 40f, 50f, 50f, 20f, 32f, 30f };
                 //var colWidthPercentages = new[] { 20f, 80f, 45f,40f, 45f, 40f, 40f, 50f, 50f, 20f, 25f};
                 table.SetWidths(colWidthPercentages);
                 //string sqlquery="select distrelation from rtolocation where rtolocationid='"+
                 string SqlQuery = string.Empty;
        ...
        private void BindGrid()
        {
            string FromDate = OrderDate.SelectedDate.ToString("yyyy/MM/dd") + " 00:00:00"; // Convert.ToDateTime();
            string ToDate = HSRPAuthDate.SelectedDate.ToString("yyyy/MM/dd") + " 23:59:59";
            SQLString = "SELECT  ROW_NUMBER() over( order by  VehicleRegNo) as SNo, a.HSRPRecord_AuthorizationNo +' / '+ a.VehicleRegNo as 'Application / Registration No',a.VehicleType,a.OwnerName,a.HSRP_Front_LaserCode as FrontLaserNo,a.HSRP_Rear_LaserCode as RearLaserNo,Product_1.ProductCode AS FrontPlateSize,b.ProductCode AS RearPlateSize1, a.StickerMandatory, b.ProductColor,a.Remarks FROM HSRPRecords a INNER JOIN Product b ON a.RearPlateSize = b.ProductID INNER JOIN  Product Product_1 ON a.FrontPlateSize = Product_1.ProductID  WHERE  a.HSRP_StateID= '4' and Addrecordby='Dealer' AND a.OrderEmbossingDate  between '" + FromDate + "' and '" + ToDate + "'";
            DataTable dt = Utils.GetDataTable(SQLString, CnnString);
