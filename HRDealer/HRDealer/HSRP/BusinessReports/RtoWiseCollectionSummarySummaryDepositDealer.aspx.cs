...
{
    public partial class RtoWiseCollectionSummarySummaryDepositDealer : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "Business_DateYearMonthWise_Collection_SummaryDepositDealer");
        ...
        private void Export(string strReportType, Workbook book, int iActiveSheet, string strProcName)
        {
            try
            {
                ...
                WorksheetCell cell = row.Cells.Add("Cumulative Collection and Deposit Report With Date");
