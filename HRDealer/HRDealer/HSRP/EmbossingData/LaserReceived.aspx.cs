...
namespace HSRP.EmbossingData
{
    public partial class LaserReceived : System.Web.UI.Page
    {
        ...
        protected void btnGO_Click(object sender, EventArgs e)
        {
            ...
            SQLString = "select  Distinct ChallanNo   from hsrprecords  where hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and rtolocationID='" + dropDownRtoLocation.SelectedValue + "'and  addrecordby = 'Dealer' and RecievedAffixationStatus='N' and  ChallanNo is not null    group by  ChallanNo";
        ...
        protected void dropdownDuplicateFIle_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string SQLString = "select hsrprecordid,vehicleregno,hsrp_rear_lasercode,hsrp_Front_lasercode,OrderStatus from hsrprecords where OrderStatus='Embossing Done' and ChallanNo='" + dropdownChallanNo.SelectedItem.ToString() + "' and hsrp_StateID='" + DropDownListStateName.SelectedValue + "' and rtolocationID='" + dropDownRtoLocation.SelectedValue + "'and RecievedAffixationStatus='N' and  addrecordby = 'Dealer' ";
            dt = Utils.GetDataTable(SQLString, CnnString);
