...
namespace HSRP.Report
{
    public partial class DailyRegisteringAuthority : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               // row.Index = 7; 
                ...
                SQLString = "Report_Monthly_StatementLocationWiseRegisteringAuthority_Dealer'" + FromDate + "','" + ToDate + "','" + intHSRPStateID + "','" + dropDownListClient.SelectedValue + "'";
        ...
        protected void btnExportToExcel0_Click(object sender, EventArgs e)
        {
            ...
            var colWidthPercentages = new[] { 20f, 95f, 20f, 25f, 25f, 35f, 35f, 35f, 25f };
            ...
            int.TryParse(DropDownListStateName.SelectedValue, out intHSRPStateID);
              ...
              for (int iRowNo = 0; iRowNo < dtrto.Rows.Count; iRowNo++)
              {
                 ...
                 // string PdfFolder = ConfigurationManager.AppSettings["PdfFolder"].ToString() + filename;
                  ...
                  //SQLString = "Report_Monthly_StatementLocationWiseRegisteringAuthority_HR'" + FromDate + "','" + ToDate + "','" + intHSRPStateID + "','" + RTOCode + "'";
                  DataTable ds = Utils.GetDataTable(SQLString, CnnString);
