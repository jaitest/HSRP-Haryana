        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               string strQuery = "insert into HSRPRecords (hsrprecord_authorizationno,hsrprecord_authorizationdate,SaveMacAddress,DeliveryChallanNo,ISFrontPlateSize,ISRearPlateSize,invoiceno, address1," +
                       ...
                       Math.Round(decimal.Parse(lblAmount.Text), 0) + "','" + dt.Rows[0]["vatper"].ToString() + "','" + date1 + "','" + DepositDate.SelectedDate + "','','" + txtexprice.Text + "','" + txtRegNumber.Text.Replace(" ","") + "','" + dealerid + "','Dealer', " + fixcharge + " ,'" + StickerMandatory + "')";
