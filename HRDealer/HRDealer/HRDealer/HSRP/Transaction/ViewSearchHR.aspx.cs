...
namespace HSRP.Transaction
{
    public partial class ViewSearchHR : System.Web.UI.Page
    {
        ...
        private void FilldropDownListHSRPState()
        {
            ...
            {
                SQLString = "select HSRPStateName,HSRP_StateID from HSRPState whereHSRP_StateID=4 ";
                Utils.PopulateDropDownList(dropDownListHSRPState, SQLString.ToString(), CnnString, "--Select State--");
            }
            else
            {
                SQLString = "select HSRPStateName,HSRP_StateID from HSRPState  where HSRP_StateID=4 ";
