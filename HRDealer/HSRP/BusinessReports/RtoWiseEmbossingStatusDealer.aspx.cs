...
{
    public partial class RtoWiseEmbossingStatusDealer : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void SaveAndDownloadFile()
        {
            ...
            Export(strOrderType, book, 1, "Business_report_RTOwiseembossing_SummaryDealer");
        ...
        private void SaveAndDownloadFileAssignment()
        {
            ...
            ExportAssignment(strOrderType, book, 1, "Business_report_AssignmentVSProduction_SummaryDealer");
        ...
        private void PIPVSProduction()
        {
            ...
            Exportpip(strOrderType, book, 1, "Business_report_PIPVSProduction_SummaryDealer");
        ...
        protected void btnPvA_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            string strParameter = string.Empty;
            cmd = new SqlCommand("Business_report_RTOwiseembossing_SummaryDealer", con);
