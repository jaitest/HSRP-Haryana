...
{
    public partial class RtoEmbossingCenterWiseEmbossingStatusDealer : System.Web.UI.Page
    {
        int UserType1;
        ...
        private void FilldropDownListClient()
        {
            ...
            string SQLString = "SELECT  distinct (a.EmbCenterName) as EmbCenterName, (a.NAVEMBID) as NAVEMBID FROM UserRTOLocationMapping INNER JOIN RTOLocation a ON UserRTOLocationMapping.RTOLocationID = a.RTOLocationID where UserRTOLocationMapping.UserID='" + strUserID1 + "' and ActiveStatus='Y' order by EmbCenterName ";
        ...
        private void SaveAndDownloadFileAssignment()
        {
            ...
            ExportAssignment(strOrderType, book, 1, "report_Business_RTOwiseAssignment_SummaryDealer");
