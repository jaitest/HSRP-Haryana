  ...
  <tr>
    <td width="900"><table id="Table1" width="100%" align="center" style="font-size: 16px; color:Black; font-family:Batang; background-color:#fff" >
      ...
      <tr>
        ...
        <td valign="top">
           <div style="" width="150px"> <asp:TextBox ID="txtRegNo" runat="server" CssClass="form_textbox2"></asp:TextBox>  <asp:Button ID="btnGo" runat="server" Text="  Go  " OnClick="btnGo_Click"         CssClass="button" Width="70px"/>  </div>  </td>
       <%-- <td></td>--%>
          <td> <asp:Button ID="Button1" runat="server" Text="  Upload Data  "         CssClass="button" Width="100px"/>       </td>
    ...
    <td valign="top"><table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td class="input-medium" style="width: 184px">Today Booking :</td>
        <td><asp:Label ID="lblCount" runat="server">0</asp:Label></td>
      </tr>
      <tr>
        <td class="input-medium" style="width: 184px">Today Collection Amount :</td>
        <td><asp:Label ID="lblCollection" runat="server">0</asp:Label></td>
      </tr>
          <tr>
                    <td class="input-xlarge" style="width: 186px">Available Amount:</td>
                    <td><asp:Label ID="lblAvailableamt" runat="server">0</asp:Label></td>
            </tr>
      <tr>
