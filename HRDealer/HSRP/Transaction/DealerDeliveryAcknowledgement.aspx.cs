...
namespace HSRP.Transaction
{
    ...
    public partial class DealerDeliveryAcknowledgement : System.Web.UI.Page
    {
        ...
        public void buildGrid()
        {
            try
            {
                string SQLString = "select  HSRPRecordID, VehicleRegNo,HSRPRecord_AuthorizationNo,OwnerName,VehicleClass,VehicleType,HSRP_Front_LaserCode,HSRP_Rear_LaserCode from hsrprecords  where  addrecordby='dealer' and dealerid='" + userdealerid + "' and hsrprecord_creationdate>'2016-12-01 00:00:00' and orderstatus='Embossing Done' and  isnull(challanno,'')!='' and hsrp_stateid = 4  order by VehicleRegNo ";
           ...
           try
            {
                ...
                {        
                   ...
                   if (chk.Checked == true)
                   {
                      ...
                      sbx.Append("update hsrprecords set orderstatus='Closed',ordercloseddate=getdate(),closeduserid='" +strUserID+ "'  where hsrprecordid='" + hsrprecordid.Text.ToString() + "';");
                    }
                }
