...
namespace HSRP.Transaction
{
    public partial class DiveleryReceipt : System.Web.UI.Page
    {
        ...
        public void EpsionPrint(string hsrpRecordID)
        {
            ...
            {
                if (dataSetFillHSRPDeliveryChallan.Rows[0]["fixingcharge"].ToString() == "115.00" || dataSetFillHSRPDeliveryChallan.Rows[0]["fixingcharge"].ToString() == "115" || dataSetFillHSRPDeliveryChallan.Rows[0]["fixingcharge"].ToString() == "287" || dataSetFillHSRPDeliveryChallan.Rows[0]["fixingcharge"].ToString() == "287.50" || dataSetFillHSRPDeliveryChallan.Rows[0]["fixingcharge"].ToString() == "345.00" || dataSetFillHSRPDeliveryChallan.Rows[0]["fixingcharge"].ToString() == "345")
                { 
                ...
                table.AddCell(cell1203);
                  ...
                  PdfPCell cellInv2 = new PdfPCell(new Phrase("Service Tax Registration No", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cellInv2.Colspan = 0;
                ...
                PdfPCell cellInv22 = new PdfPCell(new Phrase(": " + GetAddress.Rows[0]["servicetaxno"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cellInv22.Colspan = 0;
                ...
                PdfPCell cellIv2 = new PdfPCell(new Phrase("Cash Receipt No.", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cellIv2.Colspan = 0;
                ...
                PdfPCell cell21 = new PdfPCell(new Phrase("Cash Receipt DATE ", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell21.Colspan = 0;
                ...
                decimal i = Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["fixingcharge"].ToString());
                 decimal one = i / 115;
                 decimal tax = one * 15;
                 decimal DeliveryCharges = Convert.ToDecimal(dataSetFillHSRPDeliveryChallan.Rows[0]["fixingcharge"].ToString()) - tax;

                PdfPCell cellIv20 = new PdfPCell(new Phrase("Delivery Charges (Amt in Rs.) ", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cellIv2.Colspan = 0;
                ...
                PdfPCell cellInv221110 = new PdfPCell(new Phrase(": " + DeliveryCharges.ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cellNet120 = new PdfPCell(new Phrase("Service Tax  @15%", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell1205 = new PdfPCell(new Phrase(" " + tax.ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell1205.Colspan = 0;
                cell1205.BorderWidthLeft = 0f;
                cell1205.BorderWidthRight = 0f;
                cell1205.BorderWidthTop = 0f;
                ...
                PdfPCell cellNet1200 = new PdfPCell(new Phrase("Total Amount", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell12050 = new PdfPCell(new Phrase(" " + dataSetFillHSRPDeliveryChallan.Rows[0]["fixingcharge"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                cell12050.Colspan = 0;
                ...
                PdfPCell cellNet12000 = new PdfPCell(new Phrase("Dealerid", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
                ...
                PdfPCell cell120500 = new PdfPCell(new Phrase(" " + dataSetFillHSRPDeliveryChallan.Rows[0]["dealerid"].ToString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLACK)));
