...
{
    public partial class CashReceiptDataEntryBihar : System.Web.UI.Page
    {
        ...
        public void fillAffixationCenter()
        {
            ...
            sqlquery = "select Affix_Id,AffixCenterDesc from AffixationCenters where State_Id='" + HSRPStateID + "' and RTO_ID='" + RTOLocationID + "'";
        ...
        public void updateandsaverecords()
        {
            ...
            else
            {
                ...
                Query = "INSERT INTO HSRPRecords (HSRPRecord_CreationDate,HSRP_StateID,RTOLocationID,HSRPRecord_AuthorizationNo,HSRPRecord_AuthorizationDate,VehicleRegNo,OwnerName,ownerFatherName,Address1,MobileNo,VehicleClass,OrderType,StickerMandatory,isVIP,NetAmount,VehicleType,OrderStatus,CashReceiptNo,CreatedBy,ISFrontPlateSize,ISRearPlateSize,FrontPlateSize,RearPlateSize,Reference,ManufacturerModel,vehicleref,FrontplatePrize,RearPlatePrize,StickerPrize,ScrewPrize,TotalAmount,VAT_Amount,RoundOff_NetAmount,VAT_Percentage,Affix_Id,ChassisNo,EngineNo) values(GetDate(),'" + HSRPStateID + "','" + RTOLocationID + "','" + txtAuthorizationNo.Text + "','" + Convert.ToDateTime(OrderDate1).ToString("MM/dd/yyyy") + "','" + txtVehicleRegNo.Text.Trim().ToUpper() + "','" + txtOwnerName.Text + "','" + txtFatherName.Text + "','" + txtAddress.Text + "','" + txtMobileNo.Text + "','" + DropDownListVehicleClass.SelectedItem.ToString() + "','" + DropDownListOrderType.SelectedValue.ToString() + "','" + Sticker + "','" + Vip + "','" + txtAmount.Text + "','" + DropDownListVehicleModel.SelectedItem.ToString() + "','New Order','" + dt1.Rows[0]["PrifixNo"].ToString() + "','" + Session["UID"].ToString() + "','Y','Y','" + DropDownListFrontPlate.SelectedValue + "','" + DropDownListRearPlate.SelectedValue + "','" + txtReference.Text + "','" + vehiclemodel + "','New','" + HiddenFieldFrontPlatePrice.Value + "','" + HiddenFieldRearPlatePrice.Value + "','" + HiddenFieldStickerID.Value + "','" + HiddenFieldscrewrate.Value + "','" + hiddenfieldTotalAmount.Value + "','" + hiddenfieldVATAMOUNT.Value + "','" + hiddenfieldNetAmount.Value + "','" + hiddenfieldTax.Value + "','" + ddlaffixation.SelectedValue + "','"+txtChassisNo.Text+"','"+txtEngineNo.Text+"')";
                    i = Utils.ExecNonQuery(Query, ConnectionString);
        ...
        //public string AffxiationAddress()
        //{
        //    string straddress=string.Empty;
        //    if (ddlaffixation.SelectedItem.ToString() == "ANISHABAD")
        //    {
        //        straddress="DTO,PLOT NO- 258,1st FLOOR,SHIVPURI,UDAN TOLA,BEUR ROAD,ANISHABAD,PATNA- 800002(BIHAR),CONTACT NO.(07781012828)";
        //    }
        //    else if(ddlaffixation.SelectedItem.ToString()=="SIPARA")
        //    {
        //        straddress="DTO, DR.SIMA SINGH, NEAR OXYSON GAS FACTORY MAIN BY PASS ROAD,SIPARA,PATNA- 800001(BIHAR),CONTACT NO.(07781012821)"; 
        //    }
        //    else if(ddlaffixation.SelectedItem.ToString()=="BAILEY ROAD")
        //    {
        //        straddress="DTO,RAM SAHAI PALCE ,NEAR ST. KARENS HIGH SCHOOL,KRISHNA CHOK,BAILEY  ROAD,GOLA ROAD,THANA- RUPAS PUR,PATNA- 801503(BIHAR),CONTACT NO.(07781012821)";
        //    }
        //    else if(ddlaffixation.SelectedItem.ToString()=="MUZAFFARPUR")
        //    {
        //        straddress="DTO,INFRONT OF JHITKAHIYA MAI STHAN,BAIRIYA BRAHAMPURA,MAIN ROAD,MUZAFFARPUR -842003 (BIHAR),CONTACT NO-(07781012809)";
        //    }
        //    return straddress;
        //}
        //string affixationaddress = string.Empty;
        string strquery1 = string.Empty;
      
                

        protected void btna4printing_Click(object sender, EventArgs e)
        {
            //string strAffixDesc=string.Empty;
            strquery1 = "select Address1 from AffixationCenters where Affix_Id='" + ddlaffixation.SelectedValue.ToString() + "'";
            ...
            if (dataSetFillHSRPDeliveryChallan.Rows.Count > 0)
            {
                ...
                {
                    date = System.DateTime.Now.AddDays(2).ToShortDateString();
                }
                PdfPCell cell13 = new PdfPCell(new Phrase("Date : " + Convert.ToDateTime(date).ToString("dd/MM/yyyy") +" dd/mm/yyyy", new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell13.Colspan = 4;
                ...
                PdfPCell cell1213 = new PdfPCell(new Phrase("Time : " + DateTime.Now.AddMinutes(2).ToShortTimeString(), new iTextSharp.text.Font(bfTimes, 8f, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)));
                cell1213.Colspan = 4;
