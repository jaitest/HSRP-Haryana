...
namespace HSRPDataEntryNew.WebReferenceHP {
    using System;
    ...
    public partial class HSRPService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetGSTDetailOperationCompleted;
        ...
        /// <remarks/>
        public event GetGSTDetailCompletedEventHandler GetGSTDetailCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetGSTDetail", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public System.Data.DataTable GetGSTDetail(string Vehicleregno) {
            object[] results = this.Invoke("GetGSTDetail", new object[] {
                        Vehicleregno});
            return ((System.Data.DataTable)(results[0]));
        }
        
        /// <remarks/>
        public void GetGSTDetailAsync(string Vehicleregno) {
            this.GetGSTDetailAsync(Vehicleregno, null);
        }
        
        /// <remarks/>
        public void GetGSTDetailAsync(string Vehicleregno, object userState) {
            if ((this.GetGSTDetailOperationCompleted == null)) {
                this.GetGSTDetailOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetGSTDetailOperationCompleted);
            }
            this.InvokeAsync("GetGSTDetail", new object[] {
                        Vehicleregno}, this.GetGSTDetailOperationCompleted, userState);
        }
        
        private void OnGetGSTDetailOperationCompleted(object arg) {
            if ((this.GetGSTDetailCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetGSTDetailCompleted(this, new GetGSTDetailCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        public System.Data.DataTable Chalan() {
            object[] results = this.Invoke("Chalan", new object[0]);
            return ((System.Data.DataTable)(results[0]));
        }
        
        /// <remarks/>
        public void ChalanAsync() {
            this.ChalanAsync(null);
        }
        
        /// <remarks/>
        public void ChalanAsync(object userState) {
            ...
            this.InvokeAsync("Chalan", new object[0], this.ChalanOperationCompleted, userState);
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2053.0")]
    public delegate void GetGSTDetailCompletedEventHandler(object sender, GetGSTDetailCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2053.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetGSTDetailCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetGSTDetailCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
