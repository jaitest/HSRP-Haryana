        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (strorderstatus == "New Order")
            {
                ...
                else
                {
                    ...
                    //qry = "select laserno from RTOInventory where laserno='" + txtFlaser.Text + "' and inventorystatus not in ('New Order')";
                    //string laservalue = utils.getDataSingleValue(qry, utils.getCnnHSRPApp, "laserno");
                    //if (laservalue != "0")
                    //{
                    //    MessageBox.Show("Front Laser No Already Used.");
                    //    txtFlaser.Focus();
                    ...
                    //laservalue = utils.getDataSingleValue(qry, utils.getCnnHSRPApp, "laserno");
                    //if (laservalue != "0")
                    //{
                    //    MessageBox.Show("Rear Laser No Already Used.");
                    //    txtFlaser.Focus();
