...
namespace HSRPDataEntryNew
{
    public partial class CashReciept : Form
    {
        ...
        private void PrintDocument()
        {
            ...
            DataTable GSTDetail = objWebServiceHP.GetGSTDetail(txtVehRegNo.Text.Trim().ToString());
            DataTable dtgstin = objWebServiceHP.Chalan();
            ...
            p.PrintPage += delegate(object sender1, PrintPageEventArgs ee)
            {
                ...
                ee.Graphics.DrawString(utils.getCompanyName().ToString(), new Font("Times New Roman", 7), new SolidBrush(Color.Black), new Rectangle(0, 10, 950, 950));
                ee.Graphics.DrawString(utils.getRTOLocationAddress().ToString(), new Font("Times New Roman", 8), new SolidBrush(Color.Black), new Rectangle(0, 30, 300, 300));
                ee.Graphics.DrawString("Receipt Date       : " + System.DateTime.Now.ToString("dd-MM-yyyy"), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 70, 300, 300));
                ee.Graphics.DrawString("Receipt No         : " + recno, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 90, 300, 300));
                ee.Graphics.DrawString("Gstin        :  " + dtgstin.Rows[0]["GSTIN"].ToString(), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 110, 300, 300));              
                ee.Graphics.DrawString("Vehicle Reg No   : " + txtVehRegNo.Text, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 130, 300, 300));
                ee.Graphics.DrawString("Owner Name       : " + txtOwnerName.Text, new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 150, 300, 300));
               ee.Graphics.DrawString("Vehicle Class     : " + ddlVehicleClass.SelectedItem.ToString(), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 170, 300, 300));
                ee.Graphics.DrawString("Description Of Goods : " + "HSRP(HSN8310)", new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 190, 300, 300));
                ee.Graphics.DrawString("Vehicle Type      : " + ddlVehType.SelectedItem.ToString(), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 210, 300, 300));
                ee.Graphics.DrawString("HSRP Fee(RS.)     : " + GSTDetail.Rows[0]["gstbasicamount"].ToString(), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 220, 300, 100));
                ee.Graphics.DrawString("CGST" + "@" + Convert.ToInt32(Convert.ToDecimal(GSTDetail.Rows[0]["CGSTPer"].ToString())) + "%" + "                 : " + GSTDetail.Rows[0]["CGSTAmount"].ToString(), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 240, 300, 300));
                ee.Graphics.DrawString("SGST" + "@" + Convert.ToInt32(Convert.ToDecimal(GSTDetail.Rows[0]["SGSTPer"].ToString())) + "%" + "                 : " + GSTDetail.Rows[0]["SGSTAmount"].ToString(), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 260, 300, 300));

                ee.Graphics.DrawString("Total Amount (Round Off) : " + System.Math.Round(Convert.ToDecimal(txtAmount.Text), 0), new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 280, 300, 300));
                ...
                ee.Graphics.DrawString("Disclaimer : ", new Font("Times New Roman", 9), new SolidBrush(Color.Black), new Rectangle(0, 300, 300, 300));

                ee.Graphics.DrawString("Vehicle Owner is requested to please check the Correctness of the cash slip. The company shall not be responsible for any clerical mistake what so ever.", new Font("Times New Roman", 10), new SolidBrush(Color.Black), new Rectangle(0, 340, 260, 300));
